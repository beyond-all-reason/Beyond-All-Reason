...
local triggers = {
	...
	-- No sensorAllyTeamName: any allyTeam other than the unit's own may detect it. The owner is
...
local actions = {
	...
	messageUnscopedDetected = {
		type = actionTypes.SendMessage,
		parameters = { message = "Detected without a sensorAllyTeamName: seen by a non-owning allyTeam." },
	},

	messageUnscopedUndetected = {
		type = actionTypes.SendMessage,
		parameters = { message = "Undetected without a sensorAllyTeamName." },
	},

	messageOwningTeamMatches = {
		type = actionTypes.SendMessage,
		parameters = { message = "owningTeamName matched the target's team." },
	},

	messageOwningTeamUndetected = {
		type = actionTypes.SendMessage,
		parameters = { message = "Undetected with an owningTeamName filter." },
	},

	messageOwningTeamExcludes = {
		type = actionTypes.SendMessage,
		parameters = { message = "BUG: owningTeamName filter let through a unit of another team." },
	},
