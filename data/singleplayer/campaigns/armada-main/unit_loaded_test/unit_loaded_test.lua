...
local actions = {
	...
	spawnDropship = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armatlas", x = 2400, z = 2400, teamName = "thePlayerTeam", unitName = "dropship" },
			},
		},
	},
	...
	spawnPassenger = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armpw", x = 2480, z = 2400, teamName = "thePlayerTeam", unitName = "passenger" },
			},
		},
	},
	...
	spawnConstructor = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "corvac", x = 2200, z = 2400, teamName = "thePlayerTeam" },
			},
		},
	},
