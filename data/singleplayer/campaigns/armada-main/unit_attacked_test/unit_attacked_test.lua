...
local triggers = {
	...
	-- Never fires: the tank belongs to the player team.
	wrongTeamAttacked = {
		type = triggerTypes.UnitAttacked,
		parameters = {
			unitDefName = "armstump",
...
local actions = {
	...
	spawnTarget = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armstump", x = 2400, z = 2400, teamName = "thePlayerTeam", unitName = "target" },
			},
		},
	},
	...
	spawnAlly = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armpw", x = 2440, z = 2400, teamName = "thePlayerTeam", unitName = "ally" },
			},
		},
	},
	...
	spawnEnemy = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "corak", x = 3300, z = 2400, teamName = "theEnemyTeam", unitName = "enemy" },
			},
		},
	},
	...
	messageTankHit = {
		type = actionTypes.SendMessage,
		parameters = {
			message = "A tank on the player team took a hit!",
		},
	},
	...
	messageWrongTeam = {
		type = actionTypes.SendMessage,
		parameters = {
			message = "BUG: an attack on the player team counted for the enemy team!",
		},
	},
