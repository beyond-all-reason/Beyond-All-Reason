...
local actions = {
	...
	spawnGift = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armwin", x = 2400, z = 2400, teamName = "theEnemyTeam", unitName = "gift" },
			},
		},
	},
	...
	spawnSpoils = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armwin", x = 2600, z = 2400, teamName = "theEnemyTeam", unitName = "spoils" },
			},
		},
	},
	...
	spawnPrize = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = "armwin", x = 1600, z = 2800, teamName = "theEnemyTeam", unitName = "prize" },
			},
		},
	},
			...
			unitLoadout = {
				{
					...
					unitName = "decoy",
					orders = { { CMD.FIRE_STATE, CMD.FIRESTATE_HOLDFIRE } },
				},
			},
		},
	},
