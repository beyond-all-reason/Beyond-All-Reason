local unitName = Spring.I18N('units.names.coruwmme')
...
return {
	coruwmme = {
		...
		corpse = "DEAD",
		damagemodifier = 0.5,
		description = Spring.I18N('units.descriptions.coruwmme'),
		energyuse = 20,
		...
		sightdistance = 169,
		yardmap = "h yyooooyy yyssssyy osooooso osossoso osossoso osooooso yyssssyy yyooooyy",
		customparams = {
