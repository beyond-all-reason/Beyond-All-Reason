return {
	cortex_wolverine = {
		...
		objectname = "Units/cortex_wolverine.s3o",
		pushresistant = true,
		script = "Units/cortex_wolverine.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 103,
				object = "Units/cortex_wolverine_dead.s3o",
				reclaimable = true,
