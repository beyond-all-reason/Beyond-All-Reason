return {
	cortex_saviour = {
		...
		noautofire = true,
		nochasecategory = "ALL",
		objectname = "Units/cortex_saviour.s3o",
		radardistance = 50,
		script = "Units/cortex_saviour.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 980,
				object = "Units/cortex_saviour_dead.s3o",
				reclaimable = true,
