local unitName = Spring.I18N('units.names.armcv')
...
return {
	armcv = {
		...
		corpse = "DEAD",
		description = Spring.I18N('units.descriptions.armcv'),
		energymake = 10,
		energystorage = 50,
		energyuse = 10,
