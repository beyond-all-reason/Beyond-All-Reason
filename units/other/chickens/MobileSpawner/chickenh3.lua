local unitName = Spring.I18N('units.names.chickenh3')
...
return {
	chickenh3 = {
		...
		buildcostmetal = 123,
		builder = false,
		buildpic = "chickens/chickenh3.PNG",
		buildtime = 4500,
		canattack = true,
		canguard = true,
		canmove = true,
		...
		-- handled gadget side -- corpse = "chicken_egg_l_white",
		defaultmissiontype = "Standby",
		description = Spring.I18N('units.descriptions.chickenh3'),
		explodeas = "BUG_DEATH",
		floater = false,
		footprintx = 2,
		footprintz = 2,
