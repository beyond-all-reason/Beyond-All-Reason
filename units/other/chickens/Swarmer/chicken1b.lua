local unitName = Spring.I18N('units.names.chicken1b')
...
return {
	chicken1b = {
		...
		description = Spring.I18N('units.descriptions.chicken1b'),
		explodeas = "BUG_DEATH",
		floater = false,
		footprintx = 1,
		footprintz = 1,
		...
		objectname = "Chickens/chicken1b.s3o",
		script = "Chickens/chicken1b.cob",
		seismicsignature = 0,
