return {
	chickenapexallterrainassaultb = {
		...
		buildcostmetal = 302,
		builder = false,
		buildpic = "chickens/chickenapexallterrainassaultb.DDS",
		buildtime = 30000,
		canattack = true,
		canguard = true,
		canmove = true,
		...
		objectname = "Chickens/chickenapexallterrainassaultb.s3o",
		onlytargetcategory2 = "VTOL",
		script = "Chickens/chickenapexallterraina.cob",
		seismicsignature = 0,
