local unitName = Spring.I18N('units.names.chickena1c')
...
return {
	chickena1c = {
		...
		buildcostmetal = 152,
		builder = false,
		buildpic = "chickens/chickena1c.PNG",
		buildtime = 7500,
		canattack = true,
		canguard = true,
		canmove = true,
		...
		corpse = "chicken_egg_l_pink",
		defaultmissiontype = "Standby",
		description = Spring.I18N('units.descriptions.chickena1c'),
