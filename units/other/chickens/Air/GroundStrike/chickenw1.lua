local unitName = Spring.I18N('units.names.chickenw1')
...
return {
	chickenw1 = {
		...
		buildcostmetal = 72,
		builder = false,
		buildpic = "chickens/chickenw1.DDS",
		buildtime = 1950,
		cancrash = false,
		canfly = true,
		canguard = true,
		...
		description = Spring.I18N('units.descriptions.chickenw1'),
		...
		objectname = "Chickens/chicken_pidgeon.s3o",
		script = "Chickens/chickenw1.cob",
		seismicsignature = 0,
