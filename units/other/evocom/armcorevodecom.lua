...
for i = 2, 10 do
	...
	if
		unitsTable["armdecomlvl" .. i].weapondefs.backlauncher
		and unitsTable["armdecomlvl" .. i].weapondefs.backlauncher.customparams.stockpilelimit
	then
		unitsTable["armdecomlvl" .. i].weapondefs.backlauncher.customparams.stockpilelimit =
			math.ceil(unitsTable["armdecomlvl" .. i].weapondefs.backlauncher.customparams.stockpilelimit * 0.4)
	end
	...
	if
		unitsTable["cordecomlvl" .. i].weapondefs.repulsor
		and unitsTable["cordecomlvl" .. i].weapondefs.repulsor.shield.power
	then
		unitsTable["cordecomlvl" .. i].weapondefs.repulsor.shield.power = unitsTable["cordecomlvl" .. i].weapondefs.repulsor.shield.power
			* 0.2
	end
end
