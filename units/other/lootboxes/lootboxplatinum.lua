return {
	lootboxplatinum = {
		...
		corpse = "HEAP",
		description = "Platinum Resource Generator Capture & Transport",
		energymake = 1400,
		...
		featuredefs = {
			dead = {
				...
				collisionvolumetype = "Box",
				damage = 50000,
				description = "Platinum Lootbox Wreckage",
				energy = 40000,
				featuredead = "HEAP",
			...
			heap = {
				...
				damage = 2000,
				description = "Platinum Lootbox Heap",
				energy = 0,
				featurereclamate = "SMUDGE01",
				footprintx = 3,
				footprintz = 3,
