return {
	armmaruder = {
		...
		objectname = "Units/scavboss/ARMMARUDER.s3o",
		script = "Units/scavboss/armmaruder.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 592,
				object = "Units/scavboss/armmaruder_dead.s3o",
				reclaimable = true,
