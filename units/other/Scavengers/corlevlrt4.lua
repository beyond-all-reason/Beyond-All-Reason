return {
	corlevlrt4 = {
		...
		objectname = "Units/scavboss/CORLEVLRT4.s3o",
		script = "Units/scavboss/CORLEVLRT4.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				collisionvolumetype = "Box",
				damage = 100000,
				description = "Epic Leveler Wreckage",
				energy = 0,
				...
				hitdensity = 100,
				metal = 17200,
				object = "Units/scavboss/corlevlrt4_dead.s3o",
				reclaimable = true,
