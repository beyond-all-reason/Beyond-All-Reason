return {
	armrazorfront = {
		...
		movementclass = "HBOT4",
		name = "Razorfront",
		objectname = "Units/scavboss/ARMRAZORFRONT.s3o",
		script = "Units/scavboss/armrazorfront.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				collisionvolumetype = "Box",
				damage = 1500,
				description = "Razorfront Wreckage",
				energy = 0,
				featuredead = "HEAP",
				...
				hitdensity = 100,
				metal = 2325,
				object = "Units/scavboss/armrazorfront_dead.s3o",
				reclaimable = true,
