return {
	armada_sweeper = {
		...
		objectname = "Units/armada_sweeper.s3o",
		script = "Units/armada_sweeper.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 141,
				object = "Units/armada_sweeper_dead.s3o",
				reclaimable = true,
