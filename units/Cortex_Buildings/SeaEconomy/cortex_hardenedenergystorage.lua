return {
	cortex_hardenedenergystorage = {
		...
		energycost = 11000,
		metalcost = 840,
		buildpic = "cortex_hardenedenergystorage.DDS",
		buildtime = 20400,
		canrepeat = false,
		...
		maxslope = 20,
		maxwaterdepth = 9999,
		objectname = "Units/cortex_hardenedenergystorage.s3o",
		script = "Units/cortex_hardenedenergystorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_hardenedenergystorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 514,
				object = "Units/cortex_hardenedenergystorage_dead.s3o",
				reclaimable = true,
