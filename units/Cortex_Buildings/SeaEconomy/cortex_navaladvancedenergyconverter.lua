return {
	cortex_navaladvancedenergyconverter = {
		...
		energycost = 23500,
		metalcost = 400,
		buildpic = "cortex_navaladvancedenergyconverter.DDS",
		buildtime = 38600,
		canrepeat = false,
		...
		maxslope = 16,
		minwaterdepth = 15,
		objectname = "Units/cortex_navaladvancedenergyconverter.s3o",
		script = "Units/cortex_navaladvancedenergyconverter.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 242,
				object = "Units/cortex_navaladvancedenergyconverter_dead.s3o",
				reclaimable = true,
