return {
	cortex_navalenergystorage = {
		...
		energycost = 2700,
		metalcost = 300,
		buildpic = "cortex_navalenergystorage.DDS",
		buildtime = 7250,
		canrepeat = false,
		...
		maxslope = 20,
		minwaterdepth = 31,
		objectname = "Units/cortex_navalenergystorage.s3o",
		script = "Units/cortex_navalenergystorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_navalenergystorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 182,
				object = "Units/cortex_navalenergystorage_dead.s3o",
				reclaimable = true,
