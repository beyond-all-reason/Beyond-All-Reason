return {
	cortex_hardenedmetalstorage = {
		...
		energycost = 11000,
		metalcost = 760,
		buildpic = "cortex_hardenedmetalstorage.DDS",
		buildtime = 20500,
		canrepeat = false,
		...
		maxwaterdepth = 9999,
		metalstorage = 10000,
		objectname = "Units/cortex_hardenedmetalstorage.s3o",
		script = "Units/cortex_hardenedmetalstorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_hardenedmetalstorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 462,
				object = "Units/cortex_hardenedmetalstorage_dead.s3o",
				reclaimable = true,
