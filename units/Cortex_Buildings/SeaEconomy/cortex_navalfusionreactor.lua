return {
	cortex_navalfusionreactor = {
		...
		energycost = 34000,
		metalcost = 5400,
		buildpic = "cortex_navalfusionreactor.DDS",
		buildtime = 105000,
		canrepeat = false,
		...
		maxslope = 16,
		minwaterdepth = 25,
		objectname = "Units/cortex_navalfusionreactor.s3o",
		script = "Units/cortex_navalfusionreactor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_navalfusionreactor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 3099,
				object = "Units/cortex_navalfusionreactor_dead.s3o",
				reclaimable = true,
