return {
	cortex_advancedbotlab = {
		...
		metalcost = 2900,
		builder = true,
		buildpic = "cortex_advancedbotlab.DDS",
		buildtime = 16800,
		canmove = true,
		...
		maxwaterdepth = 0,
		metalstorage = 200,
		objectname = "Units/cortex_advancedbotlab.s3o",
		--radardistance = 50,
		script = "Units/cortex_advancedbotlab.lua",
		seismicsignature = 0,
		...
		buildoptions = {
			[1] = "cortex_advancedconstructionbot",
			[2] = "cortex_twitcher",
			[3] = "cortex_fiend",
			[4] = "cortex_duck",
			[5] = "cortex_sumo",
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedbotlab_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1743,
				object = "Units/cortex_advancedbotlab_dead.s3o",
				reclaimable = true,
