return {
	cortex_aircraftplant = {
		...
		maxwaterdepth = 0,
		metalstorage = 100,
		objectname = "Units/cortex_aircraftplant.s3o",
		radardistance = 510,
		radaremitheight = 40,
		script = "Units/cortex_aircraftplant.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_aircraftplant_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 540,
				object = "Units/cortex_aircraftplant_dead.s3o",
				reclaimable = true,
