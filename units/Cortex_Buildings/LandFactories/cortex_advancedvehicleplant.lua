return {
	cortex_advancedvehicleplant = {
		...
		metalcost = 2800,
		builder = true,
		buildpic = "cortex_advancedvehicleplant.DDS",
		buildtime = 18500,
		canmove = true,
		...
		maxwaterdepth = 0,
		metalstorage = 200,
		objectname = "Units/cortex_advancedvehicleplant.s3o",
		--radardistance = 50,
		script = "Units/cortex_advancedvehicleplant.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedvehicleplant_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1721,
				object = "Units/cortex_advancedvehicleplant_dead.s3o",
				reclaimable = true,
