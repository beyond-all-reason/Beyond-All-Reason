return {
	cortex_advancedsonarstation = {
		...
		energycost = 2400,
		metalcost = 160,
		buildpic = "cortex_advancedsonarstation.DDS",
		buildtime = 6100,
		canattack = false,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 24,
		objectname = "Units/cortex_advancedsonarstation.s3o",
		onoffable = false,
		script = "Units/cortex_advancedsonarstation.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedsonarstation_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 99,
				object = "Units/cortex_advancedsonarstation_dead.s3o",
				reclaimable = true,
