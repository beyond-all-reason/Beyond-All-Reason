return {
	cortex_navalpinpointer = {
		...
		energycost = 7500,
		metalcost = 800,
		buildpic = "cortex_navalpinpointer.DDS",
		buildtime = 10300,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 30,
		objectname = "Units/cortex_navalpinpointer.s3o",
		onoffable = true,
		script = "Units/cortex_navalpinpointer.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 447,
				object = "Units/cortex_navalpinpointer_dead.s3o",
				reclaimable = true,
