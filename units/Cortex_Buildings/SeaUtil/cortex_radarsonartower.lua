return {
	cortex_radarsonartower = {
		...
		energycost = 1000,
		metalcost = 130,
		buildpic = "cortex_radarsonartower.DDS",
		buildtime = 1800,
		canattack = false,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 5,
		objectname = "Units/cortex_radarsonartower.s3o",
		onoffable = false,
		radardistance = 2100,
		radaremitheight = 72,
		script = "Units/cortex_radarsonartower.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 80,
				object = "Units/cortex_radarsonartower_dead.s3o",
				reclaimable = true,
