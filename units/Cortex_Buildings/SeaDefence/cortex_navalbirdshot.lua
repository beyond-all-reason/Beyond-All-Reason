return {
	cortex_navalbirdshot = {
		...
		energycost = 25000,
		metalcost = 890,
		buildpic = "cortex_navalbirdshot.DDS",
		buildtime = 23100,
		canrepeat = false,
		...
		health = 2000,
		minwaterdepth = 2,
		objectname = "Units/cortex_navalbirdshot.s3o",
		script = "Units/cortex_navalbirdshot.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 541,
				object = "Units/cortex_navalbirdshot_dead.s3o",
				reclaimable = true,
