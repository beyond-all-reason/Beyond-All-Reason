...
return {
	cortex_devastator = {
		...
		energycost = 15000,
		metalcost = 1200,
		buildpic = "cortex_devastator.DDS",
		buildtime = 24000,
		canrepeat = false,
		...
		objectname = "Units/cortex_devastator.s3o",
		onoffable = true,
		script = "Units/cortex_devastator.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			removewait = true,
			subfolder = "cortex_buildings/seadefence",
			techlevel = 2,
		},
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 600,
				object = "Units/cortex_devastator_dead.s3o",
				reclaimable = true,
