return {
	cortex_lamprey = {
		...
		health = 2800,
		minwaterdepth = 12,
		objectname = "Units/cortex_lamprey.s3o",
		script = "Units/cortex_lamprey.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 676,
				object = "Units/cortex_lamprey_dead.s3o",
				reclaimable = true,
