return {
	cortex_jellyfish = {
		...
		maxslope = 15,
		maxwaterdepth = 0,
		objectname = "Units/cortex_jellyfish.s3o",
		script = "Units/cortex_jellyfish.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_jellyfish_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 182,
				object = "Units/cortex_jellyfish_dead.s3o",
				reclaimable = true,
