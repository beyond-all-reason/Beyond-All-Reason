return {
	cortex_dragonsmaw = {
		...
		energycost = 1550,
		metalcost = 290,
		buildpic = "cortex_dragonsmaw.DDS",
		buildtime = 4420,
		canrepeat = false,
		...
		objectname = "Units/cortex_dragonsmaw.s3o",
		radardistancejam = 8,
		script = "Units/cortex_dragonsmaw.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_dragonsmaw_aoplane.dds",
			buildinggrounddecalsizey = 4,
			buildinggrounddecalsizex = 4,
			buildinggrounddecaldecayspeed = 30,
			unitgroup = 'weapon',
			decoyfor = "cortex_dragonsmaw",
			model_author = "Mr Bob",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 177,
				object = "Units/cortex_dragonsteeth.s3o",
				reclaimable = true,
