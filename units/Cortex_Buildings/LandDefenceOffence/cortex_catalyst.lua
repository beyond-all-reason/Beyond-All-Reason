return {
	cortex_catalyst = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_catalyst.s3o",
		script = "Units/cortex_catalyst.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_catalyst_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 445,
				object = "Units/cortex_catalyst_dead.s3o",
				reclaimable = true,
