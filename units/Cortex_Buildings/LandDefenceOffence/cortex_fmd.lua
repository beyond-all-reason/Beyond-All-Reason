return {
	cortex_prevailer = {
		...
		maxwaterdepth = 0,
		noautofire = true,
		objectname = "Units/cortex_prevailer.s3o",
		radardistance = 50,
		script = "Units/cortex_prevailer.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_prevailer_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 980,
				object = "Units/cortex_prevailer_dead.s3o",
				reclaimable = true,
