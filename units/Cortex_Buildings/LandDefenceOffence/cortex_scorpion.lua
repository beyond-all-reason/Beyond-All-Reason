return {
	cortex_scorpion = {
		...
		objectname = "Units/cortex_scorpion.s3o",
		script = "Units/cortex_scorpion.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_scorpion_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 380,
				object = "Units/cortex_scorpion_dead.s3o",
				reclaimable = true,
