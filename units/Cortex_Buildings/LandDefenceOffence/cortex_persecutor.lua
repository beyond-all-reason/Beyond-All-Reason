return {
	cortex_persecutor = {
		...
		energycost = 17000,
		metalcost = 2500,
		buildpic = "cortex_persecutor.DDS",
		buildtime = 25700,
		canrepeat = false,
		...
		objectname = "Units/cortex_persecutor.s3o",
		onoffable = true,
		script = "Units/cortex_persecutor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_persecutor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1507,
				object = "Units/cortex_persecutor_dead.s3o",
				reclaimable = true,
		...
		weapons = {
			...
			[2] = {
				badtargetcategory = "VTOL GROUNDSCOUT",
				def = "cortex_persecutor_GUN_HIGH",
				onlytargetcategory = "SURFACE",
			},
		},
	},
