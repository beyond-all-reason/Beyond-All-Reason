return {
	cortex_apocalypse = {
		...
		energycost = 82000,
		metalcost = 7700,
		buildpic = "cortex_apocalypse.DDS",
		buildtime = 181000,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_apocalypse.s3o",
		radardistance = 50,
		script = "Units/cortex_apocalypse.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_apocalypse_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 4672,
				object = "Units/cortex_apocalypse_dead.s3o",
				reclaimable = true,
