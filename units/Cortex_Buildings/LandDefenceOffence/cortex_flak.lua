return {
	cortex_birdshot = {
		...
		maxwaterdepth = 0,
		nochasecategory = "ALL",
		objectname = "Units/cortex_birdshot.s3o",
		script = "Units/cortex_birdshot.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_birdshot_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 515,
				object = "Units/cortex_birdshot_dead.s3o",
				reclaimable = true,
