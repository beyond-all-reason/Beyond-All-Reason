return {
	cortex_thistle = {
		...
		maxwaterdepth = 0,
		nochasecategory = "ALL",
		objectname = "Units/cortex_thistle.s3o",
		script = "Units/cortex_thistle.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_thistle_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 49,
				object = "Units/cortex_thistle_dead.s3o",
				reclaimable = true,
