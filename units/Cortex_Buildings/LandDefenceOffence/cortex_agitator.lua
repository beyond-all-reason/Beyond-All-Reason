return {
	cortex_agitator = {
		...
		objectname = "Units/cortex_agitator.s3o",
		onoffable = true,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_agitator_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 936,
				object = "Units/cortex_agitator_dead.s3o",
				reclaimable = true,
