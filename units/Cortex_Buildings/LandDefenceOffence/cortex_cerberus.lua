return {
	cortex_cerberus = {
		...
		objectname = "Units/cortex_cerberus.s3o",
		script = "Units/cortex_cerberus.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_cerberus_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1917,
				object = "Units/cortex_cerberus_dead.s3o",
				reclaimable = true,
