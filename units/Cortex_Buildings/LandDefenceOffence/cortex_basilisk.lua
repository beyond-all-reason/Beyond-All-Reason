return {
	cortex_basilisk = {
		...
		maxslope = 13,
		maxwaterdepth = 0,
		objectname = "Units/cortex_basilisk.s3o",
		script = "Units/cortex_basilisk.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_basilisk_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 2813,
				object = "Units/cortex_basilisk_dead.s3o",
				reclaimable = true,
