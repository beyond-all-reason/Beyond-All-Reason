return {
	cortex_bulwark = {
		...
		objectname = "Units/cortex_bulwark.s3o",
		onoffable = true,
		radardistance = 1200,
		radaremitheight = 80,
		script = "Units/cortex_bulwark.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_bulwark_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1611,
				object = "Units/cortex_bulwark_dead.s3o",
				reclaimable = true,
