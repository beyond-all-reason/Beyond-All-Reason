return {
	cortex_eradicator = {
		...
		energycost = 7900,
		metalcost = 800,
		buildpic = "cortex_eradicator.DDS",
		buildtime = 12000,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_eradicator.s3o",
		script = "Units/cortex_eradicator.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_eradicator_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 370,
				object = "Units/cortex_eradicator_dead.s3o",
				reclaimable = true,
