return {
	cortex_advancedshipyard = {
		...
		metalcost = 3100,
		builder = true,
		buildpic = "cortex_advancedshipyard.DDS",
		buildtime = 15700,
		canmove = true,
		...
		metalstorage = 200,
		minwaterdepth = 30,
		objectname = "Units/cortex_advancedshipyard.s3o",
		script = "Units/cortex_advancedshipyard.cob",
		seismicsignature = 0,
		...
		buildoptions = {
			[1] = "cortex_advancedconstructionsub",
			[2] = "cortex_pathfinder",
			[3] = "cortex_buccaneer",
			[4] = "cortex_predator",
			[5] = "cortex_kraken",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 2174,
				object = "Units/cortex_advancedshipyard_dead.s3o",
				reclaimable = true,
