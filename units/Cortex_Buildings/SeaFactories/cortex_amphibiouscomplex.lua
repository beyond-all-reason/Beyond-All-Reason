return {
	cortex_amphibiouscomplex = {
		...
		metalcost = 1200,
		builder = true,
		buildpic = "cortex_amphibiouscomplex.DDS",
		buildtime = 11400,
		canmove = true,
		...
		maxslope = 10,
		minwaterdepth = 25,
		objectname = "Units/cortex_amphibiouscomplex.s3o",
		script = "Units/cortex_amphibiouscomplex.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_amphibiouscomplex_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 800,
				object = "Units/cortex_amphibiouscomplex_dead.s3o",
				reclaimable = true,
