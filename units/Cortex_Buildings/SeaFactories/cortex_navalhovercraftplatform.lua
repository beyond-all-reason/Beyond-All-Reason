return {
	cortex_navalhovercraftplatform = {
		...
		metalcost = 900,
		builder = true,
		buildpic = "cortex_navalhovercraftplatform.DDS",
		buildtime = 11000,
		canmove = true,
		...
		metalstorage = 200,
		minwaterdepth = 5,
		objectname = "Units/cortex_navalhovercraftplatform.s3o",
		--radardistance = 50,
		script = "Units/cortex_navalhovercraftplatform.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 715,
				object = "Units/cortex_navalhovercraftplatform_dead.s3o",
				reclaimable = true,
