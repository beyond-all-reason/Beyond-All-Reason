return {
	cortex_seaplaneplatform = {
		...
		metalcost = 1400,
		builder = true,
		buildpic = "cortex_seaplaneplatform.DDS",
		buildtime = 11800,
		canmove = true,
		...
		health = 2200,
		minwaterdepth = 30,
		objectname = "Units/cortex_seaplaneplatform.s3o",
		--radardistance = 50,
		script = "Units/cortex_seaplaneplatform.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 930,
				object = "Units/cortex_seaplaneplatform_dead.s3o",
				reclaimable = true,
