return {
	cortex_overseer = {
		...
		maxwaterdepth = 0,
		noautofire = true,
		objectname = "Units/cortex_overseer.s3o",
		onoffable = false,
		script = "Units/cortex_overseer.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_overseer_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 2000,
				object = "Units/cortex_overseer_dead.s3o",
				reclaimable = true,
