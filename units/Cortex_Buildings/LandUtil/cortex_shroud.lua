return {
	cortex_shroud = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_shroud.s3o",
		onoffable = true,
		radardistancejam = 700,
		script = "Units/cortex_shroud.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_shroud_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 81,
				object = "Units/cortex_shroud_dead.s3o",
				reclaimable = true,
