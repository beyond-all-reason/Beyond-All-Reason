return {
	cortex_nemesis = {
		...
		maxslope = 36,
		maxwaterdepth = 0,
		objectname = "Units/cortex_nemesis.s3o",
		onoffable = true,
		script = "Units/cortex_nemesis.cob",
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_nemesis_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 584,
				object = "Units/cortex_nemesis_dead.s3o",
				reclaimable = true,
