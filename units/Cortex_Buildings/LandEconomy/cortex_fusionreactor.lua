return {
	cortex_fusionreactor = {
		...
		energycost = 26000,
		metalcost = 4500,
		buildpic = "cortex_fusionreactor.DDS",
		buildtime = 75400,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 1,
		objectname = "Units/cortex_fusionreactor.s3o",
		script = "Units/cortex_fusionreactor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_fusionreactor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 2927,
				object = "Units/cortex_fusionreactor_dead.s3o",
				reclaimable = true,
