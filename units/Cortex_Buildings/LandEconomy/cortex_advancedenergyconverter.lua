return {
	cortex_advancedenergyconverter = {
		...
		energycost = 21000,
		metalcost = 370,
		buildpic = "cortex_advancedenergyconverter.DDS",
		buildtime = 31300,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_advancedenergyconverter.s3o",
		script = "Units/cortex_advancedenergyconverter.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedenergyconverter_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 228,
				object = "Units/cortex_advancedenergyconverter_dead.s3o",
				reclaimable = true,
