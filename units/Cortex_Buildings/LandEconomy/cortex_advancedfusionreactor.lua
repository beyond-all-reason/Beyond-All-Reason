return {
	cortex_advancedfusionreactor = {
		...
		energycost = 48000,
		metalcost = 9700,
		buildpic = "cortex_advancedfusionreactor.DDS",
		buildtime = 329200,
		canrepeat = false,
		...
		maxslope = 13,
		maxwaterdepth = 0,
		objectname = "Units/cortex_advancedfusionreactor.s3o",
		script = "Units/cortex_advancedfusionreactor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedfusionreactor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 6440,
				object = "Units/cortex_advancedfusionreactor_dead.s3o",
				reclaimable = true,
