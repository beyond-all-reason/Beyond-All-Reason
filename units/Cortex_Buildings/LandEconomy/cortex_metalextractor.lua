return {
	cortex_metalextractor = {
		...
		metalcost = 50,
		buildingmask = 0,
		buildpic = "cortex_metalextractor.DDS",
		buildtime = 1870,
		canrepeat = false,
		...
		--maxwaterdepth = 20,
		metalstorage = 50,
		objectname = "Units/cortex_metalextractor.s3o",
		onoffable = true,
		script = "Units/cortex_metalextractor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_metalextractor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 33,
				object = "Units/cortex_metalextractor_dead.s3o",
				reclaimable = true,
