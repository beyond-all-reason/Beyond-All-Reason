return {
	cortex_energyconverter = {
		...
		energycost = 1250,
		metalcost = 1,
		buildpic = "cortex_energyconverter.DDS",
		buildtime = 2680,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_energyconverter.s3o",
		script = "Units/cortex_energyconverter.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_energyconverter_aoplane.dds",
