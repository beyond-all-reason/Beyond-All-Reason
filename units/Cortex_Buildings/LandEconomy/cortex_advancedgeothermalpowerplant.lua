return {
	cortex_advancedgeothermalpowerplant = {
		...
		energycost = 27000,
		metalcost = 1500,
		buildpic = "cortex_advancedgeothermalpowerplant.DDS",
		buildtime = 32000,
		canrepeat = false,
		...
		maxslope = 20,
		maxwaterdepth = 5,
		objectname = "Units/cortex_advancedgeothermalpowerplant.s3o",
		script = "Units/cortex_advancedgeothermalpowerplant.lua",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedgeothermalpowerplant_aoplane.dds",
