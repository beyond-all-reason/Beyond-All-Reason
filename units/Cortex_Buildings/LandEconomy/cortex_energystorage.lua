return {
	cortex_energystorage = {
		...
		energycost = 1800,
		metalcost = 175,
		buildpic = "cortex_energystorage.DDS",
		buildtime = 4260,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/cortex_energystorage.s3o",
		script = "Units/cortex_energystorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_energystorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 108,
				object = "Units/cortex_energystorage_dead.s3o",
				reclaimable = true,
