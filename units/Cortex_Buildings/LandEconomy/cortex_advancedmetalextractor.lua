return {
	cortex_advancedmetalextractor = {
		...
		metalcost = 640,
		buildingmask = 0,
		buildpic = "cortex_advancedmetalextractor.DDS",
		buildtime = 14100,
		canrepeat = false,
		...
		maxwaterdepth = 20,
		metalstorage = 600,
		objectname = "Units/cortex_advancedmetalextractor.s3o",
		onoffable = true,
		script = "Units/cortex_advancedmetalextractor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_advancedmetalextractor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 318,
				object = "Units/cortex_advancedmetalextractor_dead.s3o",
				reclaimable = true,
