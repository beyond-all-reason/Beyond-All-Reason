return {
	cortex_duck = {
		...
		objectname = "Units/cortex_duck.s3o",
		radardistance = 300,
		script = "Units/cortex_duck.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 152,
				object = "Units/cortex_duck_dead.s3o",
				reclaimable = true,
		...
		weapons = {
			[1] = {
				def = "cortex_duck_WEAPON1",
				onlytargetcategory = "NOTHOVER",
			},
			[2] = {
				badtargetcategory = "VTOL",
				def = "cortex_duck_WEAPON2",
