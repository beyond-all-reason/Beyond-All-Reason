return {
	cortex_arbiter = {
		...
		objectname = "Units/cortex_arbiter.s3o",
		script = "Units/cortex_arbiter.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 194,
				object = "Units/cortex_arbiter_dead.s3o",
				reclaimable = true,
