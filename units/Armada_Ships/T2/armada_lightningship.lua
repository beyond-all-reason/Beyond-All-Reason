return {
	armada_lightningship = {
		...
		energycost = 14800,
		metalcost = 740,
		buildpic = "armada_lightningship.DDS",
		buildtime = 14800,
		canmove = true,
		...
		objectname = "Units/armada_lightningship.s3o",
		radardistance = 750,
		radaremitheight = 52,
		script = "Units/armada_lightningship.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 390,
				object = "Units/armada_lightningship_dead.s3o",
				reclaimable = true,
