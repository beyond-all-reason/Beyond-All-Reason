return {
	armbanth = {
		...
		collisionvolumescales = "58 91 58",
		...
		featuredefs = {
			dead = {
				blocking = true,
				category = "corpses",
				collisionvolumeoffsets = "5.18798065186 -2.00430091553 -5.70808410645",
				collisionvolumescales = "76.8059539795 25.2949981689 79.8361816406",
