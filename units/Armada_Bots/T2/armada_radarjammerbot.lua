return {
	armada_radarjammerbot = {
		...
		energycost = 1400,
		metalcost = 78,
		buildpic = "armada_radarjammerbot.DDS",
		buildtime = 4940,
		canattack = false,
		canmove = true,
		...
		objectname = "Units/armada_radarjammerbot.s3o",
		onoffable = true,
		radardistancejam = 450,
		script = "Units/armada_radarjammerbot.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 47,
				object = "Units/armada_radarjammerbot_dead.s3o",
				reclaimable = true,
