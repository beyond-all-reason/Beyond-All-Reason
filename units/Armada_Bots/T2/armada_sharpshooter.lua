return {
	armada_sharpshooter = {
		...
		energycost = 20000,
		metalcost = 680,
		buildpic = "armada_sharpshooter.DDS",
		buildtime = 19000,
		canmove = true,
		...
		objectname = "Units/armada_sharpshooter.s3o",
		power = 750, --compensation for XP rank with super low AoE weapons
		script = "Units/armada_sharpshooter.cob",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 322,
				object = "Units/armada_sharpshooter_dead.s3o",
				reclaimable = true,
		...
		weapondefs = {
			armada_sharpshooter_weapon = {	-- NOTE this range of 900 was shown in unit stats but was only effectively 800 by range
				areaofeffect = 16,
				avoidfeature = true,
				avoidfriendly = true,
				beamtime = 0.1,
			...
			old_armada_sharpshooter_weapon = {
				areaofeffect = 16,
				avoidfeature = false,
				collidefriendly = false,
				craterareaofeffect = 0,
		...
		weapons = {
			[1] = {
				def = "OLD_armada_sharpshooter_WEAPON",
