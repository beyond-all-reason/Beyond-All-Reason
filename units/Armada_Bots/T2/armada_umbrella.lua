return {
	armada_umbrella = {
		...
		noautofire = true,
		nochasecategory = "ALL",
		objectname = "Units/armada_umbrella.s3o",
		radardistance = 50,
		script = "Units/armada_umbrella.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 934,
				object = "Units/armada_umbrella_dead.s3o",
				reclaimable = true,
