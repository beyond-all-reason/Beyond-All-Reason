return {
	armada_centurion = {
		...
		objectname = "Units/armada_centurion.s3o",
		script = "Units/armada_centurion.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 161,
				object = "Units/armada_centurion_dead.s3o",
				reclaimable = true,
