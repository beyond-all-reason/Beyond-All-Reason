return {
	armada_prophet = {
		...
		maxwaterdepth = 0,
		movementclass = "TANK3",
		objectname = "Units/armada_prophet.s3o",
		onoffable = false,
		radardistance = 2300,
		script = "Units/armada_prophet.cob",
		seismicsignature = 0,
		selfdestructas = "smallExplosionGenericSelfd",
		sightdistance = 900,
		trackoffset = 5,
		trackstrength = 5,
		tracktype = "armada_prophet_tracks",
		trackwidth = 24,
		turninplace = true,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 80,
				object = "Units/armada_prophet_dead.s3o",
				reclaimable = true,
