return {
	armada_shredder = {
		...
		objectname = "Units/armada_shredder.s3o",
		script = "Units/armada_shredder.cob",
		seismicsignature = 0,
		selfdestructas = "mediumExplosionGenericSelfd",
		sightdistance = 390,
		trackoffset = 6,
		trackstrength = 5,
		tracktype = "armada_shredder_tracks",
		trackwidth = 33,
		turninplace = true,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 276,
				object = "Units/armada_shredder_dead.s3o",
				reclaimable = true,
