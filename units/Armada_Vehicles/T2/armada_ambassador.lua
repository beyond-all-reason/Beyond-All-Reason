return {
	armada_ambassador = {
		...
		energycost = 6500,
		metalcost = 920,
		buildpic = "armada_ambassador.DDS",
		buildtime = 15500,
		canmove = true,
		...
		objectname = "Units/armada_ambassador.s3o",
		script = "Units/armada_ambassador.cob",
		seismicsignature = 0,
		...
		trackoffset = 15,
		trackstrength = 8,
		tracktype = "armada_turtle_tracks",
		trackwidth = 44,
		turninplace = true,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 560,
				object = "Units/armada_ambassador_dead.s3o",
				reclaimable = true,
