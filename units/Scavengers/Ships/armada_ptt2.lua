...
return {
	armada_skatert2 = {
		...
		objectname = "Units/scavboss/armada_skaterT2.s3o",
		script = "Units/scavboss/armada_skaterT2.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1250,
				object = "Units/scavboss/armada_skatert2_dead.s3o",
				reclaimable = true,
