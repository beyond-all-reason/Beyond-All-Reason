return {
	cortex_experimentalaircraftplant = {
		...
		metalcost = 8500,
		builder = true,
		buildpic = "cortex_aircraftplant.DDS",
		buildtime = 72400,
		canmove = true,
		...
		maxwaterdepth = 0,
		metalstorage = 1000,
		objectname = "Units/scavbuildings/cortex_experimentalaircraftplant.s3o",
		radardistance = 510,
		radaremitheight = 40,
		script = "Units/scavbuildings/cortex_experimentalaircraftplant.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_experimentalaircraftplant_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 5400,
				object = "Units/scavbuildings/cortex_experimentalaircraftplant_dead.s3o",
				reclaimable = true,
