return {
	cortex_calamityt3 = {
		...
		energycost = 400000,
		metalcost = 12000,
		buildpic = "cortex_calamityT3.DDS",
		buildtime = 170000,
		canrepeat = false,
		...
		objectname = "Units/scavbuildings/cortex_calamityT3.s3o",
		onoffable = true,
		radardistance = 1200,
		radaremitheight = 80,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_calamityt3_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 4833,
				object = "Units/scavbuildings/cortex_calamityt3_dead.s3o",
				reclaimable = true,
