return {
	cortex_2printer = {
		...
		objectname = "Units/scavboss/cortex_2printer.s3o",
		script = "Units/scavboss/cortex_2printer.cob",
		seismicsignature = 0,
		...
		customparams = {
			unitgroup = 'buildert2',
			model_author = "Itanthias, carved up cortex_intruder, with bolted on nanotower",
