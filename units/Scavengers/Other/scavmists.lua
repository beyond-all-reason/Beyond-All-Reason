local lvlParams = {
	...
	xxl = {
		...
		landturretspawns = "armflak armminivulc corhllllt corflak legbombard legflak corgatr armlwall cormwall legrwall armlwall cormwall legrwall armlwall cormwall legrwall",
