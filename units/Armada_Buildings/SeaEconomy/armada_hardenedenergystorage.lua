return {
	armada_hardenedenergystorage = {
		...
		energycost = 10000,
		metalcost = 830,
		buildpic = "armada_hardenedenergystorage.DDS",
		buildtime = 20300,
		canrepeat = false,
		...
		maxslope = 20,
		maxwaterdepth = 9999,
		objectname = "Units/armada_hardenedenergystorage.s3o",
		script = "Units/armada_hardenedenergystorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_hardenedenergystorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 502,
				object = "Units/armada_hardenedenergystorage_dead.s3o",
				reclaimable = true,
