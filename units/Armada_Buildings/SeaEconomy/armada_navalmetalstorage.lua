return {
	armada_navalmetalstorage = {
		...
		energycost = 1200,
		metalcost = 400,
		buildpic = "armada_navalmetalstorage.DDS",
		buildtime = 3750,
		canrepeat = false,
		...
		metalstorage = 3000,
		minwaterdepth = 31,
		objectname = "Units/armada_navalmetalstorage.s3o",
		script = "Units/armada_navalmetalstorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_navalmetalstorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 234,
				object = "Units/armada_navalmetalstorage_dead.s3o",
				reclaimable = true,
