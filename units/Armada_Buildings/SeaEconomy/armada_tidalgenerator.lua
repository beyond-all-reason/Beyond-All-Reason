return {
	armada_tidalgenerator = {
		...
		energycost = 250,
		metalcost = 90,
		buildpic = "armada_tidalgenerator.DDS",
		buildtime = 2190,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 20,
		objectname = "Units/armada_tidalgenerator.s3o",
		onoffable = false,
		script = "Units/armada_tidalgenerator.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 53,
				object = "Units/armada_tidalgenerator_dead.s3o",
				reclaimable = true,
