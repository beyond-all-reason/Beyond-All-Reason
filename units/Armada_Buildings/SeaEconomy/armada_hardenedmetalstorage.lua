return {
	armada_hardenedmetalstorage = {
		...
		energycost = 11500,
		metalcost = 750,
		buildpic = "armada_hardenedmetalstorage.DDS",
		buildtime = 20400,
		canrepeat = false,
		...
		maxwaterdepth = 9999,
		metalstorage = 10000,
		objectname = "Units/armada_hardenedmetalstorage.s3o",
		script = "Units/armada_hardenedmetalstorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_hardenedmetalstorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 458,
				object = "Units/armada_hardenedmetalstorage_dead.s3o",
				reclaimable = true,
