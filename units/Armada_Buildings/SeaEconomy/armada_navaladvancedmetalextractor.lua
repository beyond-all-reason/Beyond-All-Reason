return {
	armada_navaladvancedmetalextractor = {
		...
		metalcost = 650,
		buildingmask = 0,
		buildpic = "armada_navaladvancedmetalextractor.DDS",
		buildtime = 24800,
		canrepeat = false,
		...
		metalstorage = 600,
		minwaterdepth = 15,
		objectname = "Units/armada_navaladvancedmetalextractor.s3o",
		onoffable = true,
		script = "Units/armada_navaladvancedmetalextractor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_navaladvancedmetalextractor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 391,
				object = "Units/armada_navaladvancedmetalextractor_dead.s3o",
				reclaimable = true,
