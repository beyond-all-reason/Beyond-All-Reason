return {
	armada_navalenergystorage = {
		...
		energycost = 2600,
		metalcost = 300,
		buildpic = "armada_navalenergystorage.DDS",
		buildtime = 7090,
		canrepeat = false,
		...
		maxslope = 20,
		minwaterdepth = 30,
		objectname = "Units/armada_navalenergystorage.s3o",
		script = "Units/armada_navalenergystorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_navalenergystorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 185,
				object = "Units/armada_navalenergystorage_dead.s3o",
				reclaimable = true,
