return {
	armada_navaladvancedenergyconverter = {
		...
		energycost = 24000,
		metalcost = 400,
		buildpic = "armada_navaladvancedenergyconverter.DDS",
		buildtime = 38960,
		canrepeat = false,
		...
		maxslope = 16,
		minwaterdepth = 15,
		objectname = "Units/armada_navaladvancedenergyconverter.s3o",
		script = "Units/armada_navaladvancedenergyconverter.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 247,
				object = "Units/armada_navaladvancedenergyconverter_dead.s3o",
				reclaimable = true,
