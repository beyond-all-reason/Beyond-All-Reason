return {
	armada_navalfusionreactor = {
		...
		energycost = 33500,
		metalcost = 5200,
		buildpic = "armada_navalfusionreactor.DDS",
		buildtime = 99900,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 25,
		objectname = "Units/armada_navalfusionreactor.s3o",
		script = "Units/armada_navalfusionreactor.cob",
		selfdestructas = "fusionExplosionSelfd-uw",
		sightdistance = 143,
		yardmap = "oooooo oooooo oooooo oooooo",
		customparams = {
			usebuildinggrounddecal = true,
			buildinggrounddecaltype = "decals/armada_navalfusionreactor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 3034,
				object = "Units/armada_navalfusionreactor_dead.s3o",
				reclaimable = true,
