return {
	armada_keeper = {
		...
		maxwaterdepth = 0,
		noautofire = true,
		objectname = "Units/armada_keeper.s3o",
		onoffable = false,
		script = "Units/armada_keeper.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_keeper_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 2000,
				object = "Units/armada_keeper_dead.s3o",
				reclaimable = true,
