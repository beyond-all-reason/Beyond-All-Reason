return {
	armada_veil = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_veil.s3o",
		onoffable = true,
		radardistancejam = 760,
		script = "Units/armada_veil.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_veil_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 77,
				object = "Units/armada_veil_dead.s3o",
				reclaimable = true,
