return {
	armada_advancedradartower = {
		...
		energycost = 19000,
		metalcost = 560,
		buildpic = "armada_advancedradartower.DDS",
		buildtime = 11800,
		canattack = false,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_advancedradartower.s3o",
		onoffable = false,
		radardistance = 3500,
		radaremitheight = 66,
		script = "Units/armada_advancedradartower.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_advancedradartower_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 341,
				object = "Units/armada_advancedradartower_dead.s3o",
				reclaimable = true,
