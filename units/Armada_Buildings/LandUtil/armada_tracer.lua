return {
	armada_tracer = {
		...
		maxslope = 36,
		maxwaterdepth = 0,
		objectname = "Units/armada_tracer.s3o",
		onoffable = true,
		script = "Units/armada_tracer.cob",
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_tracer_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 566,
				object = "Units/armada_tracer_dead.s3o",
				reclaimable = true,
