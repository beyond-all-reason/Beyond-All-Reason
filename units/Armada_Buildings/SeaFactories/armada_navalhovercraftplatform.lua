return {
	armada_navalhovercraftplatform = {
		...
		metalcost = 900,
		builder = true,
		buildpic = "armada_navalhovercraftplatform.DDS",
		buildtime = 11000,
		canmove = true,
		...
		metalstorage = 200,
		minwaterdepth = 5,
		objectname = "Units/armada_navalhovercraftplatform.s3o",
		--radardistance = 50,
		script = "Units/armada_navalhovercraftplatform.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 670,
				object = "Units/armada_navalhovercraftplatform_dead.s3o",
				reclaimable = true,
