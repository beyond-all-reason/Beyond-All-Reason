return {
	armada_seaplaneplatform = {
		...
		metalcost = 1450,
		builder = true,
		buildpic = "armada_seaplaneplatform.DDS",
		buildtime = 12000,
		canmove = true,
		...
		health = 2000,
		minwaterdepth = 30,
		objectname = "Units/armada_seaplaneplatform.s3o",
		onoffable = true,
		radardistance = 750,
		script = "Units/armada_seaplaneplatform.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 975,
				object = "Units/armada_seaplaneplatform_dead.s3o",
				reclaimable = true,
