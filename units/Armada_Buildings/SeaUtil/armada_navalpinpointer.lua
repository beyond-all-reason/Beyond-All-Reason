return {
	armada_navalpinpointer = {
		...
		energycost = 7300,
		metalcost = 800,
		buildpic = "armada_navalpinpointer.DDS",
		buildtime = 9880,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 30,
		objectname = "Units/armada_navalpinpointer.s3o",
		onoffable = true,
		script = "Units/armada_navalpinpointer.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 467,
				object = "Units/armada_navalpinpointer_dead.s3o",
				reclaimable = true,
