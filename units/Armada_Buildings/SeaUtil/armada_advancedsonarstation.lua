return {
	armada_advancedsonarstation = {
		...
		energycost = 2600,
		metalcost = 170,
		buildpic = "armada_advancedsonarstation.DDS",
		buildtime = 6150,
		canattack = false,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 24,
		objectname = "Units/armada_advancedsonarstation.s3o",
		onoffable = false,
		script = "Units/armada_advancedsonarstation.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_advancedsonarstation_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 106,
				object = "Units/armada_advancedsonarstation_dead.s3o",
				reclaimable = true,
