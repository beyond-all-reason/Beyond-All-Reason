return {
	armada_navalradarsonar = {
		...
		energycost = 1000,
		metalcost = 130,
		buildpic = "armada_navalradarsonar.DDS",
		buildtime = 1800,
		canattack = false,
		canrepeat = false,
		...
		maxslope = 10,
		minwaterdepth = 5,
		objectname = "Units/armada_navalradarsonar.s3o",
		onoffable = false,
		radardistance = 2100,
		radaremitheight = 52,
		script = "Units/armada_navalradarsonar.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 83,
				object = "Units/armada_navalradarsonar_dead.s3o",
				reclaimable = true,
