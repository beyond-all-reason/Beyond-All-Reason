return {
	armada_moray = {
		...
		health = 2800,
		minwaterdepth = 12,
		objectname = "Units/armada_moray.s3o",
		script = "Units/armada_moray.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 548,
				object = "Units/armada_moray_dead.s3o",
				reclaimable = true,
