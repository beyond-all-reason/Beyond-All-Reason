return {
	armada_anemone = {
		...
		maxslope = 15,
		maxwaterdepth = 0,
		objectname = "Units/armada_anemone.s3o",
		script = "Units/armada_anemone.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_anemone_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 176,
				object = "Units/armada_anemone_dead.s3o",
				reclaimable = true,
