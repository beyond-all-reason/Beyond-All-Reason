return {
	armada_navalarbalest = {
		...
		energycost = 23000,
		metalcost = 850,
		buildpic = "armada_navalarbalest.DDS",
		buildtime = 21900,
		canrepeat = false,
		...
		health = 1920,
		minwaterdepth = 5,
		objectname = "Units/armada_navalarbalest.s3o",
		script = "Units/armada_navalarbalest.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 525,
				object = "Units/armada_navalarbalest_dead.s3o",
				reclaimable = true,
