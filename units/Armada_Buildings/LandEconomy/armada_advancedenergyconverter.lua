return {
	armada_advancedenergyconverter = {
		...
		energycost = 21000,
		metalcost = 380,
		buildpic = "armada_advancedenergyconverter.DDS",
		buildtime = 35000,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_advancedenergyconverter.s3o",
		script = "Units/armada_advancedenergyconverter.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_advancedenergyconverter_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 233,
				object = "Units/armada_advancedenergyconverter_dead.s3o",
				reclaimable = true,
