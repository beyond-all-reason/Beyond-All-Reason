return {
	armada_solarcollector = {
		...
		energycost = 0,
		metalcost = 155,
		buildpic = "armada_solarcollector.DDS",
		buildtime = 2800,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_solarcollector.s3o",
		onoffable = true,
		script = "Units/armada_solarcollector.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_solarcollector_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 75,
				object = "Units/armada_solarcollector_dead.s3o",
				reclaimable = true,
