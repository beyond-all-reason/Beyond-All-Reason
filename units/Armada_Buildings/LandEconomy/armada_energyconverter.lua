return {
	armada_energyconverter = {
		...
		energycost = 1150,
		metalcost = 1,
		buildpic = "armada_energyconverter.DDS",
		buildtime = 2600,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_energyconverter.s3o",
		script = "Units/armada_energyconverter.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_energyconverter_aoplane.dds",
