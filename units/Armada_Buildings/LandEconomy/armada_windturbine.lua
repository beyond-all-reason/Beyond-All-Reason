return {
	armada_windturbine = {
		...
		energycost = 175,
		metalcost = 37,
		buildpic = "armada_windturbine.DDS",
		buildtime = 1600,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_windturbine.s3o",
		script = "Units/armada_windturbine.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_windturbine_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 23,
				object = "Units/armada_windturbine_dead.s3o",
				reclaimable = true,
