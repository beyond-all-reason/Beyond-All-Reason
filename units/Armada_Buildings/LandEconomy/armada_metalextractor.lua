return {
	armada_metalextractor = {
		...
		metalcost = 50,
		buildingmask = 0,
		buildpic = "armada_metalextractor.DDS",
		buildtime = 1800,
		canrepeat = false,
		...
		--maxwaterdepth = 20,
		metalstorage = 50,
		objectname = "Units/armada_metalextractor.s3o",
		onoffable = true,
		script = "Units/armada_metalextractor.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_metalextractor_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 33,
				object = "Units/armada_metalextractor_dead.s3o",
				reclaimable = true,
