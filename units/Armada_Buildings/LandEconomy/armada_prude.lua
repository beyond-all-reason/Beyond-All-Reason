return {
	armada_prude = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_prude.s3o",
		script = "Units/armada_prude.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_prude_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 600,
				object = "Units/armada_prude_dead.s3o",
				reclaimable = true,
