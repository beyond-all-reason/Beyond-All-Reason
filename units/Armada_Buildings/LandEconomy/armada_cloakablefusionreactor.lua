return {
	armada_cloakablefusionreactor = {
		...
		energycost = 26000,
		metalcost = 4700,
		buildpic = "armada_cloakablefusionreactor.DDS",
		buildtime = 84400,
		canrepeat = false,
		...
		objectname = "Units/armada_cloakablefusionreactor.s3o",
		script = "Units/armada_cloakablefusionreactor.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 3100,
				object = "Units/armada_cloakablefusionreactor_dead.s3o",
				reclaimable = true,
