return {
	armada_energystorage = {
		...
		energycost = 1700,
		metalcost = 170,
		buildpic = "armada_energystorage.DDS",
		buildtime = 4110,
		canrepeat = false,
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_energystorage.s3o",
		script = "Units/armada_energystorage.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_energystorage_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 103,
				object = "Units/armada_energystorage_dead.s3o",
				reclaimable = true,
