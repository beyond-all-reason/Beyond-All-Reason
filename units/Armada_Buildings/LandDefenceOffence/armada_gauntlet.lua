return {
	armada_gauntlet = {
		...
		objectname = "Units/armada_gauntlet.s3o",
		onoffable = true,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_gauntlet_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 890,
				object = "Units/armada_gauntlet_dead.s3o",
				reclaimable = true,
