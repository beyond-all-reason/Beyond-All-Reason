return {
	armada_chainsaw = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_chainsaw.s3o",
		script = "Units/armada_chainsaw.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_chainsaw_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 370,
				object = "Units/armada_chainsaw_dead.s3o",
				reclaimable = true,
