return {
	armada_paralyzer = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_paralyzer.s3o",
		script = "Units/armada_paralyzer.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_paralyzer_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 976,
				object = "Units/armada_paralyzer_dead.s3o",
				reclaimable = true,
