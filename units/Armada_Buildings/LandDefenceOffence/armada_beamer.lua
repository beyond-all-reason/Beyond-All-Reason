return {
	armada_beamer = {
		...
		maxslope = 10,
		maxwaterdepth = 0,
		objectname = "Units/armada_beamer.s3o",
		script = "Units/armada_beamer.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_beamer_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 114,
				object = "Units/armada_beamer_dead.s3o",
				reclaimable = true,
