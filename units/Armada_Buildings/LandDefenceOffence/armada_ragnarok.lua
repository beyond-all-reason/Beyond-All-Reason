return {
	armada_ragnarok = {
		...
		maxslope = 13,
		maxwaterdepth = 0,
		objectname = "Units/armada_ragnarok.s3o",
		script = "Units/armada_ragnarok.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_ragnarok_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 30000,
				object = "Units/armada_ragnarok_dead.s3o",
				reclaimable = true,
