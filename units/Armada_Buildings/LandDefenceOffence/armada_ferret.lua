return {
	armada_ferret = {
		...
		mincloakdistance = 72,
		nochasecategory = "ALL",
		objectname = "Units/armada_ferret.s3o",
		script = "Units/armada_ferret.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_ferret_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 233,
				object = "Units/armada_ferret_dead.s3o",
				reclaimable = true,
