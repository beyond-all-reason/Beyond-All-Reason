return {
	armada_mercury = {
		...
		maxslope = 20,
		maxwaterdepth = 0,
		objectname = "Units/armada_mercury.s3o",
		script = "Units/armada_mercury.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_mercury_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1022,
				object = "Units/armada_mercury_dead.s3o",
				reclaimable = true,
