return {
	armada_dragonsclaw = {
		...
		energycost = 1600,
		metalcost = 340,
		buildpic = "armada_dragonsclaw.DDS",
		buildtime = 4650,
		canrepeat = false,
		...
		objectname = "Units/armada_dragonsclaw.s3o",
		radardistancejam = 8,
		script = "Units/armada_dragonsclaw.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_dragonsclaw_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 205,
				object = "Units/armada_dragonsteeth.s3o",
				reclaimable = true,
