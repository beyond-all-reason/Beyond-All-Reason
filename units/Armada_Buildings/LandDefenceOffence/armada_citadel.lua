return {
	armada_citadel = {
		...
		maxwaterdepth = 0,
		noautofire = true,
		objectname = "Units/armada_citadel.s3o",
		radardistance = 50,
		script = "Units/armada_citadel.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_citadel_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 934,
				object = "Units/armada_citadel_dead.s3o",
				reclaimable = true,
