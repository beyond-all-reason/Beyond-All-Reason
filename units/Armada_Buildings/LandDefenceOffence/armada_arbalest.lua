return {
	armada_arbalest = {
		...
		maxwaterdepth = 0,
		nochasecategory = "ALL",
		objectname = "Units/armada_arbalest.s3o",
		script = "Units/armada_arbalest.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_arbalest_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 500,
				object = "Units/armada_arbalest_dead.s3o",
				reclaimable = true,
