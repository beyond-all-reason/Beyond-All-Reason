return {
	armada_pulsar = {
		...
		objectname = "Units/armada_pulsar.s3o",
		onoffable = true,
		radardistance = 1500,
		radaremitheight = 72,
		script = "Units/armada_pulsar.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/armada_pulsar_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1940,
				object = "Units/armada_pulsar_dead.s3o",
				reclaimable = true,
