return {
	leggant = {
		...
		maxwaterdepth = 0,
		metalstorage = 800,
		objectname = "Units/cortex_experimentalgantry.s3o",
		radardistance = 50,
		script = "Units/cortex_experimentalgantry.cob",
		seismicsignature = 0,
		...
		customparams = {
			...
			buildinggrounddecaltype = "decals/cortex_experimentalgantry_aoplane.dds",
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 5101,
				object = "Units/cortex_experimentalgantry_dead.s3o",
				reclaimable = true,
