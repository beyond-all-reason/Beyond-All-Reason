...
for i = 2, 10 do
	unitsTable["legdecomlvl" .. i] =
		VFS.Include("units/Legion/Legion EvoCom/legcomlvl" .. i .. ".lua")["legcomlvl" .. i] --if this filepath is changed, the unit will no longer work!
	...
	if
		unitsTable["legdecomlvl" .. i].weapondefs.botcannon
		and unitsTable["legdecomlvl" .. i].weapondefs.botcannon.customparams.stockpilelimit
	then
		unitsTable["legdecomlvl" .. i].weapondefs.botcannon.customparams.stockpilelimit =
			math.ceil(unitsTable["legdecomlvl" .. i].weapondefs.botcannon.customparams.stockpilelimit * 0.4)
	end
end
