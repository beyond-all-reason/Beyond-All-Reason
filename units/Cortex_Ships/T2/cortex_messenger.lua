return {
	cortex_messenger = {
		...
		objectname = "Units/cortex_messenger.s3o",
		radardistance = 1000,
		script = "Units/cortex_messenger.cob",
		seismicsignature = 0,
		...
		featuredefs = {
			dead = {
				...
				hitdensity = 100,
				metal = 1000,
				object = "Units/cortex_messenger_dead.s3o",
				reclaimable = true,
		...
		weapondefs = {
			...
			rocket = {
				...
				customparams = {
					...
					def = "cortex_messenger_rocket_split",
