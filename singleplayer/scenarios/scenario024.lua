local scenariodata = {
	...
	/luarules armada_constructionvehicle armada_constructionbot 11000 1 12000
    ...
    difficulties    = { -- Array for sortedness, Keys are text that appears in selector (as well as in scoring!), values are handicap levels
		{name = "1 unit spawn rate", playerhandicap = "armada_constructionvehicle armada_constructionbot 11000 1 12000" , enemyhandicap = 0},
		{name = "3 unit spawn rate", playerhandicap = "armada_constructionvehicle armada_constructionbot 11000 3 12000" , enemyhandicap = 0},
		{name = "10 unit spawn rate", playerhandicap = "armada_constructionvehicle armada_constructionbot 11000 10 12000" , enemyhandicap = 0},
		{name = "15 unit spawn rate", playerhandicap = "armada_constructionvehicle armada_constructionbot 11000 15 12000" , enemyhandicap = 0},
    },
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
		...
		benchmarkcommand = "luarules fightertest armada_constructionvehicle armada_constructionbot 11000 1 12000", -- make sure the matches the debugcommands identically named modoption's info
