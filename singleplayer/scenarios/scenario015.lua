 ...
 ‣  Brutal: Regular resources for you, +100% for the enemy
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
		...
		unitloadout = {
			...
			{name = 'armada_commander', x = 10114, y = 86, z = 2076, rot = 0 , team = 2},
			{name = 'cortex_commander', x = 11342, y = 89, z = 6616, rot = 0 , team = 3},
			{name = 'armada_commander', x = 8995, y = 87, z = 10831, rot = 0 , team = 4},
			{name = 'armada_commander', x = 4417, y = 88, z = 11187, rot = -11476 , team = 5},
			{name = 'cortex_commander', x = 903, y = 87, z = 7821, rot = 0 , team = 6},
		}
    },
