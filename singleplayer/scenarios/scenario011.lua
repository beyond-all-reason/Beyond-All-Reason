...
Tips:
    1. On Speed Metal, metal extractors can be built anywhere and have a rather high output. Wind Generators are by far the best energy source here, being consistently set to the maximum possible wind (25 e/s).
    2. You start with a dozen Dragon Eyes and enough energy to keep them cloaked. Use this to tell how much time you have before the enemy Behemoths reach your base.
    3. Since most land options will likely be blocked by the garguantuan Behemoths, consider using air options to infiltrate. Armada has two main air assault options: the Banshee, a more mobile light gunship with a machine gun weapon, and the Stormbringer, a traditional bomber that drops 5 bombs in a line. If you choose to make bombers, be sure to send air scouts before them to scout out the enemy.
    4. The Stork air transport may be used to drop units to the enemy base, but be careful as the enemy has light anti-air turrets that will shoot mediocre drop attempts down.
    5. As a last ditch attempt, the Commander may attempt to D-Gun the Behemoths, which will one tap them. Be wary that if your Commander dies, you lose!
