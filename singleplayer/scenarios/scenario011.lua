 ...
 - Resources spent to kill the enemy commander
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
        ...
        unitloadout = {
            ...
            {name = 'armada_solarcollector', x = 936, y = 118, z = 1064, rot = -16384 , team = 0},
            {name = 'armada_solarcollector', x = 856, y = 118, z = 984, rot = -16384 , team = 0},
            {name = 'armada_solarcollector', x = 776, y = 118, z = 984, rot = -16384 , team = 0},
            {name = 'armada_beholder', x = 2013, y = 118, z = 809, rot = 0 , team = 0},
            {name = 'armada_solarcollector', x = 696, y = 118, z = 984, rot = -16384 , team = 0},
            {name = 'armada_beholder', x = 2005, y = 118, z = 1232, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 5968, y = 118, z = 807, rot = 0 , team = 0},
            {name = 'armada_solarcollector', x = 856, y = 118, z = 1064, rot = -16384 , team = 0},
            {name = 'armada_beholder', x = 5955, y = 118, z = 1242, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 7335, y = 118, z = 812, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 7347, y = 118, z = 1229, rot = 0 , team = 0},
            {name = 'armada_solarcollector', x = 776, y = 118, z = 1064, rot = -16384 , team = 0},
            {name = 'armada_beholder', x = 11308, y = 118, z = 819, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 11304, y = 118, z = 1231, rot = 0 , team = 0},
            {name = 'armada_solarcollector', x = 696, y = 118, z = 1064, rot = -16384 , team = 0},
            {name = 'armada_beholder', x = 13285, y = 118, z = 67, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 13280, y = 118, z = 704, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 13279, y = 118, z = 1342, rot = 0 , team = 0},
            {name = 'armada_beholder', x = 13284, y = 118, z = 1984, rot = 0 , team = 0},
            {name = 'cortex_guard', x = 11488, y = 118, z = 732, rot = 0 , team = 1},
            {name = 'cortex_guard', x = 11485, y = 118, z = 474, rot = 0 , team = 1},
            {name = 'cortex_guard', x = 11484, y = 118, z = 219, rot = 0 , team = 1},
            {name = 'cortex_guard', x = 11486, y = 118, z = 1312, rot = 0 , team = 1},
            {name = 'cortex_guard', x = 11484, y = 118, z = 1563, rot = 0 , team = 1},
            {name = 'cortex_guard', x = 11485, y = 118, z = 1824, rot = 0 , team = 1},
            {name = 'cortex_thistle', x = 11608, y = 118, z = 600, rot = -16384 , team = 1},
            {name = 'cortex_thistle', x = 11608, y = 118, z = 360, rot = -16384 , team = 1},
            {name = 'cortex_thistle', x = 11608, y = 118, z = 1448, rot = -16384 , team = 1},
            {name = 'cortex_thistle', x = 11608, y = 118, z = 1688, rot = -16384 , team = 1},
            {name = 'cortex_radartower', x = 11600, y = 118, z = 1568, rot = -16384 , team = 1},
            {name = 'cortex_radartower', x = 11600, y = 118, z = 480, rot = -16384 , team = 1},
            {name = 'armada_sentry', x = 7201, y = 118, z = 1020, rot = 0 , team = 0},
		},
		featureloadout = {
