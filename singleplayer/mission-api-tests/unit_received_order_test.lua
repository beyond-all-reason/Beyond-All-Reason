...
local actions = {
	...
	spawnActors = {
		...
		parameters = {
			unitLoadout = {
				{ unitDefName = 'armpw', x = 1800, z = 1600, team = 0, unitName = 'bots', quantity = 2 },
				{ unitDefName = 'armck', x = 1700, z = 2000, team = 0, unitName = 'cons' },
				{ unitDefName = 'armlab', x = 2100, z = 2000, facing = 's', team = 0, unitName = 'lab' },
			},
		},
	},
