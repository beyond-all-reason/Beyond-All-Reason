...
------------------------------------------------------------------
function Spring.Utilities.LoadTGA(fileName) -- returns texture | nil, error on failure
...
function Spring.Utilities.SaveTGA(texture, fileName) --return nil | error on failure
...
function Spring.Utilities.NewTGA(width, height, channels, initvalue) -- returns the new 'texture table' or nil, error
