...
---@param resource any
---@param amount number
function Gadgets.ShareTeamResource(springRepo, teamID, targetTeamID, resource, amount)
  local resolved = EnsureResourceType(resource)
...
---@param policies table<number, table<ResourceType, ResourcePolicyResult>>|nil
function Gadgets.ProcessEconomy(springRepo, teamsList, policies)
  return WaterfillSolver.ProcessEconomy(springRepo, teamsList, policies)
end
