...
-- Assembles a ResourceData snapshot from Spring.GetTeamResources. The engine has no
-- Spring.GetTeamResourceData; this backs the GG.GetTeamResourceData synthetic call.
