...
function addon.Initialize()
	...
	--	return
	--end
	local originalSoundtrackEnabled = SpringUnsynced.GetConfigInt('UseSoundtrackNew', 1)
	local customSoundtrackEnabled	= SpringUnsynced.GetConfigInt('UseSoundtrackCustom', 1)
	...
	if originalSoundtrackEnabled == 1 then
		...
		-- April Fools
		---- Day 1 - 100% chance
		if SpringUnsynced.GetConfigInt('UseSoundtrackAprilFools', 1) == 1 and Spring.Utilities.Gametype.GetCurrentHolidays()["aprilfools_specialDay"] then
			table.append(musicPlaylistEvent, VFS.DirList(musicDirOriginal..'/events/aprilfools/loading', allowedExtensions))
		---- Day 2-7 - 50% chance
		elseif SpringUnsynced.GetConfigInt('UseSoundtrackAprilFools', 1) == 1 and Spring.Utilities.Gametype.GetCurrentHolidays()["aprilfools"] and math.random() <= 0.5 then
			table.append(musicPlaylistEvent, VFS.DirList(musicDirOriginal..'/events/aprilfools/loading', allowedExtensions))
		---- Post Event - Add to regular playlist
		elseif SpringUnsynced.GetConfigInt('UseSoundtrackAprilFoolsPostEvent', 0) == 1 and (not Spring.Utilities.Gametype.GetCurrentHolidays()["aprilfools"]) then
		...
		if SpringUnsynced.GetConfigInt('UseSoundtrackHalloween', 1) == 1 and Spring.Utilities.Gametype.GetCurrentHolidays()["halloween_specialDay"] then
		...
		elseif SpringUnsynced.GetConfigInt('UseSoundtrackHalloween', 1) == 1 and Spring.Utilities.Gametype.GetCurrentHolidays()["halloween"] and math.random() <= 0.5 then
			table.append(musicPlaylistEvent, VFS.DirList(musicDirOriginal..'/events/halloween/loading', allowedExtensions))
		---- Post Event - Add to regular playlist
		elseif SpringUnsynced.GetConfigInt('UseSoundtrackHalloweenPostEvent', 0) == 1 and (not Spring.Utilities.Gametype.GetCurrentHolidays()["halloween_specialDay"]) then
		...
		if SpringUnsynced.GetConfigInt('UseSoundtrackXmas', 1) == 1 and Spring.Utilities.Gametype.GetCurrentHolidays()["xmas_specialDay"] then
		...
		elseif SpringUnsynced.GetConfigInt('UseSoundtrackXmas', 1) == 1 and Spring.Utilities.Gametype.GetCurrentHolidays()["xmas"] and math.random() <= 0.5 then
			table.append(musicPlaylistEvent, VFS.DirList(musicDirOriginal..'/events/xmas/loading', allowedExtensions))
		---- Post Event - Add to regular playlist
		elseif SpringUnsynced.GetConfigInt('UseSoundtrackXmasPostEvent', 0) == 1 and (not Spring.Utilities.Gametype.GetCurrentHolidays()["xmas"]) then
	...
	local musicvolume = SpringUnsynced.GetConfigInt("snd_volmusic", 50) * 0.01
	if #musicPlaylistEvent > 0 then
		local pickedTrack = musicPlaylistEvent[math.random(1, #musicPlaylistEvent)]
		SpringUnsynced.PlaySoundStream(pickedTrack, 1)
		SpringUnsynced.SetSoundStreamVolume(musicvolume)
		SpringUnsynced.SetConfigString('music_loadscreen_track', pickedTrack)
