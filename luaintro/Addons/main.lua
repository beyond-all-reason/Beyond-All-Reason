...
local unit_descs = {
	"armck.dds "..titleColor.."Construction ARM T1 Kbot\n"..contentColor.."It is slightly slower and weaker than vehicle constructor, but it can climb steeper hills, effective at expansion on mountainous terrain.",
	"armflea.dds "..titleColor.."Flea ARM T1 Kbot\n"..contentColor.."Supercheap and fast, used for scouting and damaging the early enemy structures. Evade laser towers and destroy metal extractors to slow down your foe’s expansion!",
	"armham.dds "..titleColor.."Hammer ARM T1 Kbot\n"..contentColor.."Deals sizeable damage with relatively low cost. Used in big numbers to destroy T1 defences. Combine with resurrection Kbots (Rector), for an effective front push.",
	"armjeth.dds "..titleColor.."Jethro ARM T1 Kbot\n"..contentColor.."Amphibious mobile anti-air to take down light aircrafts. Always send a few with your army to protect it from EMP drones/gunships.",
	"armpw.dds "..titleColor.."Peewee ARM T1 Kbot\n"..contentColor.."Cheap and having high top speeds but low health. Can be useful for scouting and taking down unguarded metal extractors and eco. Also used to ambush Commanders.",
	...
	"corcrash.dds "..titleColor.."Crasher CORE T1 Kbot\n"..contentColor.."Amphibious mobile anti-air (AA) Kbot, that can easily take down light aircrafts. Send a few with your army to protect it from EMP drones/gunships.",
	"corstorm.dds "..titleColor.."Storm CORE T1 Kbot\n"..contentColor.."Light rocket Kbot used to push the frontline towards opponent's base. Outranges light laser turrets. Slow but stronger than the ARM counterpart.",
	"cornecro.dds "..titleColor.."Necro CORE T1 Kbot\n"..contentColor.."Resurrection Kbot that can turn wrecks alive again, also can reclaim and repair units.",
	"corthud.dds "..titleColor.."Thud CORE T1 Kbot\n"..contentColor.."Deals sizeable damage with relatively low cost. Used in big numbers to destroy T1 defences. Combine with resurrection Kbots (Necro), for an effective front push.",
	...
	"armbeaver.dds "..titleColor.."Beaver ARM T1 Vehicle\n"..contentColor.."Amphibious construction vehicle, can travel on land and underwater allowing easy expansion between islands, under rivers and across seas. Can build the amphibious factory.",
	"armcv.dds "..titleColor.."Construction ARM T1 Vehicle\n"..contentColor.."Able to build basic T1 structures like the Commander. Slightly faster and stronger than Kbot constructor. Each Construction vehicle increases the player's energy and metal storage capacity by 50.",
	"armjanus.dds "..titleColor.."Janus ARM T1 Vehicle\n"..contentColor.."Heavy dual rocket tank. Slow speed and fire rate makes vulnerable. Its good damage and AoE makes up for it though. Works best with heavy micro and attenton.",
	"armmlv.dds "..titleColor.."Podger ARM T1 Vehicle\n"..contentColor.."Stealthy minelayer and sweeper. Use the attack command to clear mines in an area. REMEMBER that mines use energy to remain cloaked!",
	"armpincer.dds "..titleColor.."Pincer ARM T1 Vehicle\n"..contentColor.."Light amphibious tank which can travel on land and underwater. Weaker than most tanks. Aavoid direct fire exchange and try to surprise enemies by destroying undefended targets near the shoreline.",
	"armsam.dds "..titleColor.."Samson ARM T1 Vehicle\n"..contentColor.."Missile truck that can target surface and air units. It's range is good and line-of-sight aswell. A good supporter unit.",
	"armstump.dds "..titleColor.."Stumpy ARM T1 Vehicle\n"..contentColor.."An general purpose assault tank. Has good armour and is good to group them and strike enemy defences and units",
	...
	"armca.dds "..titleColor.."Construction ARM T1 Aircraft\n"..contentColor.."Can make basic T1 structures like the Commander plus advanced land and air defense towers, advanced solar generators and most importantly the T2 Aircraft Plant.",
	...
	"armthund.dds "..titleColor.."Thunder ARM T1 Aircraft\n"..contentColor.."A bomber designed mainly for destroying buildings. A little bit weaker than its CORE counterpart (Shadow). It can strike every 9 seconds. 'A' for attack and drag your RMB to execute a carpet bombing",
}
