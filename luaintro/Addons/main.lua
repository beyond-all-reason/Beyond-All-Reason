...
local tips = {
	...
	"For wind generators to be worth building average wind speed should be over 7. Current and average wind is shown next to the energy bar.",
	...
	"Artillery vehicles can move in revers if you put waypoints close to their backs. Use this to keep shooting during a retreat.",
	...
	"Enemy's mines, radars, and jammers may be disabled using Juno - built by both factions with T1 constructors",
}
...
local unit_descs = {
	"armck.dds "..titleColor.."Construction Kbot (ARM T1)\n"..contentColor.."It is slightly slower and weaker than vehicle constructor, but it can climb steeper hills, effective in expansion on mountainous terrain.",
	"armflea.dds "..titleColor.."Flea (ARM T1 Kbot)\n"..contentColor.."Supercheap and fast, used for scouting and damaging  enemy structures in early-game stages. Evade laser towers and destroy metal extractors to slow down your foe’s expansion!",
	"armham.dds "..titleColor.."Hammer (ARM T1 Kbot)\n"..contentColor.."Deals significant damage with relatively low cost. Used in big numbers to destroy T1 defences. Combine with resurrection Kbots (Rector) for an effective front push.",
	"armjeth.dds "..titleColor.."Jethro (ARM T1 Amphibious Kbot)\n"..contentColor.."Amphibious mobile anti-air to take down light aircrafts. Always send a few with your army to protect it from EMP drones/gunships.",
	...
	"armrectr.dds "..titleColor.."Rector (ARM T1 Kbot)\n"..contentColor.."Resurrection Kbot that can turn wrecks alive again, also can reclaim and repair units.",
	"armrock.dds "..titleColor.."Rocko (ARM T1 Kbot)\n"..contentColor.."Light rocket Kbot used to push the frontline towards opponent's base. Outranges light laser turrets. Not effective against mobile units, watch out for A.K./Peewees!",
	"armwar.dds "..titleColor.."Warrior (ARM T1 Kbot)\n"..contentColor.."Durable Kbot armed with a rapid firing double laser. Has high health and can take down multiple light assault units. Combine with resurrection Kbots to heal and resurrect.",
	"corak.dds "..titleColor.."A.K. (CORE T1 Kbot)\n"..contentColor.."Light infantry Kbot which is cheap and quick to build. It is armed with light, but precise laser with a little longer range than PeeWee.",
	"corcrash.dds "..titleColor.."Crasher (CORE T1 Amphibious Kbot)\n"..contentColor.."Amphibious mobile anti-air (AA) Kbot that can easily take down light aircrafts. Send a few with your army to protect it from EMP drones/gunships.",
	...
	"cornecro.dds "..titleColor.."Necro (CORE T1 Kbot)\n"..contentColor.."Resurrection Kbot that can turn wrecks alive again, also can reclaim and repair units. Adds a snowballing effect to your attacks.",
	"corthud.dds "..titleColor.."Thud ((CORE T1 Kbot))\n"..contentColor.."Deals significant damage with relatively low cost. Used in big numbers to destroy T1 defences. Works great for defending mountain tops.",
	"armfav.dds "..titleColor.."Jeffy (ARM T1 Vehicle)\n"..contentColor.."Cheap and the fastest moving unit in the whole game. Evade laser towers and destroy metal extractors to slow down your foe's expansion.",
	"armflash.dds "..titleColor.."Flash (ARM T1 Vehicle)\n"..contentColor.."A light, fast moving tank with close combat rapid fire weapon. Slightly more powerful and faster than Peewee and A.K. on flat terrain.",
	"armart.dds "..titleColor.."Shellshocker (ARM T1 Vehicle)\n"..contentColor.."Artillery vehicle used to take down T1 defenses, esp. High Laser Turrets. It can outrange all T1 defense towers. Always keep them protected by Stumpies/Flashes.",
	...
	"armjanus.dds "..titleColor.."Janus (ARM T1 Vehicle)\n"..contentColor.."Heavy dual rocket tank. Slow speed and fire rate makes it vulnerable to fast units. Its good damage and AoE makes up for it but requires heavy micro and attention. Biggest threat to Commanders among T1 land units.",
	...
	"armsam.dds "..titleColor.."Samson (ARM T1 Vehicle)\n"..contentColor.."Missile truck that can target land and air units. It has a good range and line-of-sight. Good for supporting and taking down light defences.",
	...
	"corcv.dds "..titleColor.."Construction Vehicle (CORE T1)\n"..contentColor.."Able to build basic T1 structures. It is slightly faster and stronger than Kbot constructor, but it can't climb stepper hills.",
	"corfav.dds "..titleColor.."Weasel (CORE T1 Vehicle)\n"..contentColor.."Cheap and very fast moving unit used for scouting and early strikes. Evade laser towers and destroy metal extractors to slow down your foe's expansion.",
	"corgarp.dds "..titleColor.."Garpike (CORE T1 Amphibious Vehicle)\n"..contentColor.."Light amphibious tank which can travel on land and underwater. Weaker than most tanks. Avoid direct fire exchange and try to surprise enemies by destroying undefended targets near the shoreline.",
	"corgator.dds "..titleColor.."Instigator (CORE T1 Vehicle)\n"..contentColor.."Fight, fast moving tank armed with a precise laser weapon. A bit slower than its ARM counterpart - Flash, but it has a higher range, so always try to keep the distance.",
	...
	"cormuskrat.dds "..titlecolor.."Muskrat (CORE T1 Amphibious Vehicle)\n"..contentColor.."Construction vehicle, which can travel on land and underwater. Builds basic land and sea defenses and economy. Useful for expansion in water when you don't have ships.",
	"corraid.dds "..titlecolor.."Raider (CORE T1 Vehicle)\n"..contentColor.."Medium assault tank. It has a good armor so it should always be kept in the first line to sink in all damage. Useful for taking down light defenses with brute-force.",
	"corwolv.dds "..titlecolor.."Wolverine (CORE T1 Vehicle)\n"..contentColor.."Wolverine is an artillery vehicle used to take down T1 defenses, especially High Laser Turrets. Helpless in close quarters combat.",
	"armatlas.dds "..titleColor.."Atlas ARM T1 Aircraft\n"..contentColor.."Transportation unit. It can pick up all T1 land based units and T2, with exception of heavy ones, like Fatboy or Goliath. Can be used for transporting nano towers too.",
	...
	"armfig.dds "..titleColor.."Freedom Fighter (ARM T1 Aircraft)\n"..contentColor.."A fighter jet that is designed for eliminating air units. Always put your fighters on patrol in front of your base, so they attack any hostile aircraft moving in the vicinity.",
	"armkam.dds "..titleColor.."Banshee (ARM T1 Aircraft)\n"..contentColor.."A light gunship that can fire at surface units. It has very weak armor, so always send them in packs and scout for AA before striking. It is a weapon of surprise.",
	...
	"corvalk.dds "..titleColor.."Valkyrie (CORE T1 Aircraft)\n"..contentColor.."Airborne transportation unit. It can pick up all T1 land based units and T2, with exception of heavy ones. Used for unexpected unit drops bypassing enemy's defense line.",
	"corfink.dds "..titleColor.."Fink (CORE T1 Aircraft)\n"..contentColor.."A cheap and fast moving air scout. Its weapon is a huge line of sight. It is used to gain intelligence on what your enemy is planning, and where he keeps his most important units.",
	"corbw.dds "..titleColor.."Bladewing (CORE T1 Aircraft)\n"..contentColor.."Little drones armed with EMP lasers. They can quickly move and paralyze units. They serve as a great support for your attacks and can turn the tide of war easily.",
