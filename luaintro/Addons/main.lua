...
local tips = {
	...
	"Think ahead and include anti-air and support units in your armaday.",
...
local unit_descs = {
	...
	"armadaham.dds "..titleColor.."Hammer (ARMADA T1 Bot)\n"..contentColor.."Deals significant damage with relatively low cost. Used in large numbers to destroy T1 defences. Combine with resurrection Bots (Rector/Necro) for an almost invincible armaday.",
	"armadajeth.dds "..titleColor.."Jethro (ARMADA T1 Amphibious Bot)\n"..contentColor.."Amphibious mobile anti-air to take down light aircraft. Always send a few with your armaday to protect it from EMP drones and gunships.",
	...
	"armadawar.dds "..titleColor.."Warrior (ARMADA T1 Bot)\n"..contentColor.."Durable Bot armadaed with a rapid firing double laser. Has high health and can take down multiple light assault units. Combine with resurrection Bots for quick repairing.",
	"corak.dds "..titleColor.."A.K. (CORTEX T1 Bot)\n"..contentColor.."Light infantry Bot which is cheap and quick to build. It is armadaed with a light, but precise laser which outranges the PeeWee.",
	"corcrash.dds "..titleColor.."Crasher (CORTEX T1 Amphibious Bot)\n"..contentColor.."Amphibious mobile anti-air (AA) Bot that can easily take down light aircraft. Send a few with your armaday to protect it from EMP drones and gunships.",
	...
	"corgator.dds "..titleColor.."Instigator (CORTEX T1 Vehicle)\n"..contentColor.."Light, fast moving tank armadaed with a precise laser weapon. Slower than its ARMADA counterpart - Flash, but it has a greater range, so always try to keep the distance.",
	"corlevlr.dds "..titleColor.."Leveler (CORTEX T1 Vehicle) \n"..contentColor.."Powerful tank armadaed with an impulse weapon that deals AoE damage and repels light units. It makes it highly effective against swarmadas of peewees, flashes etc.",
	...
	"corbw.dds "..titleColor.."Bladewing (CORTEX T1 Aircraft)\n"..contentColor.."Small, fast drones armadaed with EMP lasers. They serve as a great support for your attacks and can quickly turn the tide of war.",
...
local quotes = {
	...
	{"An armaday marches on its stomach.", "Napoleon Bonaparte"},
	...
	{"I am not afraid of an armaday of lions led by a sheep; I am afraid of an armaday of sheep led by a lion.", "Alexander the Great"},
