...
-- This config int control some multithreading functionality, and are now set to their disabled state while we debug if they could be the cause of some sync errors:
