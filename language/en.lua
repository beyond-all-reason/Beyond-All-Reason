...
return {
	...
	options = {
		...
		option = {
			...
			lighteffects2 = 'Lights GL4',
			lighteffects2_descr = 'Adds lights to projectiles, lasers and explosions.',
			lighteffects2_headlights = 'headlights',
			lighteffects2_headlights_descr = 'Adds headlights to units',
			dof = 'Depth of Field',
