...
return {
	...
	options = {
		...
		option = {
			...
			auto_cloak_default = 'Default Cloak Inactive',
			auto_cloak_default_descr = 'Set default cloak as Inactive when activated',
			auto_cloak_armjamt = 'Sneaky Pete',
			auto_cloak_armjamt_descr = 'Turn On/Off Sneaky Pete cloak',
