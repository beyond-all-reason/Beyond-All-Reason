...
return {
	...
	options = {
		...
		option = {
			...
			auto_cloak_enabled = 'Default Auto Cloak',
			auto_cloak_enabled_descr = 'Set default cloak as Inactive when Toggled',
			auto_cloak_armjamt = 'Armada Sneaky Pete',
			auto_cloak_armjamt_descr = 'Turn auto cloak OFF when Toggled',
			auto_cloak_armdecom = 'Armada Decoy Commander',
			auto_cloak_armdecom_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_cordecom = 'Cortex Decoy Commander',
			auto_cloak_cordecom_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_armferret = 'Armada Ferret',
			auto_cloak_armferret_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_armamb = 'Armada Rattlesnake',
			auto_cloak_armamb_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_armpb = 'Armada Pit Bull',
			auto_cloak_armpb_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_armsnipe = 'Armada Sharpshooter',
			auto_cloak_armsnipe_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_corsktl = 'Cortex Skuttle',
			auto_cloak_corsktl_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_armgremlin = 'Armada Gremlin',
			auto_cloak_armgremlin_descr = 'Turn auto cloak ON when Toggled',
			auto_cloak_armamex = 'Armada Twilight',
			auto_cloak_armamex_descr = 'Turn auto cloak OFF when Toggled',
			auto_cloak_armckfus = 'Armada Cloakable Fusion Reactor',
			auto_cloak_armckfus_descr = 'Turn auto cloak OFF when Toggled',
			auto_cloak_armspy = 'Armada Ghost',
			auto_cloak_armspy_descr = 'Turn auto cloak OFF when Toggled',
			auto_cloak_corspy = 'Cortex Spectre',
			auto_cloak_corspy_descr = 'Turn auto cloak OFF when Toggled',
