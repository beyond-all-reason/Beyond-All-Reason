return {
	zh = {
		...
		scav = {
			messages = {
				commanderDetected1 = "发现拾荒者指挥官。",
				commanderDetected2 = "侦测到另外一名拾荒者指挥官。",
				commanderDetected3 = "在该地区发现了另一名拾荒者指挥官。",
				commanderDetected4 = "新的拾荒者指挥官进入了这个地方。",
				commanderDetected5 = "发现了一个额外的拾荒者指挥官。",
				commanderDetected6 = "侦测到新的拾荒者指挥官。",
				unkownObjectsDetected = "在附近发现了不明物体...",
				classifiedAsScavengers = "不明物体现在被归类为拾荒者。",
				eventCloud = "警报! 拾荒者毒雾正在接近。",
				dropPodsDetected = "在该地区侦测到拾荒者空投。",
				droppingUnits = "拾荒者在我们的地区投放了一些单位。",
				heavyShipsDetected = "警报。在该地区发现重型舰艇。",
				reinforcements = "发现%{player}的增援部队。 单位类型: %{unit}.",
				eventMiniboss = "警报! 探测到迷你BOSS。",
				eventSwarm = "警告! 检测到拾荒者群。",
				eventMalfunctions = "警报! 检测到拾荒者故障。",
				finalAttack = "拾荒者们正在释放他们所有的力量,他们的最后攻击已经开始。",
				finalBoss = "指挥官，我们探测到一个异常大的拾荒者单位。它正向你的方向慢慢靠近。做好最坏的打算吧!",
				bossDetected = "紧急! 拾荒者在该地区投放了一个高度致命的BOSS单位,在它到达你的基地之前将其消灭。",
				finalVictory = "干得好，指挥官。你从所有拾荒者的攻击中幸存下来。你是胜利者! 庆祝一下,然后在下一张地图上尝试歼灭他们。",
				timeRemaining12 = "还剩12.5分钟。仍然是一场漫长的战斗。",
				timeRemaining10 = "还剩10分钟。",
				timeRemaining09 = "还剩9分钟。坚守阵地。",
				timeRemaining08 = "还剩8分钟。",
				timeRemaining07 = "还剩下7分钟。奋力拼搏,战胜他们。",
				timeRemaining06 = "还剩6分钟。",
				timeRemaining05 = "还剩5分钟。很接近了。",
				timeRemaining04 = "只剩下4分钟了。",
				timeRemaining03 = "还有3分钟。",
				timeRemaining02 = "只剩下2分钟了。",
				timeRemaining01 = "还剩1分钟。"
			}
		},
		...
		tips = {
			...
			notifications = {
				...
				teamdownlastcommander = "警告:你的队伍只剩下最后一名指挥官了。",
				youhavelastcommander = "警告:你的指挥官是最后一名。",
		...
		units = {
			...
			names = {
				...
				armrespawn = "基地建设者",
				chicken_dodo1 = "神风特攻虾",
				chicken_dodo2 = "终极神风特攻虾",
				chicken_dodoair = "飞行神风特攻虾",
				chicken1 = "掠夺虾",
				chicken1b = "掠夺虾",
				chicken1c = "掠夺虾",
				chicken1d = "掠夺虾",
				...
				chickena2b = "终极斗士虾",
				chickenc2 = "全地型火枪虾",
				chickenacidallterrainassault = "全地型酸液斗士虾",
				chickenelectricallterrainassault = "全地型瘫痪斗士虾",
				chickenc3 = "全地形基础掠夺虾",
				chickenc3b = "全地形掠夺虾",
				chickenc3c = "全地形掠夺虾",
				chickenallterraina1 = "全地形斗士虾",
				chickenallterraina1b = "全地形斗士虾",
                chickenallterraina1c = "全地形斗士虾",
				chickenapexallterrainassault = "终极全地形斗士虾",
				chickenapexallterrainassaultb = "终极全地形斗士虾",
				chicken_turrets = "触手",
				chicken_turretl = "终极触手",
				chicken_turrets_electric = "瘫痪型触手",
				chicken_turretl_electric = "终极瘫痪型触手",
				chicken_turrets_acid = "酸液型触手",      
				chicken_turretl_acid = "终极酸液型触手",
				chickenf1 = "轰炸虾",
				chickenf1b = "轰炸虾",
				chickenf1apex = "终极轰炸虾",
				chickenf1apexb = "终极轰炸虾",
				chickenf2 = "观察虾",
				chickenh1 = "治疗虾",
				chickenh1b = "治疗虾",
				chickenh2 = "终极雏虾之母",
				...
				chickene1 = "瘫痪虾",
				chickene2 = "终极瘫痪虾",
				chickenearty1 = "瘫痪型迫击炮虾",
				chickenebomber1 = "瘫痪型轰炸虾",
				chickenelectricallterrain = "全地形瘫痪虾",
				chickenacidswarmer = "酸液型尖刺虾",
				chickenacidassault = "终极酸液型尖刺虾",
				chickenacidbomber = "酸液型轰炸虾",
				chickenacidarty = "酸液型迫击炮虾",
				chickenacidallterrain = "全地形酸液型尖刺虾",
				chip = "芯片",
				coraak = "蝎尾狮",
				coraap = "2级飞行器工厂",
				coraca = "2级工程飞行器",
				...
				legcomdef = "防御型指挥官",
				legcomoff = "进攻型指挥官",
				legcomt2def = "战术防御型指挥官",
				legcomt2off = "战术进攻型指挥官",
				legcomt2com = "战斗指挥官",
				legfig = "战斗/侦察无人机",
				legfort = "军团飞行堡垒",
				leggat = "加特林",
			...
			descriptions = {
				...
				armyork = "防空高射炮车",
				armzeus = "攻击型机甲",
				armrespawn = "在大范围内协助建造和维修",
				chicken_dodo1 = "步行炸弹虾",
				chicken_dodo2 = "终极步行炸弹虾",
				chicken_dodoair = "飞行炸弹虾",
				chicken1 = "普通虾",
				chicken1b = "普通虾",
				chicken1c = "普通虾",
				chicken1d = "普通虾",
				...
				chickena1b = "主要进攻型虾",
				chickena1c = "主要进攻型虾",
				chickena2 = "已进化的进攻型虾,超重型且血厚",
				chickena2b = "已进化的进攻型虾,超重型且血厚",
				chickenc2 = "全地型的火焰喷射虾",
				chickenc3 = "全地形版的普通虾",
				chickenc3b = "全地形版的普通虾",
				chickenc3c = "全地形版的普通虾",
				chickenallterraina1 = "全地形进攻型虾",
				chickenallterraina1b = "全地形进攻型虾",
				chickenallterraina1c = "全地形进攻型虾",
				chickenapexallterrainassault = "已进化的全地形虾,超重型且血厚",
				chickenapexallterrainassaultb = "已进化的全地形虾,超重型且血厚",
				chicken_turrets = "轻型防御和治疗炮塔",
			    chicken_turretl = "已进化的防御触手",
				chicken_turrets_electric = "瘫痪型防御触角",
			    chicken_turretl_electric = "已进化的瘫痪型防御触角",
			    chicken_turrets_acid = "酸液型防御触角",
				chicken_turretl_acid = "已进化的酸液型防御触角",
				chickenf1 = "飞行轰炸虾",
				chickenf1b = "飞行轰炸虾",
				chickenf1apex = "已进化的飞行轰炸虾",
				chickenf1apexb = "已进化的飞行轰炸虾",
				chickenf2 = "飞行侦察虾",
				chickenh1 = "治疗和垃圾收集虾",
				chickenh1b = "治疗和垃圾收集虾",
				chickenh2 = "死亡时孵化出2个较小的自己",
				chickenh3 = "死亡时孵化出2个较小的自己",
				chickenh4 = "体积小、速度快的掠夺虾",
				chickenh5 = "大虾指挥官",
				chickenp1 = "火焰喷射虾",
				chickenp2 = "已进化的火焰喷射虾",
				chickenpyroallterrain = "全地形的火焰喷射虾",
				chickenr1 = "炮兵虾",
				chickenr2 = "流星炮兵虾",
				chickens1 = "非常灵活的虾,吐出一个尖刺就跑了",
				chickens2 = "异常敏捷的虾,吐出一个尖刺就跑了",
				chickens3 = "飞行的尖刺喷射虾",
				chickenw1 = "飞行的防空虾",
				chickenw1b = "飞行的防空虾",
				chickenw1c = "飞行的防空虾",
				...
				chickenearty1 = "瘫痪型迫击炮虾",
				chickenebomber1 = "瘫痪型轰炸虾",
				chickenelectricallterrain = "瘫痪型全地形掠夺虾",
				chickenelectricallterrainassault = "瘫痪型全地形斗士虾",
				chickenacidswarmer = "酸液型掠夺虾, 造成长期伤害",
				chickenacidassault = "酸液型斗士虾, 造成长期伤害",
				chickenacidbomber = "酸液型轰炸虾, 造成长期伤害",
				chickenacidarty = "酸液型迫击炮虾, 造成长期伤害",
				chickenacidallterrain = "酸液型全地形掠夺虾, 造成长期伤害",
				chickenacidallterrainassault = "酸液型全地形斗士虾, 造成长期伤害",
				chip = "芯片",
				coraak = "重型两栖防空战车",
				coraap = "生产2级飞行器",
				coraca = "建造2级科技建筑",
				...
				legbart = "汽油弹/战斗机甲",
				legcen = "快速进攻机甲",
				legcom = "军团指挥官每隔7.5分钟就会自行升级一次",
				legcomecon = "改进的资源生成和建设速度/范围",
				legcomdef = "改进的防御系统和EMP手榴弹",
				legcomoff = "改进的武器和速度",
				legcomt2def = "改进的资源生成,使用EMP手榴弹和等离子体盾牌",
				legcomt2off = "速度提高,能够建造单位,短距离干扰器,跌倒后能存活",
				legcomt2com = "体型、血量和武器数量增加,但移动速度慢",
				legca = "工程无人机",
				legcib = "投下一枚朱诺炸弹，清除地雷、侦察兵、雷达和干扰器",
				legck = "工程机甲",
				legcv = "工程车辆",
				legfig = "战斗/侦察无人机",
				legfort = "飞行堡垒",
				...
				leghades = "快速进攻坦克",
				leghelios = "战斗坦克",
				legkam = "自毁,对目标区域造成爆炸性伤害",
				leglab = "生产1级机甲",
				leglob = "轻型等离子机甲",
				legmex = "提炼略微减少的金属并产生7点电力",
				legmext15 = "以高能源成本提练额外金属",
				legmext2 = "高级金属提炼器 / 存储",
				legmineb = "在目标区域部署成群的轻型地雷",
				legmos = "储存火箭的轻型炮艇机",
				legnap = "在大范围内投掷凝固汽油弹",
				legrail = "远程短兵器/防空导弹",
				legshot = "持盾进攻机甲",
			...
			longDescriptions = {
				...
				armatlas = "白鹳是一个空降运输单位。它可以接载所有的T1陆基单位和T2单位，但重型单位除外，如肥仔或歌利亚。用它来绕过敌人的防线进行意外的单位投放，但别忘了先侦察一下是否有防空单位。把你的指挥官扔到他们的基地里，让他们的所有结构都被炸毁，让你的对手感到羞辱。也可用于运输纳米塔，这使你能够将你的建设力量转移到你目前需要的地方。",
