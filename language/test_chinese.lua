	...
	zh = {
		ui = {
			...
			topbar = {
				...
				quit = {
					...
					resign = "注销",
					reallyQuit = "真的要退出吗?",
					reallyQuitResign = "你确定要注销或者返回游戏大厅吗?",
					reallyResign = "你确定要注销吗?",
			...
			orderMenu = {
				...
				landatairbase_tooltip = "Go to nearest 飞行器维修平台",
				...
				autorepairlevel_tooltip = "Set at which HP %% this aircraft retreats to nearest 飞行器维修平台",
				apAirRepair_tooltip = "Air factory: Set at which health %% an aircraft should automatically move to and land on an 飞行器维修平台",
				customOnOff = {
		...
		units = {
			...
			descriptions = {
				...
				corrad = "早期预警系统. Transportable (Heavy)",
