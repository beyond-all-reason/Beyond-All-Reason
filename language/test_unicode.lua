	...
	test_unicode = {
		...
		units = {
			...
			descriptions = {
				...
				armspid = "All-Terrain EMP Insectoid",
				armsptk = "All-Terrain Rocket Insectoid",
				...
				cortermite = "Heavy All-terrain Assault Insectoid",
				cortermite_scav = "Cloaked Medium All-Terrain Insectoid with Improved Laser",
