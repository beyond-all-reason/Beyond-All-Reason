	...
	test_unicode = {
		...
		units = {
			...
			names = {
				...
				armada_navalradar = "Floating Radar/Sonar Tower",
				...
				armada_constructionturretplat = "Nano Turret",
			...
			descriptions = {
				...
				armada_navalradar = "Early Warning System",
				...
				armada_constructionturretplat = "Repairs and builds in large radius",
