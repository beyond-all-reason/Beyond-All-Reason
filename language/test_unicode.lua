	...
	test_unicode = {
		ui = {
			...
			keybinds = {
				...
				drawing = {
					...
					erase = "Erase drawings and marks",
				},
				console = {
					title = "Console commands",
					eraseKey = "/clearmapmarks",
					erase = "Erase all drawings and marks",
					pauseKey = "/pause",
					pause = "Pause",
				},
			},
		...
		tips = {
			...
			notifications = {
				...
				tutorialParalyzer = "You are being attacked by paralyzer units. Units that have been paralyzed cannot function and won't be able to shoot or move until they have been restored.",
			},
			deathMessages = {
				team = {
		...
		units = {
			...
			descriptions = {
				...
				armamb_scav = "Powerful Stealthy Defense",
				...
				cortoast_scav = "Powerful Stealthy Defense",
