		...
		ui = {
			...
			playersList = {
				...
				chat = {
					...
					needMetalAmount = "I need %{amount} population cap!",
					needPopulation = "I need population cap!",
					needPopulationAmount = "I need %{amount} metal!",
					giveEnergy = "I sent %{amount} energy to %{name}",
					giveMetal = "I sent %{amount} metal to %{name}",
					givePopulation = "I sent %{amount} population cap to %{name}",
