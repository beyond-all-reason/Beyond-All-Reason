	...
	test_unicode = {
		...
		units = {
			...
			names = {
				...
				raptorh5 = "Patriarch",
				raptorp1 = "Bombardier",
				raptor_land_arty_basic_t2_v1 = "Lobber",
				raptor_land_arty_basic_t4_v1 = "Enraged Lobber",
				raptorr3 = "Raptor Colonizer",
				raptors1 = "Spiker",
				raptors2 = "Advanced Spiker",
				raptors3 = "Fang",
				raptorw1 = "Claw",
				raptorw1b = "Claw",
				raptorw1c = "Claw",
				...
				epic_raptorq = "Epic Raptor Queen",
			...
			descriptions = {
				...
				armzeus = "Assault Bot",
				raptor_dodo1 = "Raptor Bomb",
				raptor_dodo2 = "Raptor Bomb",
				raptor1 = "Swarmer",
				raptor1b = "Swarmer",
				raptor1c = "Swarmer",
				raptor1d = "Swarmer",
				raptor1x = "Swarmer Assault",
				raptor1y = "Swarmer Assault",
				raptor1z = "Swarmer Assault",
				raptor2 = "Advanced Swarmer",
				...
				raptor_turrets = "Defense",
				raptor_air_bomber_basic_t2_v1 = "Flying Raptor Bomber",
				raptor_air_bomber_basic_t2_v2 = "Flying Raptor Bomber",
				raptorairscout1 = "Flying Raptor Scout",
				raptorhealer1 = "Raptor Healer",
				raptorh1b = "Raptor Healer",
				raptorh2 = "Raptor Spawner",
				raptorh3 = "Progenitor Hatchling",
				raptorh4 = "Hatchling Swarmer",
				raptorh5 = "Raptor Overseer",
				raptorp1 = "Raptor Flamer",
				raptor_land_arty_basic_t2_v1 = "Artillery",
				raptor_land_arty_basic_t4_v1 = "Raptor Assault",
				raptorr3 = "Meteor Launcher",
				raptors1 = "Spike Spitter",
				raptors2 = "Ghost Spiker",
				raptors3 = "Spiker Air Assault",
				raptorw1 = "Flying Spike Spitter",
				raptorw1b = "Flying Spike Spitter",
				raptorw1c = "Flying Spike Spitter",
				raptorw1d = "Flying Spike Spitter",
				raptorw2 = "Fighter",
				chip = "Chip",
