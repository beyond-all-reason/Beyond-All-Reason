	...
	en = {
		ui = {
			...
			orderMenu = {
				...
				upgrademex_tooltip = "Click on a T1 metal extractor to upgrade it to T2 (click-drag for area)",
				...
				['UpgMex ON'] = "Auto Upgrade",
				['UpgMex OFF'] = "Auto Upgrade",
				automex_tooltip = "When toggled: Auto Upgrade all T1 metal extractors to T2",
				customOnOff = {
