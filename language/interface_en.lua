		...
		ui = {
			...
			keybinds = {
				...
				chat = {
					...
					sendToAlliesKey = 'alt + enter',
					sendToAllies = 'Send chat message to allies',
					sendToeSpectatorsKey = 'shift + enter',
					sendToSpectators = 'Send chat message to spectators',
					ignorePlayerKey = 'ctrl + left click on name',
				...
				camera = {
					...
					zoomKey = 'scrollwheel',
					zoom = 'Zoom camera',
					moveKey = 'arrow keys / mouse at screen edge',
					move = 'Move camera',
					angleKey = 'ctrl + scrollwheel',
					angle = 'Change camera angle',
				...
				selection = {
					...
					selectUnitsKey = 'left mouse (+ drag)',
					slectUnits = 'Select or deselect units',
				},
				issueContextOrders = {
					title = 'Giving orders',
				...
				massSelect = {
					...
					selectBuildersKey = 'ctrl + b',
					selectBuilders = 'Select all constructors',
					createGroupKey = 'ctrl + (num)',
					createGroup = 'Add units to group (num=1,2,..)',
					selectGroupKey = '(num)',
					selectGroup = 'Select all units assigned to group (num)',
					selectTypeKey = 'ctrl + z',
					selectType = 'Select all units of same type as current',
				},
				drawing = {
					title = 'Drawing',
