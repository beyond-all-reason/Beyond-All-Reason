...
-- VFS.Include re-executes on every call, so a module's file-local cache belongs
-- to whoever included it: resetting the spec's own shared_config leaves the one
-- inside synced.lua untouched. Re-including the chain is the reset.
