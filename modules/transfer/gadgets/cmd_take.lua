...
--- A takeover is not a share: the assets move with the seat, so they do not
--- go through the sharing pipeline and are not taxed by the sharing mode.
--- Whether the takeover may happen at all is take's own policy, decided
--- before this runs.
