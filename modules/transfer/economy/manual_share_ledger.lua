...
-- Recorded by the controller, folded in by the economy_terms policy file:
-- two include instances, one ledger.
local shared = ModuleHandler.Shared("transfer")
shared.manualShareLedger = shared.manualShareLedger or {}
local ledger = shared.manualShareLedger ---@type table<number, table<ResourceName, {sent: number, received: number}>>
