...
--- A resource share between allied teams, taxed and announced downstream.
---@class TransferResourcesRequest
---@field from integer giving team
---@field to integer receiving team
---@field resource "metal"|"energy"
---@field amount number
---@field send fun(from: integer, to: integer, resource: string, amount: number): number sent amount
