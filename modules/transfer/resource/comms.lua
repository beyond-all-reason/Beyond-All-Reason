...
local Cache = VFS.Include("modules/context/serialization.lua")
local FieldTypes = Cache.FieldTypes
local TechBlockingComms = VFS.Include("modules/tech/blocking_comms.lua")
...
---Floors to whole numbers, mirroring ResourceTransfer's slider rounding.
---@param value number
---@return string
