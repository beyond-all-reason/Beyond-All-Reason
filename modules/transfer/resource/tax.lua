...
shared.taxRateByTeam = shared.taxRateByTeam or {}
local rateByTeam = shared.taxRateByTeam ---@type table<integer, number>
...
function Tax.GetTaxRate(teamId, opts, springRepo)
	...
	local terms = ModuleHandler.Enrich("transfer", "team_terms", opts, ctx)
