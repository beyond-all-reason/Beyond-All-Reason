...
Policies.Pipeline(Stages.load)
	...
	.Select(Stages.load.Allowed, function()
		return true
	end)

Policies.Pipeline(Stages.unload)
...
Policies.Pipeline(Stages.loaded_speed).Select(Stages.loaded_speed.CommanderDrag, function(ctx)
