...
--- difficulty nil means whatever the host set, which is what makes Horde the multiplayer mode
--- rather than a preset of it. boss = false: a mission ends the pressure with a trigger.
--- Mission packs compress the clocks: four minutes of quiet in a mission beat would just be
