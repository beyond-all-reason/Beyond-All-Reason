...
---@field Mode fun(name: string): ScavengersModeChain
...
M.Mode = ModeBuilder.Grammar({
	...
	verbs = Pve.Verbs,
	-- Bot lives with the shared PvE grammar: every flavor needs its AI on the
	-- field, and no modoption can say so.
	chainVerbs = Pve.ChainVerbs,
