...
--- where a lobby writes the choice. Scavengers is a way the game is PLAYED —
...
return {
    {
        ...
        -- These dials only mean anything while the Scavengers preset is the
        -- game mode, so the lobby shows them only then.
        mode_key = "scavengers",
    },
