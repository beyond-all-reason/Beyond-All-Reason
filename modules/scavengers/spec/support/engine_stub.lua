...
---Pure matters: the two builds reach the same names in different orders, so a counter id would differ.
...
---Fabricates a def for any name: a stub that only knew listed names would send both sides down the "no such unit" branch and prove nothing.
