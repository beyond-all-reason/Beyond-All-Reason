...
--- they live and nothing else — plus ONE declaration: the section hands its
--- governance to the game axis, which is where the Scavengers choice lives.
...
describe("scavengers modoptions", function()
	it("ships its own section, at the weight it always had, governed by the game axis", function()
		...
		-- and its dials show only while the Scavengers preset is the mode
		assert.are.equal("scavengers", section.mode_key)
	end)
