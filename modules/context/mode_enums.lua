...
M.ModeCategories = {
	-- The gameplay axis: standard, ffa, mission, scavengers (raptors when it
	-- migrates). One selector, because a match is exactly one of these.
	Game = "game",
	-- What may pass between allied teams — the transfer module's category,
	-- named in the module's own language.
	Transfer = "transfer",
}
