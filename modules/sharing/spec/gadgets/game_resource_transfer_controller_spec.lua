...
describe("ResourceExcess redistribution", function()
	...
	it("processes excesses and returns results", function()
		local teamA = Builders.Team:new():WithMetal(800):WithMetalStorage(1000):WithMetalShareSlider(50):WithEnergy(500):WithEnergyStorage(1000):WithEnergyShareSlider(50)
		local teamB = Builders.Team:new():WithMetal(200):WithMetalStorage(1000):WithMetalShareSlider(50):WithEnergy(500):WithEnergyStorage(1000):WithEnergyShareSlider(50)
