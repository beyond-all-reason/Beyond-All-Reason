...
function Squads.New()
	...
	---A squad at zero that still has units destroys itself: the anti-stalemate valve, the only way a stuck squad ever clears.
	---@param spec WaveSpec
	---@param state WaveDirectorState
	...
	---Orders only when something changed: re-issuing every tick would cancel the pathing the units are doing.
	---@param spec WaveSpec
	---@param state WaveDirectorState
	---@param squadID integer
