...
---Scaled by how rich the economy settings are: a fat economy techs faster, so the waves
...
---Published as rulesparams so the UI can say WHY the boss is early.
...
---The value is per-second boss anger, normalised to a 60 minute
