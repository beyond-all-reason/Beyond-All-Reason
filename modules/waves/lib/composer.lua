...
---nil when the bucket has nothing eligible: an honest answer the caller can act on.
...
---Same composition as a wave, one pass, and a tighter population ceiling: these are extras, not the wave.
---@param input WaveComposeInput
---@return { entries: WaveQueueEntry[], count: integer }
