...
---A wheel with every counter already expired except the named one, so a
---single flavor is the only thing that can claim the wave.
---@param only string
...
describe("waves wheel", function()
	...
	it("carries the previous wave's composing anger through untouched", function()
		local shape = Wheel.Shape(armedFor("epic"), input({ waveTechAnger = 412, airStartAnger = 10000 }), SeededRng.New(31))
