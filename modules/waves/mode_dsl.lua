...
--- A flavor may omit any key; the matching verb then serializes nothing.
---@class PveModeKeys
...
--- Each verb takes the pack noun first so a flavor with several packs can dial them independently.
Pve.Verbs = {
	---@param modeName string
	---@param noun table
