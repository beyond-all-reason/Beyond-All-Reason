--- The build steps a delayed builder may not take.
---
--- A mode can make a received constructor stand down for a while; transfer
--- applies that when the unit changes hands, and this is where the engine's
--- question — may this builder add to this thing right now — is answered.
