local function makeInstanceVBOTable(layout, maxElements, myName, objectTypeAttribID, objecttype)
	...
	if newInstanceVBO == nil then SpringShared.Echo("makeInstanceVBOTable, cannot get VBO for", myName); return nil end
...
local function pushElementInstance(iT,thisInstance, instanceID, updateExisting, noUpload, unitID, objecttype, teamID)
	...
	if (objecttype == "unitID" and (SpringShared.ValidUnitID(unitID) == false)) or
		(objecttype == "featureID" and (SpringShared.ValidFeatureID(unitID) == false)) or
