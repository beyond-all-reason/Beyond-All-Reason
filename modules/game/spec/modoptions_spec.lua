...
local fragment = VFS.Include("modules/game/modoptions.lua")
...
describe("the game axis", function()
	...
	describe("the FFA preset", function()
		local ffa = VFS.Include("modules/game/modes/ffa.lua")
	...
	describe("the Team FFA preset", function()
		local teamFfa = VFS.Include("modules/game/modes/team_ffa.lua")
	...
	describe("the Territorial Domination preset", function()
		local td = VFS.Include("modules/game/modes/territorial_domination.lua")
