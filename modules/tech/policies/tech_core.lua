...
--- Everything the tier computation needs, injected: pure in, verdict out.
...
--- What the next tier would open, and at what price.
---@class TechUnlock
...
Policies.Pipeline()
	.Compute("TechCoreLadder", function(request)
		local currentTax =
			tonumber(TechTier.resolveByTechLevel(request.opts, "tax_resource_sharing_amount", request.level))
