...
---
--- The one addition is the governance pair: mode_category hands the section
--- to the game axis (modules/modes/modoptions.lua), whose game_mode selector
--- is where a lobby writes the choice, and mode_key shows these dials only
--- while the Raptors preset is the mode. Nothing in the game reads the
...
return {
    {
        ...
        -- These dials only mean anything while the Raptors preset is the
