--- Legacy quirk kept on purpose: in shared-dynamic-alliance mode a winner COUNT (a number)
--- is handed around instead of a table; every type(winners) == 'table' guard is that inheritance.
