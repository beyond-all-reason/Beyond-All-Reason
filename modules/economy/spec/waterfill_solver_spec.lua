...
local BarEconomy = VFS.Include("modules/economy/lib/waterfill_solver.lua")
...
--- What a transfer costs is the caller's rule, not the solver's: Solve takes
--- the rate as taxRateFor. Reading the modoption here keeps economy's spec
--- inside economy — transfer owns tier resolution, and tests it itself.
---@param springRepo Spring
---@return number
local function taxRateFor(springRepo)
	local rate = tonumber(springRepo.GetModOptions()[ModeEnums.ModOptions.TaxResourceSharingAmount]) or 0
