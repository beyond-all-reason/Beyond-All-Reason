...
---The tax a spec sets by modoption, read the way transfer would provide it.
---@param springRepo Spring
---@return number
local function taxRateFromModoption(springRepo)
	return tonumber(springRepo.GetModOptions()[ModeEnums.ModOptions.TaxResourceSharingAmount]) or 0
end
