...
function Roster.ForFile(filename)
	...
	--- A group as a value: `local outpost = Group("outpost_auto")`, exported and
	--- handed to Transfer.Give — the name is spelled once.
	...
	local Finalize = function(exports)
		...
		if exports ~= nil then
			...
			-- Anything may export — a UnitDef, a number, a group — and reads on
			-- the other side as the value it is. A handle of this file exports
			-- with its name: the export key names an unnamed unit.
