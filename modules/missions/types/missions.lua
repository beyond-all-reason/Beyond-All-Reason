...
--- The injected Combat verbs. Protect's Until sugar bounds the protection
--- with a companion trigger: the desugared statement When(condition).Do(Combat.Unprotect(unit)).
---@class MissionCombat
