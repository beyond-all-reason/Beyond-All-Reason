...
-- Protection starts with the match, not the discovery: waves fight through this
-- valley long before anyone looks at it, and neutrality only stops the aiming,
-- never the splash. The rest of the base stays mortal on purpose.
