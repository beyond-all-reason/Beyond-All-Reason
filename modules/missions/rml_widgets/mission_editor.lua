...
-- Written via io (relative to the engine WRITE dir) because serve watches
-- that dir.
...
--- Glyphs no font RmlUi loads can draw (Exo 2 and Poppins both stop short of
--- U+2713); a missing glyph is a tofu box.
local GLYPHS = {
	["\226\156\147"] = "\226\136\154",
	["\226\150\184"] = "\194\187",
}
...
--- Sections the in-game panel skips: the graph is a layout the RmlUi backend
--- cannot draw, and its flat fallback is not worth the room on a game HUD.
