local function proposed_unit_reworksTweaks(name, uDef)
	...
	if name == "armflea" then
		uDef.weapondefs.flea_laser.reloadtime = 0.7
	end
	if name == "corfav" then
		uDef.speed = 150
		uDef.weapondefs.cor_laser.reloadtime = 1.2
	end
	if name == "armfav" then
		uDef.speed = 163
		uDef.weapondefs.arm_laser.range = 170
	end
