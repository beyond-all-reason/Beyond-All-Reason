...
local halloweenModels = {
	armcom = "units/event/halloween/armcom.s3o",
	armdecom = "units/event/halloween/armcom.s3o",
	corcom = "units/event/halloween/corcom.s3o",
	cordecom = "units/event/halloween/corcom.s3o",
	legcom = "units/event/halloween/legcom.s3o",
	legdecom = "units/event/halloween/legcom.s3o",
	correap = "units/event/halloween/correap.s3o",
	leggob = "units/event/halloween/leggob.s3o",
	armrectr = "units/event/halloween/armrectr.s3o",
	armspy = "units/event/halloween/armspy.s3o",
}

local xmasModels = {
	armcom = "units/event/xmas/armcom.s3o",
	armdecom = "units/event/xmas/armcom.s3o",
	corcom = "units/event/xmas/corcom.s3o",
	cordecom = "units/event/xmas/corcom.s3o",
}
