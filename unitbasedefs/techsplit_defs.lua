local function techsplitTweaks(name, uDef)
	...
	elseif name == "armaap" or name == "armasy" or name == "armalab" or name == "armavp" or name == "coraap" or name == "corasy" or name == "coralab" or name == "coravp" then
	...
	elseif name == "armack" or name == "armacv" or name == "armaca" or name == "armacsub" or name == "corack" or name == "coracv" or name == "coraca" or name == "coracsub" or name == "legack" or name == "legacv" or name == "legaca" then
	...
	if name == "armmoho" or name == "cormoho" or name == "armuwmme" or name == "coruwmme" or name == "legmoho" then
	...
	if name == "armaser" or name == "corspec" or name == "legajamk" or name == "armjam" or name == "coreter" or name == "legavjam" then
	...
	if name == "armtarg" or name == "cortarg" or name == "legtarg" or name == "armfatf" or name == "corfatf" then
	...
	if name == "legaap" or name == "legasy" or name == "legalab" or name == "legavp" then
		uDef.metalcost = uDef.metalcost - 1300
		uDef.energycost = uDef.energycost - 5000
		uDef.buildtime = math.ceil(uDef.buildtime * 0.015) * 100
	end
