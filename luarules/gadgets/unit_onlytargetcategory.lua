...
function gadget:AllowCommand(unitID, unitDefID, teamID, cmdID, cmdParams, cmdOptions, cmdTag, playerID, fromSynced, fromLua)
	-- accepts: CMD.ATTACK
	if cmdParams[2] == nil and unitOnlyTargetsCategory[unitDefID] and type(cmdParams[1]) == "number" and not (unitCategories[Engine.Shared.GetUnitDefID(cmdParams[1])] and unitCategories[Engine.Shared.GetUnitDefID(cmdParams[1])][unitOnlyTargetsCategory[unitDefID]]) then
		return false
	else
