...
function gadget:AllowCommand(unitID, unitDefID, teamID, cmdID, cmdParams, cmdOptions, cmdTag, playerID, fromSynced, fromLua)
	...
	and not (unitCategories[SpringShared.GetUnitDefID(cmdParams[1])] and unitCategories[SpringShared.GetUnitDefID(cmdParams[1])][unitOnlyTargetsCategory[unitDefID]]) then
		return false
	else
