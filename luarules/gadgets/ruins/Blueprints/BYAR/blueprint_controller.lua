...
local function populateBlueprints(blueprintType)
	...
	for _, blueprintFile in ipairs(blueprintsDirectory) do
		...
		if not success then
			Engine.Shared.Echo("[Ruins Blueprints] Failed to load blueprint file: " .. blueprintFile .. " - " .. fileContents)
		else
			for _, blueprintFunction in ipairs(fileContents) do
				...
				if not blueprintSuccess then
					Engine.Shared.Echo("[Ruins Blueprints] Failed to execute blueprint function in file: " .. blueprintFile .. " - " .. blueprint)
				else
