...
local function minefield1()
	return {
		...
		buildings = {
			...
			{
				unitDefID = UDN.cormine1_scav.id,
				xOffset = math.random(-192, 192),
				zOffset = math.random(-192, 192),
				direction = 0,
			},
			{
				unitDefID = UDN.armmine3_scav.id,
				xOffset = math.random(-192, 192),
				zOffset = math.random(-192, 192),
				direction = 0,
			},
			{
				unitDefID = UDN.cormine3_scav.id,
				xOffset = math.random(-192, 192),
				zOffset = math.random(-192, 192),
				direction = 0,
			},
...
local function minefield2()
	return {
		...
		buildings = {
			{
				unitDefID = UDN.armmine1_scav.id,
				xOffset = math.random(-96, 96),
				zOffset = math.random(-96, 96),
				direction = 0,
			},
			{
				unitDefID = UDN.cormine1_scav.id,
...
local function minefield3()
	return {
		...
		buildings = {
			{
				unitDefID = UDN.armmine1_scav.id,
				xOffset = math.random(-384, 384),
				zOffset = math.random(-384, 384),
				direction = 0,
			},
			{
				unitDefID = UDN.cormine1_scav.id,
