...
for udid, ud in pairs(UnitDefs) do
	if string.find(ud.name, 'cortex_commando') or string.find(ud.name, 'legcomt2off') or string.find(ud.name, 'lootbox') or string.find(ud.name, 'scavengerdroppodbeacon_scav') then
