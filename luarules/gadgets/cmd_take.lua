...
-- Auto-grant: once a delayed take's timer expires, hand the held-back units to
-- the player who first ran /take, without requiring a second /take. Cancel if
-- the source team regained an active player, or drop it if the original taker
-- is gone (left/died).
