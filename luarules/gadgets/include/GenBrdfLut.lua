...
function GenBrdfLut:Initialize()
	...
	if not self.tex then
		Engine.Shared.Echo("GenBrdfLut: tex creation error:\n")
	end
	...
	if not self.fbo then
		Engine.Shared.Echo("GenBrdfLut: FBO creation error:\n")
	end
	...
	if not self.shader then
		Engine.Shared.Echo(string.format("GenBrdfLut: [%s] shader errors:\n%s", "GenBrdfLut", shLog))
		return false
	elseif shLog ~= "" then
		Engine.Shared.Echo(string.format("GenBrdfLut: [%s] shader warnings:\n%s", "GenBrdfLut", shLog))
	end
end
