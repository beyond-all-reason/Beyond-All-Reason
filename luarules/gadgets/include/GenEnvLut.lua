...
function GenEnvLut:Initialize()
	...
	if not self.tex then
		Engine.Shared.Echo("GenEnvLut: tex creation error:\n")
	end
	...
	if not self.shader then
		Engine.Shared.Echo(string.format("GenEnvLut: [%s] shader errors:\n%s", "GenEnvLut", shLog))
		return false
	elseif shLog ~= "" then
		Engine.Shared.Echo(string.format("GenEnvLut: [%s] shader warnings:\n%s", "GenEnvLut", shLog))
	end
end
