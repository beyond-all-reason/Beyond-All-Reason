...
function gadget:Initialize()
  ...
  Spring.AddUnitIcon("sub_worker.user", "LuaUI/Icons/sub_worker.png",1.33)
  ...
  Spring.AddUnitIcon("hover_worker.user", "LuaUI/Icons/hover_worker.png",1)
  Spring.AddUnitIcon("hover_aa.user", "LuaUI/Icons/hover_aa.png",1)

  Spring.AddUnitIcon("ship_t2_flagship.user", "LuaUI/Icons/ship.png",3)
  Spring.AddUnitIcon("ship_t2_battleship.user", "LuaUI/Icons/ship.png",2.3)
  Spring.AddUnitIcon("ship_t2.user", "LuaUI/Icons/ship.png",1.6)
  Spring.AddUnitIcon("ship.user", "LuaUI/Icons/ship.png",1.2)
  Spring.AddUnitIcon("ship_worker.user", "LuaUI/Icons/ship_worker.png",1.3)
  ...
  Spring.AddUnitIcon("krogoth.user", "LuaUI/Icons/mech.png",3)
  Spring.AddUnitIcon("bantha.user", "LuaUI/Icons/mech.png",2.5)
  Spring.AddUnitIcon("juggernaut.user", "LuaUI/Icons/kbot.png",2.6)
  ...
  Spring.AddUnitIcon("kbot_t3.user", "LuaUI/Icons/kbot.png",1.8)

  Spring.AddUnitIcon("vehicle_flea.user", "LuaUI/Icons/vehicle.png",0.55)
  Spring.AddUnitIcon("vehicle_t1_raid.user", "LuaUI/Icons/vehicle.png",0.75)
  Spring.AddUnitIcon("vehicle_t1.user", "LuaUI/Icons/vehicle.png",1)
  Spring.AddUnitIcon("vehicle_t1_aa.user", "LuaUI/Icons/vehicle_aa.png",1)
  Spring.AddUnitIcon("vehicle_t2.user", "LuaUI/Icons/vehicle.png",1.3)
  Spring.AddUnitIcon("vehicle_t2_aa.user", "LuaUI/Icons/vehicle_aa.png",1.3)
  Spring.AddUnitIcon("vehicle_t2_big.user", "LuaUI/Icons/vehicle.png",1.5)
  Spring.AddUnitIcon("vehicle_worker.user", "LuaUI/Icons/vehicle_worker.png",0.95)
  Spring.AddUnitIcon("vehicle_t2_worker.user", "LuaUI/Icons/vehicle_worker.png", 1.3)
  ...
  Spring.AddUnitIcon("lrpc.user", "LuaUI/Icons/lrpc.png", 2.3)
  Spring.AddUnitIcon("lrpc_lolcannon.user", "LuaUI/Icons/lrpc.png", 3.3)
  ...
  Spring.AddUnitIcon("air_lichenergy1.user", "LuaUI/Icons/air_bomber.png",2)
  ...
  Spring.AddUnitIcon("air_worker.user", "LuaUI/Icons/air_worker.png",1.2)
  Spring.AddUnitIcon("air_worker_t2.user", "LuaUI/Icons/air_worker.png",1.6)
  ...
  Spring.AddUnitIcon("defence_1", "LuaUI/Icons/defence.png", 1)
  Spring.AddUnitIcon("defence_2", "LuaUI/Icons/defence.png", 1.3)
  Spring.AddUnitIcon("defence_3", "LuaUI/Icons/defence.png", 1.66)
  ...
  for udid,ud in pairs(UnitDefs) do
    ...
    if (ud ~= nil) then
      ...
      elseif ud.selfDCountdown == 0 then
      ...
      elseif (ud.name=="corfav" or ud.name=="armfav" or ud.name=="armflea") then
        if vehUnits[ud.name] ~= nil then
          Spring.SetUnitDefIcon(udid, "vehicle_flea.user")
        else
      ...
      elseif (ud.name=="armfig") or (ud.name=="corveng") or (ud.name=="armsfig") or (ud.name=="corsfig") or (ud.name=="armhawk") or (ud.name=="corvamp") then
	...
	(ud.name=="cormakr") or (ud.name=="corfmkr") or (ud.name=="cormmkr") or (ud.name=="coruwmmm") then
      ...
      elseif (ud.isBuilder) then
          ...
          elseif (ud.name=="armcv" or ud.name=="armbeaver" or ud.name=="corcv" or ud.name=="cormuskrat") then
            Spring.SetUnitDefIcon(udid, "vehicle_worker.user")
          ...
          elseif (ud.canFly) then
            if (ud.name=="armaca" or ud.name=="coraca") then
              Spring.SetUnitDefIcon(udid, "air_worker_t2.user")
            else
              Spring.SetUnitDefIcon(udid, "air_worker.user")
            end
          elseif ((ud.minWaterDepth > 0) and (ud.speed > 0)) then -- ships
            Spring.SetUnitDefIcon(udid, "ship_worker.user")
          ...
          elseif (ud.name=="armrecl" or ud.name=="correcl") then  -- subs
            ...
            if ud.modCategories["hover"] ~= nil then
              Spring.SetUnitDefIcon(udid, "hover_worker.user")
            elseif ((ud.speed > 0) and ud.canMove) then
              Spring.SetUnitDefIcon(udid, "worker.user")     -- mobile
            else
              Spring.SetUnitDefIcon(udid, "nano.user")  -- immobile
            end
          end
      elseif ud.modCategories["hover"] ~= nil then -- hovers
      ...
      elseif (ud.canFly) then
        ...
        if (ud.hoverAttack) then
          ...
          if (ud.name=="armliche") then
            Spring.SetUnitDefIcon(udid, "air_lichenergy1.user")
          else
      ...
      elseif (ud.isBuilding or (ud.speed <= 0)) then
        ...
        elseif (ud.techLevel == 6 or ud.name=="orcone" or ud.name=="krogtaar" or ud.name=="corsumo" or ud.name=="armmanni" or ud.name=="corgol") then
          if vehUnits[ud.name] ~= nil then
            Spring.SetUnitDefIcon(udid, "vehicle_t2_big.user")
          elseif ud.name=="corsumo" then
          ...
          if vehUnits[ud.name] ~= nil then
            if ud.weapons[1] ~= nil and ud.weapons[1].onlyTargets["vtol"] then
              Spring.SetUnitDefIcon(udid, "vehicle_t1_aa.user")
            else
              Spring.SetUnitDefIcon(udid, "vehicle_t1.user")
            end
          else
            if ud.weapons[1] ~= nil and ud.weapons[1].onlyTargets["vtol"] then
              Spring.SetUnitDefIcon(udid, "kbot_t1_aa.user")
            else
