...
local iconScale = 1
local icons = {
  {"armcom.user", "LuaUI/Icons/armcom.png",1.75*iconScale},
  {"corcom.user", "LuaUI/Icons/corcom.png",1.75*iconScale},

  {"mine1.user", "LuaUI/Icons/mine.png",0.36*iconScale},
  ...
  {"hover_t1.user", "LuaUI/Icons/hover.png",0.9*iconScale},
  ...
  {"ship_destroyer.user", "LuaUI/Icons/ship.png",1.44*iconScale},
  {"ship_t1_worker.user", "LuaUI/Icons/ship_worker.png",1.33*iconScale},
  {"ship_aa1.user", "LuaUI/Icons/ship_aa.png",1.2*iconScale},
  {"ship_t2.user", "LuaUI/Icons/ship.png",1.65*iconScale},
  {"ship_t2_worker.user", "LuaUI/Icons/ship_worker.png",1.65*iconScale},
  {"ship_t2_aa1.user", "LuaUI/Icons/ship_aa.png",1.65*iconScale},
  {"ship_t2_big.user", "LuaUI/Icons/ship.png",2*iconScale},
  {"ship_t2_battleship.user", "LuaUI/Icons/ship.png",2.5*iconScale},
  {"ship_t2_battleship.user", "LuaUI/Icons/ship.png",2.5*iconScale},
  {"ship_t2_flagship.user", "LuaUI/Icons/ship.png",3.3*iconScale},

  {"amphib_t1.user", "LuaUI/Icons/amphib.png",1.2*iconScale},
  {"amphib_t1_aa.user", "LuaUI/Icons/amphib_aa.png",1.2*iconScale},
  {"amphib_t1_worker.user", "LuaUI/Icons/amphib_worker.png",1.3*iconScale},
  {"amphib_t2.user", "LuaUI/Icons/amphib.png",1.6*iconScale},
  {"amphib_t2_aa.user", "LuaUI/Icons/amphib_aa.png",1.6*iconScale},
  {"amphib_t3.user", "LuaUI/Icons/amphib.png",2.05*iconScale},

  {"shield.user", "LuaUI/Icons/shield.png", 2.05*iconScale},

  {"radar_t1.user", "LuaUI/Icons/radar.png", 0.9*iconScale},
  {"jammer_t1.user", "LuaUI/Icons/jammer.png", 0.9*iconScale},
  {"radar_t2.user", "LuaUI/Icons/radar.png", 1.2*iconScale},
  ...
  {"aa_flak.user", "LuaUI/Icons/aa.png", 1.4*iconScale},
  {"aa_longrangenergy1.user", "LuaUI/Icons/aa.png", 1.8*iconScale},

  {"worker.user", "LuaUI/Icons/worker.png", 0.85*iconScale},

  {"allterrain_t1.user", "LuaUI/Icons/allterrain.png",1*iconScale},
  {"allterrain_t2.user", "LuaUI/Icons/allterrain.png",1.33*iconScale},
  {"allterrain_t3.user", "LuaUI/Icons/allterrain.png",1.95*iconScale},
  ...
  {"kbot_t1_worker.user", "LuaUI/Icons/kbot_worker.png",0.95*iconScale},
  {"kbot_t1_aa1.user", "LuaUI/Icons/kbot_aa.png",0.95*iconScale},
  {"kbot_t2.user", "LuaUI/Icons/kbot.png",1.28*iconScale},
  {"kbot_t2_big.user", "LuaUI/Icons/kbot.png",1.47*iconScale},
  {"kbot_t2_worker.user", "LuaUI/Icons/kbot_worker.png", 1.33*iconScale},
  {"kbot_t2_aa1.user", "LuaUI/Icons/kbot_aa.png",1.28*iconScale},
  {"kbot_t3.user", "LuaUI/Icons/kbot.png",1.9*iconScale},

  {"tank_t1_flea.user", "LuaUI/Icons/vehicle.png",0.55*iconScale},
  {"tank_t1_raid.user", "LuaUI/Icons/vehicle.png",0.75*iconScale},
  {"tank_t1.user", "LuaUI/Icons/vehicle.png",1*iconScale},
  {"tank_t1_big.user", "LuaUI/Icons/vehicle.png",1.15*iconScale},
  {"tank_t1_aa1.user", "LuaUI/Icons/vehicle_aa.png",1*iconScale},
  {"tank_t2.user", "LuaUI/Icons/vehicle.png",1.3*iconScale},
  {"tank_t2_aa1.user", "LuaUI/Icons/vehicle_aa.png",1.3*iconScale},
  {"tank_t2_big.user", "LuaUI/Icons/vehicle.png",1.5*iconScale},
  {"tank_t1_worker.user", "LuaUI/Icons/vehicle_worker.png",0.95*iconScale},
  {"tank_t2_worker.user", "LuaUI/Icons/vehicle_worker.png", 1.3*iconScale},

  {"building_t1.user", "LuaUI/Icons/building.png", 1*iconScale},
  {"building_t2.user", "LuaUI/Icons/building.png", 1.3*iconScale},

  {"factory_t1", "LuaUI/Icons/factory.png",1.45*iconScale},
  {"factory_t2", "LuaUI/Icons/factory.png",1.85*iconScale},
  {"factory_t3", "LuaUI/Icons/factory.png",2.4*iconScale},
  ...
  {"air_t1.user", "LuaUI/Icons/air.png",0.85*iconScale},
  {"air_t1_worker.user", "LuaUI/Icons/air_worker.png",1.2*iconScale},
  {"air_t1_hover_t1.user", "LuaUI/Icons/air_hover.png",1.25*iconScale},
  {"air_t1_bomber.user", "LuaUI/Icons/air_bomber.png",1.35*iconScale},
  {"air_t1_transport.user", "LuaUI/Icons/transport.png",1.3*iconScale},
  {"air_t1_scout.user", "LuaUI/Icons/air_los.png",0.6*iconScale},
  {"air_t2.user", "LuaUI/Icons/air.png",1.05*iconScale},
  {"air_t2_worker.user", "LuaUI/Icons/air_worker.png",1.6*iconScale},
  ...
  {"defence_0", "LuaUI/Icons/defence.png", 0.8*iconScale},
  {"defence_1", "LuaUI/Icons/defence.png", 1.05*iconScale},
  {"defence_2", "LuaUI/Icons/defence.png", 1.4*iconScale},
  {"defence_3", "LuaUI/Icons/defence.png", 1.95*iconScale},

  {"blank.user", "LuaUI/Icons/blank.png", 1*iconScale},
  {"unknown.user", "LuaUI/Icons/unknown.png", 2*iconScale},
}
