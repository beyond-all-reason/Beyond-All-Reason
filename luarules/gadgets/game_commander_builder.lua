...
local PvEEnabled = BAR.Utilities.Gametype.IsPvE()
if
	Spring.GetModOptions().commanderbuildersenabled == "enabled"
	or (Spring.GetModOptions().commanderbuildersenabled == "pve_only" and PvEEnabled)
then
