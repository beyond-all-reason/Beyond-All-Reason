...
function gadget:GetInfo()
	return {
		...
		desc      = "Finds metal and geothermal spots for other gadgets",
...
function gadget:Initialize()
	--make interfaces available to other gadgets:
	_G['resource_spot_finder'] = { }
	_G['resource_spot_finder'].metalSpotsList = GetSpotsMetal()

	_G['resource_spot_finder'].GetBuildingPositions = GetBuildingPositions
	_G['resource_spot_finder'].IsMexPositionValid = IsBuildingPositionValid
end

local firstUpdate = true
function gadget:Update(dt)
	if firstUpdate then
		--GetSpotsGeo() uses Spring.GetAllFeatures() which is empty at the time of gadget:Initialize
		_G['resource_spot_finder'].geoSpotsList = GetSpotsGeo()
		firstUpdate = false
	end
end
