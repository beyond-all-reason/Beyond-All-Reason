...
if gadgetHandler:IsSyncedCode() then
	...
	function gadget:RecvLuaMsg(msg, playerID)
		...
		if cmd == "desync" then
			subPermission = "test"
		elseif cmd == "givecat" or cmd == "xpunits" or cmd == "destroyunits" or cmd == "removeunits" or cmd == "removenearbyunits" or cmd == "reclaimunits" or cmd == "transferunits" or cmd == "wreckunits" or cmd == "halfhealth" or cmd == "sethealth" or cmd == "spawnceg" or cmd == "spawnunitexplosion" or cmd == "removeunitdef" then
			subPermission = "units"
