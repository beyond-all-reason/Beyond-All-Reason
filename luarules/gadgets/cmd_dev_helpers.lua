...
if gadgetHandler:IsSyncedCode() then
	...
	function GiveCat(_, line, words, playerID)
		...
		-- give units
		local exclusions = { meteor = true, raptor_hive = true, nuketest = true, nuketestcor = true, nuketestcororg = true, nuketestorg = true, scavtacnukespawner = true, scavempspawner = true }
		local newExclusions = {}
