...
local function updateFeatureFadeDistances()
	local drawDist = SpringUnsynced.GetConfigInt("FeatureDrawDistance", 10000)
	local fadeDist = SpringUnsynced.GetConfigInt("FeatureFadeDistance", math.floor(drawDist * 0.8))
