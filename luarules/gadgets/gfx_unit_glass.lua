...
void main(void){
	...
	for unitDefID, unitDef in pairs(UnitDefs) do
		...
		if
			unitNormalTexture
			and (unitTextureFiles[string.lower(unitNormalTexture)] or VFS.FileExists(unitNormalTexture))
		then
	...
	function gadget:UnitEnteredLos(unitID, unitTeam, allyTeam, unitDefID)
		if
			(glassUnitDefs[unitDefID] or not solidUnitDefs[unitDefID])
			and CallAsTeam(myTeamID, Spring.IsUnitVisible, unitID, nil, false)
		then
	...
	function gadget:UnitLeftLos(unitID, unitTeam, allyTeam, unitDefID)
		if
			(glassUnitDefs[unitDefID] or not solidUnitDefs[unitDefID])
			and not CallAsTeam(myTeamID, Spring.IsUnitVisible, unitID, nil, false)
		then
