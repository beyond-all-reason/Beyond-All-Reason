...
local function SetUnitWantedSpeed(unitID, unitDefID, wantedSpeed, forceUpdate)
	...
	if Engine.Synced.MoveCtrl.GetTag(unitID) then
	...
	if units[unitID].moveType == 1 then
		Engine.Synced.MoveCtrl.SetGunshipMoveTypeData(unitID, "maxWantedSpeed", (wantedSpeed or 2000))
	elseif units[unitID].moveType == 2 then
		Engine.Synced.MoveCtrl.SetGroundMoveTypeData(unitID, "maxWantedSpeed", (wantedSpeed or 2000))
	end
end
...
local function MaintainWantedSpeed(unitID)
	...
	if units[unitID].moveType == 1 then
		Engine.Synced.MoveCtrl.SetGunshipMoveTypeData(unitID, "maxWantedSpeed", units[unitID].lastWantedSpeed)
	elseif units[unitID].moveType == 2 then
		Engine.Synced.MoveCtrl.SetGroundMoveTypeData(unitID, "maxWantedSpeed", units[unitID].lastWantedSpeed)
	end
end
