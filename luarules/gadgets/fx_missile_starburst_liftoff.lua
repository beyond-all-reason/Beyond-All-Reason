		...
		if gf <= missile[6] then
			...
			if y and y > 0 then
				...
				if gf <= missile[5] or gf % 2 == 1 then
					...
					Engine.Synced.SpawnCEG(missile[4], x, y, z, dirX, dirY, dirZ)
					if y <= missile[8] or (y <= missile[9] and gf % 2 == 1) then
						-- add ground dust
						Engine.Synced.SpawnCEG(missile[7], x, missile[2], z, dirX, dirY, dirZ)
					end
					if y <= missile[11] or (y <= missile[12] and gf % 2 == 1) then
						--add ground fire
						Engine.Synced.SpawnCEG(missile[10], x, missile[2], z, dirX, dirY, dirZ)
					end
				end
			else
