...
function MakeButton()
	subsButton = gl.CreateList(function()
		...
		-- gloss
		RectRound(-bW/2, 0, bW/2, bH/2, 3, 2,2,2,2, {1,1,1,0.045}, {1,1,1,0.15})
		RectRound(-bW/2, -bH/2, bW/2, -bH/4, 3, 2,2,2,2, {1,1,1,0.05}, {1,1,1,0})
		gl.Color(1,1,1,1)
	end)
	subsButtonHover = gl.CreateList(function()
		...
		-- gloss
		RectRound(-bW/2, 0, bW/2, bH/2, 3, 2,2,2,2, {1,1,1,0.075}, {1,1,1,0.25})
		RectRound(-bW/2, -bH/2, bW/2, -bH/4, 3, 2,2,2,2, {1,1,1,0.1}, {1,1,1,0})
		gl.Color(1,1,1,1)
	end)
end
