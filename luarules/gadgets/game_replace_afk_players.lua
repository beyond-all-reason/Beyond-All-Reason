...
function MakeButton()
	subsButton = gl.CreateList(function()
		...
		gl.Color(0,0,0,0.8)
		RectRound(-((bW/2)+bgMargin), -((bH/2)+bgMargin), ((bW/2)+bgMargin), ((bH/2)+bgMargin), 5)
		--gl.Color(1,1,1,0.13)
		RectRound(-bW/2, -bH/2, bW/2, bH/2, 3, 1,1,1,1, {1,1,1,0}, {1,1,1,0.1})
		-- gloss
		RectRound(-bW/2, -bH/2, bW/2, 0, 3, 1,1,1,1, {1,1,1,0.06}, {1,1,1,0.15})
		RectRound(-bW/2, bH/4, bW/2, bH/2, 3, 1,1,1,1, {1,1,1,0}, {1,1,1,0.05})
		gl.Color(1,1,1,1)
	end)
	subsButtonHover = gl.CreateList(function()
		...
		RectRound(-bW/2, -bH/2, bW/2, bH/2, 3, 1,1,1,1, {1,1,1,0}, {1,1,1,0.22})
		-- gloss
		RectRound(-bW/2, -bH/2, bW/2, 0, 3, 1,1,1,1, {1,1,1,0.12}, {1,1,1,0.25})
		RectRound(-bW/2, bH/4, bW/2, bH/2, 3, 1,1,1,1, {1,1,1,0}, {1,1,1,0.1})
		gl.Color(1,1,1,1)
	end)
end
