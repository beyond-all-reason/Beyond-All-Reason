...
function MakeButton()
	subsButton = gl.CreateList(function()
		...
		RectRound(-bW/2, 0, bW/2, bH/2, 3, 2,2,0,0, {1,1,1,0.045}, {1,1,1,0.12})
		RectRound(-bW/2, -bH/2, bW/2, -bH/4, 3, 0,0,2,2, {1,1,1,0.05}, {1,1,1,0})
	...
	subsButtonHover = gl.CreateList(function()
		...
		-- gloss
		gl.Blending(GL.SRC_ALPHA, GL.ONE)
		RectRound(-bW/2, 0, bW/2, bH/2, 3, 2,2,0,0, {1,1,1,0.075}, {1,1,1,0.2})
		RectRound(-bW/2, -bH/2, bW/2, -bH/4, 3, 0,0,2,2, {1,1,1,0.085}, {1,1,1,0})
		gl.Blending(GL.SRC_ALPHA, GL.ONE_MINUS_SRC_ALPHA)
		gl.Color(1,1,1,1)
	end)
end
