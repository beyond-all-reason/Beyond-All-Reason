	...
	if mapHasWater then
		for weaponID, weaponDef in pairs(WeaponDefs) do
			if weaponDef.type == "TorpedoLauncher" then
				if
					weaponDef.visuals.modelName == "objects3d/torpedo.s3o"
					or weaponDef.visuals.modelName == "objects3d/cordepthcharge.s3o"
					or weaponDef.visuals.modelName == "objects3d/torpedo.3do"
					or weaponDef.visuals.modelName == "objects3d/depthcharge.3do"
				then
					depthChargeWeapons[weaponID] = waterIsLava and "lavasplash-torpedo" or "splash-torpedo"
				elseif
					weaponDef.visuals.modelName == "objects3d/coradvtorpedo.s3o"
					or weaponDef.visuals.modelName == "objects3d/Advtorpedo.3do"
				then
