...
local function setGaiaStorage()
	...
	if currentMetalStorage and currentMetalStorage < metalStorageToSet then
		GG.SetTeamResourceData(gaiaTeamID, { resourceType = ResourceTypes.METAL, storage = metalStorageToSet })
	end
	...
	if currentEnergyStorage and currentEnergyStorage < energyStorageToSet then
		GG.SetTeamResourceData(gaiaTeamID, { resourceType = ResourceTypes.ENERGY, storage = energyStorageToSet })
	end
end
