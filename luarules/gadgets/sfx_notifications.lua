...
--Player left send to all in allyteam
	...
	for unitDefID, unitDef in pairs(UnitDefs) do
		...
		if not string.find(unitDef.name, 'critter') and not string.find(unitDef.name, 'raptor') and (not unitDef.modCategories or not unitDef.modCategories.object) then
			...
			if string.find(unitDef.name,'cortex_basilisk') or string.find(unitDef.name,'armada_basilica') or string.find(unitDef.name,'cortex_calamity') or string.find(unitDef.name,'armada_ragnarok') or string.find(unitDef.name,'legstarfall') then
