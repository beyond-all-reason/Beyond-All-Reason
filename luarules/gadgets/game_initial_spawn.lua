...
if gadgetHandler:IsSyncedCode() then
	...
	local function isFootingUntraversable(x, y, z, unitDefID)
		...
		if type == 2 then
			return not (SpringShared.TestMoveOrder(unitDefID, x, y, z) and
			SpringShared.TestMoveOrder(unitDefID, x, y, z, 1, 0, 0) and
			SpringShared.TestMoveOrder(unitDefID, x, y, z, 0, 0, 1) and
			SpringShared.TestMoveOrder(unitDefID, x, y, z,-1, 0, 0) and
			SpringShared.TestMoveOrder(unitDefID, x, y, z, 0, 0,-1))
		end
