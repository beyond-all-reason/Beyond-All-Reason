...
if gadgetHandler:IsSyncedCode() then
	...
	function gadget:GameOver(winningAllyTeams)
		...
		if
			ecoKillAwardTeam ~= -1
			and (ecoKillAwardTeam == fightKillAwardTeam)
			and (ecoKillAwardTeam == efficiencyAwardTeam)
			and nTeams > 3
		then
	...
	local function ProcessAwards(_)
		...
		local ecoKillLine = "\161"
			.. tostring(1 + awards.ecoKill[1].teamID)
			.. ":"
			.. tostring(awards.ecoKill[1].score)
			.. "\161"
			.. tostring(1 + awards.ecoKill[2].teamID)
			.. ":"
			.. tostring(awards.ecoKill[2].score)
			.. "\161"
			.. tostring(1 + awards.ecoKill[3].teamID)
			.. ":"
			.. tostring(awards.ecoKill[3].score)
		local fightKillLine = "\162"
			.. tostring(1 + awards.fightKill[1].teamID)
			.. ":"
			.. tostring(awards.fightKill[1].score)
			.. "\162"
			.. tostring(1 + awards.fightKill[2].teamID)
			.. ":"
			.. tostring(awards.fightKill[2].score)
			.. "\162"
			.. tostring(1 + awards.fightKill[3].teamID)
			.. ":"
			.. tostring(awards.fightKill[3].score)
		local efficientKillLine = "\163"
			.. tostring(1 + awards.efficiency[1].teamID)
			.. ":"
			.. tostring(awards.efficiency[1].score)
			.. "\163"
			.. tostring(1 + awards.efficiency[2].teamID)
			.. ":"
			.. tostring(awards.efficiency[2].score)
			.. "\163"
			.. tostring(1 + awards.efficiency[3].teamID)
			.. ":"
			.. tostring(awards.efficiency[3].score)
		local otherLine = "\164"
			.. tostring(1 + awards.goldenCow[1].teamID)
			.. "\165"
			.. tostring(1 + awards.eco[1].teamID)
			.. ":"
			.. tostring(awards.eco[1].score)
			.. "\166"
			.. tostring(1 + awards.damageReceived[1].teamID)
			.. ":"
			.. tostring(awards.damageReceived[1].score)
			.. "\167"
			.. tostring(1 + awards.sleep[1].teamID)
			.. ":"
			.. tostring(awards.sleep[1].score)
