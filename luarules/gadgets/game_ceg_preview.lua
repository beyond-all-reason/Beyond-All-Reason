...
if gadgetHandler:IsSyncedCode() then
	...
	local function FireCEGTestProjectile(
		ceg,
		impactBlock,
		muzzleBlock,
		fireSound,
	...
	function gadget:RecvLuaMsg(msg, playerID)
		...
		if msg:sub(1, #PREFIX_PROJ) == PREFIX_PROJ or msg:sub(1, #PREFIX_GROUND) == PREFIX_GROUND then
			local body = (msg:sub(1, #PREFIX_PROJ) == PREFIX_PROJ) and msg:sub(#PREFIX_PROJ + 1)
				or msg:sub(#PREFIX_GROUND + 1)
