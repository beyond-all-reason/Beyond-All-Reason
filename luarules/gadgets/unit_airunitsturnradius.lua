...
for udid, ud in pairs(UnitDefs) do
	...
	if (ud["weapons"] and ud["weapons"][1] and isBomb[ud["weapons"][1].weaponDef] == true) or (string.find(ud.name, 'armada_cormorant') or string.find(ud.name, 'cortex_angler')) then
		isBomber[udid] = true
	end
