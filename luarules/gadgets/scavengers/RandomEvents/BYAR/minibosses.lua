...
local function miniboss1(currentFrame)
	if currentFrame > scavconfig.gracePeriod*2 then
		...
		local T4bosses = {"cortex_juggernaut_scav", "cortex_behemoth_scav", "armada_titan_scav","armada_pawnt4_scav","armada_ratte_scav","armada_epictumbleweed_scav","cortex_demon_scav","cortex_epickarganeth_scav",}
