...
local function miniboss1(currentFrame)
	if currentFrame > scavconfig.gracePeriod*2 then
		...
		local T3bosses = {"armada_marauder_scav","armada_vanguard_scav","armada_razorback_scav","corshiva_scav","corkarg_scav","corcat_scav","armada_lunkhead_scav","corsok_scav","armada_recluset4_scav",}
