...
local function miniboss1(currentFrame)
	if currentFrame > scavconfig.gracePeriod*2 then
		...
		local T4bosses = {"cortex_juggernaut_scav", "cortex_behemoth_scav", "armada_titan_scav","armada_pawnt4_scav","armrattet4_scav","armada_tumbleweedt4_scav","cortex_demon_scav","cortex_karganetht4_scav",}
