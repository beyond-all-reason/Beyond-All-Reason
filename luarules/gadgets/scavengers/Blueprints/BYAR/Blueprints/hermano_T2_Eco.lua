...
local function HermanoT2Eco0()
	return {
		...
		buildings = {
			...
			{ unitDefID = UnitDefNames.cortex_birdshot_scav.id, xOffset = 0, zOffset = 201, direction = 2},
			{ unitDefID = UnitDefNames.cortex_birdshot_scav.id, xOffset = 0, zOffset = -215, direction = 2},
			...
			{ unitDefID = UnitDefNames.cortex_advancedenergyconverter_scav.id, xOffset = 96, zOffset = 25, direction = 2},
			{ unitDefID = UnitDefNames.cortex_advancedenergyconverter_scav.id, xOffset = -96, zOffset = 89, direction = 2},
			{ unitDefID = UnitDefNames.cortex_bulwark_scav.id, xOffset = 224, zOffset = -151, direction = 2},
			{ unitDefID = UnitDefNames.cortex_bulwark_scav.id, xOffset = -224, zOffset = 137, direction = 2},
...
local function HermanoT2Eco1()
	return {
		...
		buildings = {
			...
			{ unitDefID = UnitDefNames.cortex_birdshot_scav.id, xOffset = 0, zOffset = 144, direction = 2},
...
local function HermanoT2Eco6()
	return {
		...
		radius = 206,
		buildings = {
			{ unitDefID = UnitDefNames.armada_advancedwindturbine_scav.id, xOffset = 134, zOffset = -15, direction = 2},
			{ unitDefID = UnitDefNames.armada_advancedwindturbine_scav.id, xOffset = -186, zOffset = 129, direction = 2},
			{ unitDefID = UnitDefNames.armada_advancedwindturbine_scav.id, xOffset = -90, zOffset = -95, direction = 2},
			{ unitDefID = UnitDefNames.armada_advancedwindturbine_scav.id, xOffset = 38, zOffset = 193, direction = 2},
			{ unitDefID = UnitDefNames.armada_advancedwindturbine_scav.id, xOffset = 22, zOffset = -47, direction = 2},
			{ unitDefID = UnitDefNames.armada_advancedwindturbine_scav.id, xOffset = -74, zOffset = 161, direction = 2},
			...
			{ unitDefID = UnitDefNames.cortex_birdshot_scav.id, xOffset = -90, zOffset = -159, direction = 2},
			{ unitDefID = UnitDefNames.cortex_birdshot_scav.id, xOffset = 150, zOffset = 49, direction = 2},
			{ unitDefID = UnitDefNames.cortex_birdshot_scav.id, xOffset = -186, zOffset = 65, direction = 2},
		},
	}
end
