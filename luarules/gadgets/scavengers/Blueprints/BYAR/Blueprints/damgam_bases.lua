...
local function redBase1()
	...
	return {
		...
		buildings = {
			...
			-- Walls
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset = -32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset =  32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset =   0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset = -64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset =  64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  136,  zOffset = -32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  136,  zOffset =  32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  136,  zOffset =   0, direction = 0 },
...
local function blueBase2()
	return {
		...
		buildings = {
			...
			-- Walls
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  160,  zOffset =  192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =   64, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  128,  zOffset =  192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -128,  zOffset = -192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset = -192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -64,  zOffset =  192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset = -160, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -64,  zOffset = -192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =  -96, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset = -128, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -96,  zOffset = -192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =  128, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset =  192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset = -192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset =   64, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =   96, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -160,  zOffset =  192, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -160,  zOffset = -192, direction = 1 },
...
local function redBase2()
	return {
		...
		buildings = {
			...
			-- Walls
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -160,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset = -128, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  160,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  128,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =   96, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   96,  zOffset = -192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset = -192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =  -96, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset =  128, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -96,  zOffset = -192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset = -192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =  128, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset = -160, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset = -128, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -192,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  160,  zOffset = -192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset =  160, direction = 3 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -160,  zOffset = -192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   96,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset =  -64, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -128,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset =  192, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset =   64, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset =  -96, direction = 3 },
