...
local function Nikuksis_land0()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 136, zOffset = 40, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 40, zOffset = 136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 8, zOffset = -168, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 168, zOffset = -8, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 24, zOffset = 168, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -168, zOffset = 8, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -136, zOffset = -40, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 136, zOffset = -24, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 168, zOffset = 24, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -24, zOffset = 136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 24, zOffset = -136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -8, zOffset = 168, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -168, zOffset = -24, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -24, zOffset = -168, direction = 1},
...
local function Nikuksis_land6()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 16, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -48, zOffset = -16, direction = 1},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 16, zOffset = -48, direction = 1},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -16, zOffset = 48, direction = 1},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -48, zOffset = 16, direction = 1},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -48, zOffset = -48, direction = 1},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 48, zOffset = -16, direction = 1},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 48, zOffset = 48, direction = 1},
...
local function Nikuksis_land7()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -16, zOffset = -96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 16, zOffset = 96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 80, zOffset = 16, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 48, zOffset = 48, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 80, zOffset = -16, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -16, zOffset = 96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -80, zOffset = -16, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 48, zOffset = -48, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -48, zOffset = -48, direction = 1},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -80, zOffset = 16, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 16, zOffset = 64, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -48, zOffset = -16, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 16, zOffset = -64, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 48, zOffset = 16, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 48, zOffset = -16, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -48, zOffset = 16, direction = 0},
...
local function Nikuksis_land8()
	return {
		...
		radius = 192,
		buildings = {
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -192, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -96, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -96, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 192, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 96, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 192, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = -192, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 0, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 0, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav'), xOffset = 96, zOffset = 48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 48, zOffset = 48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -144, zOffset = -48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 0, zOffset = 0, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -48, zOffset = -48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 192, zOffset = 0, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 48, zOffset = -48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 144, zOffset = -48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -192, zOffset = 0, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -96, zOffset = 0, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -48, zOffset = 48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 96, zOffset = 0, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = -144, zOffset = 48, direction = 0},
			{ unitDefID = UnitDefNames.corscavfort_scav.id, xOffset = 144, zOffset = 48, direction = 0},
