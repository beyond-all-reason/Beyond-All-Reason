...
local function Nikuksis_land0()
	return {
		...
		radius = 168,
		buildings = {
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -40, zOffset = -136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 136, zOffset = 40, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 40, zOffset = 136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 8, zOffset = -168, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 168, zOffset = -8, direction = 1},
			...
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -24, zOffset = 136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 24, zOffset = -136, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -8, zOffset = 168, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -168, zOffset = -24, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -24, zOffset = -168, direction = 1},
...
local function Nikuksis_land6()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -16, zOffset = -48, direction = 1},
...
local function Nikuksis_land7()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 16, zOffset = -96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -16, zOffset = -96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 16, zOffset = 96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 80, zOffset = 16, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 48, zOffset = 48, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 80, zOffset = -16, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -16, zOffset = 96, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -80, zOffset = -16, direction = 0},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 48, zOffset = -48, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -48, zOffset = -48, direction = 1},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -80, zOffset = 16, direction = 0},
...
local function Nikuksis_land8()
	return {
		...
		radius = 192,
		buildings = {
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -192, zOffset = -48, direction = 0},
			...
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 192, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = -192, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 0, zOffset = -48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 0, zOffset = 48, direction = 0},
			{ unitDefID = BPWallOrPopup('scav', 1), xOffset = 96, zOffset = 48, direction = 0},
