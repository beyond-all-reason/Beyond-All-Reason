...
local function nukeOutpost2()
	return {
		...
		buildings = {
			...
			{ unitDefID = UDN.cortex_calamity_scav.id,     xOffset =  104,  zOffset =   56, direction = 1 },
			...
			{ unitDefID = UDN.cortex_calamity_scav.id,     xOffset = -104,  zOffset =   56, direction = 3 },
...
local function nukeOutpost7()
	return {
		...
		radius =   64,
		buildings = {
			{ unitDefID = UDN.cortex_calamity_scav.id,   xOffset = 64,  zOffset = 64, direction = 3 },
			{ unitDefID = UDN.cortex_catalyst_scav.id,   xOffset = 64,  zOffset = 64, direction = 3 },
			{ unitDefID = UDN.cortex_calamity_scav.id,   xOffset = 64,  zOffset = 64, direction = 1 },
			{ unitDefID = UDN.cortex_catalyst_scav.id,   xOffset = 64,  zOffset = 64, direction = 3 },
