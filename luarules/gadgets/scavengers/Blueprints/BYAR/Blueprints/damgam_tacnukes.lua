...
local function tacnukes2()
	return {
		...
		buildings = {
			...
			{ unitDefID = UnitDefNames.armnanotc_scav.id, xOffset = -96, zOffset = 96, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 8, zOffset = 88, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 88, zOffset = -8, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -8, zOffset = -88, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 88, zOffset = -56, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -56, zOffset = -88, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -88, zOffset = 56, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -88, zOffset = 8, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 56, zOffset = 88, direction = 3},
...
local function tacnukes3()
	return {
		...
		buildings = {
			...
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 100, zOffset = -36, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -76, zOffset = -20, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 68, zOffset = 60, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 20, zOffset = 60, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -76, zOffset = 28, direction = 3},
...
local function tacnukes4()
	return {
		...
		buildings = {
			...
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = -12, zOffset = 34, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 68, zOffset = -62, direction = 3},
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 36, zOffset = 34, direction = 3},
...
local function tacnukes5()
	return {
		...
		buildings = {
			...
			{ unitDefID = UnitDefNames.armmg_scav.id, xOffset = 39, zOffset = 26, direction = 3},
