...
local function t1RadarOutpost()
	return {
		...
		radius = 166,
		buildings = {
			{ unitDefID = UnitDefNames.armada_sharksteeth_scav.id, xOffset = 54, zOffset = -74, direction = 0},
			{ unitDefID = UnitDefNames.armada_sharksteeth_scav.id, xOffset = -74, zOffset = 118, direction = 0},
			{ unitDefID = UnitDefNames.armada_sharksteeth_scav.id, xOffset = 102, zOffset = -74, direction = 0},
			{ unitDefID = UnitDefNames.armada_sharksteeth_scav.id, xOffset = -74, zOffset = 54, direction = 0},
			{ unitDefID = UnitDefNames.armada_sharksteeth_scav.id, xOffset = -74, zOffset = 150, direction = 0},
			{ unitDefID = UnitDefNames.armada_navalnettle_scav.id, xOffset = 86, zOffset = -26, direction = 0},
			...
			{ unitDefID = UnitDefNames.armada_sharksteeth_scav.id, xOffset = 22, zOffset = -74, direction = 0},
