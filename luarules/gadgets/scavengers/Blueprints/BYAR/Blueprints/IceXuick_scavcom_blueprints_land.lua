...
local function t1FactoryBase1()
	...
	if r == 0 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -80,  zOffset =  131, direction = 1 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   48,  zOffset = -125, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset =   99, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset =   67, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -64,  zOffset =   35, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   64,  zOffset =   35, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   16,  zOffset = -141, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  144,  zOffset =    3, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -64,  zOffset =   67, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -64,  zOffset =   99, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  112,  zOffset =  -29, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -112,  zOffset =  -29, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -48,  zOffset = -125, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -16,  zOffset = -141, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -144,  zOffset =    3, direction = 0 },
	...
	elseif r == 2 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   72,  zOffset =   62, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   72,  zOffset =   94, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   72,  zOffset =   30, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -72,  zOffset =   94, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -72,  zOffset =   30, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -104,  zOffset =  -50, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -72,  zOffset =  -50, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -40,  zOffset =  -82, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset =  -50, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   40,  zOffset =  -82, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -40,  zOffset =  -50, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   40,  zOffset =  -50, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   72,  zOffset =  -50, direction = 0 },
		}
	elseif r == 3 then
	...
	elseif r == 4 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   81,  zOffset =   25, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   65,  zOffset = -183, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   65,  zOffset =  185, direction = 0 },
			{ unitDefID = UDN.corhlt_scav.id,    xOffset =  113,  zOffset =    9, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -63,  zOffset =  -87, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   81,  zOffset =   -7, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   33,  zOffset = -199, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   81,  zOffset =  -39, direction = 2 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   33,  zOffset =  201, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   81,  zOffset =   57, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -95,  zOffset =  -55, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -127,  zOffset =  -55, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   65,  zOffset = -151, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -63,  zOffset =  105, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -31,  zOffset =   89, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   65,  zOffset =  153, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -159,  zOffset =  -55, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  113,  zOffset =  -23, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  113,  zOffset =   41, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -175,  zOffset =  -23, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -111,  zOffset =   57, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -95,  zOffset =   89, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  145,  zOffset =   -7, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -95,  zOffset =  -87, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =    1,  zOffset = -199, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  145,  zOffset =   25, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =    1,  zOffset =  201, direction = 0 },
		}
	else
		buildings = {
...
return {
	...
	buildings = {
		...
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -72,  zOffset = -72, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -40,  zOffset = -72, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  -8,  zOffset = -72, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -72,  zOffset = -40, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -72,  zOffset =  -8, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  72,  zOffset =  72, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  72,  zOffset =  40, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  72,  zOffset =   8, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  40,  zOffset =  72, direction = 0 },
...
return {
	...
	buildings = {
		...
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -104,  zOffset = -104, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  -72,  zOffset = -104, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  -40,  zOffset = -104, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -104,  zOffset =  -72, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset = -104,  zOffset =  -40, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset =  104, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset =   72, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset =   40, direction = 0 },
		{ unitDefID = BPWallOrPopup("scav"), xOffset =   72,  zOffset =  104, direction = 0 },
...
local function t1Resources2()
	...
	if r == 0 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset =  -8, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset =  24, direction = 1 },
	...
	elseif r == 1 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  144,  zOffset =  -16, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  144,  zOffset =   16, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  112,  zOffset =  -48, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  144,  zOffset =  -48, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -48,  zOffset = -144, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -48,  zOffset = -112, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -16,  zOffset = -144, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   16,  zOffset = -144, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -144,  zOffset =   16, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -144,  zOffset =  -16, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -144,  zOffset =   48, direction = 1 },
...
local function t1MetalStore1()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -96,  zOffset = -80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -96,  zOffset = -48, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -64,  zOffset = -80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  96,  zOffset =  80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  96,  zOffset =  48, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  64,  zOffset =  80, direction = 0 },
		},
...
local function t1Barriers()
	...
	if r == 0 then
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -64,  zOffset = -64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -32,  zOffset = -32, direction = 0 },
	...
	elseif r == 2 then
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -64,  zOffset = 0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -32,  zOffset = 0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   0,  zOffset = 0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  32,  zOffset = 0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  64,  zOffset = 0, direction = 0 },
		}
...
local function t1IntelBase2()
	...
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -128,  zOffset =   0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -96,  zOffset = -32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -96,  zOffset =  32, direction = 0 },			
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  128,  zOffset =   0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   96,  zOffset = -32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   96,  zOffset =  32, direction = 0 },
...
local function t1Firebase2()
	...
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -32,  zOffset =   80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   0,  zOffset =   96, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  32,  zOffset =  112, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -32,  zOffset = -112, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   0,  zOffset =  -96, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  32,  zOffset =  -80, direction = 0 },
		},
...
local function t2Firebase2()
	return {
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -96,  zOffset =  32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -64,  zOffset =  64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  192,  zOffset = 128, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  160,  zOffset =  96, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  128,  zOffset =  64, direction = 0 },
		},
	}
end
...
local function t2Firebase3()
	...
	if r == 0 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -80,  zOffset =  48, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -80,  zOffset =  80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -48,  zOffset =  80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  80,  zOffset = -48, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  80,  zOffset = -80, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  48,  zOffset = -80, direction = 0 },
		}
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   35,  zOffset =   15, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -77,  zOffset =  -49, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   35,  zOffset =  111, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset = -109,  zOffset =   47, direction = 1 },
			{ unitDefID = UDN.coruwadvms_scav.id, xOffset =   83,  zOffset =   63, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset = -141,  zOffset =   15, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -45,  zOffset =   15, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   19,  zOffset =  -81, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -45,  zOffset =  -17, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   19,  zOffset = -145, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  131,  zOffset =  111, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  131,  zOffset =   15, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset = -141,  zOffset =  -17, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -77,  zOffset =   47, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset = -109,  zOffset =  -49, direction = 1 },
			{ unitDefID = UDN.corshroud_scav.id,  xOffset =   19,  zOffset = -113, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   99,  zOffset =   15, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -13,  zOffset =  -97, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset = -141,  zOffset =   47, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   35,  zOffset =   47, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  131,  zOffset =   47, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -45,  zOffset =  -49, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  131,  zOffset =   79, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   35,  zOffset =   79, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   51,  zOffset = -129, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -45,  zOffset =   47, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   99,  zOffset =  111, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   67,  zOffset =  111, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   51,  zOffset =  -97, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset = -141,  zOffset =  -49, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =  -13,  zOffset = -129, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"),  xOffset =   67,  zOffset =   15, direction = 1 },
		}
	end
	return {
		type = types.Land,
...
local function t2HeavyFirebase1()
	...
	if r == 0 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset = -128,  zOffset =  128, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset = -128,  zOffset =   96, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset = -128,  zOffset =   64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -96,  zOffset =  128, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -64,  zOffset =  128, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  160,  zOffset = -192, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  128,  zOffset = -192, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =   96,  zOffset = -192, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  160,  zOffset = -160, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  160,  zOffset = -128, direction = 0 },
			{ unitDefID = randomTurrets[math.random(1, #randomTurrets)], xOffset =  240,  zOffset = -260, direction = 0 },
		}
	elseif r == 1 then
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   32,  zOffset =  -45, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -32,  zOffset =   51, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -48,  zOffset =  -13, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   48,  zOffset =  -13, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   48,  zOffset =   19, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =    0,  zOffset =   51, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -32,  zOffset =  -45, direction = 0 },
			{ unitDefID = UDN.cormine3_scav.id,  xOffset =  104,  zOffset =   91, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =    0,  zOffset =  -45, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   32,  zOffset =   51, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -48,  zOffset =   19, direction = 0 },
		}
	else
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  176,  zOffset =  208, direction = 2 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  208,  zOffset =  176, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -112,  zOffset =  176, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -16,  zOffset =   48, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -176,  zOffset =  144, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  208,  zOffset =   16, direction = 3 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -16,  zOffset = -144, direction = 3 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   48,  zOffset =   16, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  144,  zOffset =  -16, direction = 3 },
			{ unitDefID = UDN.corhlt_scav.id,    xOffset = -176,  zOffset =   16, direction = 3 },
			...
			{ unitDefID = UDN.corhllt_scav.id,   xOffset =   16,  zOffset =  176, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -48,  zOffset =  -16, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  240,  zOffset =    0, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -144,  zOffset =   16, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -240,  zOffset =    0, direction = 3 },
			{ unitDefID = UDN.corhllt_scav.id,   xOffset =   16,  zOffset = -176, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  144,  zOffset = -176, direction = 2 },
		}
	end
...
local function t2HeavyFirebase2()
	...
	if r == 0 then
		...
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -46,  zOffset = -136, direction = 1 },
			{ unitDefID = UDN.corarad_scav.id,   xOffset =  -62,  zOffset =   40, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   34,  zOffset =    8, direction = 0 },
			{ unitDefID = UDN.cortoast_scav.id,  xOffset = -102,  zOffset =   80, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -46,  zOffset =   -8, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   98,  zOffset =   56, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -78,  zOffset = -120, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   50,  zOffset =  136, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -94,  zOffset =  -88, direction = 1 },
			{ unitDefID = UDN.corflak_scav.id,   xOffset =   66,  zOffset =  -24, direction = 2 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -94,  zOffset =  -56, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   18,  zOffset =  136, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   82,  zOffset =  120, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   98,  zOffset =   88, direction = 1 },
			{ unitDefID = UDN.corint_scav.id,    xOffset =   26,  zOffset =   64, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -14,  zOffset = -136, direction = 1 },
		}
	end
...
local function t2Base1()
	...
	return {
		...
		radius = 144,
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =    0,  zOffset = -122, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -48,  zOffset =   70, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -64,  zOffset = -122, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -16,  zOffset =   86, direction = 0 },
			{ unitDefID = UDN.coruwadvms_scav.id,                        xOffset =   32,  zOffset =  -74, direction = 0 },
			{ unitDefID = UDN.coreyes_scav.id,                           xOffset =  -72,  zOffset =   62, direction = 0 },
			{ unitDefID = UDN.cormakr_scav.id,                           xOffset =   72,  zOffset =   30, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  144,  zOffset =   70, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset = -128,  zOffset =  102, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =   16,  zOffset =   86, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =   48,  zOffset =   70, direction = 0 },
			{ unitDefID = randomTurrets[math.random(1, #randomTurrets)], xOffset =    0,  zOffset =  134, direction = 0 },
			{ unitDefID = UDN.coreyes_scav.id,                           xOffset =   72,  zOffset =   62, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -32,  zOffset = -122, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -80,  zOffset =  -90, direction = 0 },
			{ unitDefID = UDN.corsd_scav.id,                             xOffset =    0,  zOffset =   22, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =   80,  zOffset =  -90, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset = -144,  zOffset =   70, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset = -144,  zOffset =   38, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  144,  zOffset =   38, direction = 0 },
...
local function t2Firebase5()
	...
	return {
		...
		radius = 170,
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  135,  zOffset =   74, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =  -22, direction = 0 },
			{ unitDefID = UDN.corhllt_scav.id,   xOffset = -137,  zOffset =  138, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -57,  zOffset = -166, direction = 1 },
			{ unitDefID = UDN.corhllt_scav.id,   xOffset =  135,  zOffset =  138, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =  -54, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =  138, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =   10, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset = -166, direction = 1 },
			{ unitDefID = UDN.corasp_scav.id,    xOffset =   -1,  zOffset =   34, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =  106, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =   74, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -137,  zOffset =   10, direction = 1 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =    7,  zOffset = -182, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =  -54, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =   42, direction = 0 },
			{ unitDefID = UDN.corflak_scav.id,   xOffset = -137,  zOffset =   42, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -169,  zOffset =   58, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -137,  zOffset =   74, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =   10, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   71,  zOffset = -182, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =   74, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =  106, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -89,  zOffset =  -22, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  167,  zOffset =   26, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =   42, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  167,  zOffset =   58, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   87,  zOffset =  138, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -169,  zOffset =   26, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   39,  zOffset = -182, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -25,  zOffset = -182, direction = 1 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  135,  zOffset =   10, direction = 1 },
		},
	}
end
...
local function t2Energy1()
	...
	if r == 0 then
		buildings = {
			...
			{ unitDefID = UDN.corfus_scav.id,                            xOffset =   96,  zOffset =    0, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -96,  zOffset =  -64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -64,  zOffset =  -64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -32,  zOffset =  -64, direction = 0 },
	...
	elseif r == 1 then
		buildings = {
			...
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -80,  zOffset =  -64, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -96,  zOffset =  -32, direction = 0 },
			{ unitDefID = randomTurrets[math.random(1, #randomTurrets)], xOffset =  -96,  zOffset =    0, direction = 3 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -96,  zOffset =   32, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"),                         xOffset =  -80,  zOffset =   64, direction = 0 },
	...
	elseif r == 2 then
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -24,  zOffset =  -65, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   24,  zOffset =  -65, direction = 0 },
			{ unitDefID = UDN.coreyes_scav.id,   xOffset =    0,  zOffset =   39, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   56,  zOffset =  -33, direction = 0 },
			{ unitDefID = UDN.cormine3_scav.id,  xOffset =    0,  zOffset =  -73, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  104,  zOffset = -145, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -56,  zOffset =  -33, direction = 0 },
			{ unitDefID = UDN.corestor_scav.id,  xOffset =  -88,  zOffset =   95, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   56,  zOffset =   -1, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset =  143, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   56,  zOffset =   31, direction = 0 },
			{ unitDefID = UDN.cormine3_scav.id,  xOffset =   16,  zOffset =   39, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  136,  zOffset = -113, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  136,  zOffset =  111, direction = 0 },
			{ unitDefID = UDN.cormine3_scav.id,  xOffset =   32,  zOffset =   39, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -104,  zOffset =  143, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -136,  zOffset =  111, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -56,  zOffset =   31, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -24,  zOffset =   63, direction = 0 },
			{ unitDefID = UDN.cormine3_scav.id,  xOffset =  -32,  zOffset =   39, direction = 0 },
			{ unitDefID = UDN.cormine3_scav.id,  xOffset = -144,  zOffset =  -89, direction = 0 },
			...
			{ unitDefID = UDN.cormine3_scav.id,  xOffset =  -16,  zOffset =   39, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   24,  zOffset =   63, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  136,  zOffset = -145, direction = 0 },
			{ unitDefID = UDN.corestor_scav.id,  xOffset =   88,  zOffset =   95, direction = 0 },
	...
	elseif r == 3 then
		buildings = {
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -44,  zOffset =   63, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  148,  zOffset =   95, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -44,  zOffset =   95, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  116,  zOffset =   95, direction = 0 },
			{ unitDefID = UDN.corafus_scav.id,   xOffset =   20,  zOffset =   -1, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  180,  zOffset =   63, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   84,  zOffset =  -33, direction = 0 },
			{ unitDefID = UDN.corllt_scav.id,    xOffset =  180,  zOffset =   95, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  180,  zOffset =   31, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -60,  zOffset = -129, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -92,  zOffset = -129, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -124,  zOffset =  -65, direction = 0 },
			...
			{ unitDefID = BPWallOrPopup("scav"), xOffset =  -44,  zOffset =   31, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset =   52,  zOffset =  -65, direction = 0 },
			{ unitDefID = UDN.corestor_scav.id,  xOffset =  -76,  zOffset =  -81, direction = 0 },
			{ unitDefID = BPWallOrPopup("scav"), xOffset = -124,  zOffset =  -97, direction = 0 },
