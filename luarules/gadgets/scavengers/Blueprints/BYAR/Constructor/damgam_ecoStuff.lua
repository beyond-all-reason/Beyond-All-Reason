...
local posradius = 160
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-112), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(-48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-112), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-80), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(112), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(112), posy, posz+(-128), 1}, {"shift"})
...
local posradius = 168
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-88), posy, posz+(-168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(120), posy, posz+(136), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-120), posy, posz+(-168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-120), posy, posz+(-136), 1}, {"shift"})
...
local posradius = 121
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-103), posy, posz+(80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(57), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(121), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(89), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(121), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(41), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(121), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-71), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-103), posy, posz+(-80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(57), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(89), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(25), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-103), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(-39), posy, posz+(48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(-39), posy, posz+(-48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(25), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-71), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-103), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-103), posy, posz+(0), 1}, {"shift"})
	end
end
...
-- local posradius = 32
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(0), posy, posz+(32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(0), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(32), posy, posz+(32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(32), posy, posz+(0), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(-32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(32), posy, posz+(-32), 1}, {"shift"})
...
-- local posradius = 40
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(40), posy, posz+(8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-24), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-40), posy, posz+(-8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-40), posy, posz+(24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(24), posy, posz+(40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(40), posy, posz+(-24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(8), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-8), posy, posz+(40), 1}, {"shift"})
	-- end
-- end
...
-- local posradius = 48
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(16), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(48), posy, posz+(16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-48), posy, posz+(-16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-48), posy, posz+(16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-16), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(48), posy, posz+(48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(48), posy, posz+(-16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-48), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-48), posy, posz+(48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-16), posy, posz+(48), 1}, {"shift"})
...
local posradius = 160
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(-48), posy, posz+(96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(112), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-112), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(-48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(112), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-80), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(112), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-80), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(48), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-112), posy, posz+(160), 1}, {"shift"})
...
local posradius = 168
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-120), posy, posz+(-136), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(120), posy, posz+(136), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-88), posy, posz+(168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corsolar_scav.id), {posx+(-48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corsolar_scav.id), {posx+(48), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-120), posy, posz+(136), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corsolar_scav.id), {posx+(-48), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corsolar_scav.id), {posx+(-48), posy, posz+(96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-120), posy, posz+(-168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(120), posy, posz+(-136), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-88), posy, posz+(-168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(120), posy, posz+(168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corsolar_scav.id), {posx+(48), posy, posz+(96), 1}, {"shift"})
...
local posradius = 112
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(56), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-40), posy, posz+(64), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(88), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-72), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(88), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-72), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormaw_scav.id), {posx+(88), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(24), posy, posz+(48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(88), posy, posz+(80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-40), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(-56), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-104), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-104), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(56), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(88), posy, posz+(-80), 1}, {"shift"})
	end
...
-- local posradius = 32
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(32), posy, posz+(0), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(32), posy, posz+(32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(32), posy, posz+(-32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-32), posy, posz+(-32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(0), posy, posz+(-32), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-32), posy, posz+(32), 1}, {"shift"})
...
-- local posradius = 40
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-40), posy, posz+(-8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(24), posy, posz+(40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(8), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-40), posy, posz+(24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-8), posy, posz+(40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(40), posy, posz+(-24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(40), posy, posz+(8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-24), posy, posz+(-40), 1}, {"shift"})
...
-- local posradius = 48
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(48), posy, posz+(16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(16), posy, posz+(48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-48), posy, posz+(16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(48), posy, posz+(48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(48), posy, posz+(-16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(48), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(16), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-16), posy, posz+(-48), 1}, {"shift"})
