...
local posradius = 160
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-112), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(-48), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-112), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(112), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(112), posy, posz+(-128), 1}, {"shift"})
...
local posradius = 168
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-88), posy, posz+(-168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(120), posy, posz+(136), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-120), posy, posz+(-168), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-120), posy, posz+(-136), 1}, {"shift"})
...
local posradius = 121
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-103), posy, posz+(80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(57), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(121), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(89), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(121), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(41), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(121), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-71), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-103), posy, posz+(-80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(57), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(89), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(25), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-103), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(-39), posy, posz+(48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armadvsol_scav.id), {posx+(-39), posy, posz+(-48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(25), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-71), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-103), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-103), posy, posz+(0), 1}, {"shift"})
	end
end
...
-- local posradius = 32
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-32), posy, posz+(32), 1}, {"shift"})
...
-- local posradius = 40
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(40), posy, posz+(8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-24), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(-8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(24), posy, posz+(40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(40), posy, posz+(-24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(8), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-8), posy, posz+(40), 1}, {"shift"})
	-- end
-- end
...
-- local posradius = 48
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(-16), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(48), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(48), 1}, {"shift"})
...
local posradius = 112
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(64), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(88), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-72), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(88), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-72), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormaw_scav.id), {posx+(88), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(24), posy, posz+(48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(88), posy, posz+(80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coradvsol_scav.id), {posx+(-56), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-104), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-104), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(88), posy, posz+(-80), 1}, {"shift"})
	end
...
local posradius = 128
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-128), posy, posz+(-48), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armfus_scav.id), {posx+(-56), posy, posz+(0), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-128), posy, posz+(-80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(96), posy, posz+(-80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(128), posy, posz+(80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armfus_scav.id), {posx+(56), posy, posz+(0), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-128), posy, posz+(48), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-96), posy, posz+(80), 3}, {"shift"})
...
local posradius = 80
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(48), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(-80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(-48), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(80), posy, posz+(-80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(80), posy, posz+(80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(80), posy, posz+(-48), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(-80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(80), posy, posz+(48), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(80), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(80), 3}, {"shift"})
...
local posradius = 128
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-96), posy, posz+(72), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-128), posy, posz+(-40), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corfus_scav.id), {posx+(56), posy, posz+(0), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(128), posy, posz+(72), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-128), posy, posz+(-72), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-96), posy, posz+(-72), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(128), posy, posz+(-40), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(96), posy, posz+(-72), 3}, {"shift"})
...
-- local posradius = 48
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(-8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(-56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-56), 1}, {"shift"})
...
local posradius = 208
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(208), posy, posz+(112), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(208), posy, posz+(-48), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-208), posy, posz+(-48), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-176), posy, posz+(-144), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armmmkr_scav.id), {posx+(-128), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-208), posy, posz+(-112), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-208), posy, posz+(-16), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(176), posy, posz+(144), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(208), posy, posz+(-144), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(112), posy, posz+(-144), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-208), posy, posz+(48), 0}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(UDN.armflak_scav.id), {posx+(64), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(-144), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-208), posy, posz+(16), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-208), posy, posz+(-80), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-176), posy, posz+(144), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armmmkr_scav.id), {posx+(128), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-144), posy, posz+(-144), 0}, {"shift"})
...
local posradius = 270
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(174), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-98), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(62), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(126), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-130), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-34), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-194), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-66), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armmmkr_scav.id), {posx+(206), posy, posz+(112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(126), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-194), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armbrtha_scav.id), {posx+(-146), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-162), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(126), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(94), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(270), posy, posz+(64), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(270), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(270), posy, posz+(96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(30), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(270), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(206), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(142), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-2), posy, posz+(-192), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-130), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(238), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armfus_scav.id), {posx+(54), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-66), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(270), posy, posz+(32), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armpb_scav.id), {posx+(-26), posy, posz+(184), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(270), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-226), posy, posz+(-192), 1}, {"shift"})
	end
end
...
local posradius = 214
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(-122), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(166), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(214), posy, posz+(-58), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(54), posy, posz+(166), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-42), posy, posz+(-154), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-106), posy, posz+(198), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-10), posy, posz+(198), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(-58), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armtarg_scav.id), {posx+(62), posy, posz+(94), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(102), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(-26), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-106), posy, posz+(-154), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(182), posy, posz+(-154), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(214), posy, posz+(-154), 2}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(134), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armanni_scav.id), {posx+(22), posy, posz+(-138), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(86), posy, posz+(-154), 2}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(118), posy, posz+(-154), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(54), posy, posz+(198), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(-90), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(150), posy, posz+(-154), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-42), posy, posz+(198), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(214), posy, posz+(-90), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(-154), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(22), posy, posz+(198), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-74), posy, posz+(-154), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(70), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armafus_scav.id), {posx+(-42), posy, posz+(102), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(214), posy, posz+(-122), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-138), posy, posz+(198), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-74), posy, posz+(198), 2}, {"shift"})
	end
end
...
local posradius = 170
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(110), posy, posz+(-141), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(142), posy, posz+(-45), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(78), posy, posz+(-141), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-114), posy, posz+(179), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(142), posy, posz+(-77), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(46), posy, posz+(-141), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(142), posy, posz+(-13), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-178), posy, posz+(115), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(142), posy, posz+(-109), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-114), posy, posz+(147), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(14), posy, posz+(-141), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-114), posy, posz+(115), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(142), posy, posz+(-141), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormmkr_scav.id), {posx+(-114), posy, posz+(51), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-146), posy, posz+(115), 1}, {"shift"})
...
local posradius = 181
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-149), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corvipe_scav.id), {posx+(-93), posy, posz+(159), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(107), posy, posz+(151), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-117), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-181), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-181), posy, posz+(55), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coruwadves_scav.id), {posx+(-109), posy, posz+(79), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-181), posy, posz+(87), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(123), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corscreamer_scav.id), {posx+(75), posy, posz+(-57), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(155), posy, posz+(-89), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(155), posy, posz+(-121), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(59), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-149), posy, posz+(151), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cortarg_scav.id), {posx+(-5), posy, posz+(-65), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-181), posy, posz+(151), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(139), posy, posz+(119), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corvipe_scav.id), {posx+(19), posy, posz+(159), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(155), posy, posz+(-57), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(139), posy, posz+(55), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(91), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(139), posy, posz+(151), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-181), posy, posz+(119), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(75), posy, posz+(151), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(139), posy, posz+(87), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(155), posy, posz+(-153), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coruwadves_scav.id), {posx+(-29), posy, posz+(79), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-85), posy, posz+(-153), 2}, {"shift"})
...
-- local posradius = 56
	...
	-- else
		...
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(8), posy, posz+(56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-56), posy, posz+(40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-8), posy, posz+(-56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(-56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(40), posy, posz+(56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-56), posy, posz+(-24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(24), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-24), posy, posz+(56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(-8), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(-40), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(24), posy, posz+(-56), 1}, {"shift"})
		-- Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-56), posy, posz+(8), 1}, {"shift"})
	-- end
