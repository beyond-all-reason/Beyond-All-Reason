...
local posradius = 120
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(UDN.corfort_scav.id), {posx+(16), posy, posz+(86), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cordrag_scav.id), {posx+(48), posy, posz+(70), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+(0), posy, posz+(134), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coreyes_scav.id), {posx+(72), posy, posz+(62), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corfort_scav.id), {posx+(-32), posy, posz+(-122), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+(96), posy, posz+(-58), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+(128), posy, posz+(102), 0}, {"shift"})
