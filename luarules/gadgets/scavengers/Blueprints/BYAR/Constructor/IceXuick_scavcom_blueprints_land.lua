...
local function scavlabt1(scav, posx, posy, posz, GaiaTeamID, radiusCheck)
	...
	if radiusCheck then
		...
		if r == 0 then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(131), 1}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(-125), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(64), posy, posz+(99), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(64), posy, posz+(67), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-64), posy, posz+(35), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(64), posy, posz+(35), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(-141), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(3), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-64), posy, posz+(67), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-64), posy, posz+(99), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(112), posy, posz+(-29), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-112), posy, posz+(-29), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-125), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(-141), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-144), posy, posz+(3), 0}, {"shift"})
		...
		elseif r == 2 then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(72), posy, posz+(62), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(72), posy, posz+(94), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(72), posy, posz+(30), 0}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-104), posy, posz+(-50), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-72), posy, posz+(-50), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(-82), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(104), posy, posz+(-50), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(40), posy, posz+(-82), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-40), posy, posz+(-50), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(40), posy, posz+(-50), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(72), posy, posz+(-50), 0}, {"shift"})
		elseif r == 3 then
		...
		elseif r == 4 then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(81), posy, posz+(25), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(65), posy, posz+(-183), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(65), posy, posz+(185), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corhlt_scav.id), {posx+(113), posy, posz+(9), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-63), posy, posz+(-87), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(81), posy, posz+(-7), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(33), posy, posz+(-199), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(81), posy, posz+(-39), 2}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(33), posy, posz+(201), 0}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(81), posy, posz+(57), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-95), posy, posz+(-55), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-127), posy, posz+(-55), 2}, {"shift"})
			
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(65), posy, posz+(-151), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-63), posy, posz+(105), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-31), posy, posz+(89), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(65), posy, posz+(153), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-159), posy, posz+(-55), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(113), posy, posz+(-23), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(113), posy, posz+(41), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-175), posy, posz+(-23), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-111), posy, posz+(57), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-95), posy, posz+(89), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(145), posy, posz+(-7), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-95), posy, posz+(-87), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(1), posy, posz+(-199), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(145), posy, posz+(25), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(1), posy, posz+(201), 0}, {"shift"})
		else
...
local posradius = 88
--local unitoptions = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	if radiusCheck then
		return posradius
	else
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-72, posy, posz-72, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-40, posy, posz-72, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-8, posy, posz-72, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-72, posy, posz-40, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-72, posy, posz-8, 0}, {"shift"})
...
local posradius = 120
--local unitoptions = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	if radiusCheck then
		return posradius
	else
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-104, posy, posz-104, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-72, posy, posz-104, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-40, posy, posz-104, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-104, posy, posz-72, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-104, posy, posz-40, 0}, {"shift"})
...
--local unitoptions = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	local r = math_random(0,2)
		if radiusCheck then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(104), posy, posz+(-8), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(104), posy, posz+(24), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(72), posy, posz+(24), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-104), posy, posz+(-24), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-104), posy, posz+(8), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-72), posy, posz+(-24), 1}, {"shift"})
			elseif r == 1 then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(-16), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(16), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(112), posy, posz+(-48), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(-48), 1}, {"shift"})

			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-144), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-112), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(-144), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(-144), 1}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(0), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.cormakr_scav.id), {posx+(-40), posy, posz+(40), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(64), posy, posz+(0), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(64), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-64), posy, posz+(0), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.cormakr_scav.id), {posx+(40), posy, posz+(-40), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(-64), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(32), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.cormakr_scav.id), {posx+(40), posy, posz+(40), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corllt_scav.id), {posx+(0), posy, posz+(128), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.cormakr_scav.id), {posx+(-40), posy, posz+(-40), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-32), posy, posz+(0), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(32), posy, posz+(0), 1}, {"shift"})
...
--local unitoptions = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz-80, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz-48, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-64, posy, posz-80, 0}, {"shift"})
	...
	local r = math_random(0,1)
		if radiusCheck then
			...
			if r == 0 then
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(32), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(-32), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(32), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(-32), 1}, {"shift"})
			end
...
local function roadblocks(scav, posx, posy, posz, GaiaTeamID, radiusCheck)
	--local unitoptionsblue = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	--local unitoptionsred = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	local posradius = 80
	local r = math_random(0,7)
		if radiusCheck then
			...
			if r == 0 then
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-64, posy, posz-64, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-32, posy, posz-32, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+32, posy, posz+32, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+64, posy, posz+64, 0}, {"shift"})
			elseif r == 1 then
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-64, posy, posz+64, 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+64, posy, posz-64, 0}, {"shift"})
			elseif r == 2 then
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-64, posy, posz, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-32, posy, posz, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+32, posy, posz, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+64, posy, posz, 0}, {"shift"})
			elseif r == 3 then
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz+64, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz+32, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz-32, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz-64, 0}, {"shift"})
			elseif r == 4 then
...
local unitoptions = {UDN.corllt_scav.id, UDN.corllt_scav.id, UDN.corllt_scav.id, UDN.corrl_scav.id, UDN.corhllt_scav.id, UDN.corhllt_scav.id, UDN.corerad_scav.id, UDN.cornanotc_scav.id,}
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(unitoptions[math_random(1,#unitoptions)]), {posx, posy, posz+96, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-128, posy, posz, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz-32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz+32, 0}, {"shift"})
...
--local unitoptions2 = {BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav"), BPWallOrPopup("scav")}
	if radiusCheck then
		return posradius
	else
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-32, posy, posz+80, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx, posy, posz+96, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+32, posy, posz+112, 0}, {"shift"})
...
local posradius = 128
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+192, posy, posz+128, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+160, posy, posz+96, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+128, posy, posz+64, 0}, {"shift"})
...
local unitoptions = {UDN.corarad_scav.id, UDN.corvipe_scav.id, UDN.corhlt_scav.id, UDN.corhllt_scav.id, UDN.cormadsam_scav.id,}
	...
	local r = math_random(0,1)
		if radiusCheck then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-80, posy, posz+48, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-80, posy, posz+80, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-48, posy, posz+80, 0}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(35), posy, posz+(15), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-77), posy, posz+(-49), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(35), posy, posz+(111), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-109), posy, posz+(47), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.coruwadvms_scav.id), {posx+(83), posy, posz+(63), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-141), posy, posz+(15), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-45), posy, posz+(15), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(19), posy, posz+(-81), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-45), posy, posz+(-17), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(19), posy, posz+(-145), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(131), posy, posz+(111), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(131), posy, posz+(15), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-141), posy, posz+(-17), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-77), posy, posz+(47), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-109), posy, posz+(-49), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corshroud_scav.id), {posx+(19), posy, posz+(-113), 1}, {"shift"})
			
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(99), posy, posz+(15), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-13), posy, posz+(-97), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-141), posy, posz+(47), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(35), posy, posz+(47), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(131), posy, posz+(47), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-45), posy, posz+(-49), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(131), posy, posz+(79), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(35), posy, posz+(79), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(51), posy, posz+(-129), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-45), posy, posz+(47), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(99), posy, posz+(111), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(67), posy, posz+(111), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(51), posy, posz+(-97), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-141), posy, posz+(-49), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-13), posy, posz+(-129), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(67), posy, posz+(15), 1}, {"shift"})
		end
	end
end
...
local defenseoptions = {UDN.corhlt_scav.id, UDN.corhllt_scav.id, UDN.corllt_scav.id, UDN.corrl_scav.id, UDN.corhllt_scav.id, UDN.corhllt_scav.id, UDN.corerad_scav.id, UDN.cornanotc_scav.id,}
	local r = math_random(0,2)
		if radiusCheck then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-128, posy, posz+128, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-128, posy, posz+96, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-128, posy, posz+64, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz+128, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-64, posy, posz+128, 0}, {"shift"})

			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+160, posy, posz-192, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+128, posy, posz-192, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+96, posy, posz-192, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+160, posy, posz-160, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+160, posy, posz-128, 0}, {"shift"})

			Spring.GiveOrderToUnit(scav, -(defenseoptions[math_random(1,#defenseoptions)]), {posx+240, posy, posz-260, 0}, {"shift"})
			elseif r == 1 then
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(32), posy, posz+(-45), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-32), posy, posz+(51), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-13), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(-13), 0}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(19), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(51), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-32), posy, posz+(-45), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(104), posy, posz+(91), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(-45), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(32), posy, posz+(51), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(19), 0}, {"shift"})
			else
			Spring.GiveOrderToUnit(scav, -(UDN.corerad_scav.id), {posx+(128), posy, posz+(-128), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(176), posy, posz+(208), 2}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(176), posy, posz+(-144), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corerad_scav.id), {posx+(-128), posy, posz+(128), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(208), posy, posz+(176), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-112), posy, posz+(176), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(48), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-176), posy, posz+(144), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(208), posy, posz+(16), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corpun_scav.id), {posx+(192), posy, posz+(128), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(-48), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-144), posy, posz+(176), 2}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(-144), 3}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-176), posy, posz+(-176), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corgate_scav.id), {posx+(0), posy, posz+(0), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(16), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(-16), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corhlt_scav.id), {posx+(-176), posy, posz+(16), 3}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(144), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(144), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-176), posy, posz+(112), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-176), posy, posz+(-208), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(208), posy, posz+(-16), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(16), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(112), posy, posz+(-176), 2}, {"shift"})
			...
			Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(16), posy, posz+(176), 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(-16), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(240), posy, posz+(0), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-144), posy, posz+(16), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-240), posy, posz+(0), 3}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(16), posy, posz+(-176), 2}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(-176), 2}, {"shift"})
		end
	end
	...
	local r = math_random(0,1)
		if radiusCheck then
			...
			if r == 0 then
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-46), posy, posz+(-136), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corarad_scav.id), {posx+(-62), posy, posz+(40), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(34), posy, posz+(8), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.cortoast_scav.id), {posx+(-102), posy, posz+(80), 3}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-46), posy, posz+(-8), 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(98), posy, posz+(56), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-78), posy, posz+(-120), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(50), posy, posz+(136), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-94), posy, posz+(-88), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corflak_scav.id), {posx+(66), posy, posz+(-24), 2}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-94), posy, posz+(-56), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(18), posy, posz+(136), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(82), posy, posz+(120), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(98), posy, posz+(88), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corint_scav.id), {posx+(26), posy, posz+(64), 1}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-14), posy, posz+(-136), 1}, {"shift"})
			end
	end
end
...
local posradius = 144
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(0), posy, posz+(-122), 0}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-48), posy, posz+(70), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-64), posy, posz+(-122), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-16), posy, posz+(86), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coruwadvms_scav.id), {posx+(32), posy, posz+(-74), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coreyes_scav.id), {posx+(-72), posy, posz+(62), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormakr_scav.id), {posx+(72), posy, posz+(30), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(70), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-128), posy, posz+(102), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(16), posy, posz+(86), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(48), posy, posz+(70), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math_random(1,#defenseoptions)]), {posx+(0), posy, posz+(134), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.coreyes_scav.id), {posx+(72), posy, posz+(62), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-32), posy, posz+(-122), 0}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-80), posy, posz+(-90), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corsd_scav.id), {posx+(0), posy, posz+(22), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(80), posy, posz+(-90), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-144), posy, posz+(70), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-144), posy, posz+(38), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(144), posy, posz+(38), 0}, {"shift"})
...
local unitoptions = {UDN.corvipe_scav.id, UDN.corvipe_scav.id, UDN.corflak_scav.id,}
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(135), posy, posz+(74), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(-22), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(-137), posy, posz+(138), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-57), posy, posz+(-166), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(135), posy, posz+(138), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(-54), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(138), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(10), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(-166), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corasp_scav.id), {posx+(-1), posy, posz+(34), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(106), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(74), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-137), posy, posz+(10), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(7), posy, posz+(-182), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(-54), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(42), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corflak_scav.id), {posx+(-137), posy, posz+(42), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-169), posy, posz+(58), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-137), posy, posz+(74), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(10), 0}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(71), posy, posz+(-182), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(74), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(106), 0}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-89), posy, posz+(-22), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(167), posy, posz+(26), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(42), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(167), posy, posz+(58), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(87), posy, posz+(138), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-169), posy, posz+(26), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(39), posy, posz+(-182), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-25), posy, posz+(-182), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(135), posy, posz+(10), 1}, {"shift"})
	end
end
...
local function scavnrgplants(scav, posx, posy, posz, GaiaTeamID, radiusCheck)
	local unitoptions = {UDN.corhlt_scav.id, UDN.corflak_scav.id, UDN.corshroud_scav.id, UDN.cortarg_scav.id, BPWallOrPopup("scav"), BPWallOrPopup("scav"),}
	local posradius = 160
	local r = math_random(0,4)
		if radiusCheck then
			...
			if r == 0 then
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz-64, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-64, posy, posz-64, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-32, posy, posz-64, 0}, {"shift"})
			...
			elseif r == 1 then
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-80, posy, posz-64, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz-32, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(unitoptions[math_random(1,#unitoptions)]), {posx-96, posy, posz, 3}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-96, posy, posz+32, 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx-80, posy, posz+64, 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+80, posy, posz+64, 0}, {"shift"})
			elseif r == 2 then
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-24), posy, posz+(-65), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(24), posy, posz+(-65), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.coreyes_scav.id), {posx+(0), posy, posz+(39), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(-33), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(0), posy, posz+(-73), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(104), posy, posz+(-145), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-56), posy, posz+(-33), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corestor_scav.id), {posx+(-88), posy, posz+(95), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(-1), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-136), posy, posz+(143), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(56), posy, posz+(31), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(16), posy, posz+(39), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(136), posy, posz+(-113), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(136), posy, posz+(111), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(32), posy, posz+(39), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-104), posy, posz+(143), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-136), posy, posz+(111), 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-56), posy, posz+(31), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-24), posy, posz+(63), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(-32), posy, posz+(39), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(-144), posy, posz+(-89), 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(-16), posy, posz+(39), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(24), posy, posz+(63), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(136), posy, posz+(-145), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corestor_scav.id), {posx+(88), posy, posz+(95), 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(UDN.cormine3_scav.id), {posx+(-144), posy, posz+(87), 0}, {"shift"})
			elseif r == 3 then
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-44), posy, posz+(63), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(148), posy, posz+(95), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-44), posy, posz+(95), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(116), posy, posz+(95), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corafus_scav.id), {posx+(20), posy, posz+(-1), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(180), posy, posz+(63), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(84), posy, posz+(-33), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corllt_scav.id), {posx+(180), posy, posz+(95), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(180), posy, posz+(31), 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-60), posy, posz+(-129), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-92), posy, posz+(-129), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-124), posy, posz+(-65), 0}, {"shift"})
				...
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-44), posy, posz+(31), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(52), posy, posz+(-65), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(UDN.corestor_scav.id), {posx+(-76), posy, posz+(-81), 0}, {"shift"})
				Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("scav")), {posx+(-124), posy, posz+(-97), 0}, {"shift"})
