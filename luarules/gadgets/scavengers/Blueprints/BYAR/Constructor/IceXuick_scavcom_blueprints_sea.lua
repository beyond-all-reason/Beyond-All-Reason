...
local r = math.random(0,8)		
	local posradius = 70
		if radiusCheck then
			...
			if r == 0 or r == 1 then
				Spring.GiveOrderToUnit(scav, -(UDN.corplat_scav.id), {posx, posy, posz, math.random(0,3)}, {"shift"})
			elseif r == 2 or r == 3 then
				Spring.GiveOrderToUnit(scav, -(UDN.armplat_scav.id), {posx, posy, posz, math.random(0,3)}, {"shift"})
			...
			elseif r == 6 or r == 7 then
				...
				Spring.GiveOrderToUnit(scav, -(unitoptions[math.random(1,#unitoptions)]), {posx, posy, posz, math.random(0,3)}, {"shift"})
		end
	end
end
...
local function scavsonaroutpost(scav, posx, posy, posz, GaiaTeamID, radiusCheck)
	...
	local posradius = 120
	local z1 = math.random(-60,40)
	local z2 = math.random(-40,60)		
		if radiusCheck then
			return posradius
		else	
			Spring.GiveOrderToUnit(scav, -(unitoptions[math.random(1,#unitoptions)]), {posx, posy, posz, 0}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx-70, posy, posz+z1, 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+70, posy, posz+z2, 1}, {"shift"})
		end
end
...
local posradius = 120
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(unitoptions[math.random(1,#unitoptions)]), {posx, posy, posz, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+z1, posy, posz-70, 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+z2, posy, posz+70, 0}, {"shift"})
	end
end
...
local defenseoptions = {UDN.cortl_scav.id, UDN.armtl_scav.id, UDN.corfrt_scav.id,}
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(UDN.coruwms_scav.id), {posx+50, posy, posz-40, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(unitoptions[math.random(1,#unitoptions)]), {posx-20, posy, posz-150, 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+40, posy, posz+100, 0}, {"shift"})
	end
end
...
local defenseoptions = {UDN.coratl_scav.id, UDN.armatl_scav.id, UDN.armfrt_scav.id,}
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(unitoptions[math.random(1,#unitoptions)]), {posx-30, posy, posz-150, 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(defenseoptions[math.random(1,#defenseoptions)]), {posx+30, posy, posz+150, 0}, {"shift"})
	end
end
