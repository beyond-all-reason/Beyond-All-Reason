...
local r = math_random(0,3)
	if radiusCheck then
		...
		if r == 0 then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-72), posy, posz+(72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(72), posy, posz+(-72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(72), posy, posz+(40), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(72), posy, posz+(8), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(8), posy, posz+(72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-72), posy, posz+(-40), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-40), posy, posz+(-72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-8), posy, posz+(-72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(40), posy, posz+(72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(72), posy, posz+(72), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-72), posy, posz+(-8), 1}, {"shift"})
		...
		elseif r == 2 then
			...
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(80), posy, posz+(-80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-80), posy, posz+(80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-80), posy, posz+(-48), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(80), posy, posz+(48), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-48), posy, posz+(-80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-80), posy, posz+(-80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(80), posy, posz+(80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-16), posy, posz+(-80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(16), posy, posz+(80), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-80), posy, posz+(-16), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(80), posy, posz+(16), 1}, {"shift"})
			Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(48), posy, posz+(80), 1}, {"shift"})
...
local posradius = 96
local randomturrets = {UDN.armllt_scav.id, BPWallOrPopup("arm"), UDN.armbeamer_scav.id, UDN.armhlt_scav.id, UDN.armguard_scav.id, UDN.armrl_scav.id, UDN.armferret_scav.id, UDN.armcir_scav.id, UDN.armnanotc_scav.id, BPWallOrPopup("cor"), UDN.corllt_scav.id, UDN.corhllt_scav.id, UDN.corhlt_scav.id, UDN.corpun_scav.id, UDN.corrl_scav.id, UDN.cormadsam_scav.id, UDN.corerad_scav.id, UDN.cornanotc_scav.id,}
	if radiusCheck then
		return posradius
	else
...
local posradius = 134
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(26), posy, posz+(-91), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(90), posy, posz+(-59), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(26), posy, posz+(101), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-134), posy, posz+(53), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-86), posy, posz+(-43), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(58), posy, posz+(-75), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(58), posy, posz+(85), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(122), posy, posz+(53), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(90), posy, posz+(69), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-118), posy, posz+(21), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-102), posy, posz+(-11), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-6), posy, posz+(-107), 2}, {"shift"})
...
local posradius = 172
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(138), posy, posz+(-132), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(138), posy, posz+(12), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(138), posy, posz+(76), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-102), posy, posz+(156), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(10), posy, posz+(-100), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-150), posy, posz+(-52), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-70), posy, posz+(156), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-6), posy, posz+(172), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-134), posy, posz+(-84), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-38), posy, posz+(172), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(74), posy, posz+(-132), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(138), posy, posz+(44), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(122), posy, posz+(108), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-118), posy, posz+(-116), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(122), posy, posz+(-20), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-134), posy, posz+(140), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(42), posy, posz+(-116), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-166), posy, posz+(-20), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-86), posy, posz+(-132), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(106), posy, posz+(-148), 2}, {"shift"})
	end
end
...
local posradius = 196
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(148), posy, posz+(157), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(100), posy, posz+(-131), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(212), posy, posz+(13), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-12), posy, posz+(-163), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(132), posy, posz+(-131), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(180), posy, posz+(93), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-172), posy, posz+(-147), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-140), posy, posz+(-147), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-172), posy, posz+(-35), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-124), posy, posz+(93), 2}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(180), posy, posz+(157), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(132), posy, posz+(-99), 2}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-44), posy, posz+(-147), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-156), posy, posz+(29), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-108), posy, posz+(-147), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-124), posy, posz+(125), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(180), posy, posz+(125), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(20), posy, posz+(173), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-12), posy, posz+(157), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-172), posy, posz+(-3), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armferret_scav.id), {posx+(140), posy, posz+(117), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(20), posy, posz+(-179), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-172), posy, posz+(-115), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armjamt_scav.id), {posx+(100), posy, posz+(-99), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-172), posy, posz+(-83), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(196), posy, posz+(-19), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(52), posy, posz+(173), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-92), posy, posz+(125), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(116), posy, posz+(157), 2}, {"shift"})
	end
end
...
local posradius = 328
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(312), posy, posz+(49), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(312), posy, posz+(17), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(8), posy, posz+(177), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-328), posy, posz+(-15), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(312), posy, posz+(81), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armferret_scav.id), {posx+(48), posy, posz+(105), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-312), posy, posz+(-47), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(232), posy, posz+(-111), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(168), posy, posz+(-143), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(136), posy, posz+(145), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-152), posy, posz+(97), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armrad_scav.id), {posx+(152), posy, posz+(81), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-56), posy, posz+(-143), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(136), posy, posz+(-159), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-248), posy, posz+(81), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(296), posy, posz+(-15), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(168), posy, posz+(129), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(72), posy, posz+(161), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(104), posy, posz+(145), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-216), posy, posz+(81), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-120), posy, posz+(-127), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-360), posy, posz+(1), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(200), posy, posz+(113), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armferret_scav.id), {posx+(112), posy, posz+(-103), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(40), posy, posz+(177), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-120), posy, posz+(113), 2}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-88), posy, posz+(113), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(232), posy, posz+(97), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-280), posy, posz+(-111), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-24), posy, posz+(-159), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(296), posy, posz+(-47), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.armjamt_scav.id), {posx+(-168), posy, posz+(49), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-296), posy, posz+(-79), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-152), posy, posz+(-127), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(104), posy, posz+(-175), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-280), posy, posz+(81), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-88), posy, posz+(-143), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(72), posy, posz+(-191), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-184), posy, posz+(-127), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-184), posy, posz+(97), 2}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(200), posy, posz+(-127), 2}, {"shift"})
...
local posradius = 110
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(11), posy, posz+(110), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-53), posy, posz+(-98), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-53), posy, posz+(62), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-21), posy, posz+(94), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(91), posy, posz+(-18), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(91), posy, posz+(14), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-85), posy, posz+(-34), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-69), posy, posz+(-66), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(91), posy, posz+(-50), 1}, {"shift"})
	end
end
...
local posradius = 245
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(123), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-245), posy, posz+(-48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-5), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-181), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(187), posy, posz+(-32), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-165), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(139), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(59), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-101), posy, posz+(-176), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corerad_scav.id), {posx+(-85), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(203), posy, posz+(32), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-213), posy, posz+(48), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corrad_scav.id), {posx+(-69), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-197), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(203), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(187), posy, posz+(-64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-149), posy, posz+(96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-85), posy, posz+(144), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corjamt_scav.id), {posx+(139), posy, posz+(0), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(219), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(107), posy, posz+(144), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(11), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-133), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(91), posy, posz+(-112), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-229), posy, posz+(-80), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(43), posy, posz+(176), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(27), posy, posz+(-144), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-117), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(75), posy, posz+(160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(171), posy, posz+(112), 1}, {"shift"})
	end
end
...
local posradius = 325
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(277), posy, posz+(100), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(149), posy, posz+(-188), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(133), posy, posz+(260), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(117), posy, posz+(-252), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-107), posy, posz+(292), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-235), posy, posz+(-124), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(213), posy, posz+(164), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-123), posy, posz+(260), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-75), posy, posz+(-268), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corrad_scav.id), {posx+(85), posy, posz+(116), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-331), posy, posz+(52), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-155), posy, posz+(228), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(-139), posy, posz+(-188), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(309), posy, posz+(-76), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-219), posy, posz+(180), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(245), posy, posz+(-108), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-283), posy, posz+(116), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(149), posy, posz+(196), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-107), posy, posz+(-252), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(325), posy, posz+(36), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(245), posy, posz+(132), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(213), posy, posz+(-172), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corjamt_scav.id), {posx+(-75), posy, posz+(100), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-251), posy, posz+(148), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(149), posy, posz+(228), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-187), posy, posz+(196), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corrad_scav.id), {posx+(-91), posy, posz+(-60), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-299), posy, posz+(-92), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-315), posy, posz+(84), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(149), posy, posz+(-220), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-171), posy, posz+(-188), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(85), posy, posz+(-268), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(277), posy, posz+(-108), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corhllt_scav.id), {posx+(-203), posy, posz+(-124), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-139), posy, posz+(-220), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-203), posy, posz+(-156), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(245), posy, posz+(-140), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(309), posy, posz+(68), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(181), posy, posz+(196), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(181), posy, posz+(-188), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-267), posy, posz+(-92), 1}, {"shift"})
...
local posradius = 333
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(93), posy, posz+(-325), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-163), posy, posz+(-53), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.corjamt_scav.id), {posx+(189), posy, posz+(-69), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-83), posy, posz+(299), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(61), posy, posz+(139), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-99), posy, posz+(-117), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(221), posy, posz+(-21), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-19), posy, posz+(-213), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormadsam_scav.id), {posx+(-123), posy, posz+(211), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(189), posy, posz+(11), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(269), posy, posz+(-85), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormadsam_scav.id), {posx+(133), posy, posz+(-189), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-179), posy, posz+(-21), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-67), posy, posz+(-149), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-243), posy, posz+(43), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-19), posy, posz+(235), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-259), posy, posz+(75), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(237), posy, posz+(-53), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(157), posy, posz+(43), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-211), posy, posz+(11), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-323), posy, posz+(123), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(13), posy, posz+(-245), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(29), posy, posz+(-277), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormadsam_scav.id), {posx+(85), posy, posz+(-189), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-115), posy, posz+(315), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(93), posy, posz+(107), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(29), posy, posz+(171), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-51), posy, posz+(267), 1}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-131), posy, posz+(-85), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(UDN.cormadsam_scav.id), {posx+(-75), posy, posz+(211), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(61), posy, posz+(-309), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(13), posy, posz+(203), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-291), posy, posz+(107), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-51), posy, posz+(-181), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(125), posy, posz+(75), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(301), posy, posz+(-117), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(333), posy, posz+(-133), 1}, {"shift"})
	end
end
