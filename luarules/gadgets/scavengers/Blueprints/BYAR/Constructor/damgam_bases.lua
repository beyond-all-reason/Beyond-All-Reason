...
local function DamBase1Red(scav, posx, posy, posz, GaiaTeamID, radiusCheck)
	--local randompopups = {BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor"),}
	local randomturrets = {UDN.corllt_scav.id, UDN.corllt_scav.id, UDN.corhllt_scav.id, UDN.corhlt_scav.id, BPWallOrPopup("cor"), UDN.corrl_scav.id, UDN.cornanotc_scav.id,}
	...
	if radiusCheck then
		...
		-- Walls
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx-136, posy, posz-32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx-136, posy, posz+32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx-136, posy, posz, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx-136, posy, posz-64, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx-136, posy, posz+64, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+136, posy, posz-32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+136, posy, posz+32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+136, posy, posz, 0}, {"shift"})
...
--local randompopups = {BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm"),}
local randomturrets = {UDN.armllt_scav.id, UDN.armllt_scav.id, UDN.armhlt_scav.id, BPWallOrPopup("arm"), UDN.armrl_scav.id, UDN.armnanotc_scav.id,}
local r = math_random(0,1)
local posradius = 196
	if radiusCheck then
		return posradius
		...
		-- Walls
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx-136, posy, posz-32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx-136, posy, posz+32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx-136, posy, posz, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx-136, posy, posz-64, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx-136, posy, posz+64, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+136, posy, posz-32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+136, posy, posz+32, 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+136, posy, posz, 0}, {"shift"})
...
local posradius = 192
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(160), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-192), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(128), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-128), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(64), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-64), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-192), posy, posz+(-160), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-64), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-192), posy, posz+(-96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(192), posy, posz+(-128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-96), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-192), posy, posz+(128), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(64), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-192), posy, posz+(-192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(192), posy, posz+(64), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-192), posy, posz+(96), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-160), posy, posz+(192), 1}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-160), posy, posz+(-192), 1}, {"shift"})
...
local posradius = 192
	if radiusCheck then
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-160), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(-128), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(160), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(128), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(96), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(96), posy, posz+(-192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(64), posy, posz+(-192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(-96), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(192), posy, posz+(128), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-96), posy, posz+(-192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(-192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(128), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(-160), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(192), posy, posz+(-128), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-192), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(160), posy, posz+(-192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(192), posy, posz+(160), 3}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-160), posy, posz+(-192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(96), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(192), posy, posz+(-64), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-128), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(64), posy, posz+(192), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(192), posy, posz+(64), 3}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(192), posy, posz+(-96), 3}, {"shift"})
...
local posradius = 96
	if radiusCheck then
		...
		local unitOptions = {BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm"), BPWallOrPopup("arm")}
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(32), posy, posz+(-32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(-32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(32), posy, posz+(32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(96), posy, posz+(-32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(32), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(96), posy, posz+(-96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(64), posy, posz+(-64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(0), posy, posz+(64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-32), posy, posz+(-96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(64), posy, posz+(0), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-96), posy, posz+(-96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(0), posy, posz+(0), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-64), posy, posz+(-64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(64), posy, posz+(64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(-64), posy, posz+(0), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("arm")), {posx+(96), posy, posz+(32), 0}, {"shift"})
...
local posradius = 96
	if radiusCheck then
		...
		local unitOptions = {BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor"), BPWallOrPopup("cor")}
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(32), posy, posz+(32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(32), posy, posz+(-32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-32), posy, posz+(-32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-32), posy, posz+(32), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-32), posy, posz+(-96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(64), posy, posz+(0), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-64), posy, posz+(0), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(0), posy, posz+(-64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(64), posy, posz+(-64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-96), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(32), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-32), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-64), posy, posz+(-64), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(0), posy, posz+(64), 0}, {"shift"})
		...
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(96), posy, posz+(96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(-96), posy, posz+(-96), 0}, {"shift"})
		Spring.GiveOrderToUnit(scav, -(BPWallOrPopup("cor")), {posx+(0), posy, posz+(0), 0}, {"shift"})
	end
end
