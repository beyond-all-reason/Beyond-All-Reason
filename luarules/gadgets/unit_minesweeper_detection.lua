...
local spSetUnitLosState = Engine.Synced.SetUnitLosState
local spSetUnitLosMask = Engine.Synced.SetUnitLosMask
...
local teamIDs = {}
for _, teamID in pairs(Engine.Shared.GetTeamList()) do
	local _, _, _, _, _, allyTeam = Engine.Shared.GetTeamInfo(teamID, false)
