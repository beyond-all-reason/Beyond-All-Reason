...
function shard_generate_include_func(runtime_path, ai_path)
	return function(file)
		...
		Engine.Shared.Echo("Failed to load " .. file .. " we attempted to load the first of the following:")
		for index, file in ipairs(candidates) do
			Engine.Shared.Echo(index .. ": " .. file)
		end
		return nil
	end
end
...
function shard_include(file)
	...
	Engine.Shared.Echo("Failed to load " .. runtime_file)
	return
end
