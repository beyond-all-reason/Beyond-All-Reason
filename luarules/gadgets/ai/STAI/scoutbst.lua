...
function ScoutBST:Init()
	...
	self.armed = UnitiesHST.unitTable[self.name].isWeapon
	self.keepYourDistance = UnitiesHST.unitTable[self.name].losRadius * 0.5
	if mtype == "air" then
		self.airDistance = UnitiesHST.unitTable[self.name].losRadius * 1.5
