...
function CleanerBST:Update()
	...
	if self.ai.schedulerhst.behaviourTeam ~= self.ai.id or self.ai.schedulerhst.behaviourUpdate ~= "CleanerBST" then
		return
	end
...
function CleanerBST:Priority() end
