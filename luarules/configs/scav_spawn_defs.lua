...
addNewSquad({ type = "basicLand", minAnger = 60, units = { "6 cortex_shiva_scav","2 armada_razorback_scav","1 legpede_scav","1 armada_shredder_scav","1 corsent_scav",}, weight = 4, maxAnger = 100}) --T3 Assault/AA
