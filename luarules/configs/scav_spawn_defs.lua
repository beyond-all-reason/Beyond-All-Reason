...
scavBehaviours = {
	...
	BERSERK = { -- Run towards target after getting hit by enemy or after hitting the target
		...
		[UnitDefNames["scavengerbossv4_veryeasy_scav"].id]	= { distance = 2000, chance = 0.001},
		[UnitDefNames["scavengerbossv4_easy_scav"].id] 		= { distance = 2000, chance = 0.001},
		[UnitDefNames["scavengerbossv4_normal_scav"].id] 	= { distance = 2000, chance = 0.001},
		[UnitDefNames["scavengerbossv4_hard_scav"].id] 		= { distance = 2000, chance = 0.001},
		[UnitDefNames["scavengerbossv4_veryhard_scav"].id] 	= { distance = 2000, chance = 0.001},
		[UnitDefNames["scavengerbossv4_epic_scav"].id]		= { distance = 2000, chance = 0.001},
...
local squadSpawnOptionsTable = {
	...
	commanders = {
		...
		["armdecom_scav"]    = { minAnger = 25, maxAnger = 1000, maxAlive = 100 },
		...
		["cordecom_scav"]    = { minAnger = 25, maxAnger = 1000, maxAlive = 100 },
		...
		["legdecom_scav"]    = { minAnger = 25, maxAnger = 1000, maxAlive = 100 },
	}
}
