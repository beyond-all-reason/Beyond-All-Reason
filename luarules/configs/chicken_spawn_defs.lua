...
chickenBehaviours = {
	SKIRMISH = { -- Run away from target after target gets hit
		...
		[UnitDefNames["ve_chickenq"].id] = { distance = 500, chance = 0.05 },
		[UnitDefNames["e_chickenq"].id] = { distance = 500, chance = 0.05 },
		[UnitDefNames["n_chickenq"].id] = { distance = 500, chance = 0.05 },
		[UnitDefNames["h_chickenq"].id] = { distance = 500, chance = 0.05 },
		[UnitDefNames["vh_chickenq"].id] = { distance = 500, chance = 0.05 },
		[UnitDefNames["epic_chickenq"].id] = { distance = 500, chance = 0.05 },
	},
...
local optionValues = {
	...
	[difficulties.normal] = {
		gracePeriod       = 10 * Spring.GetModOptions().chicken_graceperiodmult * 60,
	...
	[difficulties.epic] = {
		...
		queenResistanceMult   = 1.4,
	},
	[difficulties.unbeatable] = {
		gracePeriod       = 2 * Spring.GetModOptions().chicken_graceperiodmult * 60,
		queenTime      	  = 28 * Spring.GetModOptions().chicken_queentimemult * 60, -- time at which the queen appears, frames
		chickenSpawnRate  = 60,
		burrowSpawnRate   = 20,
		turretSpawnRate   = 40,
		queenSpawnMult    = 3,
