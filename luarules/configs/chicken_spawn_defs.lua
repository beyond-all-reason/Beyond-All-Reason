...
addSuperSquad(5,	{ "2 chickena2", "2 chickena2b"													    }, 2) -- Apex Brawler
addSuperSquad(5,    { "2 chickenr1" 																	}) -- Artillery

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Special Squads -----------------------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

	addSpecialSquad(1, { "1 chickenf2", "4 chickenp1"											 		}) -- Observer and Small Pyro
