...
if not Spring.GetModOptions().unit_restrictions_nonukes then
	chickenTurrets = {
		["chicken_turrets"] 			= { minQueenAnger = 0, 		spawnedPerWave = 4,		spawnOnBurrows = true,	maxQueenAnger = 40,},
		["chicken_turrets_antiair"] 	= { minQueenAnger = 0, 		spawnedPerWave = 2,		spawnOnBurrows = true,	maxQueenAnger = 40,},
		["chicken_turrets_acid"] 		= { minQueenAnger = 20, 	spawnedPerWave = 2,		spawnOnBurrows = false,	maxQueenAnger = 60,},
		["chicken_turrets_electric"] 	= { minQueenAnger = 20, 	spawnedPerWave = 2,		spawnOnBurrows = false,	maxQueenAnger = 60,},
		["chicken_turretl"] 			= { minQueenAnger = 40, 	spawnedPerWave = 4,		spawnOnBurrows = true,	maxQueenAnger = 1000,},
		["chicken_turretl_antiair"] 	= { minQueenAnger = 40, 	spawnedPerWave = 2,		spawnOnBurrows = true,	maxQueenAnger = 1000,},
		["chicken_turretl_acid"] 		= { minQueenAnger = 60, 	spawnedPerWave = 2,		spawnOnBurrows = false,	maxQueenAnger = 1000,},
		["chicken_turretl_electric"] 	= { minQueenAnger = 60, 	spawnedPerWave = 2,		spawnOnBurrows = false,	maxQueenAnger = 1000,},
		["chicken_turretxl_meteor"]		= { minQueenAnger = 70, 	spawnedPerWave = 1,		spawnOnBurrows = false,	maxQueenAnger = 1000,},
	}
else
	chickenTurrets = {
		["chicken_turrets"] 			= { minQueenAnger = 0, 		spawnedPerWave = 4,		spawnOnBurrows = true,	maxQueenAnger = 40,},
...
-- Basic Swarmer
addNewSquad({type = "basic", minAnger = 0, units = {"4 chicken1_mini"	}, weight = 5})
addNewSquad({type = "basic", minAnger = 5, units = {"4 chicken1"		}})
addNewSquad({type = "basic", minAnger = 5, units = {"4 chicken1b"		}})
addNewSquad({type = "basic", minAnger = 5, units = {"4 chicken1c"		}})
addNewSquad({type = "basic", minAnger = 5, units = {"4 chicken1d"		}})

-- Better Swarmer
addNewSquad({type = "basic", minAnger = 20, units = {"4 chicken1x"		}})
addNewSquad({type = "basic", minAnger = 20, units = {"4 chicken1y"		}})
addNewSquad({type = "basic", minAnger = 20, units = {"4 chicken1z"		}})

-- Brawlers
addNewSquad({type = "basic", minAnger = 30, units = {"3 chickena1"		}})
addNewSquad({type = "basic", minAnger = 30, units = {"3 chickena1b"		}})
addNewSquad({type = "basic", minAnger = 30, units = {"3 chickena1c"		}})

-- Apex Swarmer and  Apex Brawler
addNewSquad({type = "basic", minAnger = 60, units = { "4 chicken2b"		}})
addNewSquad({type = "basic", minAnger = 60, units = { "4 chicken2"		}})
addNewSquad({type = "basic", minAnger = 60, units = { "1 chickena2"		}})
addNewSquad({type = "basic", minAnger = 60, units = { "1 chickena2b"	}})
...
addNewSquad({type = "special", minAnger = 90, units = {	"5 chickenapexallterrainassault"							}})
addNewSquad({type = "special", minAnger = 90, units = {	"5 chickenapexallterrainassaultb"							}})
addNewSquad({type = "special", minAnger = 90, units = {	"10 chickena2_spectre"										}})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickenr1"												}, weight = 3})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickenearty1"											}, weight = 3})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickenacidarty"											}, weight = 3})
addNewSquad({type = "special", minAnger = 90, units = {	"2 chickenh2"												}})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickene2"												}})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickenelectricallterrainassault"						}})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickenacidassault"										}})
addNewSquad({type = "special", minAnger = 90, units = {	"3 chickenacidallterrainassault"							}})
addNewSquad({type = "special", minAnger = 90, units = {	"25 chicken_dodo2"											}})
addNewSquad({type = "special", minAnger = 90, units = {	"10 chickenp2"												}})
addNewSquad({type = "special", minAnger = 90, units = {	"10 chickens2"												}, weight = 2})
addNewSquad({type = "special", minAnger = 90, units = {	"10 chickens2_spectre"										}})
...
local airStartAnger = 40 -- needed for air waves to work correctly.

-- addNewSquad({type = "air", minAnger = 10, units = { "1 chickenw1",			}})
-- addNewSquad({type = "air", minAnger = 10, units = { "1 chickenw1b",			}})
-- addNewSquad({type = "air", minAnger = 10, units = { "1 chickenw1c",			}})
-- addNewSquad({type = "air", minAnger = 10, units = { "1 chickenw1d",			}})
-- addNewSquad({type = "air", minAnger = 10, units = { "1 chickenf1",			}})
-- addNewSquad({type = "air", minAnger = 10, units = { "1 chickenf1b",			}})
