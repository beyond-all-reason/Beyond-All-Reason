...
local ecoBuildingsPenalty = { -- Additional queen hatch per second from eco buildup (for 60 minutes queen time. scales to queen time)
	[UnitDefNames["armadvsol"].id] 	= 0.000025,
	[UnitDefNames["coradvsol"].id] 	= 0.000025,
	[UnitDefNames["armmakr"].id] 	= 0.000025,
	[UnitDefNames["cormakr"].id] 	= 0.000025,
	[UnitDefNames["armfmkr"].id] 	= 0.000025,
	[UnitDefNames["corfmkr"].id] 	= 0.000025,
	[UnitDefNames["armfus"].id] 	= 0.000625,
	[UnitDefNames["armckfus"].id] 	= 0.000625,
	[UnitDefNames["corfus"].id] 	= 0.000625,
	[UnitDefNames["armafus"].id] 	= 0.0025,
	[UnitDefNames["corafus"].id] 	= 0.0025,
	[UnitDefNames["armmmkr"].id] 	= 0.00125,
	[UnitDefNames["cormmkr"].id] 	= 0.000625,
	[UnitDefNames["armuwfus"].id] 	= 0.000625,
	[UnitDefNames["coruwfus"].id] 	= 0.000625,
	[UnitDefNames["armuwmmm"].id] 	= 0.00125,
	[UnitDefNames["coruwmmm"].id] 	= 0.00125,
}
