...
SOpener@ GetOpenInfo()
{
	return SOpener({
		...
		{Factory::leglab, array<SQueue> = {
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER, 4), SO(RT::BUILDER), SO(RT::RIOT, 2)}),
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::RAIDER, 2), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER, 2), SO(RT::RIOT), SO(RT::BUILDER), SO(RT::RAIDER, 2)}),
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::RAIDER, 3), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER), SO(RT::BUILDER), SO(RT::RAIDER)})
		}},
