...
- not expanding
- stalling/overflowing metal, e  => difficult to achieve that with config cause regulation of resources is in the core program
...
actual state:
- command delay => lower unit production and expansion rate
...
- poor unit response: respond only to air threat.
