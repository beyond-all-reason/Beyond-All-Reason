...
local function VisibilityCheck(posx, posy, posz, posradius, allyTeamID, checkLoS, checkAirLos, checkRadar) -- Return True when position is not in sensor ranges of specified allyTeam.
    ...
    if checkLoS and (
        SpringShared.IsPosInLos(posx, posy, posz, allyTeamID) == true or
        SpringShared.IsPosInLos(xPlus, posy, zPlus, allyTeamID) == true or
        SpringShared.IsPosInLos(xPlus, posy, zMinus, allyTeamID) == true or
        SpringShared.IsPosInLos(xMinus, posy, zPlus, allyTeamID) == true or
        SpringShared.IsPosInLos(xMinus, posy, zMinus, allyTeamID) == true) then
        return false
    end

    if checkRadar and (
        SpringShared.IsPosInRadar(posx, posy, posz, allyTeamID) == true or
        SpringShared.IsPosInRadar(xPlus, posy, zPlus, allyTeamID) == true or
        SpringShared.IsPosInRadar(xPlus, posy, zMinus, allyTeamID) == true or
        SpringShared.IsPosInRadar(xMinus, posy, zPlus, allyTeamID) == true or
        SpringShared.IsPosInRadar(xMinus, posy, zMinus, allyTeamID) == true) then
        return false
    end

    if checkAirLos and (
        SpringShared.IsPosInAirLos(posx, posy, posz, allyTeamID) == true or
        SpringShared.IsPosInAirLos(xPlus, posy, zPlus, allyTeamID) == true or
        SpringShared.IsPosInAirLos(xPlus, posy, zMinus, allyTeamID) == true or
        SpringShared.IsPosInAirLos(xMinus, posy, zPlus, allyTeamID) == true or
        SpringShared.IsPosInAirLos(xMinus, posy, zMinus, allyTeamID) == true) then
        return false
    end
