...
function walk()
	...
	MultiTurn(
		right_l, z_axis, 0, math.rad(135),
		left_l, z_axis, 0, math.rad(130),
		foot_l, y_axis, 0, math.rad(130),
		foot_r, y_axis, 0, math.rad(130),
		foot_l, x_axis, 0, math.rad(130),
		foot_r, x_axis, 0, math.rad(130),
		foot_l, z_axis, 0, math.rad(130),
		foot_r, z_axis, 0, math.rad(130),
		right_l, y_axis, 0, math.rad(135),
		left_l, y_axis, 0, math.rad(130)
	)
	...
	while true do
		...
		MultiTurn(
			cod, y_axis, math.rad(-5), math.rad(6 * speedMult),
			base, x_axis, math.rad(20), math.rad(10 * speedMult),
			base, y_axis, math.rad(3), math.rad(6 * speedMult),
			head, y_axis, math.rad(2), math.rad(6 * speedMult),
			right_l, y_axis, math.rad(5), math.rad(6 * speedMult),
			left_l, y_axis, math.rad(5), math.rad(6 * speedMult),
			base, z_axis, math.rad(2), math.rad(2 * speedMult),
			shin_r, x_axis, math.rad(65), math.rad(137.5 * speedMult),
			right_l, x_axis, math.rad(-50), math.rad(70 * speedMult),
			left_l, x_axis, math.rad(30), math.rad(70 * speedMult)
		)
		Sleep(400/speedMult)
		...
		MultiTurn(
			cod, y_axis, math.rad(5), math.rad(6 * speedMult),
			base, x_axis, math.rad(20*gravFactor), math.rad(10 * speedMult),
			base, y_axis, math.rad(-3), math.rad(6 * speedMult),
			head, y_axis, math.rad(-2), math.rad(6 * speedMult),
			right_l, y_axis, math.rad(-5), math.rad(6 * speedMult),
			left_l, y_axis, math.rad(-5), math.rad(6 * speedMult),
			base, z_axis, math.rad(-2), math.rad(2 * speedMult),
			shin_l, x_axis, math.rad(65), math.rad(137.5 * speedMult),
			left_l, x_axis, math.rad(-50), math.rad(70 * speedMult),
			right_l, x_axis, math.rad(30), math.rad(70 * speedMult)
		)
