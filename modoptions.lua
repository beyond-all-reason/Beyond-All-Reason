...
-- Control Victory Options	
	...
	{
		key    = "ignoreconfig",
		name   = "Ignore preset map-specific Control Point locations?",
		desc   = "Should the control point config for this map be ignored so that we can use autogenerated control points?",		
		type="list",
		def="disabled",
		section= "controlvictoryoptions",
		items={
			{key="disabled", name="Disabled", desc=""},
			{key="enabled", name="Enabled", desc="This will tell the game to ignore the preset control point config and instead use autogenerated control points."},
		}
    },
	{
		key    = 'captureradius',
