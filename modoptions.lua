...
local options = {
    ...
    -- Chobby discovers modes from modes/sharing/ and builds the selector key
    -- by convention (category .. "_mode"). This entry is needed so SPADS accepts
    -- the key, and its `name` field provides the mode panel label in Chobby.
    {
        ...
        def     = "enabled",
        items   = {}, -- Will be populated dynamically by Chobby from modes/sharing/ directory
    },

    {
        key     = ModeEnums.ModOptions.TechBlocking,
        name    = "Tech Blocking",
        desc    = "Build Catalyst buildings to accumulate tech points and unlock T2/T3 units.",
        type    = "bool",
        section = ModeEnums.ModeCategories.Sharing,
        def     = false,
    },
    {
        ...
        name    = "Catalysts per Player for Tech 2",
        desc    = "Catalysts each player needs to unlock Tech 2. Multiplied by team size automatically.",
        type    = "number",
        section = ModeEnums.ModeCategories.Sharing,
        def     = 1,
        min     = 0.5,
    ...
    },
    {
        ...
        name    = "Catalysts per Player for Tech 3",
        desc    = "Catalysts each player needs to unlock Tech 3. Multiplied by team size automatically.",
        type    = "number",
        section = ModeEnums.ModeCategories.Sharing,
        def     = 1.5,
        min     = 0.5,
	...
	},
    {
        ...
        section = ModeEnums.ModeCategories.Sharing,
        def     = "",
        items   = unitSharingCategoriesWithNone,
    },
    {
        key     = ModeEnums.ModOptions.UnitSharingModeAtT3,
        name    = "Unit Sharing at Tech 3",
        desc    = "Unit sharing mode that activates when team reaches Tech 3",
        type    = "list",
        section = ModeEnums.ModeCategories.Sharing,
        def     = "",
        items   = unitSharingCategoriesWithNone,
	...
	},
    {
        ...
        desc    = "Tax rate when team reaches Tech 2. -1 means no override.",
        type    = "number",
        section = ModeEnums.ModeCategories.Sharing,
        def     = -1,
        min     = -1,
    ...
    },
    {
        ...
        desc    = "Tax rate when team reaches Tech 3. -1 means no override.",
        type    = "number",
        section = ModeEnums.ModeCategories.Sharing,
        def     = -1,
        min     = -1,
	...
	{
		key     = ModeEnums.ModOptions.PlayerMetalSendThreshold,
	...
	{
		key     = ModeEnums.ModOptions.PlayerEnergySendThreshold,
