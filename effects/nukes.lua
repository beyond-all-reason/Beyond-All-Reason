...
local definitions = {
    ["newnuke"] = {
        ...
        explosion_flames = {
            ...
            properties = {
                airdrag            = 0.96,
                colormap           = [[0 0 0 0   1 0.95 0.8 0.02   0.92 0.67 0.35 0.015   0.69 0.31 0.10 0.01   0.1 0.05 0.02 0.005]],
                directional        = true,
                emitrot            = 45,
                emitrotspread      = 32,
                emitvector         = [[0, 1, 0]],
        ...
        explosion = {
            ...
            properties = {
                airdrag            = 0.92,
                colormap           = [[0 0 0 0   1 0.93 0.7 0.008  0.9 0.53 0.21 0.012   0.70 0.32 0.04 0.008   0.60 0.25 0.02 0.003   0 0 0 0.001]],
                directional        = true,
                emitrot            = 45,
                emitrotspread      = 32,
                emitvector         = [[0, 1, 0]],
