...
local definitions = {
    ["newnuke"] = {
        ...
        explosion = {
            ...
            properties = {
                airdrag            = 0.93,
                colormap           = [[0 0 0 0   1 0.93 0.7 0.008  0.9 0.53 0.21 0.012   0.70 0.38 0.04 0.008    0.60 0.25 0.02 0.004   0.20 0.1 0.005 0.006   0 0 0 0.01]],
                directional        = true,
                emitrot            = 45,
                emitrotspread      = 32,
                emitvector         = [[0, 1, 0]],
...
definitions['newnuketac'].explosion_flames.properties.particlespeed = math.floor(definitions['newnuketac'].explosion_flames.properties.particlespeed * 0.8)
definitions['newnuketac'].explosion_flames.properties.particlesize = math.floor(definitions['newnuketac'].explosion_flames.properties.particlesize * size)
