...
local definitions = {
    ["newnuke"] = {
        ...
        brightflaresingularity = {
          ...
          water              = true,
          properties = {
            colormap           = [[0.5 0.5 0.5 0.7    0.7 0.7 0.7 0.4    0.35 0.32 0.28 0.2    0 0 0 0]],
            dir                = [[0, 1, 0]],
            --gravity            = [[0.0, 0.1, 0.0]],
            frontoffset        = 2,
            fronttexture       = [[exploflare]],
...
definitions['newnukecor'].groundflashanim.properties.size = math.floor(definitions['newnukecor'].groundflash_large.properties.size * size)
definitions['newnukecor'].airflashanim.properties.size = math.floor(definitions['newnukecor'].groundflash_white.properties.size * size)
