...
local definitions = {
    ...
    ["newnuke-floor"] = {
            ...
            smoke1 = {
                ...
                properties = {
                    airdrag            = 0.86,
                    colormap           = [[0 0 0 0.01   0.20 0.16 0.14 0.46   0.32 0.244 0.12 0.30    0.24 0.20 0.16 0.55   0.22 0.18 0.14 0.45   0.20 0.16 0.14 0.40   0.18 0.12 0.1 0.32   0.12 0.10 0.06 0.27   0.065 0.048 0.037 0.21   0.045 0.035 0.03 0.18   0.05 0.04 0.035 0.13    0 0 0 0.01]],
                    --colormap           =[[1 0.66 0.4 0.45     0.18 0.15 0.11 0.65    0.13 0.12 0.1 0.55   0.11 0.1 0.093 0.45   0.063 0.062 0.058 0.20    0 0 0 0.01]],
...
definitions['newnuketac-floor'].smoke1.properties.particlespeed = math.floor(definitions['newnuketac-floor'].smoke1.properties.particlespeed * size * 0.4)
definitions['newnuketac-floor'].smoke1.properties.particlespeedspread = math.floor(definitions['newnuketac-floor'].smoke1.properties.particlespeedspread * size * 0.4)
definitions['newnuketac-floor'].smoke1.properties.particlesize = math.floor(definitions['newnuketac-floor'].smoke1.properties.particlesize * size * 0.4)
definitions['newnuketac-floor'].smoke1.properties.particlelife = math.floor(definitions['newnuketac-floor'].smoke1.properties.particlelife * size * 0.4)
