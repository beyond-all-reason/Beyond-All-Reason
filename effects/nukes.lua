...
local definitions = {
    ["newnuke"] = {
        ...
        brightflare = {
          ...
          water              = true,
          properties = {
            colormap           = [[1.0 0.98 0.85 0.5    0.35 0.28 0.18 0.5    0 0 0 0]],
            dir                = [[0, 1, 0]],
            --gravity            = [[0.0, 0.1, 0.0]],
            frontoffset        = 0,
...
definitions['newnukecor'].brightflash.properties.ttl = math.floor(definitions['newnukecor'].brightflash.properties.ttl * size)
