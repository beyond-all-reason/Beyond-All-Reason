...
definitions['decoycommander'].confetti = {
	...
	properties = {
		airdrag            = 0.95,
		colormap           = [[1 0 0 0.01  0 1 0 0.01  1 0 0 0.01  0 1 0.5 0.01  1 0 0.01  0 1 0 0.01  1 1 0 0.01  0 1 0 0.01  0 1 0.6 0.01  0 1 0 0.01  1 0.1 0.7 0.01  0.6 0.3 0.6 0.01  0.6 0.6 0.6 0.01   0 0 0 0.01]],
		directional        = true,
		emitrot            = 17,
		emitrotspread      = 22,
		emitvector         = [[0, 1, 0]],
