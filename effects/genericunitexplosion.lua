...
local definitions = {
  [root.."-tiny"] = {
    ...
    groundflash_large = {
      ...
      water              = false,
      properties = {
        colormap           = [[1 0.95 0.95 0.38   1 0.7 0.3 0.2   0 0 0 0.01]],
        size               = 58,
        sizegrowth         = -0.4,
        ttl                = 20,
        texture            = [[groundflash]],
  ...
  [root.."-small"] = {
    ...
    groundflash_large = {
      ...
      water              = false,
      properties = {
        colormap           = [[1 0.95 0.95 0.34   1 0.7 0.3 0.23   0 0 0 0.01]],
        size               = 80,
        sizegrowth         = -0.7,
        ttl                = 30,
        texture            = [[groundflash]],
    ...
    explosion = {
      ...
      properties = {
        airdrag            = 0.82,
        colormap           = [[0 0 0 0   1 0.9 0.8 0.09   0.9 0.4 0.15 0.066   0.66 0.22 0.03 0.033   0 0 0 0.01]],
        directional        = true,
        emitrot            = 45,
        emitrotspread      = 32,
        emitvector         = [[0, 1, 0]],
  ...
  [root.."-medium"] = {
    ...
    groundflash_large = {
      ...
      water              = false,
      properties = {
        colormap           = [[1 0.95 0.95 0.36   1 0.7 0.3 0.26   0 0 0 0.01]],
        size               = 122,
        sizegrowth         = -1,
        ttl                = 40,
        texture            = [[groundflash]],
  ...
  [root.."-large"] = {
    ...
    groundflash_large = {
      ...
      water              = false,
      properties = {
        colormap           = [[1 0.95 0.95 0.38   1 0.7 0.3 0.27   0 0 0 0.01]],
        size               = 170,
        sizegrowth         = -1.2,
        ttl                = 48,
        texture            = [[groundflash]],
    ...
    groundflash_white = {
      ...
      water              = false,
      properties = {
        colormap           = [[1 0.9 0.75 0.69  0 0 0 0.01]],
        size               = 110,
        sizegrowth         = -0.5,
        ttl                = 15,
        texture            = [[groundflash]],
  ...
  [root.."-huge"] = {
    ...
    groundflash_large = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.95 0.95 0.40   1 0.7 0.3 0.29   0 0 0 0.01]],
        size               = 235,
        sizegrowth         = -1.33,
        ttl                = 52,
        texture            = [[groundflash]],
  ...
  [root.."-gigantic"] = {
    ...
    groundflash_large = {
      ...
      water              = false,
      properties = {
        colormap           = [[1 0.95 0.95 0.46   1 0.7 0.3 0.3   0 0 0 0.01]],
        size               = 295,
        sizegrowth         = -1.4,
        ttl                = 52,
        texture            = [[groundflash]],
