...
definitions['crashing-large'].smoke2.properties.particlelife = definitions['crashing-large'].smoke2.properties.particlelife * 1.8
definitions['crashing-large'].smoke2.properties.particlelifespread = definitions['crashing-large'].smoke2.properties.particlelifespread
definitions['crashing-large'].smoke2.properties.particlesize = definitions['crashing-large'].smoke2.properties.particlesize * sizeMult  * 0.6
...
definitions['crashing-large'].smoke2.properties.numparticles = [[0.85 r0.30]]
definitions['crashing-large'].smoke2.properties.colormap = [[0.35 0.22 0.10 0.85   0.05 0.05 0.05 0.72   0.05 0.05 0.05 0.68   0.030 0.03 0.03 0.35   0.01 0.01 0.01 0.01]]
...
definitions['crashing-large2'].smoke2.properties.particlelife = definitions['crashing-large2'].smoke2.properties.particlelife * 1.8
definitions['crashing-large2'].smoke2.properties.particlelifespread = definitions['crashing-large2'].smoke2.properties.particlelifespread 
definitions['crashing-large2'].smoke2.properties.particlesize = definitions['crashing-large2'].smoke2.properties.particlesize * sizeMult  * 0.6
...
definitions['crashing-large2'].smoke2.properties.numparticles = [[0.85 r0.30]]
definitions['crashing-large2'].smoke2.properties.colormap = [[0.35 0.22 0.10 0.85   0.05 0.05 0.05 0.72   0.05 0.05 0.05 0.68   0.030 0.03 0.03 0.35   0.01 0.01 0.01 0.01]]
...
definitions['crashing-large3'].smoke2.properties.particlelife = definitions['crashing-large3'].smoke2.properties.particlelife * 1.8
definitions['crashing-large3'].smoke2.properties.particlelifespread = definitions['crashing-large3'].smoke2.properties.particlelifespread
definitions['crashing-large3'].smoke2.properties.particlesize = definitions['crashing-large3'].smoke2.properties.particlesize * sizeMult * 0.7
...
definitions['crashing-large3'].smoke2.properties.numparticles = [[0.85 r0.30]]
definitions['crashing-large3'].smoke2.properties.colormap = [[0.35 0.22 0.10 0.85   0.05 0.05 0.05 0.72   0.05 0.05 0.05 0.68   0.030 0.03 0.03 0.35   0.01 0.01 0.01 0.01]]
