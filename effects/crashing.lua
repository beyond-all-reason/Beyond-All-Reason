...
definitions['crashing-large'].smoke2.properties.particlesize = definitions['crashing-large'].smoke2.properties.particlesize * sizeMult  * 0.55
...
definitions['crashing-large'].smoke2.properties.colormap = [[0.35 0.22 0.10 0.85   0.07 0.07 0.07 0.72   0.05 0.05 0.05 0.68   0.030 0.03 0.03 0.35   0.01 0.01 0.01 0.01]]
...
definitions['crashing-large2'].smoke2.properties.particlesize = definitions['crashing-large2'].smoke2.properties.particlesize * sizeMult  * 0.55
...
definitions['crashing-large2'].smoke2.properties.colormap = [[0.35 0.22 0.10 0.85   0.08 0.08 0.08 0.72   0.05 0.05 0.05 0.68   0.030 0.03 0.03 0.35   0.01 0.01 0.01 0.01]]
...
definitions['crashing-large3'].smoke2.properties.particlesize = definitions['crashing-large3'].smoke2.properties.particlesize * sizeMult * 0.55
...
definitions['crashing-large3'].smoke2.properties.colormap = [[0.35 0.22 0.10 0.85   0.08 0.08 0.08 0.72   0.05 0.05 0.05 0.68   0.030 0.03 0.03 0.35   0.01 0.01 0.01 0.01]]
