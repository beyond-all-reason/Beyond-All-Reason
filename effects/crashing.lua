local definitions = {
    ["crashing-small"] = {
        smoke = {
            ...
            properties = {
                airdrag            = 0.91,
                colormap           = [[0.05 0.04 0.033 0.80   0.04 0.038 0.034 0.75   0.04 0.036 0.032 0.65   0.025 0.025 0.025 0.50   0.014 0.014 0.014 0.35    0.006 0.006 0.006 0.08   0 0 0 0.01]],
                directional        = true,
                emitrot            = -180,
                emitrotspread      = 28,
                emitvector         = [[dir]],
        ...
        smoke2 = {
            ...
            properties = {
                airdrag            = 0.91,
                colormap           = [[0.12 0.09 0.08 0.65   0.095 0.085 0.07 0.55   0.08 0.072 0.07 0.45  0.05 0.045 0.04 0.35   0.027 0.027 0.027 0.15    0.012 0.012 0.012 0.04   0 0 0 0.01]],
                directional        = true,
                emitrot            = -180,
                emitrotspread      = 28,
                emitvector         = [[dir]],
                gravity            = [[0.0, -0.03, 0.0]],
                numparticles       = [[0.7 r1.3]],
                particlelife       = 14,
                particlelifespread = 24,
                particlesize       = 4.1,
                particlesizespread = 5.4,
                particlespeed      = 0.4,
                particlespeedspread = 2,
                pos                = [[-5 r10, -5 r10, -5 r10]],
                sizegrowth         = 0.1,
