...
["fire-area-75"] = {
  ...
  --["fire-flames-backup"] = {
    ...
    fireburngroundcircle = {
      ...
      properties = {
        --colormap           = [[0 0 0 0   0.06 0.04 0.02 0.006   0.10 0.08 0.04 0.008   0.18 0.12 0.08 0.010   0.4 0.35 0.3 0.15  0.18 0.12 0.08 0.010   0.10 0.08 0.04 0.005    0.06 0.04 0.02 0.004    0 0 0 0.01]],
        colormap           = [[0.60 0.60 0.48 0.05   0.60 0.60 0.48 0.2   0.66 0.69 0.9 0.35   0.64 0.67 0.79 0.25   0.68 0.78 0.88 0.45   0.02 0.02 0.03 0.24   0.026 0.026 0.026 0.20   0.02 0.02 0.02 0.20   0.023 0.023 0.023 0.18   0 0 0 0.03   0 0 0 0.01]],
        dir                = [[0, 1, 0]],
        --gravity            = [[0.0, 0.1, 0.0]],
        frontoffset        = 0,
        fronttexture       = [[FireBall02-anim]],
        animParams         = [[8,8,40 r50]],
        length             = 0,
        sidetexture        = [[none]],
        size               = [[120 r30]],
        sizegrowth         = [[-0.7 r0.3]],
