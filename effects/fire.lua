...
local definitions = {
	...
	["fire-flames-repeat"] = {
		...
		flame1 = {
			...
			properties = {
				airdrag = 0.88,
				colormap = [[0 0 0 0.01   0.9 0.87 0.87 0.4  0.65 0.65 0.4 0.2   0.65 0.65 0.4 0.2   0.13 0.13 0.02 0.12   0.08 0.08 0.02 0.07   0.025 0.02 0.01 0.02   0 0 0 0.01]],
				directional = false,
				emitrot = 40,
				emitrotspread = 30,
		...
		blacksmoke = {
			...
			properties = {
				airdrag = 0.8,
				colormap = [[0.01 0.01 0.01 0.01   0.03 0.03 0.01 0.2   0.01 0.01 0.01 0.32   0.1 0.1 0.1 0.64   0.04 0.04 0.04 0.32    0.02 0.02 0.02 0.17   0.01 0.01 0.01 0.01]],
				directional = false,
				emitrot = 90,
				emitrotspread = 70,
	...
	["fire-burnground-repeat"] = {
		...
		flamemattalways = {
			...
			properties = {
				airdrag = 0.9,
				colormap = [[0.25 0.22 0.18 0.6   0.75 0.77 0.40 0.8   0.72 0.58 0.39 1    0.67 0.54 0.34 0.9   0.63 0.49 0.27 0.8   0.58 0.39 0.29 0.7   0.48 0.29 0.22 0.6    0.11 0.06 0.12 0.50   0.016 0.009 0.07 0.4   0 0 0 0.01]],
				directional = false,
				emitrot = 90,
				emitrotspread = 5,
				emitvector = [[0, 0.7, 0]],
		...
		flamedark = {
			...
			properties = {
				airdrag = 0.93,
				colormap = [[0.01 0.01 0.01 0.01   0.02 0.02 0.01 0.2   0.26 0.2 0.18 0.333   0.36 0.27 0.29 0.72   0.34 0.28 0.40 0.88   0.33 0.29 0.20 0.7    0.33 0.27 0.18 0.83   0.29 0.22 0.14 0.80   0.29 0.20 0.13 0.75   0.22 0.16 0.11 0.55    0.05 0.06 0.09 0.35   0.021 0.022 0.023 0.2   0.01 0.01 0.01 0.01   0 0 0 0.01]],
				directional = false,
				emitrot = 85,
				emitrotspread = 25,
