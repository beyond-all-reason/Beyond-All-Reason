  ...
  ["fire-flames-repeat"] = {
    ...
    blacksmoke = {
      ...
      properties = {
        ...
        --colormap           = [[0.01 0.01 0.01 0.01   0.02 0.02 0.01 0.2   0.15 0.14 0.12 0.68   0.13 0.12 0.10 0.75   0.11 0.10 0.09 0.85  0.09 0.08 0.08 0.7    0.075 0.07 0.07 0.6   0.05 0.05 0.05 0.4   0.01 0.01 0.01 0.01]],
        colormap            =
        [[0.01 0.01 0.01 0.01   0.02 0.02 0.01 0.2   0.15 0.14 0.12 0.68   0.11 0.10 0.09 0.85    0.075 0.07 0.07 0.6   0.01 0.01 0.01 0.01]],
        directional         = false,
        emitrot             = 90,
        emitrotspread       = 70,
        emitvector          = [[0.3, 1, 0.3]],
  ...
  ["fire-burnground-small-repeat"] = {
    ...
    flamematt = {
      ...
      properties = {
        airdrag             = 0.96,
        colormap            =
        [[0.4 0.25 0.1 0.75   1 0.66 0.45 0.95   0.9 0.8 0.66 1   0.85 0.52 0.28 1    0.80 0.47 0.24 0.98   0.75 0.41 0.20 0.97   0.72 0.38 0.18 0.96   0.6 0.30 0.12 0.9    0.18 0.10 0.05 0.55   0.023 0.022 0.022 0.2   0 0 0 0.01]],
        directional         = false,
        emitrot             = 65,
        emitrotspread       = 65,
        emitvector          = [[0.28, 1, 0.28]],
...
for ii = 1, #areaCegSizes do
  ...
  definitions[name].fireflamearea.properties.count = count
  definitions[name].fireflameground.properties.count = count
