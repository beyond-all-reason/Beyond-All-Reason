  ...
  ["fire-flames-repeat"] = {
    ...
    blacksmoke = {
      ...
      properties = {
        airdrag             = 0.78,
        colormap            =
        [[0.01 0.01 0.01 0.01   0.02 0.02 0.01 0.2   0.15 0.14 0.12 0.68   0.11 0.10 0.09 0.22    0.01 0.01 0.01 0.01]],
        directional         = false,
        emitrot             = 90,
        emitrotspread       = 70,
        ...
        particlelife        = 108, -- this is a long animated effect; we can't just decrease its ttl
        particlelifespread  = 64,  -- but this change tries to do so anyway
        particlesize        = 45,
        particlesizespread  = 60,
        particlespeed       = 3,
        particlespeedspread = 2,
  ...
  ["fire-burnground-repeat"] = {
    ...
    flamemattalways = {
      ...
      properties = {
        airdrag             = 0.92,
        colormap            =
        [[0.25 0.22 0.18 0.75   0.75 0.77 0.71 1   0.72 0.51 0.39 1    0.67 0.47 0.34 0.99   0.63 0.41 0.27 0.98   0.58 0.33 0.29 0.97   0.48 0.29 0.22 0.91    0.11 0.08 0.12 0.50   0.016 0.011 0.07 0.45   0 0 0 0.01]],
        directional         = false,
        emitrot             = 90,
        emitrotspread       = 5,
        emitvector          = [[0, 0.7, 0]],
