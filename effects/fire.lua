   ...
   ["fire-flames"] = {
     usedefaultexplosions = false,
        ...
        smoke2 = {
                ...
                properties = {
                    airdrag            = 0.70,
                    colormap           = [[0.01 0.01 0.01 0.01   0.02 0.02 0.01 0.1   0.15 0.14 0.12 0.58   0.13 0.12 0.10 0.65   0.11 0.10 0.09 0.65  0.09 0.08 0.08 0.5    0.075 0.07 0.07 0.3   0.05 0.05 0.05 0.2   0.01 0.01 0.01 0.01]],
                    directional        = false,
                    emitrot            = 65,
                    emitrotspread      = 45,
                    emitvector         = [[0.3, 1, 0.3]],
                    gravity            = [[-0.03 r0.06, 0.26 r0.3, -0.03 r0.06]],
    ...
    flamematt = {
      ...
      properties = {
        airdrag            = 0.96,
        colormap           = [[0.4 0.25 0.1 0.75   1 0.66 0.45 0.95   0.9 0.8 0.66 1   0.85 0.52 0.28 1    0.80 0.47 0.24 0.98   0.75 0.41 0.20 0.97   0.72 0.38 0.18 0.96   0.6 0.30 0.12 0.9    0.18 0.10 0.05 0.55   0.023 0.022 0.022 0.50   0.018 0.010 0.05 0.45   0 0 0 0.01]],

        directional        = false,
        emitrot            = 65,
        emitrotspread      = 65,
        emitvector         = [[0.28, 0.7, 0.28]],
        gravity            = [[-0.025 r0.05, 0.04 r0.09, -0.025 r0.05]],
        numparticles       = [[0.70 r0.70]],
        particlelife       = 50,
        particlelifespread = 60,
        particlesize       = 55,
        particlesizespread = 95,
        particlespeed      = 0.10,
        particlespeedspread = 0.10,
        rotParams          = [[-5 r10, 0, -180 r360]],
        animParams         = [[16,6,80 r55]],
        pos                = [[-3 r6, -8 r6, -3 r6]],
    ...
    flamedark = {
      ...
      properties = {
        airdrag            = 0.96,
        colormap           = [[0.4 0.25 0.1 0.75   0.5 0.22 0.22 0.90   0.45 0.4 0.33 0.88   0.42 0.26 0.14 0.85    0.40 0.24 0.12 0.83   0.37 0.21 0.10 0.80   0.36 0.19 0.09 0.75   0.3 0.15 0.06 0.55    0.09 0.05 0.05 0.35   0.023 0.022 0.022 0.2   0 0 0 0.01]],

        directional        = false,
        emitrot            = 65,
        emitrotspread      = 65,
        emitvector         = [[0.20, 0.9, 0.20]],
        gravity            = [[-0.02 r0.04, 0.02 r0.03, -0.02 r0.04]],
        numparticles       = [[0.41 r0.55]],
        particlelife       = 35,
