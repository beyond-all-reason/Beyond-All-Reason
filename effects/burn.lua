...
return {
  ...
  ["flamestream"] = {
    ...
    sparks = {
      ...
      properties = {
        airdrag            = 0.83,
        colormap           = [[0 0 0 0.01  1 0.88 0.77 0.015   0.8 0.55 0.3 0.01   0 0 0 0]],
        directional        = true,
        emitrot            = 8,
        emitrotspread      = 4,
        emitvector         = [[dir]],
        gravity            = [[-0.4 r0.8, 0.55 r0.4, -0.4 r0.8]],
        numparticles       = [[0.6 r0.65]],
        particlelife       = 10,
  ...
  ["flamestreamxxl"] = {
    flame = {
      ...
      properties = {
        airdrag            = 0.90,
        colormap           = [[0.75 0.45 0.99 0.3   0.96 0.90 0.95 1   0.98 0.95 0.90 0.98  0.92 0.88 0.80 0.95   0.75 0.45 0.1 0.3    0.01 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 1,
        emitvector         = [[dir]],
        gravity            = [[0, 0.06, 0]],
        numparticles       = [[0.65 r0.78]],
        particlelife       = 9,
        particlelifespread = 8,
        particlesize       = -22,
