...
return {
  ...
  ["burnblack"] = {
    flame = {
      ...
      properties = {
        airdrag            = 0.98,
        --colormap           = [[1.0 0.78 0.25 0.3   1.0 1.0 0.9 1   1.0 0.95 0.55 1   1.0 0.78 0.25 0.6   0.45 0.25 0.1 0.3   0.15 0.12 0.06 0.15   0.023 0.022 0.022 0.05   0.023 0.022 0.022 0.05   0 0 0 0.03   0 0 0 0.01]],
        colormap           = [[1.0 0.95 0.55 0.9   1.0 1.0 0.9 1   1.0 0.78 0.25 0.88   0.45 0.25 0.1 0.66   0.033 0.023 0.05 0.3   0.023 0.022 0.022 0.25   0 0 0 0.01]],
        directional        = true,
        emitrot            = 70,
        emitrotspread      = 40,
        emitvector         = [[0.3, 1, 0.3]],
        gravity            = [[-0.03 r0.05, 0.06 r0.05, -0.03 r0.05]],
        numparticles       = [[1 r1]],
        particlelife       = 27,
  ...
  ["burnblackxl"] = {
    flame = {
      ...
      properties = {
        ...
        emitrotspread      = 40,
        emitvector         = [[0.3, 1, 0.3]],
        gravity            = [[-0.03 r0.05, 0.07 r0.05, -0.03 r0.05]],
        numparticles       = [[2 r1]],
        particlelife       = 40,
  ...
  ["burnblackbig"] = {
    flame1 = {
      ...
      properties = {
        airdrag            = 0.98,
        colormap           = [[1.0 0.78 0.25 0.3   1.0 1.0 0.9 1   1.0 0.95 0.55 1   1.0 0.78 0.25 0.6   0.45 0.25 0.1 0.3   0.12 0.07 0.05 0.1   0.25 0.18 0.07 0.45   0.045 0.04 0.04 0.33   0.023 0.022 0.022 0.25   0 0 0 0.01]],
        directional        = true,
        emitrot            = 70,
        emitrotspread      = 40,
        emitvector         = [[0.15, 1, 0.15]],
        gravity            = [[-0.03 r0.05, 0.04 r0.03, -0.03 r0.05]],
        numparticles       = [[1 r1]],
        particlelife       = 28,
