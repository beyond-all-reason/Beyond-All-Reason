local defs = {
  ...
  ["deathceg2"] = {
	  flame = {
		  ...
		  properties = {
			  airdrag            = 0.85,
			  colormap           = [[1.0 0.9 0.7 1  0.8 0.55 0.33 0.85   0.19 0.15 0.12 0.73  0.16 0.12 0.1 0.62   0.1 0.08 0.07 0.5   0.023 0.022 0.022 0.3   0.01 0.01 0.01 0.15   0 0 0 0.01]],
			  directional        = true,
			  emitrot            = 90,
			  emitrotspread      = 30,
