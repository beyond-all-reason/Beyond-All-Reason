local defs = {
  ...
  ["deathceg2"] = {
    ...
    fireandsmoke = {
      ...
      properties = {
        airdrag            = 0.4,
        colormap           = [[0.05 0.04 0.033 0.31   0.04 0.038 0.034 0.57   0.04 0.036 0.032 0.48   0.025 0.025 0.025 0.3   0.014 0.014 0.014 0.15    0.006 0.006 0.006 0.06   0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0.0, 1, 0.0]],
