...
return {
	...
	volcano_lava_splash_nukexl = {
		...
		waterrush = {
			...
			properties = {
				airdrag             = 0.97,
				colormap            =
				[[0 0 0 0.005  0.35 0.12 0.05 .011     0.25 0.08 0.03 .006    0.1 0.03 0.01 .005   0 0 0 0.01]],
				directional         = false,
				emitrot             = 1,
				emitrotspread       = 0,
	...
	["volcano_fire-area"] = {
		...
		burned_area = {
			...
			properties = {
				colormap      =
				[[0 0 0 0.1   0.08 0.06 0.06 0.2   0.12 0.1 0.1 0.75      0.12 0.1 0.1 0.80   0.12 0.1 0.1 0.80    0.12 0.1 0.1 0.80    0.11 0.08 0.08 0.45   0.10 0.07 0.07 0.2   0.08 0.06 0.06 0.2   0 0 0 0.1]],
				dir           = [[0, 1, 0]],
				frontoffset   = 0,
		...
		fireburngroundcircle = {
			...
			properties = {
				colormap      =
				[[0 0 0 0.01   0.40 0.40 0.48 0.12   0.67 0.69 0.9 0.85   0.64 0.67 0.79 0.55   0.68 0.78 0.88 0.85   0.02 0.02 0.03 0.44   0.026 0.026 0.026 0.40   0.02 0.02 0.02 0.30   0.023 0.023 0.023 0.38   0 0 0 0.03   0 0 0 0.01]],
				dir           = [[0, 1, 0]],
				frontoffset   = 0,
