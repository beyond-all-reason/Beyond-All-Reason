...
return {
  ...
  ["waterwake-small-long"] = {
    waterring = {
      ...
      water              = true,
      properties = {
        colormap           = [[0.11 0.11 0.11 0.10   0.45 0.45 0.45 0.3   0.14 0.14 0.14 0.16   0.09 0.09 0.09 0.1  0 0 0 0.01]],
        dir                = [[0, 1, 0]],
        gravity            = [[-1 r2, 0, -1 r2]],
        frontoffset        = 0,
        fronttexture       = [[wake]],
  ...
  ["waterwake-medium"] = {
    waterring = {
      ...
      water              = true,
      properties = {
        colormap           = [[0.15 0.15 0.15 0.15   0.40 0.40 0.40 0.28   0.13 0.13 0.13 0.15   0.09 0.09 0.09 0.1  0 0 0 0.01]],
        dir                = [[0, 1, 0]],
        gravity            = [[-1 r2, 0, -1 r2]],
        frontoffset        = 0,
        fronttexture       = [[wake]],
