...
local definitions = {
  ...
  [root.."-large-aoe"] = {
    ...
    explosion = {
      ...
      properties = {
        airdrag            = 0.87,
        colormap           = [[1 0.9 0.6 0.11   0.9 0.5 0.2 0.08   0.66 0.28 0.04 0.033   0.55 0.15 0.02 0.011   0 0 0 0]],
        directional        = true,
        emitrot            = 45,
        emitrotspread      = 32,
        emitvector         = [[0, 1.1, 0]],
  ...
  [root.."-huge"] = {
    ...
    shockwavering = {
      ...
      water              = true,
      properties = {
        colormap           = [[0 0 0 0   1 0.95 0.9 0.12   0.7 0.6 0.25 0.50  0.20 0.10 0.01 0.008   0 0 0 0]],
        dir                = [[0, 1, 0]],
        --gravity            = [[0.0, 0.1, 0.0]],
        frontoffset        = 0,
        fronttexture       = [[groundflash]],
        length             = 45,
        sidetexture        = [[none]],
        size               = 4,
        sizegrowth         = -14,
