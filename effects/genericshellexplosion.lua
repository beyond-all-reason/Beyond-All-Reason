...
for size, effects in pairs(sizes) do
	definitions[root .. "-" .. size].explosion.properties.numparticles =
		math.ceil(definitions[root .. "-" .. size].explosion.properties.numparticles / 1.7)
	definitions[root .. "-" .. size].explosion2 = table.copy(definitions[root .. "-" .. size].explosion)
	definitions[root .. "-" .. size].explosion2.properties.colormap =
		[[1 0.33 0 0.1   0.5 0.15 0 0.05   0.07 0.03 0 0.02   0 0 0 0]]
	definitions[root .. "-" .. size].explosion2.properties.numparticles = definitions[root .. "-" .. size].explosion.properties.numparticles
		- 1
end
...
local colors = {
	air = {
		...
		explosion = {
			...
			unit = true,
			properties = {
				colormap = [[0 0 0 0   1 0.85 0.7 0.09   0.9 0.45 0.37 0.066   0.66 0.26 0.2 0.033   0 0 0 0]],
			},
		},
		explosion2 = {
			air = false,
			...
			water = false,
			unit = true,
			properties = { colormap = [[1 0.3 0.24 0.1   0.5 0.13 0.1 0.05   0.07 0.025 0.02 0.02   0 0 0 0]] },
		},
		sparks = {
			air = false,
			ground = false,
			water = false,
			unit = true,
			properties = { colormap = [[0.9 0.8 0.7 0.017   0.8 0.5 0.4 0.011   0 0 0 0]] },
		},
	...
	aa = {
		...
		explosion = {
			...
			water = false,
			properties = {
				colormap = [[0 0 0 0   1 0.9 0.8 0.09   0.9 0.5 0.55 0.066   0.66 0.28 0.35 0.033   0 0 0 0]],
			},
		},
		explosion2 = {
			ground = false,
			water = false,
			properties = {
				colormap = [[0 0 0 0   1 0.6 0.4 0.09   0.6 0.3 0.45 0.066   0.46 0.18 0.25 0.033   0 0 0 0]],
			},
		},
		dustparticles = {
			ground = false,
			water = false,
			properties = { colormap = [[1 0.65 0.85 0.22  1 0.5 0.77 0.12  1 0.4 0.7 0.06   0 0 0 0.01]] },
		},
	...
	uw = {
		...
		dustparticles = {
			...
			air = false,
			underwater = true,
			properties = { colormap = [[0.5 0.51 0.53 0.020   0.30 0.31 0.33 0.016   0 0 0 0.01]] },
		},
		dirt = false,
		dirt2 = false,
		sparks = false,
	...
	bomb = {
		explosion = {
			properties = {
				colormap = [[0 0 0 0   1 0.62 0.38 0.09   0.7 0.27 0.1 0.066   0.5 0.15 0.025 0.033   0 0 0 0]],
			},
		},
		explosion2 = {
			properties = {
				colormap = [[0 0 0 0   1 0.32 0.18 0.09   0.7 0.17 0.05 0.066   0.3 0.08 0.015 0.033   0 0 0 0]],
			},
		},
		innersmoke = {
			properties = {
				colormap = [[1 0.6 0.4 0.4    0.5 0.24 0.14 0.5   0.27 0.17 0.13 0.42    0.21 0.16 0.14 0.35   0.105 0.095 0.088 0.25   0.07 0.064 0.058 0.17    0 0 0 0.01]],
			},
		},
		outersmoke = {
			properties = {
				colormap = [[1 0.58 0.36 0.4    0.48 0.24 0.14 0.45   0.26 0.16 0.13 0.4    0.2 0.16 0.14 0.35   0.1 0.09 0.088 0.25   0.07 0.063 0.058 0.17    0 0 0 0.01]],
			},
		},
		...
		sparks = {
			properties = { colormap = [[0.85 0.4 0.15 0.01   0.95 0.45 0.18 0.017   0 0 0 0]], numparticles = 5 },
		},
	},
}
...
definitions[root .. "-large-aa"].explosion.properties.particlesize = definitions[root .. "-large-aa"].explosion.properties.particlesize
	* 0.5
definitions[root .. "-large-aa"].explosion.properties.numparticles =
	math.floor(definitions[root .. "-large-aa"].explosion.properties.numparticles * 0.5)
definitions[root .. "-large-aa"].explosion2.properties.particlesize = definitions[root .. "-large-aa"].explosion2.properties.particlesize
	* 0.5
definitions[root .. "-large-aa"].explosion2.properties.numparticles =
	math.floor(definitions[root .. "-large-aa"].explosion2.properties.numparticles * 0.5)
...
for size, e in pairs(sizes) do
	...
	definitions[defname].centerflare.properties.heat =
		math.ceil(definitions[defname].centerflare.properties.heat / devideBy)
	definitions[defname].centerflare.properties.maxheat =
		math.ceil(definitions[defname].centerflare.properties.maxheat / devideBy)
...
definitions["genericshellexplosion-medium-aoe"].explosion.properties.colormap =
	[[0 0 0 0   1 0.62 0.38 0.09   0.7 0.27 0.1 0.066   0.5 0.15 0.025 0.033   0 0 0 0]]
definitions["genericshellexplosion-medium-aoe"].explosion2.properties.colormap =
	[[0 0 0 0   1 0.32 0.18 0.09   0.7 0.17 0.05 0.066   0.3 0.08 0.015 0.033   0 0 0 0]]
...
definitions["genericshellexplosion-debris"].explosion.properties.colormap =
	[[0 0 0 0   1 0.77 0.44 0.06   0.75 0.38 0.14 0.045   0.55 0.22 0.04 0.02   0 0 0 0]]
...
definitions["genericshellexplosion-catapult"].explosion.properties.colormap =
	[[0 0 0 0   1 0.45 0.25 0.09   0.75 0.35 0.15 0.066   0.44 0.25 0.06 0.033   0 0 0 0]]
definitions["genericshellexplosion-catapult"].explosion2.properties.numparticles = 4
definitions["genericshellexplosion-catapult"].explosion2.properties.colormap =
	[[0 0 0 0   1 0.38 0.1 0.09   0.55 0.22 0.05 0.066   0.25 0.08 0.03 0.033   0 0 0 0]]
...
definitions["genericshellexplosion-sniper"].explosion.properties.colormap =
	[[0 0 0 0   1 0.3 0.15 0.01   1 0.2 0.12 0.01   0.8 0.16 0.09 0.01   0 0 0 0]]
definitions["genericshellexplosion-sniper"].explosion.properties.numparticles = definitions["genericshellexplosion-sniper"].explosion.properties.numparticles
	* 1.3
definitions["genericshellexplosion-sniper"].explosion2.properties.colormap =
	[[0 0 0 0   1 0 0 0.01   1 0.1 0.09 0.01   0.8 0.1 0.05 0.01   0 0 0 0]]
definitions["genericshellexplosion-sniper"].explosion2.properties.numparticles = definitions["genericshellexplosion-sniper"].explosion2.properties.numparticles
	* 1.3
definitions["genericshellexplosion-sniper"].sparks.properties.colormap =
	[[1 0.3 0.1 0.01   0.9 0.3 0.2 0.017   0 0 0 0]]
definitions["genericshellexplosion-sniper"].explosion.properties.particlesize = definitions["genericshellexplosion-sniper"].explosion.properties.particlesize
	* 0.85
definitions["genericshellexplosion-sniper"].explosion.properties.particlesizespread = definitions["genericshellexplosion-sniper"].explosion.properties.particlesizespread
	* 0.85
definitions["genericshellexplosion-sniper"].explosion2.properties.particlesize = definitions["genericshellexplosion-sniper"].explosion2.properties.particlesize
	* 0.85
definitions["genericshellexplosion-sniper"].explosion2.properties.particlesizespread = definitions["genericshellexplosion-sniper"].explosion2.properties.particlesizespread
	* 0.85
