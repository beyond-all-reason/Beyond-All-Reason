...
return {
  ["missiletrailmship"] = {
    engine = {
      ...
      water              = true,
      properties = {
        colormap           = [[1.0 0.25 0.05 0.01   1.0 0.15 0.03 0.01   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[none]],
        length             = [[-7 r2]],
    ...
    fire = {
      ...
      properties = {
        airdrag            = 0.25,
        colormap           = [[0.88 0.35 0.15 0.01   0.46 0.12 0.04 0.01    0.27 0.03 0 0.01    0.08 0.02 0 0.01    0.02 0.005 0 0.01	 0 0 0 0.01]],
        directional        = true,
        emitrot            = 45,
        emitrotspread      = 45,
    ...
    fireglow = {
      ...
      properties = {
        airdrag            = 0,
        colormap           = [[0.1 0.05 0.02 0.01   0 0 0 0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0.0, 1, 0.0]],
