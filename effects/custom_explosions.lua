...
local definitions = {
    ...
    shockwavefirst = {
     ...
     shockwavefast = {
      ...
      water              = true,
      properties = {
        colormap           = [[0 0 0 0   0.5 0.71 0.12 0.22   0.45 0.68 0.10 0.18   0.35 0.60 0.08 0.011    0.15 0.28 0.04 0.009   0 0 0 0.01]],
        dir                = [[0, 1, 0]],
        gravity            = [[0.0, 0.1, 0.0]],
        frontoffset        = 0,
        fronttexture       = [[blastwave]],
  ...
  --     water              = true,
  --     properties = {
  --       colormap           = [[0.5 0.71 0.12 0.22   0.45 0.68 0.10 0.22   0.40 0.62 0.09 0.011   0 0 0 0.01]],
  --       dir                = [[0, 1, 0]],
  --       gravity            = [[0.0, 0.1, 0.0]],
  --       frontoffset        = 0,
  --       fronttexture       = [[blastwave]],
