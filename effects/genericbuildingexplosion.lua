...
definitions[root .. "-wind"].clouddust.properties.numparticles = definitions[root .. "-wind"].clouddust.properties.numparticles
	/ 3
definitions[root .. "-wind"].grounddust.properties.numparticles = definitions[root .. "-wind"].grounddust.properties.numparticles
	/ 3
definitions[root .. "-wind"].dirt.properties.numparticles = definitions[root .. "-wind"].dirt.properties.numparticles
	/ 2
definitions[root .. "-wind"].dirt2.properties.numparticles = definitions[root .. "-wind"].dirt2.properties.numparticles
	/ 2
definitions[root .. "-wind"].sparks.properties.numparticles = definitions[root .. "-wind"].sparks.properties.numparticles
	/ 2
...
definitions[root .. "-nano"].sparks.properties.numparticles = definitions[root .. "-nano"].sparks.properties.numparticles
	* 1.5
...
definitions[root .. "-metalmaker"].clouddust.properties.numparticles = definitions[root .. "-metalmaker"].clouddust.properties.numparticles
	/ 3
definitions[root .. "-metalmaker"].grounddust.properties.numparticles = definitions[root .. "-metalmaker"].grounddust.properties.numparticles
	/ 3
definitions[root .. "-metalmaker"].dirt.properties.numparticles = definitions[root .. "-metalmaker"].dirt.properties.numparticles
	/ 2
definitions[root .. "-metalmaker"].dirt2.properties.numparticles = definitions[root .. "-metalmaker"].dirt2.properties.numparticles
	/ 2
definitions[root .. "-metalmaker"].sparks.properties.numparticles = definitions[root .. "-metalmaker"].sparks.properties.numparticles
	/ 2

definitions[root .. "-metalmakerselfd"] = table.copy(definitions[root .. "-large"])
definitions[root .. "-metalmakerselfd"].clouddust.properties.numparticles = definitions[root .. "-metalmakerselfd"].clouddust.properties.numparticles
	/ 3
definitions[root .. "-metalmakerselfd"].grounddust.properties.numparticles = definitions[root .. "-metalmakerselfd"].grounddust.properties.numparticles
	/ 3
definitions[root .. "-metalmakerselfd"].dirt.properties.numparticles = definitions[root .. "-metalmakerselfd"].dirt.properties.numparticles
	/ 2
definitions[root .. "-metalmakerselfd"].dirt2.properties.numparticles = definitions[root .. "-metalmakerselfd"].dirt2.properties.numparticles
	/ 2
definitions[root .. "-metalmakerselfd"].sparks.properties.numparticles = definitions[root .. "-metalmakerselfd"].sparks.properties.numparticles
	/ 2
...
definitions[root .. "-advmetalmakerselfd"].clouddust.properties.numparticles = definitions[root .. "-advmetalmakerselfd"].clouddust.properties.numparticles
	/ 3
definitions[root .. "-advmetalmakerselfd"].grounddust.properties.numparticles = definitions[root .. "-advmetalmakerselfd"].grounddust.properties.numparticles
	/ 3
definitions[root .. "-advmetalmakerselfd"].dirt.properties.numparticles = definitions[root .. "-advmetalmakerselfd"].dirt.properties.numparticles
	/ 2
definitions[root .. "-advmetalmakerselfd"].dirt2.properties.numparticles = definitions[root .. "-advmetalmakerselfd"].dirt2.properties.numparticles
	/ 2
definitions[root .. "-advmetalmakerselfd"].sparks.properties.numparticles = definitions[root .. "-advmetalmakerselfd"].sparks.properties.numparticles
	/ 2
...
local types = {
	uw = {
		...
		explosion = {
			...
			air = false,
			underwater = true,
			properties = { colormap = [[0.5 0.51 0.53 0.010   0.30 0.31 0.33 0.008   0 0 0 0.01]] },
		},
		dirt = false,
		dirt2 = false,
		sparks = false,
