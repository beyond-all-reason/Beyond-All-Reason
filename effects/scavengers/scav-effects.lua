...
return {
  ["scavradiation"] = {
    ...
    cloud = {
              ...
              water              = false,
              properties = {
            colormap           = [[0 0 0 0.01  0.20 0.012 0.4 0.22   0.10 0.0055 0.24 0.12   0 0 0 0.01]],
            dir                = [[-0.25 r0.5, 0.56 r0.33, -0.25 r0.5]],
            --gravity            = [[0.0, 0.1, 0.0]],
            frontoffset        = 0.9,
            fronttexture       = [[dirt]],
            length             = 90,
  ...
  ["scavmist"] = {
   ...
   ["scavmistxl"] = {
    ...
    grounddust = {
      ...
      properties = {
        airdrag            = 0.96,
        colormap           = [[0 0 0 0.01   0.10 0.005 0.28 0.08   0.14 0.007 0.37 0.16   0.25 0.014 0.55 0.22  0.30 0.016 0.6 0.40   0.14 0.007 0.37 0.18   0 0 0 0.0]],
        directional        = false,
        emitrot            = 90,
        emitrotspread      = 60,
        emitvector         = [[0, 1, 0]],
        gravity            = [[-0.004 r0.008, 0.022 r0.014, -0.004 r0.008]],
        numparticles       = [[0.78 r0.86]],
        particlelife       = 170,
