...
definitions["barrelshot-tiny"].fire.properties.ttl											= 4
...
definitions["barrelshot-tiny"].fire2.properties.ttl											= 4
...
definitions["barrelshot-tiny"].fireglow.properties.particlelife					= 4
definitions["barrelshot-tiny"].fireglow.properties.colormap       			= [[0.07 0.04 0.007 0.01   0 0 0 0.01]]
definitions["barrelshot-tiny"].smoke2.properties.particlelifespread			= definitions["barrelshot-tiny"].smoke2.properties.particlelifespread * (size * 1.4)
definitions["barrelshot-tiny"].smoke2.properties.particlesize						= definitions["barrelshot-tiny"].smoke2.properties.particlesize * (size * 1.4)
definitions["barrelshot-tiny"].smoke2.properties.particlesizespread			= definitions["barrelshot-tiny"].smoke2.properties.particlesizespread * (size * 1.4)
definitions["barrelshot-tiny"].smoke2.properties.numparticles						= 3
definitions["barrelshot-tiny"].smoke2.properties.particlespeedspread		= definitions["barrelshot-tiny"].smoke2.properties.particlespeedspread * (size * 1.4)
definitions["barrelshot-tiny"].smoke.properties.particlelifespread			= definitions["barrelshot-tiny"].smoke.properties.particlelifespread * (size * 1.4)
definitions["barrelshot-tiny"].smoke.properties.particlesize						= definitions["barrelshot-tiny"].smoke.properties.particlesize * (size * 1.4)
definitions["barrelshot-tiny"].smoke.properties.particlesizespread			= definitions["barrelshot-tiny"].smoke.properties.particlesizespread * (size * 1.4)
definitions["barrelshot-tiny"].smoke.properties.numparticles						= 2
definitions["barrelshot-tiny"].smoke.properties.particlespeedspread		= definitions["barrelshot-tiny"].smoke.properties.particlespeedspread * (size * 1.4)
...
definitions["barrelshot-small"].fire.properties.ttl											= 6
...
definitions["barrelshot-small"].fire2.properties.ttl										= 6
...
definitions["barrelshot-small"].fireglow.properties.particlelife				= 6
...
definitions["barrelshot-large"].fire.properties.ttl											= 8
...
definitions["barrelshot-large"].fire2.properties.ttl										= 8
...
definitions["barrelshot-large"].fireglow.properties.particlelife				= 8
...
definitions["barrelshot-huge"].fire.properties.ttl                      = 10
...
definitions["barrelshot-huge"].fire2.properties.ttl											= 10
...
definitions["barrelshot-huge"].fireglow.properties.particlelife					= 10
