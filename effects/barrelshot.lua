...
definitions["barrelshot-larger"].fire.properties.length                  = definitions["barrelshot-larger"].fire.properties.length * size
definitions["barrelshot-larger"].fire.properties.size                    = definitions["barrelshot-larger"].fire.properties.size * size
definitions["barrelshot-larger"].fire.properties.sizegrowth              = definitions["barrelshot-larger"].fire.properties.sizegrowth * 1.5
definitions["barrelshot-larger"].fire.properties.ttl                     = definitions["barrelshot-larger"].fire.properties.ttl * 1.04
definitions["barrelshot-larger"].fire2.properties.length                 = definitions["barrelshot-larger"].fire2.properties.length * size
definitions["barrelshot-larger"].fire2.properties.size                   = definitions["barrelshot-larger"].fire2.properties.size * size
definitions["barrelshot-larger"].fire2.properties.sizegrowth             = definitions["barrelshot-larger"].fire2.properties.sizegrowth * 1.5
definitions["barrelshot-larger"].fire2.properties.ttl                    = definitions["barrelshot-larger"].fire2.properties.ttl * 1.04
...
definitions["barrelshot-larger"].smoke2.properties.particlelifespread    = definitions["barrelshot-larger"].smoke2.properties.particlelifespread * size
definitions["barrelshot-larger"].smoke2.properties.particlesize          = definitions["barrelshot-larger"].smoke2.properties.particlesize * size
definitions["barrelshot-larger"].smoke2.properties.particlesizespread    = definitions["barrelshot-larger"].smoke2.properties.particlesizespread * size
definitions["barrelshot-larger"].smoke2.properties.particlespeedspread   = definitions["barrelshot-larger"].smoke2.properties.particlespeedspread * size * 1.2
...
definitions["barrelshot-larger"].smoke.properties.particlesizespread     = definitions["barrelshot-larger"].smoke.properties.particlesizespread * size
...
definitions["barrelshot-huge"].smoke2.count                             = 8
