...
definitions["barrelshot-large"].fire2.properties.size = definitions["barrelshot-large"].fire2.properties.size * size * 0.7
definitions["barrelshot-large"].fire2.properties.sizegrowth = definitions["barrelshot-large"].fire2.properties.sizegrowth * 1.4
...
definitions["barrelshot-larger"].fire2.properties.length = definitions["barrelshot-larger"].fire2.properties.length * size * 1.3
definitions["barrelshot-larger"].fire2.properties.size = definitions["barrelshot-larger"].fire2.properties.size * size * 0.9
definitions["barrelshot-larger"].fire2.properties.sizegrowth = definitions["barrelshot-larger"].fire2.properties.sizegrowth * 0.5
...
definitions["barrelshot-huge"].fire2.properties.sizegrowth = definitions["barrelshot-huge"].fire2.properties.sizegrowth * 1.9
...
definitions["barrelshot-medium-impulse"].fire.properties.length = definitions["barrelshot-medium-impulse"].fire.properties.length * 1.5
