...
definitions["barrelshot-larger"].smoke2.properties.particlesize          = definitions["barrelshot-larger"].smoke2.properties.particlesize * size  * 1.3
definitions["barrelshot-larger"].smoke2.properties.particlesizespread    = definitions["barrelshot-larger"].smoke2.properties.particlesizespread * size * 1.2
...
definitions["barrelshot-larger"].smoke2.properties.particlespeedspread   = definitions["barrelshot-larger"].smoke2.properties.particlespeedspread * size
