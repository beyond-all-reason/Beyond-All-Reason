local definitions = {
	...
	["missiletrailaa-medium"] = {
		...
		sparks = {
			...
			properties = {
				airdrag = 0.9,
				colormap = [[0 0 0 0.01  0 0 0 0.01  0.9 0.5 0.7 0.1   0.9 0.4 0.6 0.08  0.25 0.1 0.2 0.005   0 0 0 0.01]],
				directional = true,
				emitrot = 180,
				emitrotspread = 6,
				emitvector = [[dir]],
...
definitions.antimissiletrail.smokeandfire.properties.colormap =
	[[0.7 0.45 0.45 0.2   0.44 0.25 0.25 0.2    0.34 0.12 0.12 0.15    0.09 0.023 0.023 0.11     0.05 0.008 0.008 0.09   0.02 0.006 0.01 0.06   0 0 0 0.01]]
...
definitions["antimissiletrail-starburst"].smokeandfire.properties.colormap =
	[[0.7 0.45 0.45 0.2   0.44 0.25 0.25 0.2    0.34 0.12 0.12 0.15    0.09 0.023 0.023 0.11     0.05 0.008 0.008 0.09   0.02 0.006 0.01 0.06   0 0 0 0.01]]
definitions["antimissiletrail-starburst"].sparks.properties.colormap =
	[[0.9 0.4 0.4 0.01   0.9 0.3 0.3 0.007  0.5 0.07 0.07 0]]

definitions["missiletrailsmall-red"] = table.copy(definitions["missiletrailsmall-simple"])
definitions["missiletrailsmall-red"].engine.properties.colormap =
	[[1 0.33 0.17 0.01   1.0 0.25 0.1 0.01   1.0 0.22 0.05 0.01   0 0 0 0.01]]
...
definitions["missiletrailsmall-red"].sparks.properties.colormap =
	[[0.8 0.3 0.18 0.01   0.8 0.3 0.1 0.007  0.4 0.11 0.04 0.007   0 0 0 0.01]]
...
definitions["missiletrailmedium-red"].engine.properties.colormap =
	[[1 0.33 0.17 0.01   1.0 0.25 0.1 0.01   1.0 0.22 0.05 0.01   0 0 0 0.01]]
...
definitions["missiletrailmedium-red"].sparks.properties.colormap =
	[[0.9 0.44 0.4 0.01   0.9 0.36 0.1 0.007  0.4 0.13 0.05 0.007   0 0 0 0.01]]
...
definitions["missiletraillarge-red"].sparks.properties.colormap =
	[[1 0.85 0.7 0.01   0.9 0.4 0.14 0.007  0.4 0.13 0.05 0.007   0 0 0 0.01]]
...
definitions["missiletrailsmall-starburst-vertical"].smoke.properties.particlespeed = definitions["missiletrailsmall-starburst-vertical"].smoke.properties.particlespeed
	* 1.25
definitions["missiletrailsmall-starburst-vertical"].smoke.properties.particlespeedspread = definitions["missiletrailsmall-starburst-vertical"].smoke.properties.particlespeedspread
	* 1.25

definitions["missiletrailmedium-starburst"] = table.copy(definitions.missiletrailmedium)
definitions["missiletrailmedium-starburst"].sparks.properties.colormap =
	[[1 0.2 0.1 0.01   1 0.15 0.05 0.007  0.55 0.05 0 0.007   0 0 0 0.01]]
definitions["missiletrailmedium-starburst"].dustparticles.properties.colormap =
	[[0.4 0.35 0.3 0.008    1 0.5 0.3 0.02    0.66 0.33 0.2 0.17    0.5 0.22 0.12 0.16    0.33 0.16 0.05 0.15    0 0 0 0.01]]
definitions["missiletrailmedium-starburst"].fireglow = nil
definitions["missiletrailmedium-starburst-vertical"] = table.copy(definitions["missiletrailmedium-starburst"])
definitions["missiletrailmedium-starburst-vertical"].sparks.properties.particlesize = definitions["missiletrailmedium-starburst-vertical"].sparks.properties.particlesize
	* 1.15
definitions["missiletrailmedium-starburst-vertical"].sparks.properties.particlesize = definitions["missiletrailmedium-starburst-vertical"].sparks.properties.particlesize
	* 1.5
definitions["missiletrailmedium-starburst-vertical"].sparks.properties.particlesizespread = definitions["missiletrailmedium-starburst-vertical"].sparks.properties.particlesizespread
	* 1.5
...
definitions["missiletraillarge-starburst"].smoke.properties.particlespeed = definitions["missiletraillarge-starburst"].smoke.properties.particlespeed
	* 2
definitions["missiletraillarge-starburst"].smoke.properties.particlespeedspread = definitions["missiletraillarge-starburst"].smoke.properties.particlespeedspread
	* 2
definitions["missiletraillarge-starburst"].fire.properties.colormap =
	[[1 0.5 0.15 0.15   0.55 0.2 0.05 0.2    0.14 0.03 0 0.17    0.02 0.005 0.006 0.1	 0 0 0 0.01]]
definitions["missiletraillarge-starburst"].sparks.properties.colormap =
	[[1 0.2 0.1 0.01   1 0.15 0.05 0.007  0.55 0.05 0 0.007   0 0 0 0.01]]
definitions["missiletraillarge-starburst"].dustparticles.properties.colormap =
	[[0.4 0.35 0.3 0.008    1 0.5 0.3 0.02    0.66 0.33 0.2 0.17    0.5 0.22 0.12 0.16    0.33 0.16 0.05 0.15    0 0 0 0.01]]
...
definitions["missiletrail-juno"].engine.properties.colormap =
	[[0.66 1 0.4 0.01   0.6 1 0.2 0.01   0.44 1 0.1 0.01   0 0 0 0.01]]
definitions["missiletrail-juno"].sparks.properties.colormap =
	[[0.4 0.9 0.2 0.01   0.33 0.9 0.1 0.007  0.2 0.4 0.05 0.007   0 0 0 0.01]]
definitions["missiletrail-juno"].dustparticles.properties.colormap =
	[[0.4 0.4 0.4 0.008    0.7 1 0.48 0.02    0.44 0.66 0.28 0.17    0.33 0.5 0.19 0.16    0.2 0.33 0.13 0.15    0 0 0 0.01]]
...
definitions["missiletrail-juno-starburst"].engine.properties.size = definitions["missiletrail-juno"].engine.properties.size
	* 1.25
definitions["missiletrail-juno-starburst"].engine.properties.colormap =
	[[0.9 1 0.4 0.01   0.85 1 0.2 0.01   0.66 1 0.1 0.01   0 0 0 0.01]]
definitions["missiletrail-juno-starburst"].sparks.properties.particlesize = definitions["missiletrail-juno"].sparks.properties.particlesize
	* 1.5
definitions["missiletrail-juno-starburst"].sparks.properties.colormap =
	[[1 0.8 0.4 0.01   1 0.8 0.1 0.007  0.5 0.4 0.05 0.007   0 0 0 0.01]]
definitions["missiletrail-juno-starburst"].dustparticles.properties.particlesize = definitions["missiletrail-juno"].dustparticles.properties.particlesize
	* 1.5
definitions["missiletrail-juno-starburst"].fireglow.properties.particlesize = definitions["missiletrail-juno"].fireglow.properties.particlesize
	* 1.5

definitions["cruisemissiletrail-emp"] = table.copy(definitions.cruisemissiletrail)
definitions["cruisemissiletrail-emp"].smokeandfire.properties.colormap =
	[[0.5 0.44 0.7 0.01   0.3 0.26 0.5 0.01    0.24 0.22 0.4 0.01    0.064 0.06 0.11 0.01     0.032 0.03 0.065 0.01   0.053 0.05 0.2 0.01   0 0 0 0.01]]
definitions["cruisemissiletrail-emp"].fireglow.properties.colormap = [[0.17 0.15 0.25 0.01   0 0 0 0.01]]
definitions["cruisemissiletrail-emp"].sparks.properties.colormap =
	[[0.66 0.6 1.0 0.01   0.5 0.45 0.9 0.01  0.27 0.25 0.65 0]]
definitions["cruisemissiletrail-emp"].sparks2.properties.colormap =
	[[0.66 0.6 1.0 0.01   0.5 0.45 0.9 0.01  0.27 0.25 0.65 0]]
definitions["cruisemissiletrail-emp"].fireglowbright = nil

definitions["cruisemissiletrail-tacnuke"] = table.copy(definitions.cruisemissiletrail)
definitions["cruisemissiletrail-tacnuke"].smokeandfire.properties.colormap =
	[[0.7 0.6 0.45 0.01   0.44 0.33 0.06 0.01    0.34 0.15 0 0.01    0.09 0.025 0 0.01     0.05 0.01 0 0.01   0.024 0.01 0 0.01   0.014 0.002 0 0.01   0 0 0 0.01]]
...
for defName, def in pairs(definitions) do
	...
	definitions[defName].fireglow = nil
	--definitions[defName] = {}
end
