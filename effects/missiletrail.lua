...
local definitions = {
  ...
  ["missiletraillarge"] = {
    ...
    fire = {
        ...
        properties = {
            airdrag            = 1,
            colormap           = [[0.9 0.7 0.33 0.01   0.44 0.26 0.09 0.01    0.14 0.04 0.01 0.01    0.02 0.01 0.006 0.01	 0 0 0 0.01]],
            directional        = true,
            emitrot            = 180,
            emitrotspread      = 7,
            emitvector         = [[dir]],
    ...
    sparks = {
      ...
      smoke = {
          ...
          properties = {
              airdrag            = 0.92,
              colormap           = [[0.006 0.006 0.006 0.05   0.05 0.04 0.033 0.6   0.04 0.038 0.034 0.5   0.04 0.036 0.032 0.4   0.025 0.025 0.025 0.22   0.014 0.014 0.014 0.1    0.006 0.006 0.006 0.04   0 0 0 0.01]],
              directional        = true,
              emitrot            = -180,
              emitrotspread      = 7,
              emitvector         = [[dir]],
	...
	dustparticles = {
      ...
      properties = {
        airdrag            = 0.92,
        colormap           = [[0.4 0.4 0.4 0.01    1 0.75 0.5 0.02    0.66 0.37 0.3 0.18    0.5 0.27 0.22 0.15    0.33 0.18 0.18 0.1    0 0 0 0.01]],
        directional        = true,
        emitrot            = -180,
        emitrotspread      = 28,
        emitvector         = [[1, 1, 1]],
  ...
  ["missiletrailaa-large"] = {
    ...
    ["nuketrail"] = {
        ...
        fire = {
            ...
            properties = {
                airdrag            = 1,
                colormap           = [[0.7 0.6 0.45 0.01   0.44 0.33 0.06 0.01    0.3 0.14 0 0.01    0.08 0.022 0 0.01   0 0 0 0.01]],
                directional        = true,
                emitrot            = 180,
                emitrotspread      = 6,
                emitvector         = [[dir]],
        ...
        smoke = {
            ...
            properties = {
                airdrag            = 0.97,
                colormap           = [[0.015 0.015 0.015 0    0.035 0.03 0.02 0.15    0.04 0.035 0.025 0.22  0.042 0.041 0.04 0.15   0.015 0.015 0.015 0.1   0 0 0 0]],
                directional        = true,
                emitrot            = 90,
                emitrotspread      = 25,
                emitvector         = [[0, 0.33, 0]],
