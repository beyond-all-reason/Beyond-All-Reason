  ...
  ["missiletrailtiny"] = {
    ...
    ["missiletrailsmall"] = {
        ...
        smoke = {
            ...
            properties = {
                airdrag            = 0.95,
                colormap           = [[0.05 0.04 0.033 0.0   0.04 0.038 0.034 0.27   0.04 0.036 0.032 0.3   0.025 0.025 0.025 0.22   0.014 0.014 0.014 0.11    0.006 0.006 0.006 0.05   0 0 0 0.01]],
                directional        = true,
                emitrot            = -180,
                emitrotspread      = 5,
                emitvector         = [[dir]],
        ...
        trail = {
            ...
            water              = true,
            properties = {
                colormap           = [[0.035 0.025 0.015 0.09   0 0 0 0.01]],
                dir                = [[dir]],
                frontoffset        = 0,
                fronttexture       = [[trans]],
                length             = -90,
                sidetexture        = [[smoketrailsoft]],
                size               = 2.0,
                sizegrowth         = -0.05,
                ttl                = 3,
        },
    ...
    ["missiletrailviper"] = {
        ...
        dustparticles = {
            ...
            properties = {
                airdrag            = 0.77,
                colormap           = [[0.4 0.4 0.4 0.008    1 0.74 0.48 0.02    0.66 0.35 0.28 0.24    0.5 0.24 0.19 0.16    0.33 0.13 0.13 0.15    0 0 0 0.01]],
                directional        = false,
                emitrot            = 80,
                emitrotspread      = 15,
                emitvector         = [[dir]],
