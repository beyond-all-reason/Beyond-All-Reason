...
return {
	...
	["fire-ongoing-low"] = {
		...
		firelow = {
			...
			properties = {
				airdrag             = 0.92,
				animParams          = [[8,8,88 r55]],
				castShadow          = false,
				colormap            =
				[[0.25 0.22 0.18 0.65   0.75 0.77 0.51 0.7   0.72 0.71 0.39 0.8    0.67 0.57 0.34 0.6   0.60 0.51 0.29 0.6   0.50 0.37 0.39 0.5   0.48 0.31 0.32 0.5    0.11 0.11 0.12 0.40   0.016 0.011 0.07 0.3   0 0 0 0.01]],
				directional         = false,
				drawOrder           = layer.high,
				emitrot             = 90,
				emitrotspread       = 5,
	...
	["fire-ongoing-area"] = {
		...
		firearea = {
			...
			properties = {
				...
				castShadow          = false,
				colormap            =
				[[0 0 0 0.01   0.65 0.65 0.58 0.4  0.65 0.65 0.48 0.2   0.1 0.1 0.1 0.12   0.15 0.15 0.18 0.15   0 0 0 0.05]],
				directional         = false,
				drawOrder           = layer.high,
				emitrot             = 40,
				emitrotspread       = 30,
		...
		fxsmoke = {
			...
			properties = {
				...
				castShadow          = true,
				colormap            =
				[[0.01 0.01 0.01 0.01   0.02 0.02 0.01 0.2   0.11 0.10 0.09 0.48   0.11 0.10 0.09 0.65    0.075 0.07 0.07 0.3   0.01 0.01 0.01 0.01]],
				directional         = false,
				drawOrder           = 0,
				emitrot             = 90,
				emitrotspread       = 70,
	...
	["fire-area-75-dur-300"] = {
		...
		fireunder = {
			...
			water      = false,
			properties = {
				animParams   = [[8,8,20 r100]],
				castShadow   = false,
				colormap     =
				[[0.60 0.60 0.38 0.07   0.64 0.67 0.38 0.36   0.74 0.77 0.5 0.28   0.67 0.72 0.4 0.25   0.68 0.78 0.68 0.34   0.68 0.78 0.68 0.3   0.68 0.78 0.68 0.12   0.023 0.023 0.023 0.26   0.023 0.023 0.023 0.18   0.023 0.023 0.023 0.1   0 0 0 0.05]],
				dir          = [[0, 1, 0]],
				drawOrder    = layer.lower,
				frontoffset  = 0,
				...
				sidetexture  = [[none]],
				size         = getRandomFrequency(75, 20, 1, 4),
				sizegrowth   = [[-0.4 r0.4]],
				ttl          = 300 + 100,
			},
		},
	...
	["fire-area-150-dur-300"] = {
		...
		fireunder = {
			...
			properties = {
				...
				rotParams    = [[-2 r4, -2 r4, -90 r180]],
				sidetexture  = [[none]],
				size         = getRandomFrequency(150, 20, 1, 4),
				sizegrowth   = [[-0.4 r0.4]],
				ttl          = 300 + 100,
			},
		},
