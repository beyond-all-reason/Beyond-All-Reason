...
local function setup()
	...
	assert(
		Game.nativeExcessSharing == false,
...
local function test()
	...
	assert(
		metalReceivedAfter > metalReceivedBefore,
		"team1 metal should increase after share, before="
			.. tostring(metalReceivedBefore)
			.. " after="
			.. tostring(metalReceivedAfter)
	)
	...
	assert(
		energyReceivedAfter > energyReceivedBefore,
		"team1 energy should increase after share, before="
			.. tostring(energyReceivedBefore)
			.. " after="
			.. tostring(energyReceivedAfter)
	)
end
