...
function M.attach(doc, ctx)
	...
	local function populateBuiltinPresets(filter)
		...
		for _, entry in ipairs(shown) do
			...
			local html = '<div id="' .. itemId .. '" class="ll-preset-item">' .. '<div class="ll-preset-name">' .. (preset.name or "Unnamed") .. "</div>" .. '<div class="ll-preset-desc">' .. (preset.desc or "") .. " (" .. #preset.lights .. " lights)</div>" .. "</div>"
	...
	local function populateUserPresets(filter)
		...
		for _, entry in ipairs(shown) do
			...
			local html = '<div id="' .. itemId .. '" class="ll-preset-item">' .. '<div class="ll-preset-name">' .. (p.name or "?") .. "</div>" .. "</div>"
...
function M.sync(doc, ctx, lpState, setSummary)
	...
	setSummary("LIGHTS", "#fdc04c", "", (lpState.lightType or "point"):upper(), "Bright ", string.format("%.1f", lpState.brightness or 1), "Rad ", tostring(lpState.lightRadius or 200), "Elev ", tostring(lpState.elevation or 100))
