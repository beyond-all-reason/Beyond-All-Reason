...
function M.sync(doc, ctx, stpState, setSummary)
	...
	setSummary("START POS", "#fdc04c", "", (stpState.subMode or "express"):upper(), "Players ", tostring(stpState.totalPlayers or (stpState.numAllyTeams or 2)) .. " (" .. tostring(stpState.numAllyTeams or 2) .. "x" .. tostring(stpState.numTeamsPerAlly or 1) .. ")")
