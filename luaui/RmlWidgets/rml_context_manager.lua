...
local function calculateDpRatio()
	...
	local userScale = Engine.Unsynced.GetConfigFloat("ui_scale", 1)
...
function widget:Shutdown()
	Engine.Shared.Echo("Rml Context Manager shutdown, dynamic context dp ratio updates to contexts disabled.")
end
