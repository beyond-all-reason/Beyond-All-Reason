...
-- Tunables
--------------------------------------------------------------------------------
local MARGIN_CELLS      = 1      -- number of build-squares of preview around the unit footprint
...
local SHOW_NEAR_BLOCKED  = true  -- when ONLY_WHEN_BLOCKED, still show if any adjacent margin cell is blocked
