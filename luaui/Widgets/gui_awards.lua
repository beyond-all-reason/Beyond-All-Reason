...
function widget:MousePress(x, y, button)
	if drawAwards then
		...
		if (x > widgetX + widgetWidthScaled - quitRightX - mathFloor(5*widgetScale)
				and (x < widgetX + widgetWidthScaled - quitRightX + mathFloor(20*widgetScale) * font:GetTextWidth(I18N('ui.awards.leave')) + mathFloor(5*widgetScale))
		...
		if (x > widgetX + widgetWidthScaled - graphsRightX - mathFloor(5*widgetScale))
				and (x < widgetX + widgetWidthScaled - graphsRightX + mathFloor(20*widgetScale) * font:GetTextWidth(I18N('ui.awards.showGraphs')) + mathFloor(5*widgetScale))
				and (y > widgetY + mathFloor((50 - 5)*widgetScale)
					and (y < widgetY + mathFloor((50 + 17 + 5)*widgetScale))) then
...
function widget:DrawScreen()
	...
	-- Leave button
	if (x > widgetX + widgetWidthScaled - quitRightX - mathFloor(5*widgetScale))
			and (x < widgetX + widgetWidthScaled - quitRightX + mathFloor(20*widgetScale) * font2:GetTextWidth(I18N('ui.awards.leave')) + mathFloor(5*widgetScale))
			and (y > widgetY + mathFloor((50 - 5)*widgetScale))
			and (y < widgetY + mathFloor((50 + 17 + 5)*widgetScale)) then
	...
	if (x > widgetX + widgetWidthScaled - graphsRightX - (5*widgetScale))
			and (x < widgetX + widgetWidthScaled - graphsRightX + mathFloor(20*widgetScale) * font2:GetTextWidth(I18N('ui.awards.showGraphs')) + mathFloor(5*widgetScale))
			and (y > widgetY + mathFloor((50 - 5)*widgetScale))
			and (y < widgetY + mathFloor((50 + 17 + 5))*widgetScale) then
