...
{            "0", "group", "0"            },
{       "Ctrl+0", "group", "set 0"        },
{      "Shift+0", "group", "selectadd 0" },
{ "Ctrl+Shift+0", "group", "add 0"        },
{        "Alt+0", "group", "selecttoggle 0"     },
{            "1", "group", "1"            },
{       "Ctrl+1", "group", "set 1"        },
{      "Shift+1", "group", "selectadd 1" },
{ "Ctrl+Shift+1", "group", "add 1"        },
{        "Alt+1", "group", "selecttoggle 1"     },
{            "2", "group", "2"            },
{       "Ctrl+2", "group", "set 2"        },
{      "Shift+2", "group", "selectadd 2" },
{ "Ctrl+Shift+2", "group", "add 2"        },
{        "Alt+2", "group", "selecttoggle 2"     },
{            "3", "group", "3"            },
{       "Ctrl+3", "group", "set 3"        },
{      "Shift+3", "group", "selectadd 3" },
{ "Ctrl+Shift+3", "group", "add 3"        },
{        "Alt+3", "group", "selecttoggle 3"     },
{            "4", "group", "4"            },
{       "Ctrl+4", "group", "set 4"        },
{      "Shift+4", "group", "selectadd 4" },
{ "Ctrl+Shift+4", "group", "add 4"        },
{        "Alt+4", "group", "selecttoggle 4"     },
{            "5", "group", "5"            },
{       "Ctrl+5", "group", "set 5"        },
{      "Shift+5", "group", "selectadd 5" },
{ "Ctrl+Shift+5", "group", "add 5"        },
{        "Alt+5", "group", "selecttoggle 5"     },
{            "6", "group", "6"            },
{       "Ctrl+6", "group", "set 6"        },
{      "Shift+6", "group", "selectadd 6" },
{ "Ctrl+Shift+6", "group", "add 6"        },
{        "Alt+6", "group", "selecttoggle 6"     },
{            "7", "group", "7"            },
{       "Ctrl+7", "group", "set 7"        },
{      "Shift+7", "group", "selectadd 7" },
{ "Ctrl+Shift+7", "group", "add 7"        },
{        "Alt+7", "group", "selecttoggle 7"     },
{            "8", "group", "8"            },
{       "Ctrl+8", "group", "set 8"        },
{      "Shift+8", "group", "selectadd 8" },
{ "Ctrl+Shift+8", "group", "add 8"        },
{        "Alt+8", "group", "selecttoggle 8"     },
{            "9", "group", "9"            },
{       "Ctrl+9", "group", "set 9"        },
{      "Shift+9", "group", "selectadd 9" },
{ "Ctrl+Shift+9", "group", "add 9"        },
{        "Alt+9", "group", "selecttoggle 9"     },
