...
function widget:LanguageChanged()
	...
	elseif deathmode == "builders" then
		key = 'killAllBuilders'
	elseif (deathmode == "territorial_domination" or Spring.GetModOptions().temp_enable_territorial_domination) and not Spring.Utilities.Gametype.IsRaptors() and not Spring.Utilities.Gametype.IsScavengers() then
