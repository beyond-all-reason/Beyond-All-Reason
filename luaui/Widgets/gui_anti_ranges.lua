...
function drawCircle(uID, coverageRange, x, y, z, camX, camY, camZ)
	...
	if lineOpacityMultiplier > 0 then
		...
		--
		glColor(circleColor[1], circleColor[2], circleColor[3], 0.55 * lineOpacityMultiplier)
...
function widget:SetConfigData(data)
	if data.showLineGlow2 ~= nil then
		showLineGlow2 = data.showLineGlow2
	end
	if data.fadeOnCloseup ~= nil then
		fadeOnCloseup = data.fadeOnCloseup
	end
end
