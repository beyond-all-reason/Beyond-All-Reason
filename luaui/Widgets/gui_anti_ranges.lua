...
local arm_mobile_anti_water_2	= UnitDefNames.armada_supportship.id
local cor_anti					= UnitDefNames.cortex_prevailer.id
local cor_mobile_anti			= UnitDefNames.cortex_saviour.id
local cor_mobile_anti_water		= UnitDefNames.cortex_oasis.id
local cor_mobile_anti_water_2	= UnitDefNames.cortex_supportship.id
...
local coverageRangeCoreStatic	= WeaponDefs[UnitDefNames.cortex_prevailer.weapons[1].weaponDef].coverageRange
...
local coverageRangeArmWater2	= WeaponDefs[UnitDefNames.armada_supportship.weapons[1].weaponDef].coverageRange
local coverageRangeCoreWater2	= WeaponDefs[UnitDefNames.cortex_supportship.weapons[1].weaponDef].coverageRange
