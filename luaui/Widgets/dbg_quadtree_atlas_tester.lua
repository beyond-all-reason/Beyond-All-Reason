...
function widget:DrawScreen()
	...
	for id, textItem in pairs(textItems) do
		MyAtlasOnDemand:TextRect(
			id,
			o + offsetX + textItem.uvcoords.x * MyAtlasOnDemand.xsize,
			o + textItem.uvcoords.y * MyAtlasOnDemand.ysize + textItem.uvcoords.d
		)
	end
...
function widget:Initialize()
	...
	MyAtlasOnDemand = MakeAtlasOnDemand({
		sizex = 1024,
		sizey = 512,
		xresolution = 224,
		yresolution = 24,
