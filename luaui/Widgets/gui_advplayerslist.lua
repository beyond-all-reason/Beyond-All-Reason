...
local modules, ModuleRefs, m_point,

m_take = ModulesFactory(pics, drawAllyButton)
...
function updateShareAmount(player, resourceType)
...
function DrawResources(energy, energyStorage, energyShare, energyConversion, metal, metalStorage, metalShare, posY, dead, maxAllyTeamEnergyStorage, maxAllyTeamMetalStorage)
    ...
    if metalShare < 0.99 then  -- default = 0.99
        ...
        DrawRect(ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (metalStorage/maxStorage)) * metalShare) - 0.75 - bordersize,
                posY + y1Offset + 0.55 + bordersize, ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (metalStorage/maxStorage)) * metalShare) + 0.75 + bordersize,
        ...
        DrawRect(ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (metalStorage/maxStorage)) * metalShare) - 0.75,
                posY + y1Offset + 0.55, ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (metalStorage/maxStorage)) * metalShare) + 0.75,
                posY + y2Offset - 0.55)
    end
    ...
    if energyConversion and energyConversion ~= 0.75 and not dead then    -- default = 0.75
        ...
        DrawRect(ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyConversion) - 0.75 - bordersize,
                posY + y1Offset + 0.55 + bordersize, ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyConversion) + 0.75 + bordersize,
                posY + y2Offset - 0.55 - bordersize)
        ...
        DrawRect(ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyConversion) - 0.75,
                posY + y1Offset + 0.55, ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyConversion) + 0.75,
                posY + y2Offset - 0.55)
    end
    ...
    if energyShare < 0.94 or energyShare > 0.96 then  -- default = 0.94999999
        ...
        DrawRect(ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyShare) - 0.75 - bordersize,
                posY + y1Offset + 1.1, ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyShare) + 0.75 + bordersize,
                posY + y2Offset - 1.1)
        gl_Color(1, 0.25, 0.25, 1)
        gl_Texture(pics.resbarPic)
        DrawRect(ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyShare) - 0.75,
                posY + y1Offset + 0.55, ModuleRefs.resources.posX + widgetPosX + paddingLeft + ((barWidth * (energyStorage/maxStorage)) * energyShare) + 0.75,
                posY + y2Offset - 0.55)
    end
end
...
function DrawIncome(energy, metal, posY, dead)
    ...
    if energy > 0 then
        font:Print(
                '\255\255\255\050' .. string.formatSI(mathFloor(energy)), ModuleRefs.income.posX + widgetPosX + ModuleRefs.income.width - 2,
    ...
    if metal > 0 then
        font:Print(
                '\255\235\235\235' .. string.formatSI(mathFloor(metal)), ModuleRefs.income.posX + widgetPosX + ModuleRefs.income.width - 2,
