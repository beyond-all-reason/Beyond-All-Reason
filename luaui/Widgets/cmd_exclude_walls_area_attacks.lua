...
function widget:CommandNotify(cmdID, cmdParams, cmdOpts)
	...
	if targetListCommandID and #targetIDs > 0 then
		local selectedUnits = spGetSelectedUnits()
		return spGiveOrderToUnitArray(selectedUnits, targetListCommandID, targetIDs, cmdOpts.coded or 0) or nil
	end
