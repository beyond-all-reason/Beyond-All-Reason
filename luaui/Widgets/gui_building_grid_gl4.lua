...
local function goodbye(reason)
	Engine.Shared.Echo("Building Grid GL4 widget exiting with reason: " .. reason)
...
function widget:DrawWorldPreUnit()
	...
	local mx, my, _ = Engine.Unsynced.GetMouseState()
	local _, mousePos = Engine.Unsynced.TraceScreenRay(mx, my, true, false, false, not waterSurfaceMode)
