...
local function generateCode(type)
	...
	for _, unitID in ipairs(selectedUnits) do
		...
		if type == types.blueprint and (unitName == "armada_dragonsteeth_scav" or unitName == "cortex_dragonsteeth_scav" or unitName == "armada_dragonsclaw_scav" or unitName == "cortex_dragonsmaw_scav" or unitName == "cortex_scavdragonsteeth_scav" or unitName == "cortex_scavdragonsmaw_scav" or unitName == "cortex_scavdragonsclaw_scav" or unitName == "cortex_scavmissilewall_scav") then
