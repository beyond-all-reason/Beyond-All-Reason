function widget:GetInfo()
	return {
		name      = "Weapon Range GL4",
		desc      = "Shows Weapon ranges of all ally units.",
		author    = "Beherith GL4, Icexuick, Floris",
		date      = "2021.11.14",
		license   = "CC BY-NC",
		layer     = 0,
		enabled   = true
...
local rangeColor = { 1.0, 0.0, 0.0, 0.12 }
...
for unitDefID, unitDef in pairs(UnitDefs) do
	if unitDef.weaponrange and unitDef.weaponrange > minWeaponDistance then	-- save perf by excluding low radar range units
		if not unitRange[unitDefID] then unitRange[unitDefID] = unitDef.losweaponrange end
