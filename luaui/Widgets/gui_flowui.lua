...
WG.FlowUI.opacity = Engine.Unsynced.GetConfigFloat("ui_opacity", 0.7)
WG.FlowUI.clampedOpacity = mathMax(0.75, WG.FlowUI.opacity)
WG.FlowUI.scale = Engine.Unsynced.GetConfigFloat("ui_scale", 1)
WG.FlowUI.tileOpacity = Engine.Unsynced.GetConfigFloat("ui_tileopacity", 0.014)
WG.FlowUI.tileScale = Engine.Unsynced.GetConfigFloat("ui_tilescale", 7)
