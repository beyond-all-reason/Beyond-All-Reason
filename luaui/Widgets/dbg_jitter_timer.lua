...
function widget:DrawScreen()
	...
	--background rect
	gl.Rect(
		viewSizeX - timerwidth,
		viewSizeY - timerYoffset - panelBottomPadding,
		viewSizeX,
		viewSizeY - timerYoffset + timerheight
	)

	gl.Color(1.0, 0.0, 1.0, 1.0)
	gl.Rect(
		viewSizeX - (timerwidth * 0.5),
		viewSizeY - timerYoffset + timerheight / 2,
		viewSizeX + timerwidth * 0.5 - (timerwidth * (1.0 - deltajitter * 30)),
		viewSizeY - timerYoffset + timerheight
	)
	...
	gl.Rect(
		viewSizeX - (timerwidth * 0.5),
		viewSizeY - timerYoffset,
		viewSizeX + timerwidth * 0.5 - (timerwidth * (1.0 - spreadCTO)),
		viewSizeY - timerYoffset + timerheight / 2
	)
	...
	gl.Rect(
		viewSizeX - timerwidth + offset,
		frameIndicatorY,
		viewSizeX - timerwidth + frameIndicatorSize + offset,
		frameIndicatorY - frameIndicatorSize
	)
