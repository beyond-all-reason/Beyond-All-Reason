...
for udid, udef in pairs(UnitDefs) do
	...
	local isMobile = (udef.canMove and udef.speed > 0.000001)  or  (includeNanosAsMobile and (udef.name == "armada_constructionturret" or udef.name == "cortex_constructionturret"))
	...
	if string.find(udef.name, 'armada_webber') then
		builder = false
	end
