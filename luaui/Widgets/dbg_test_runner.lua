...
Test = {
	...
	prepareWidget = function(widgetName)
		...
		assert(widgetHandler.knownWidgets[widgetName] ~= nil, string.format("prepareWidget: unknown widget %q — not in widgetHandler.knownWidgets", widgetName))
	...
	restoreWidget = function(widgetName)
		...
		assert(wasActive ~= nil, string.format("restoreWidget: widget %q was never prepared (no entry in initialWidgetActive)", widgetName))
