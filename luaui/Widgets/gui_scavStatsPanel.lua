...
local function CreatePanelDisplayList()
	...
	if currentTime > gameInfo.scavGracePeriod then
		if gameInfo.scavBossAnger < 100 then
			...
			if totalSeconds < 1800 or revealedBossEta then
				...
				font:Print(
					textColor .. Spring.I18N("ui.scavs.bossETA", { count = nBosses, time = time }),
					panelMarginX + 5,
					PanelRow(2),
					panelFontSize,
					""
			...
			font:Print(
				textColor .. Spring.I18N("ui.scavs.bossHealth", { count = nBosses, health = gameInfo.scavBossHealth }),
				panelMarginX,
				PanelRow(1),
				panelFontSize,
				""
			...
			if Spring.GetGameRulesParam("scavBossStaggerActive") == false then
				...
				font:Print(
					"\255\255\255\0" .. Spring.I18N("ui.scavs.bossStaggerActive", { count = nBosses }),
					panelMarginX,
					PanelRow(2),
					panelFontSize,
					""
			...
			for i = 1, #currentlyResistantToNames do
				if i == 1 then
					font:Print(
						textColor .. Spring.I18N("ui.scavs.bossResistantToList", { count = nBosses }),
						panelMarginX,
						PanelRow(12),
						panelFontSize,
						""
	...
	font:Print(
		textColor .. Spring.I18N("ui.scavs.mode", { mode = difficultyCaption }) .. endless,
		panelMarginX,
		h - 195,
		panelFontSize,
		""
	...
	for i = 1, #resistancesTable do
		...
		if string.sub(attackerName, -5, -1) == "_scav" then
			...
			currentlyResistantToNames[#currentlyResistantToNames + 1] = "Scav "
				.. Spring.I18N("units.names." .. attackerNameNonScav)
		else
