...
function widget:Update(dt)
	...
	if backgroundRect and math_isInRect(x, y, backgroundRect[1], backgroundRect[2], backgroundRect[3], backgroundRect[4]) then
		...
		if numGroups >= 1 then
			tooltipAddition = tooltipAddition .. BAR.I18N("ui.unitGroups.shiftclick") .. "\n" .. BAR.I18N("ui.unitGroups.ctrlclick") .. "\n" .. BAR.I18N("ui.unitGroups.rightclick")
		end
		tooltipAddition = tooltipAddition .. (tooltipAddition ~= "" and "\n" or "") .. BAR.I18N("ui.unitGroups.tooltip")
		if WG["autogroup"] ~= nil then
			tooltipAddition = tooltipAddition .. (tooltipAddition ~= "" and "\n\n" or "") .. "\255\200\255\200" .. BAR.I18N("ui.unitGroups.autogroupTooltip")
		end
		if WG["tooltip"] then
