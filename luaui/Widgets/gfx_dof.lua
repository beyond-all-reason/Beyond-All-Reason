...
local function CleanupTextures()
	...
	baseBlurTex, baseNearBlurTex, intermediateBlurTex0, intermediateBlurTex1, intermediateBlurTex2, intermediateBlurTex3, finalBlurTex, finalNearBlurTex, screenTex, depthTex =
...
local function FilterCalculation()
	...
	local gmin = Spring.GetGroundExtremes()
