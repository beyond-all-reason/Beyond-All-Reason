...
local widgetSpaceMargin, bgpadding, RectRound, TexturedRectRound, UiElement, font, font2
...
local function updateRejoin()
	...
	dlistRejoin = gl.CreateList(function()
		...
		local barHeightPadding = math.floor((9 * widgetScale) + 0.5) --((height/2) * widgetScale) - (barHeight/2)
		...
		-- Text
		local fontsize = math.floor(height*0.37)
		font2:Begin()
		font2:Print('\255\225\255\225' .. Spring.I18N('ui.rejoin.catchingUp') .. ' \255\166\166\166'..gametime, area[1] + ((area[3] - area[1]) / 2), area[2] + barHeight * 2 + (fontsize*0.66), fontsize, 'cor')
		font2:End()
