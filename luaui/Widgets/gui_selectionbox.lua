...
function widget:MousePress(x, y, button)
	...
	local mmX, mmY, mmW, mmH, minimized, maximized = Engine.Unsynced.GetMiniMapGeometry()
	if not mmX or minimized or maximized then
		return false
	end
...
function widget:Update()
	...
	local mx, my, leftPressed = Engine.Unsynced.GetMouseState()
