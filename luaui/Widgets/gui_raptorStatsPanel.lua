	...
	if currentTime > gameInfo.raptorGracePeriod then
		if gameInfo.raptorQueenAnger < 100 then
			...
			if Spring.GetGameRulesParam("raptorQueenStaggerActive") == false then
				font:Print(textColor .. Spring.I18N('ui.raptors.queenStaggerPercentage', {count = nBosses, value = Spring.GetGameRulesParam("raptorQueenStaggerPercentage") }), panelMarginX, PanelRow(2), panelFontSize, "")
			else
				font:Print("\255\255\255\0" .. Spring.I18N('ui.raptors.queenStaggerActive', {count = nBosses}), panelMarginX, PanelRow(2), panelFontSize, "")
				font:Print("\255\255\255\0" .. Spring.I18N('ui.raptors.queenStaggerPercentage', {count = nBosses, value = Spring.GetGameRulesParam("raptorQueenStaggerPercentage") }), panelMarginX, PanelRow(3), panelFontSize, "")
			end
