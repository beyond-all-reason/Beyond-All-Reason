			...
			if faction ~= "" and faction ~= "SCAVS" then
				...
				if unitDef.weapons then
					for wid, weapon in pairs(unitDef.weapons) do
						...
						if
							weaponDef.customParams.bogus ~= "1"
							and weaponShowGroups[weaponDef.customParams.weapons_group]
						then
				...
				file:write(
					unitDef.name
						...
						.. columnSeparator
						.. unitDef.translatedTooltip
						.. columnSeparator
						.. description
						.. columnSeparator
						.. (iconTypes[unitDef.iconType] and iconTypes[unitDef.iconType].bitmap and string.gsub(
							string.gsub(iconTypes[unitDef.iconType].bitmap, "icons/", ""),
							".png",
							""
						) or "")
						.. columnSeparator
						.. round(unitDef.height, 0)
						.. columnSeparator
						.. unitDef.metalCost
						.. columnSeparator
						.. unitDef.energyCost
						...
						.. unitDef.buildSpeed
						.. columnSeparator
						.. round(unitDef.speed, 0)
						.. columnSeparator
						.. unitDef.health
						.. columnSeparator
						.. ((unitDef.modCategories.phib ~= nil or (unitDef.modCategories.canbeuw ~= nil and unitDef.modCategories.underwater == nil)) and "1" or "")
						.. columnSeparator
						.. ((unitDef.modCategories.underwater ~= nil) and "1" or "")
						.. columnSeparator
						.. (unitDef.canFly and "1" or "")
						.. columnSeparator
						.. (unitDef.modCategories.hover and "1" or "")
						.. columnSeparator
						.. (unitDef.modCategories.ship and "1" or "")
						.. columnSeparator
						.. (unitDef.modCategories.tank and "1" or "")
						.. columnSeparator
						.. (unitDef.modCategories.bot and "1" or "")
						.. columnSeparator
						.. ((unitDef.isBuilding or unitDef.isFactory or unitDef.speed == 0) and "1" or "")
						.. columnSeparator
						.. dps
						.. columnSeparator
						.. weaponRange
						...
						.. columnSeparator
						.. (unitDef.customParams.subfolder and unitDef.customParams.subfolder .. "/" or "")
						.. unitDef.name
						.. ".lua"
						.. "\n"
				)
