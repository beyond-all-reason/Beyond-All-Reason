...
local function drawWindow(activetab)
	...
	for i, tab in ipairs(tabs) do
		...
		font2:Print(
			tabcolor .. tab,
			screenX + (titleFontSize * 0.75) + tabrects[tab][5],
	...
	if activetab ~= "Keybindings" and keybindsimages[activetab] then
		...
		font:Begin()
		font:Print(
			Spring.I18N("ui.keybinds.disclaimer"),
			screenX + (12 * widgetScale),
			screenY - screenHeight + (34 * widgetScale),
			12.5 * widgetScale
		)
		font:Print(
			Spring.I18N("ui.keybinds.howtochangekeybinds"),
			screenX + (12 * widgetScale),
			screenY - screenHeight + (20 * widgetScale),
			12.5 * widgetScale
		)
		font:End()
	end
...
local function refreshText()
	...
	keybindsText = {
		...
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.chat.alliesKey"),
			text = Spring.I18N("ui.keybinds.chat.allies"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.chat.spectatorsKey"),
			text = Spring.I18N("ui.keybinds.chat.spectators"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.chat.ignoreKey"),
			text = Spring.I18N("ui.keybinds.chat.ignore"),
		},
		{ type = lineType.blank },
		...
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.camera.zoomKey"),
			text = Spring.I18N("ui.keybinds.camera.zoom"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.camera.panKey"),
			text = Spring.I18N("ui.keybinds.camera.pan"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.camera.tiltKey"),
			text = Spring.I18N("ui.keybinds.camera.tilt"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.camera.dragKey"),
			text = Spring.I18N("ui.keybinds.camera.drag"),
		},
		...
		{
			type = lineType.key,
			key = getActionHotkey("viewta") .. ", " .. getActionHotkey("viewspring"),
			text = Spring.I18N("ui.keybinds.cameraModes.change"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.cameraModes.fullscreenKey"),
			text = Spring.I18N("ui.keybinds.cameraModes.fullscreen"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("toggleoverview"),
			text = Spring.I18N("ui.keybinds.cameraModes.overview"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("togglelos"),
			text = Spring.I18N("ui.keybinds.cameraModes.los"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("showelevation"),
			text = Spring.I18N("ui.keybinds.cameraModes.heightmap"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("showpathtraversability"),
			text = Spring.I18N("ui.keybinds.cameraModes.traversability"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("lastmsgpos"),
			text = Spring.I18N("ui.keybinds.cameraModes.mapmarks"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("showmetalmap"),
			text = Spring.I18N("ui.keybinds.cameraModes.resourceSpots"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("hideinterface"),
			text = Spring.I18N("ui.keybinds.cameraModes.interface"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.sound.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.sound.volumeKey"),
			text = Spring.I18N("ui.keybinds.sound.volume"),
		},
		...
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.selection.unitsKey"),
			text = Spring.I18N("ui.keybinds.selection.units"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.issueContextOrders.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueContextOrders.orderKey"),
			text = Spring.I18N("ui.keybinds.issueContextOrders.order"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueContextOrders.formationOrderKey"),
			text = Spring.I18N("ui.keybinds.issueContextOrders.formationOrder"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.orders.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.orders.defaultKey"),
			text = Spring.I18N("ui.keybinds.orders.default"),
		},
		...
		{
			type = lineType.key,
			key = getActionHotkey("settarget"),
			text = Spring.I18N("ui.keybinds.orders.setTarget"),
		},
		...
		{
			type = lineType.key,
			key = getActionHotkey("resurrect"),
			text = Spring.I18N("ui.keybinds.orders.resurrect"),
		},
		...
		{
			type = lineType.key,
			key = getActionHotkey("canceltarget"),
			text = Spring.I18N("ui.keybinds.orders.cancelTarget"),
		},
		{ type = lineType.blank },
		...
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueOrders.orderKey"),
			text = Spring.I18N("ui.keybinds.issueOrders.order"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueOrders.revertKey"),
			text = Spring.I18N("ui.keybinds.issueOrders.revert"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueOrders.formationKey"),
			text = Spring.I18N("ui.keybinds.issueOrders.formation"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.queues.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.queues.appendKey"),
			text = Spring.I18N("ui.keybinds.queues.append"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("commandinsert"),
			text = Spring.I18N("ui.keybinds.queues.prepend"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.buildOrders.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.buildOrders.selectTileKey"),
			text = Spring.I18N("ui.keybinds.buildOrders.selectTile"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.buildOrders.metalKey"),
			text = Spring.I18N("ui.keybinds.buildOrders.metal"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.buildOrders.energyKey"),
			text = Spring.I18N("ui.keybinds.buildOrders.energy"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.buildOrders.intelKey"),
			text = Spring.I18N("ui.keybinds.buildOrders.intel"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.buildOrders.factoriesKey"),
			text = Spring.I18N("ui.keybinds.buildOrders.factories"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("buildfacing_inc") .. " / " .. getActionHotkey("buildfacing_dec"),
			text = Spring.I18N("ui.keybinds.buildOrders.rotate"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.issueBuildOrders.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueBuildOrders.orderKey"),
			text = Spring.I18N("ui.keybinds.issueBuildOrders.order"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueBuildOrders.deselect"),
			text = Spring.I18N("ui.keybinds.issueBuildOrders.deselect"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueBuildOrders.lineKey"),
			text = Spring.I18N("ui.keybinds.issueBuildOrders.line"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.issueBuildOrders.gridKey"),
			text = Spring.I18N("ui.keybinds.issueBuildOrders.grid"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("buildspacing_inc"),
			text = Spring.I18N("ui.keybinds.issueBuildOrders.spacingUp"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("buildspacing_dec"),
			text = Spring.I18N("ui.keybinds.issueBuildOrders.spacingDown"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.massSelect.title") },
		{
			type = lineType.key,
			key = getActionHotkey("select_AllMap++_ClearSelection_SelectAll+"),
			text = Spring.I18N("ui.keybinds.massSelect.all"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("select_AllMap+_Builder_Idle+_ClearSelection_SelectOne+"),
			text = Spring.I18N("ui.keybinds.massSelect.builders"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.massSelect.createGroupKey"),
			text = Spring.I18N("ui.keybinds.massSelect.createGroup"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.massSelect.createAutoGroupKey"),
			text = Spring.I18N("ui.keybinds.massSelect.createAutoGroup"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("remove_from_autogroup"),
			text = Spring.I18N("ui.keybinds.massSelect.removeAutoGroup"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.massSelect.groupKey"),
			text = Spring.I18N("ui.keybinds.massSelect.group"),
		},
		{
			type = lineType.key,
			key = getActionHotkey("select_AllMap+_InPrevSel+_ClearSelection_SelectAll+"),
			text = Spring.I18N("ui.keybinds.massSelect.sameType"),
		},
		{
			type = lineType.key,
			key = getActionHotkey(
				"select_PrevSelection+_Not_Building_Not_RelativeHealth_60+_ClearSelection_SelectAll+"
			),
			text = Spring.I18N("ui.keybinds.massSelect.damaged"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.drawing.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.drawing.mapmarkKey"),
			text = Spring.I18N("ui.keybinds.drawing.mapmark"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.drawing.drawKey"),
			text = Spring.I18N("ui.keybinds.drawing.draw"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.drawing.eraseKey"),
			text = Spring.I18N("ui.keybinds.drawing.erase"),
		},
		{ type = lineType.blank },
		{ type = lineType.title, text = Spring.I18N("ui.keybinds.console.title") },
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.console.eraseKey"),
			text = Spring.I18N("ui.keybinds.console.erase"),
		},
		{
			type = lineType.key,
			key = Spring.I18N("ui.keybinds.console.pauseKey"),
			text = Spring.I18N("ui.keybinds.console.pause"),
		},
	}
end
