...
local function refreshText()
	...
	keybindsText = {
		...
		{ type = lineType.key, key = getActionHotkey('AllMap++_ClearSelection_SelectAll+'),			text = Spring.I18N('ui.keybinds.massSelect.all')		},
		{ type = lineType.key, key = getActionHotkey('AllMap+_Builder_Idle+_ClearSelection_SelectOne+'),		text = Spring.I18N('ui.keybinds.massSelect.builders')	},
		...
		{ type = lineType.key, key = getActionHotkey('AllMap+_InPrevSel+_ClearSelection_SelectAll+'),		text = Spring.I18N('ui.keybinds.massSelect.sameType')	},
		{ type = lineType.blank },
