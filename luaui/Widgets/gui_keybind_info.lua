...
local function refreshText()
	...
	keybindsText = {
		...
		{ type = lineType.key, key = Spring.I18N('ui.keybinds.buildOrders.economyKey'),		text = Spring.I18N('ui.keybinds.buildOrders.economy')		},
		{ type = lineType.key, key = Spring.I18N('ui.keybinds.buildOrders.combatKey'),		text = Spring.I18N('ui.keybinds.buildOrders.combat')	},
		{ type = lineType.key, key = Spring.I18N('ui.keybinds.buildOrders.utilityKey'),		text = Spring.I18N('ui.keybinds.buildOrders.utility')		},
		{ type = lineType.key, key = Spring.I18N('ui.keybinds.buildOrders.buildKey'),	text = Spring.I18N('ui.keybinds.buildOrders.build')	},
		...
		{ type = lineType.key, key = Spring.I18N('ui.keybinds.massSelect.sameTypeOnscreenKey'),		text = Spring.I18N('ui.keybinds.massSelect.sameTypeOnscreen')	},
		{ type = lineType.blank },
