...
local function updateButtons()
	...
	if WG['options'] then addButton('options', I18N('ui.topbar.button.settings')) end
	if WG['keybinds'] then addButton('keybinds', I18N('ui.topbar.button.keys')) end
	if WG['changelog'] then addButton('changelog', I18N('ui.topbar.button.changes')) end
	if WG['teamstats'] then addButton('stats', I18N('ui.topbar.button.stats')) end
	if gameIsOver then addButton('graphs', I18N('ui.topbar.button.graphs')) end
	if WG['scavengerinfo'] then addButton('scavengers', I18N('ui.topbar.button.scavengers')) end
	if isSinglePlayer and cfg.allowSavegame and WG['savegame'] then addButton('save', I18N('ui.topbar.button.save')) end
