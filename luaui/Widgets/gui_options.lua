...
function DrawWindow()
	...
	if changesRequireRestart then
		...
		font:SetOutlineColor(0, 0, 0, 0.4)
		font:Print(
			Spring.I18N("ui.settings.madechanges"),
						...
						then
							...
							then
								...
								if options[i].restart then
									desc = desc
										.. "\n\n\255\255\120\120"
										.. Spring.I18N("ui.settings.changesrequirerestart")
								end
...
function init()
	...
	options = {
		...
		},
		{
			id = "label_gfx_screen",
			group = "gfx",
			name = Spring.I18N("ui.settings.option.label_screen"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.limitoffscreenfps"),
			type = "bool",
			value = GetWidgetToggleValue("Limit idle FPS"),
			description = Spring.I18N("ui.settings.option.limitoffscreenfps_descr"),
		},
		{
			id = "limitidlefps",
			group = "gfx",
...

		{
			...
			category = types.advanced,
			widget = "Sepia Tone",
			name = Spring.I18N("ui.settings.option.sepiatone"),
			type = "bool",
...

		{
			...
			group = "gfx",
			name = Spring.I18N("ui.settings.option.label_lighting"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.bloomdeferred"),
			type = "bool",
			value = GetWidgetToggleValue("Bloom Shader Deferred"),
			description = Spring.I18N("ui.settings.option.bloomdeferred_descr"),
		},
		{
...

		{
			...
			name = Spring.I18N("ui.settings.option.distortioneffects"),
			type = "bool",
			value = GetWidgetToggleValue("Distortion GL4"),
			description = Spring.I18N("ui.settings.option.distortioneffects_descr"),
		},
...

		{
			...
			group = "gfx",
			name = Spring.I18N("ui.settings.option.label_environment"),
			category = types.basic,
		},
...

		{
			...
			group = "gfx",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.lineofsight") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			name = Spring.I18N("ui.settings.option.mapedgeextension"),
			type = "bool",
			value = GetWidgetToggleValue("Map Edge Extension"),
			description = Spring.I18N("ui.settings.option.mapedgeextension_descr"),
		},
...

		{
			...
			category = types.basic,
			widget = "Decals GL4",
			name = Spring.I18N("ui.settings.option.decalsgl4"),
			type = "bool",
...

		{
			...
			name = Spring.I18N("ui.settings.option.grass"),
			type = "bool",
			value = GetWidgetToggleValue("Map Grass GL4"),
			description = Spring.I18N("ui.settings.option.grass_desc"),
		},
		{
			id = "grassdistance",
			group = "gfx",
...

		{
			...
			category = types.basic,
			widget = "Snow",
			name = Spring.I18N("ui.settings.option.snow"),
			type = "bool",
			value = GetWidgetToggleValue("Snow"),
			description = Spring.I18N("ui.settings.option.snow_descr"),
		},
		{
			id = "snowmap",
			group = "gfx",
...

		{
			...
			name = Spring.I18N("ui.settings.option.clouds"),
			type = "bool",
...

		{
			...
			group = "gfx",
			name = Spring.I18N("ui.settings.option.label_effects"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.dof"),
			type = "bool",
			value = GetWidgetToggleValue("Depth of Field"),
			description = Spring.I18N("ui.settings.option.dof_descr"),
		},
		{
			id = "dof_autofocus",
			group = "gfx",
...

		{
			...
			group = "sound",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.volume") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			group = "sound",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.label_soundtrack"),
		},
...

		{
			...
			group = "notif",
			name = Spring.I18N("ui.settings.option.label_messages"),
			category = types.basic,
		},
		...
		-- CONTROL
		{
			id = "label_ui_hotkeys",
			group = "control",
			name = Spring.I18N("ui.settings.option.label_hotkeys"),
			category = types.basic,
		},
		...
		},
		{
			...
			value = (
				WG.gridmenu ~= nil
				and WG.gridmenu.getAlwaysReturn ~= nil
				and WG.gridmenu.getAlwaysReturn()
			),
		...
		},
		{
			...
			value = (
				WG.gridmenu ~= nil
				and WG.gridmenu.getAutoSelectFirst ~= nil
				and WG.gridmenu.getAutoSelectFirst()
			),
		...
		},
		{
			...
			value = (
				WG.gridmenu ~= nil
				and WG.gridmenu.getUseLabBuildMode ~= nil
				and WG.gridmenu.getUseLabBuildMode()
			),
...

		{
			...
			value = (
				WG.gridmenu ~= nil
				and WG.gridmenu.getCtrlKeyModifier ~= nil
				and WG.gridmenu.getCtrlKeyModifier()
			),
...

		{
			id = "label_ui_cursor",
			group = "control",
			name = Spring.I18N("ui.settings.option.label_cursor"),
			category = types.basic,
		},
...

		{
			id = "label_ui_camera",
			group = "control",
			name = Spring.I18N("ui.settings.option.label_camera"),
			category = types.basic,
		},
...

		{
			...
			type = "select",
			options = {
				Spring.I18N("ui.settings.option.select_firstperson"),
				Spring.I18N("ui.settings.option.select_overhead"),
				Spring.I18N("ui.settings.option.select_springcam"),
				Spring.I18N("ui.settings.option.select_rotoverhead"),
				Spring.I18N("ui.settings.option.select_free"),
			},
		...
		},
		{
			...
			type = "select",
			options = {
				Spring.I18N("ui.settings.option.select_constant"),
				Spring.I18N("ui.settings.option.select_terrain"),
				Spring.I18N("ui.settings.option.select_smooth"),
			},
		...
		--},
		{
			...
			type = "select",
			options = {
				Spring.I18N("ui.settings.option.smoothing_exponential"),
				Spring.I18N("ui.settings.option.smoothing_spring"),
			},
		...
		},
		{
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.scrolltoggleoverview"),
			type = "bool",
			value = GetWidgetToggleValue("Scrolldown Toggleoverview"),
			description = Spring.I18N("ui.settings.option.scrolltoggleoverview_descr"),
		},

		{
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.camoverviewrestore"),
			type = "bool",
			value = GetWidgetToggleValue("Overview Camera Keep Position"),
			description = Spring.I18N("ui.settings.option.camoverviewrestore_descr"),
		},

		{
			...
			group = "control",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.lockcamera") .. widgetOptionColor .. "   " .. Spring.I18N(
...

		{
			id = "label_ui_command",
			group = "control",
			name = Spring.I18N("ui.settings.option.label_commands"),
			category = types.advanced,
		},
		...
		-- INTERFACE
		{
			...
			group = "ui",
			name = Spring.I18N("ui.settings.option.label_interface"),
			category = types.basic,
		},
		...
		},
		{
			...
			group = "ui",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.interface") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			category = types.basic,
			widget = "GUI Shader",
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.guishader"),
			type = "bool",
...

		{
			...
			group = "ui",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.minimap") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			...
			type = "select",
			options = {
				Spring.I18N("ui.settings.option.minimaprotation_none"),
				Spring.I18N("ui.settings.option.minimaprotation_autoflip"),
				Spring.I18N("ui.settings.option.minimaprotation_autorotate"),
				Spring.I18N("ui.settings.option.minimaprotation_autolandscape"),
			},
		...
		},
		{
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.minimappip"),
			type = "bool",
			value = GetWidgetToggleValue("Picture-in-Picture Minimap"),
			description = Spring.I18N("ui.settings.option.minimappip_descr"),
		},
		{
			id = "pip_altkeyzoom",
			group = "ui",
		...
		},
		{
			...
			group = "ui",
			category = types.dev,
			name = widgetOptionColor .. "      " .. Spring.I18N("ui.settings.option.pip_nanostreams"),
			type = "bool",
			value = Spring.GetConfigInt("PipDrawNanoStreams", 1) == 1,
			description = Spring.I18N("ui.settings.option.pip_nanostreams_descr"),
			onchange = function(i, value)
		...
		},
		{
			...
			group = "ui",
			category = types.dev,
			name = widgetOptionColor .. "      " .. Spring.I18N("ui.settings.option.pip_nanostream_usage"),
			type = "bool",
			value = Spring.GetConfigInt("PipNanoStreamReflectUsage", 1) == 1,
			description = Spring.I18N("ui.settings.option.pip_nanostream_usage_descr"),
			onchange = function(i, value)
...

		{
			...
			name = Spring.I18N("ui.settings.option.pip"),
			type = "bool",
			value = GetWidgetToggleValue("Picture-in-Picture"),
			description = Spring.I18N("ui.settings.option.pip_descr"),
		},
		{
			id = "pip2",
			group = "ui",
			...
			name = Spring.I18N("ui.settings.option.pip2"),
			type = "bool",
			value = GetWidgetToggleValue("Picture-in-Picture 2"),
			description = Spring.I18N("ui.settings.option.pip2_descr"),
		},

		{
			...
			group = "ui",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.buildmenu") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			...
			value = (
				WG.buildmenu ~= nil
				and WG.buildmenu.getAlwaysShow ~= nil
				and WG.buildmenu.getAlwaysShow()
			),
		...
		},
		{
			...
			value = (
				WG.buildmenu ~= nil
				and WG.buildmenu.getShowGroupIcon ~= nil
				and WG.buildmenu.getShowGroupIcon()
			),
		...
		},
		{
			...
			value = (
				WG.buildmenu ~= nil
				and WG.buildmenu.getShowRadarIcon ~= nil
				and WG.buildmenu.getShowRadarIcon()
			),
...

		{
			...
			group = "ui",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.ordermenu") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			...
			value = (
				WG.ordermenu ~= nil
				and WG.ordermenu.getAlwaysShow ~= nil
				and WG.ordermenu.getAlwaysShow()
			),
...

		{
			...
			group = "ui",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.info") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			group = "ui",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.advplayerlist") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.unittotals"),
			type = "bool",
			value = GetWidgetToggleValue("AdvPlayersList Unit Totals"),
			description = Spring.I18N("ui.settings.option.unittotals_descr"),
		},
		{
			id = "musicplayer",
			group = "ui",
		...
		},
		{
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.mascot"),
			type = "bool",
			value = GetWidgetToggleValue("AdvPlayersList Mascot"),
			description = Spring.I18N("ui.settings.option.mascot_descr"),
		},
...

		{
			...
			group = "ui",
			category = types.basic,
			name = Spring.I18N("ui.settings.option.console") .. "   " .. widgetOptionColor .. Spring.I18N(
		...
		},
		{
			...
			group = "ui",
			category = types.basic,
			name = widgetOptionColor .. "      " .. widgetOptionColor .. Spring.I18N(
		...
		--},
		{
			...
			name = Spring.I18N("ui.settings.option.autoeraser"),
			type = "bool",
			value = GetWidgetToggleValue("Auto mapmark eraser"),
			description = Spring.I18N("ui.settings.option.autoeraser_descr"),
		},
		{
...

		{
			...
			group = "ui",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.topbar") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			category = types.basic,
			widget = "Unit Groups",
			name = Spring.I18N("ui.settings.option.unitgroups"),
			type = "bool",
			value = GetWidgetToggleValue("Unit Groups"),
			description = Spring.I18N("ui.settings.option.unitgroups_descr"),
		},
		{
			id = "idlebuilders",
			group = "ui",
			...
			name = Spring.I18N("ui.settings.option.idlebuilders"),
			type = "bool",
			value = GetWidgetToggleValue("Idle Builders"),
			description = Spring.I18N("ui.settings.option.idlebuilders_descr"),
		},
		{
			id = "buildbar",
			group = "ui",
			category = types.basic,
			widget = "BuildBar",
			name = Spring.I18N("ui.settings.option.buildbar"),
			type = "bool",
			value = GetWidgetToggleValue("BuildBar"),
			description = Spring.I18N("ui.settings.option.buildbar_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.converterusage"),
			type = "bool",
			value = GetWidgetToggleValue("Converter Usage"),
			description = Spring.I18N("ui.settings.option.converterusage_descr"),
		},
...

		{
			id = "label_ui_visuals",
			group = "ui",
			name = Spring.I18N("ui.settings.option.label_visuals"),
			category = types.basic,
		},
...

		{
			...
			category = types.basic,
			widget = "TeamPlatter",
			name = Spring.I18N("ui.settings.option.teamplatter"),
			type = "bool",
			value = GetWidgetToggleValue("TeamPlatter"),
			description = Spring.I18N("ui.settings.option.teamplatter_descr"),
		},
		{
...

		{
			...
			category = types.basic,
			widget = "EnemySpotter",
			name = Spring.I18N("ui.settings.option.enemyspotter"),
			type = "bool",
			value = GetWidgetToggleValue("EnemySpotter"),
			description = Spring.I18N("ui.settings.option.enemyspotter_descr"),
		},
		{
		...
		--{ id = "selectedunits", group = "ui", category = types.basic, widget = "Selected Units GL4", name = "Selection", type = "bool", value = GetWidgetToggleValue("Selected Units GL4"), description = Spring.I18N('ui.settings.option.selectedunits_descr') },
		{
			...
			group = "ui",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.selectedunits") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			group = "ui",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.ghosticons") .. widgetOptionColor .. "   " .. Spring.I18N(
...

		{
			id = "label_ui_info",
			group = "ui",
			name = Spring.I18N("ui.settings.option.label_info"),
			category = types.basic,
		},
...

		{
			...
			group = "ui",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.metalspots") .. widgetOptionColor .. "   " .. Spring.I18N(
...

		{
			...
			name = Spring.I18N("ui.settings.option.geospots"),
			type = "bool",
			value = GetWidgetToggleValue("Metalspots"),
			description = Spring.I18N("ui.settings.option.geospots_descr"),
		},

		{
			...
			group = "ui",
			category = types.advanced,
			name = Spring.I18N("ui.settings.option.healthbars") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			...
			name = Spring.I18N("ui.settings.option.rankicons"),
			type = "bool",
			value = GetWidgetToggleValue("Rank Icons GL4"),
			description = Spring.I18N("ui.settings.option.rankicons_descr"),
		},
		{
			...
			value = (
				WG.rankicons ~= nil
				and WG.rankicons.getDrawDistance ~= nil
				and WG.rankicons.getDrawDistance()
			),
			description = "",
			onload = function(i) end,
			onchange = function(i, value)
...

		{
			...
			category = types.basic,
			widget = "AllyCursors",
			name = Spring.I18N("ui.settings.option.allycursors"),
			type = "bool",
			value = GetWidgetToggleValue("AllyCursors"),
			description = Spring.I18N("ui.settings.option.allycursors_descr"),
		},
		{
...

		{
			...
			name = Spring.I18N("ui.settings.option.showbuilderqueue"),
			type = "bool",
			value = GetWidgetToggleValue("Show Builder Queue"),
			description = Spring.I18N("ui.settings.option.showbuilderqueue_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.unitenergyicons"),
			type = "bool",
			value = GetWidgetToggleValue("Unit Energy Icons"),
			description = Spring.I18N("ui.settings.option.unitenergyicons_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.unitidlebuildericons"),
			type = "bool",
			value = GetWidgetToggleValue("Unit Idle Builder Icons"),
			description = Spring.I18N("ui.settings.option.unitidlebuildericons_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.unitfirestateicons"),
			type = "bool",
			value = GetWidgetToggleValue("Unit Fire State Icons"),
			description = Spring.I18N("ui.settings.option.unitfirestateicons_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.resurrectionhalos"),
			type = "bool",
			value = GetWidgetToggleValue("Resurrection Halos GL4"),
			description = Spring.I18N("ui.settings.option.resurrectionhalos_descr"),
		},
...

		{
			...
			category = types.basic,
			widget = "Commands FX",
			name = Spring.I18N("ui.settings.option.commandsfx"),
			type = "bool",
			value = GetWidgetToggleValue("Commands FX"),
			description = Spring.I18N("ui.settings.option.commandsfx_descr"),
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.flankingicons"),
			type = "bool",
			value = GetWidgetToggleValue("Flanking Icons GL4"),
			description = Spring.I18N("ui.settings.option.flankingicons_descr"),
		},
...

		{
			...
			category = types.advanced,
			widget = "Given Units",
			name = Spring.I18N("ui.settings.option.givenunits"),
			type = "bool",
			value = GetWidgetToggleValue("Given Units"),
			description = Spring.I18N("ui.settings.option.givenunits_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.reclaimfieldhighlight"),
			type = "bool",
			description = Spring.I18N("ui.settings.option.reclaimfieldhighlight_descr"),
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.highlightcomwrecks"),
			type = "bool",
			value = GetWidgetToggleValue("Highlight Commander Wrecks"),
			description = Spring.I18N("ui.settings.option.highlightcomwrecks_descr"),
		},
		{
...

		{
			...
			name = Spring.I18N("ui.settings.option.buildinggrid"),
			type = "bool",
			value = GetWidgetToggleValue("Building Grid GL4"),
			description = Spring.I18N("ui.settings.option.buildinggrid_descr"),
		},
		{
			...
			value = (
				WG.buildinggrid ~= nil
				and WG.buildinggrid.getOpacity ~= nil
				and WG.buildinggrid.getOpacity()
			) or 1,
			description = "",
			onload = function(i)
		...
		},
		{
			...
			name = Spring.I18N("ui.settings.option.startpositionsuggestions"),
			type = "bool",
			value = GetWidgetToggleValue("Start Position Suggestions"),
			description = Spring.I18N("ui.settings.option.startpositionsuggestions_descr"),
		},

		{
			id = "label_ui_ranges",
			group = "ui",
			name = Spring.I18N("ui.settings.option.label_ranges"),
			category = types.basic,
		},
		...
		-- Radar range rings:
		{
			...
			name = Spring.I18N("ui.settings.option.radarrange"),
			type = "bool",
			value = GetWidgetToggleValue("Sensor Ranges Radar"),
			description = Spring.I18N("ui.settings.option.radarrange_descr"),
		},

		{
			...
			max = 0.33,
			step = 0.01,
			value = (WG.radarrange ~= nil and WG.radarrange.getOpacity ~= nil and WG.radarrange.getOpacity())
				or 0.08,
			description = "",
			onload = function(i)
		...
		-- Sonar range
		{
			...
			name = Spring.I18N("ui.settings.option.sonarrange"),
			type = "bool",
			value = GetWidgetToggleValue("Sensor Ranges Sonar"),
			description = Spring.I18N("ui.settings.option.sonarrange_descr"),
		},

		{
			...
			max = 0.33,
			step = 0.01,
			value = (WG.sonarrange ~= nil and WG.sonarrange.getOpacity ~= nil and WG.sonarrange.getOpacity())
				or 0.08,
			description = "",
			onload = function(i)
		...
		-- Jammer range
		{
			...
			name = Spring.I18N("ui.settings.option.jammerrange"),
			type = "bool",
			value = GetWidgetToggleValue("Sensor Ranges Jammer"),
			description = Spring.I18N("ui.settings.option.jammerrange_descr"),
		},

		{
			...
			value = (
				WG.jammerrange ~= nil
				and WG.jammerrange.getOpacity ~= nil
				and WG.jammerrange.getOpacity()
			) or 0.08,
			description = "",
			onload = function(i)
		...
		-- LOS Range:
		{
			...
			name = Spring.I18N("ui.settings.option.losrange"),
			type = "bool",
			value = GetWidgetToggleValue("Sensor Ranges LOS"),
			description = Spring.I18N("ui.settings.option.losrange_descr"),
		},

		{
			...
			max = 0.33,
			step = 0.01,
			value = (WG.losrange ~= nil and WG.losrange.getOpacity ~= nil and WG.losrange.getOpacity())
				or 0.08,
			description = "",
			onload = function(i)
		...
		},
		{
			...
			value = (
				WG.losrange ~= nil
				and WG.losrange.getUseTeamColors ~= nil
				and WG.losrange.getUseTeamColors()
			),
			description = "",
			onload = function(i)
...

		{
			...
			name = Spring.I18N("ui.settings.option.attackrange"),
			type = "bool",
			value = GetWidgetToggleValue("Attack Range GL4"),
			description = Spring.I18N("ui.settings.option.attackrange_descr"),
		},
		{
			...
			value = (
				WG.attackrange ~= nil
				and WG.attackrange.getShiftOnly ~= nil
				and WG.attackrange.getShiftOnly()
			),
		...
		},
		{
			...
			value = (
				WG.attackrange ~= nil
				and WG.attackrange.getOpacity ~= nil
				and WG.attackrange.getNumRangesMult()
			) or 1,
...

		{
			...
			name = Spring.I18N("ui.settings.option.defrange"),
			type = "bool",
			value = GetWidgetToggleValue("Defense Range GL4"),
			description = Spring.I18N("ui.settings.option.defrange_descr"),
		},
		...
		},
		{
			...
			value = (
				WG.defrange ~= nil
				and WG.defrange.getEnemyGround ~= nil
				and WG.defrange.getEnemyGround()
			),
...

		{
			...
			category = types.advanced,
			widget = "Anti Ranges",
			name = Spring.I18N("ui.settings.option.antiranges"),
			type = "bool",
			value = GetWidgetToggleValue("Anti Ranges"),
			description = Spring.I18N("ui.settings.option.antiranges_descr"),
		},

		{
			id = "label_ui_spectator",
			group = "ui",
			name = Spring.I18N("ui.settings.option.label_spectator"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.spectator_hud"),
			type = "bool",
			value = GetWidgetToggleValue("Spectator HUD"),
			description = Spring.I18N("ui.settings.option.spectator_hud_descr"),
		},
		{
...

		{
			...
			value = (
				WG.spectator_hud ~= nil
				and WG.spectator_hud.getConfig ~= nil
				and WG.spectator_hud.getConfig()
			) or 1,
...

		{
			...
			group = "ui",
			name = Spring.I18N("ui.settings.option.label_developer"),
			category = types.advanced,
		},
		...
		},
		{
			...
			category = types.basic,
			widget = "Autoquit",
			name = Spring.I18N("ui.settings.option.autoquit"),
			type = "bool",
			value = GetWidgetToggleValue("Autoquit"),
			description = Spring.I18N("ui.settings.option.autoquit_descr"),
		},
...

		{
			...
			group = "game",
			name = Spring.I18N("ui.settings.option.label_behavior"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.prioconturrets"),
			type = "bool",
			value = GetWidgetToggleValue("Priority Construction Turrets"),
			description = Spring.I18N("ui.settings.option.prioconturrets_descr"),
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.factory") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.factoryguard"
			),
			type = "bool",
			value = GetWidgetToggleValue("Factory Guard Default On"),
			description = Spring.I18N("ui.settings.option.factoryguard_descr"),
		},
		{
			id = "factoryholdpos",
			group = "game",
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.factoryholdpos"),
			type = "bool",
			value = GetWidgetToggleValue("Factory hold position"),
			description = Spring.I18N("ui.settings.option.factoryholdpos_descr"),
		},
		{
			id = "factoryrepeat",
			group = "game",
			...
			name = widgetOptionColor .. "   " .. Spring.I18N("ui.settings.option.factoryrepeat"),
			type = "bool",
			value = GetWidgetToggleValue("Factory Auto-Repeat"),
			description = Spring.I18N("ui.settings.option.factoryrepeat_descr"),
		},
		{
			id = "factorypreset",
			group = "game",
			...
			name = Spring.I18N("ui.settings.option.factorypreset"),
			type = "bool",
			value = GetWidgetToggleValue("Factory Presets"),
			description = Spring.I18N("ui.settings.option.factorypreset_descr"),
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.onlyfighterspatrol"),
			type = "bool",
			value = GetWidgetToggleValue("Autoquit"),
			description = Spring.I18N("ui.settings.option.onlyfighterspatrol_descr"),
		},
		{
			...
			name = Spring.I18N("ui.settings.option.bombers_default_hold_fire"),
			type = "bool",
			value = GetWidgetToggleValue("BombersDefaultHoldFire"),
			description = Spring.I18N("ui.settings.option.bombers_default_hold_fire_descr"),
		},
		{
			id = "fightersfly",
			group = "game",
			...
			name = Spring.I18N("ui.settings.option.fightersfly"),
			type = "bool",
			value = GetWidgetToggleValue("Set fighters on Fly mode"),
			description = Spring.I18N("ui.settings.option.fightersfly_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.settargetdefault"),
			type = "bool",
			value = GetWidgetToggleValue("Set target default"),
			description = Spring.I18N("ui.settings.option.settargetdefault_descr"),
		},
		{
			...
			name = Spring.I18N("ui.settings.option.dgunnogroundenemies"),
			type = "bool",
			value = GetWidgetToggleValue("DGun no ground enemies"),
			description = Spring.I18N("ui.settings.option.dgunnogroundenemies_descr"),
		},
		{
			id = "dgunstallassist",
			group = "game",
			...
			name = Spring.I18N("ui.settings.option.dgunstallassist"),
			type = "bool",
			value = GetWidgetToggleValue("DGun Stall Assist"),
			description = Spring.I18N("ui.settings.option.dgunstallassist_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.unitreclaimer"),
			type = "bool",
			value = GetWidgetToggleValue("Specific Unit Reclaimer"),
			description = Spring.I18N("ui.settings.option.unitreclaimer_descr"),
		},
...

		{
			id = "label_ui_cloak",
			group = "game",
			name = Spring.I18N("ui.settings.option.label_cloak"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.autocloak"),
			type = "bool",
...

		{
			id = "label_teamcolors",
			group = "accessibility",
			name = Spring.I18N("ui.settings.option.label_teamcolors"),
			category = types.basic,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.autocheat"),
			type = "bool",
			value = GetWidgetToggleValue("Dev Auto cheat"),
			description = Spring.I18N("ui.settings.option.autocheat_descr"),
		},
		{
			id = "restart",
			group = "dev",
...

		{
			id = "label_dev_debug",
			group = "dev",
			name = Spring.I18N("ui.settings.option.label_debug"),
			category = types.dev,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.profiler") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			...
			name = Spring.I18N("ui.settings.option.framegrapher"),
			type = "bool",
...

		{
			id = "label_dev_other",
			group = "dev",
			name = Spring.I18N("ui.settings.option.label_other"),
			category = types.dev,
		},
...

		{
			...
			name = Spring.I18N("ui.settings.option.cegbrowser"),
			type = "bool",
			value = GetWidgetToggleValue("CEG Effects Browser"),
			description = Spring.I18N("ui.settings.option.cegbrowser_descr"),
		},

		{
			...
			name = Spring.I18N("ui.settings.option.startboxeditor"),
			type = "bool",
			value = GetWidgetToggleValue("Startbox Editor"),
			description = Spring.I18N("ui.settings.option.startboxeditor_descr"),
		},
...

		{
			id = "label_dev_map",
			group = "dev",
			name = Spring.I18N("ui.settings.option.label_map"),
			category = types.dev,
		},
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.sun") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.fog") .. widgetOptionColor .. "  " .. Spring.I18N(
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.color_groundambient") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.color_grounddiffuse") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.color_groundspecular") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.color_unitambient") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.color_unitdiffuse") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.color_unitspecular") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.skycolor") .. widgetOptionColor .. "  " .. Spring.I18N(
				"ui.settings.option.red"
			),
			type = "slider",
			min = 0,
...

		{
			...
			group = "dev",
			category = types.dev,
			name = Spring.I18N("ui.settings.option.skybox") .. widgetOptionColor .. "  " .. Spring.I18N(
		...
		},
		{
			id = "label_dev_water",
			group = "dev",
			name = Spring.I18N("ui.settings.option.label_water"),
			category = types.dev,
		},
		...
		for i, option in pairs(options) do
			...
			if option.id == "soundtrackFades" then
				...
				newOptions[count] = {
					...
					group = "sound",
					name = Spring.I18N("ui.settings.option.label_playlist"),
					category = types.basic,
				}
				count = count + 1
		...
		if not data.fromZip then
			if not userwidgetsDetected then
				...
				options[#options + 1] = {
					...
					group = "custom",
					name = Spring.I18N("ui.settings.option.label_widgets"),
					category = types.basic,
				}
			...
			if data.author and data.author ~= "" then
				desc = desc
					.. (desc ~= "" and "\n" or "")
					.. widgetOptionColor
					.. Spring.I18N("ui.settings.option.author")
					.. ": "
					.. data.author
			end
			options[#options + 1] = {
	...
	if customOptionsCount > 0 then
		options[#options + 1] = {
			...
			group = "custom",
			name = Spring.I18N("ui.settings.option.label_options"),
			category = types.basic,
		}
