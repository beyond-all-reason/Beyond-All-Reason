...
function init()
	...
	options = {
		...
		{ id = "onlybombersholdfire", group = "game", category = types.basic, widget = "OnlyBombersHoldFire", name = Spring.I18N('ui.settings.option.onlybombersholdfire'), type = "bool", value = GetWidgetToggleValue("OnlyBombersHoldFire"), description = Spring.I18N('ui.settings.option.onlybombersholdfire_descr') },
