...
function init()
	...
	options = {
		...
		{ id = "bombers_default_manualtargeting", group = "game", category = types.basic, widget = "BombersManualTargeting", name = Spring.I18N('ui.settings.option.bombers_default_manualtargeting'), type = "bool", value = GetWidgetToggleValue("BombersManualTargeting"), description = Spring.I18N('ui.settings.option.bombers_default_manualtargeting_descr') },
