				...
				if inputText ~= "" then
					if ssub(inputText, 1, 1) == "/" then
						...
						if badWord ~= nil and inputText ~= lastMessage then
							addChatLine(Spring.GetGameFrame(), LineTypes.System, "Moderation", "\255\255\000\000" .. I18N("ui.chat.moderation.prefix"), I18N("ui.chat.moderation.blocked", { badWord = badWord }))
						else
