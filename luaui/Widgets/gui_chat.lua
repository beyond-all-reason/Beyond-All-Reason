...
local state = {
	...
	myName = SpringShared.GetPlayerInfo(Spring.GetMyPlayerID(), false),
				...
				if inputText ~= "" then
					...
					if ssub(inputText, 1, 1) == "/" then
						...
						if badWord ~= nil and inputText ~= lastMessage then
							addChatLine(SpringShared.GetGameFrame(), LineTypes.System, "Moderation", "\255\255\000\000" .. Spring.I18N("ui.chat.moderation.prefix"), Spring.I18N("ui.chat.moderation.blocked", { badWord = badWord }))
						else
