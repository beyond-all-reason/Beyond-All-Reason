...
local function ReloadMusicPlaylists()
	...
	if newSoundtrackEnabled then
		...
		-- April Fools --------------------------------------------------------------------------------------------------------------------
		if Spring.Utilities.Gametype.GetCurrentHolidays()["aprilfools"] and SpringUnsynced.GetConfigInt("UseSoundtrackAprilFools", 1) == 1 then
		...
		elseif (not Spring.Utilities.Gametype.GetCurrentHolidays()["aprilfools"]) and SpringUnsynced.GetConfigInt("UseSoundtrackAprilFoolsPostEvent", 0) == 1 then
		...
		-- Halloween --------------------------------------------------------------------------------------------------------------------
		if Spring.Utilities.Gametype.GetCurrentHolidays()["halloween"] and SpringUnsynced.GetConfigInt("UseSoundtrackHalloween", 1) == 1 then
		...
		elseif (not Spring.Utilities.Gametype.GetCurrentHolidays()["halloween"]) and SpringUnsynced.GetConfigInt("UseSoundtrackHalloweenPostEvent", 0) == 1 then
		...
		-- Christmas --------------------------------------------------------------------------------------------------------------------
		if Spring.Utilities.Gametype.GetCurrentHolidays()["xmas"] and SpringUnsynced.GetConfigInt("UseSoundtrackXmas", 1) == 1 then
		...
		elseif (not Spring.Utilities.Gametype.GetCurrentHolidays()["xmas"]) and SpringUnsynced.GetConfigInt("UseSoundtrackXmasPostEvent", 0) == 1 then
