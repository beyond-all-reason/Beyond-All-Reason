...
local function ReloadMusicPlaylists()
	...
	if newSoundtrackEnabled then
		...
		-- April Fools --------------------------------------------------------------------------------------------------------------------
		if (Spring.Utilities.Gametype.IsHoliday()["aprilfools"] and Spring.GetConfigInt('UseSoundtrackAprilFools', 1) == 1) then
		...
		elseif ((not Spring.Utilities.Gametype.IsHoliday()["aprilfools"]) and Spring.GetConfigInt('UseSoundtrackAprilFoolsPostEvent', 0) == 1) then
		...
		-- Spooktober --------------------------------------------------------------------------------------------------------------------
		if (Spring.Utilities.Gametype.IsHoliday()["spooktober"] and Spring.GetConfigInt('UseSoundtrackSpooktober', 1) == 1) then
		...
		elseif ((not Spring.Utilities.Gametype.IsHoliday()["spooktober"]) and Spring.GetConfigInt('UseSoundtrackSpooktoberPostEvent', 0) == 1) then
		...
		-- Christmas --------------------------------------------------------------------------------------------------------------------
		if (Spring.Utilities.Gametype.IsHoliday()["xmas"] and Spring.GetConfigInt('UseSoundtrackXmas', 1) == 1) then
		...
		elseif ((not Spring.Utilities.Gametype.IsHoliday()["xmas"]) and Spring.GetConfigInt('UseSoundtrackXmasPostEvent', 0) == 1) then
	...
	if #interludeTracks > 1 then
		interludeTracksPlayCounter = math.random(#interludeTracks)
	else
...
function PlayNewTrack(paused)
	...
	elseif warMeter >= warLowLevel then
		if #eventWarLowTracks > 0 and songsSinceEvent > math.random(1,4) then
			...
			songsSinceEvent = 0
			if math.random() <= 0.5 and playInterlude == false then playInterlude = true else playInterlude = false end
		...
		if #eventPeaceTracks > 0 and songsSinceEvent > math.random(1,4) then
			...
			songsSinceEvent = 0
			if math.random() <= 0.75 and playInterlude == false then playInterlude = true else playInterlude = false end
		elseif #interludeTracks > 0 and playInterlude then
			currentTrackList = interludeTracks
			currentTrackListString = "interlude"
			playInterlude = false
