...
local function ReloadMusicPlaylists()
	...
	if newSoundtrackEnabled then
		...
		-- Spooktober --------------------------------------------------------------------------------------------------------------------
		if (Spring.Utilities.Gametype.GetCurrentHolidays()["spooktober"] and Spring.GetConfigInt('UseSoundtrackSpooktober', 1) == 1) then
		...
		elseif ((not Spring.Utilities.Gametype.GetCurrentHolidays()["spooktober"]) and Spring.GetConfigInt('UseSoundtrackSpooktoberPostEvent', 0) == 1) then
