...
local function ReloadMusicPlaylists()
	...
	if newSoundtrackEnabled then
		...
		elseif
			not Spring.Utilities.Gametype.GetCurrentHolidays()["aprilfools"]
		...
		-- Halloween --------------------------------------------------------------------------------------------------------------------
		if
			Spring.Utilities.Gametype.GetCurrentHolidays()["halloween"]
		...
		elseif
			not Spring.Utilities.Gametype.GetCurrentHolidays()["halloween"]
		...
		-- Christmas --------------------------------------------------------------------------------------------------------------------
		if
			Spring.Utilities.Gametype.GetCurrentHolidays()["xmas"]
		...
		elseif
			not Spring.Utilities.Gametype.GetCurrentHolidays()["xmas"]
