...
function widget:Initialize()
	...
	miscState.startX, _, miscState.startZ = Engine.Shared.GetTeamStartPosition(Spring.GetMyTeamID())
...
function widget:Update(dt)
	...
	if not gameHasStarted and not isMinimapMode then
		...
		if not isSpec and not interactionState.trackingPlayerID then
			local newX, _, newZ = Engine.Shared.GetTeamStartPosition(Spring.GetMyTeamID())
