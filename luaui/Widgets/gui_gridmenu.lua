...
local labGrids = {
	...
	coralab = {
		"corack", "corfast", "corspy", "corvoyr",							 -- T2 con, freaker, spy, radar bot
		"corspec", "corpyro", "corcan", "corhrk",							 -- jammer bot, pyro, can, dominator
		"cormort", "cortermite", "coraak", "corsktl",					 -- morty, termite, AA bot, skuttle
	}
}
local unitGrids = {
-- Commanders
