...
local function setActiveCommand(cmd, button, leftClick, rightClick)
	local didChangeCmd = button and SpringUnsynced.SetActiveCommand(cmd, button, leftClick, rightClick, SpringUnsynced.GetModKeyState())
		or SpringUnsynced.SetActiveCommand(cmd)
