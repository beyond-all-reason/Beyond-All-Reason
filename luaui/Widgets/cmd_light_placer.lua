...
local function placeAtPosition(worldX, worldZ)
	...
	elseif lp.mode == "scatter" then
		local positions =
			generateScatterPositions(worldX, worldZ, lp.radius, lp.lightCount, lp.shape, lp.rotation, lp.distribution)
