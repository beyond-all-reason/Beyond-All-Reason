...
function init()
	...
	options = {
		...
		{id="playerlistcollapse", group="ui", name="Playerlist auto collapses", type="bool", value=true, description='Auto collapses the playerlist, mouseover will show it again'},
