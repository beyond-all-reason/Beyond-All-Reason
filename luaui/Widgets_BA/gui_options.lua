...
function widget:Initialize()
  ...
  for name,data in pairs(widgetHandler.knownWidgets) do
	...
	options = {
		...
		{id="particles", name="Max particles", type="slider", min=2500, max=25000, value=tonumber(Spring.GetConfigInt("MaxParticles",1) or 1000), description=''},
		{id="nanoparticles", name="Max nano particles", type="slider", min=500, max=7000, value=tonumber(Spring.GetConfigInt("MaxNanoParticles",1) or 500), description=''},
