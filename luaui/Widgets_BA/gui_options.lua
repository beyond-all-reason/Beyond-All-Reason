...
function widget:Initialize()
  ...
  for name,data in pairs(widgetHandler.knownWidgets) do
	...
	options = {
		...
		{id="idlebuilders", widget="Idle Builders", name="Display idle builders", type="bool", value=widgetHandler.orderList["Idle Builders"] ~= nil and (widgetHandler.orderList["Idle Builders"] > 0), description='Displays a bar with a list of idle builder units if there are any'},
