...
function widget:DrawScreen()
	...
	if dlistResbar['metal'][1] and dlistResbar['metal'][2] and dlistResbar['metal'][3] then
		glCallList(dlistResbar['metal'][1])
		glCallList(dlistResbar['metal'][3])
		glCallList(dlistResbar['metal'][2])
	end

	if dlistResbar['energy'][1] and dlistResbar['energy'][2] and dlistResbar['energy'][3] then
