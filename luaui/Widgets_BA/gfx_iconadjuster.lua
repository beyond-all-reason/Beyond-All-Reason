...
function applyIcons()
    local icons = {
        ...
        {"chicken_queen.user", "LuaUI/Icons/queen.png", 5*iconScale},

        {"meteor.user", "LuaUI/Icons/meteor.png", 2.5*iconScale},
...
function widget:Initialize()
    applyIcons()
    WG['iconadjuster'] = {}
    WG['iconadjuster'].getScale = function()
        return iconScale
    end
    WG['iconadjuster'].setScale = function(value)
        iconScale = tonumber(value)
        applyIcons()
    end
end
...
function widget:GetConfigData(data)
    savedTable = {}
    savedTable.iconScale = iconScale
    return savedTable
end
