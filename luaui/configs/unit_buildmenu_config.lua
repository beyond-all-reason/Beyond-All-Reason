...
for unitDefID, unitDef in pairs(UnitDefs) do
	...
	if unitDef.name == 'armada_anemone' or unitDef.name == 'cordl' or unitDef.name == 'armada_cormorant' or unitDef.name == 'cortitan'	-- or unitDef.name == 'armbeaver' or unitDef.name == 'cormuskrat'
