...
return {
	...
	{ category = "ui.keybinds.camera.title", items = {
		...
		{ action = "moveforward", label = "ui.keybinds.camera.moveForward" },
		{ action = "moveback", label = "ui.keybinds.camera.moveBack" },
		{ action = "moveleft", label = "ui.keybinds.camera.moveLeft" },
		{ action = "moveright", label = "ui.keybinds.camera.moveRight" },
		{ action = "moveup", label = "ui.keybinds.camera.moveUp" },
		{ action = "movedown", label = "ui.keybinds.camera.moveDown" },
		{ action = "movefast", label = "ui.keybinds.camera.moveFast" },
		{ action = "moveslow", label = "ui.keybinds.camera.moveSlow" },
		{ action = "movereset", label = "ui.keybinds.camera.moveReset" },
		{ action = "moverotate", label = "ui.keybinds.camera.moveRotate" },
		{ action = "movetilt", label = "ui.keybinds.camera.moveTilt" },
		{ prefix = "set_camera_anchor ", label = "ui.keybinds.camera.setAnchor" },
		{ prefix = "focus_camera_anchor ", label = "ui.keybinds.camera.jumpAnchor" },
		{ action = "pip1_switch", label = "ui.keybinds.camera.pipSwitch" },
		{ action = "pip1_copy", label = "ui.keybinds.camera.pipCopy" },
		{ action = "pip1_track", label = "ui.keybinds.camera.pipTrack" },
		{ action = "fov_inc 5", label = "ui.keybinds.camera.fovIncrease" },
		{ action = "fov_dec 5", label = "ui.keybinds.camera.fovDecrease" },
	} },
	...
	{ category = "ui.keybinds.cameraModes.title", items = {
		...
		{ action = "togglecammode", label = "ui.keybinds.cameraModes.cycle" },
		{ action = "viewfps", label = "ui.keybinds.cameraModes.fps" },
		{ action = "viewta", label = "ui.keybinds.cameraModes.overhead" },
		{ action = "viewrot", label = "ui.keybinds.cameraModes.rotatable" },
		{ action = "viewfree", label = "ui.keybinds.cameraModes.free" },
		{ action = "track", label = "ui.keybinds.cameraModes.track" },
		{ action = "trackmode", label = "ui.keybinds.cameraModes.trackMode" },
	} },
	...
	{ category = "ui.keybinds.mapViews.title", items = {
		...
		{ action = "losradar", label = "ui.keybinds.mapViews.fogOfWar" },
	} },
	...
	{ category = "ui.keybinds.interfaceDisplay.title", items = {
		{ action = "options", label = "ui.keybinds.interfaceDisplay.settings" },
		{ action = "hideinterface", label = "ui.keybinds.cameraModes.interface" },
		{ action = "fullscreen", label = "ui.keybinds.cameraModes.fullscreen" },
		{ action = "unit_stats", label = "ui.keybinds.interfaceDisplay.unitStats" },
		{ action = "customgameinfo", label = "ui.keybinds.interfaceDisplay.gameInfo" },
		{ action = "savegame", label = "ui.keybinds.interfaceDisplay.saveGame" },
		{ action = "screenshot png", label = "ui.keybinds.interfaceDisplay.screenshot" },
		{ action = "luaui selector", label = "ui.keybinds.interfaceDisplay.widgetSelector" },
		{ action = "attack_range_inc", label = "ui.keybinds.interfaceDisplay.firingRange" },
	} },
	...
	{ category = "ui.keybinds.selection.title", items = {
		...
		{ action = "selectcomm append", label = "ui.keybinds.selection.commAppend" },
		{ action = "selectcomm focus", label = "ui.keybinds.selection.commFocus" },
		...
		{ action = "selectbox_any", label = "ui.keybinds.selection.boxAny" },
		{ action = "selectbox_append", label = "ui.keybinds.selection.boxAppend" },
		{ action = "selectbox_deselect", label = "ui.keybinds.selection.boxDeselect" },
		{ action = "selectbox_mobile", label = "ui.keybinds.selection.boxMobile" },
		{ action = "selectbox_idle", label = "ui.keybinds.selection.boxIdle" },
		{ action = "selectbox_same", label = "ui.keybinds.selection.boxSame" },
		{ action = "selectloop", label = "ui.keybinds.selection.loopActivate" },
		{ action = "selectloop_add", label = "ui.keybinds.selection.loopAdd" },
		{ action = "selectloop_invert", label = "ui.keybinds.selection.loopInvert" },
	} },
	...
	{ category = "ui.keybinds.controlGroups.title", items = {
		...
		{ prefix = "load_autogroup_preset ", label = "ui.keybinds.controlGroups.preset" },
	} },
	...
	{ category = "ui.keybinds.orders.title", items = {
		...
		{ action = "wait queued", label = "ui.keybinds.orders.waitQueued" },
		...
		{ action = "selfd queued", label = "ui.keybinds.orders.selfDestructQueued" },
	} },

	{ category = "ui.keybinds.moreOrders.title", items = {
		{ prefix = "areaattack", label = "ui.keybinds.moreOrders.areaAttack" },
		{ prefix = "guard", label = "ui.keybinds.moreOrders.guard" },
		{ prefix = "capture", label = "ui.keybinds.moreOrders.capture" },
		{ prefix = "restore", label = "ui.keybinds.moreOrders.restore" },
		{ prefix = "settargetnoground", label = "ui.keybinds.moreOrders.setTargetNoGround" },
		{ prefix = "loadunits", label = "ui.keybinds.moreOrders.loadUnits" },
		{ prefix = "unloadunits", label = "ui.keybinds.moreOrders.unloadUnits" },
		{ prefix = "gatherwait", label = "ui.keybinds.moreOrders.gatherWait" },
		{ prefix = "manuallaunch", label = "ui.keybinds.moreOrders.manualLaunch" },
		{ prefix = "stopproduction", label = "ui.keybinds.moreOrders.stopProduction" },
	} },
	...
	{ category = "ui.keybinds.queues.title", items = {
		...
		{ prefix = "command_skip_current", label = "ui.keybinds.queues.skipCurrent" },
		{ prefix = "command_cancel_last", label = "ui.keybinds.queues.cancelLast" },
	} },

	{ category = "ui.keybinds.unitStates.title", items = {
		{ action = "firestate 0", label = "ui.keybinds.unitStates.fireHold" },
		{ action = "firestate 1", label = "ui.keybinds.unitStates.fireReturn" },
		{ action = "firestate 2", label = "ui.keybinds.unitStates.fireAtWill" },
		{ action = "movestate 0", label = "ui.keybinds.unitStates.moveHold" },
		{ action = "movestate 1", label = "ui.keybinds.unitStates.moveManeuver" },
		{ action = "movestate 2", label = "ui.keybinds.unitStates.moveRoam" },
		{ action = "onoff", label = "ui.keybinds.unitStates.onoffToggle" },
		{ action = "onoff 0", label = "ui.keybinds.unitStates.onoffOff" },
		{ action = "onoff 1", label = "ui.keybinds.unitStates.onoffOn" },
		{ action = "repeat 0", label = "ui.keybinds.unitStates.repeatOff" },
		{ action = "repeat 1", label = "ui.keybinds.unitStates.repeatOn" },
		{ prefix = "trajectory_toggle ", label = "ui.keybinds.unitStates.trajectory" },
	} },

	{ category = "ui.keybinds.buildHotkeys.title", items = {
		{ action = "areamex", label = "ui.keybinds.buildHotkeys.areaMex" },
		{ prefix = "buildunit_", label = "ui.keybinds.buildHotkeys.unit", unit = true },
		...
		{ action = "buildsplit", label = "ui.keybinds.buildHotkeys.split" },
		{ prefix = "factoryqueuemode", label = "ui.keybinds.factory.queueMode" },
		{ prefix = "factory_preset load ", label = "ui.keybinds.factory.loadPreset" },
		{ prefix = "factory_preset save ", label = "ui.keybinds.factory.savePreset" },
		{ action = "factory_preset_show", label = "ui.keybinds.factory.showPresets" },
		{ prefix = "factoryguard ", label = "ui.keybinds.factory.guard" },
	...
	{ category = "ui.keybinds.gridMenu.title", items = {
		...
		{ prefix = "gridmenu_key", label = "ui.keybinds.gridMenu.buildKey" },
		{ prefix = "gridmenu_next_page", label = "ui.keybinds.gridMenu.nextPage" },
		{ prefix = "gridmenu_cycle_builder", label = "ui.keybinds.gridMenu.cycleBuilder" },
	} },

	{ category = "ui.keybinds.gameControl.title", items = {
		{ prefix = "increasespeed", label = "ui.keybinds.gameControl.increaseSpeed" },
		{ prefix = "decreasespeed", label = "ui.keybinds.gameControl.decreaseSpeed" },
		{ action = "pause", label = "ui.keybinds.console.pause" },
		{ action = "chain force forcestart | say !cv forcestart", label = "ui.keybinds.gameControl.voteForcestart" },
	} },

	{ category = "ui.keybinds.spectating.title", items = {
		{ prefix = "specteam ", label = "ui.keybinds.spectating.spectate" },
	} },

	{ category = "ui.keybinds.blueprints.title", items = {
		{ action = "blueprint_create", label = "ui.keybinds.blueprints.create" },
		{ action = "blueprint_place", label = "ui.keybinds.blueprints.place" },
		{ action = "blueprint_delete", label = "ui.keybinds.blueprints.delete" },
		{ action = "blueprint_next", label = "ui.keybinds.blueprints.next" },
		{ action = "blueprint_prev", label = "ui.keybinds.blueprints.prev" },
		{ prefix = "blueprint_" },
	} },
}
