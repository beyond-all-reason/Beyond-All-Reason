local labGrids = {
	...
	leglab = {
		...
		"legbal", "leglob", "legkark", "legcen",		-- balista, lobber, karkinos, centuar
		"", "", "corcrash",  							-- aa bot
	},
	...
	armalab = {
		...
		"armfido", "armsnipe", "armaak", "armfboy",			-- hound, sniper, AA bot, fatboy
		-- page2
		"armamph", "armsptk", "armspid", "armvader",		-- platypus, recluse, webber, tumbleweed
		"armdecom", "armscab", 								-- decoy com, antinuke
	},
	coralab = {
		-- page1
		...
		-- page2
		"coramph", "cortermite", "corsktl", "cordecom",		-- duck, termite, skuttle, decoy com
		"cormando",											-- commando
	},
	legalab = {
		-- page1
		"legack", "legaceb", "legstr", "corspy",			-- T2 con, proteus, strider, spy
		"corvoyr", "corspec", "legshot", "leginfestor",		-- radar bot, jammer bot, phalanx, infestor
		"legbart", "legsrail", "coraak", "leginc",			-- belcher, arquebus, AA bot, incinerator
		-- page2
		"coramph", "corhrk", "legsnapper", "corsktl",		-- amphbious bot, arbiter, snapper, skuttle
		"legdecom",	"", "", "", 							-- decoy com
	},

	-- T1 vehicle
	armvp = {
		"armcv", "armmlv", "armflash", "armfav",		-- T1 con, minelayer, blitz, scout
		"armstump", "armjanus", "armart", "",			-- stout, janus, shellshocker
		"armbeaver", "armpincer", "armsam", "",			-- amphib con, amphib tank, missile truck
	},
	corvp = {
		"corcv", "cormlv", "corgator", "corfav",		-- T1 con, minelayer, incisor, scout
		"corraid", "corlevlr", "corwolv", "",			-- brute, pounder, wolverine
	...
	legvp = {
		...
		"leghelios", "leggat", "legbar", ""				-- helios, decurion, barrage
		"legotter", "legamphtank", "legrail", "",		-- amphib con, amphib tank, railgun truck
	},

	-- T2 vehicle
	armavp = {
		"armacv", "armconsul", "armbull", "armmart",           -- T2 con, consul, bull, mauser
		"armseer", "armjam", "armmanni", "armst",              -- radar, jammer, starlight, gremlin
		"armlatnk", "armcroc", "armyork", "armmerl",           -- jaguar, turtle, AA truck, ambassador
	},
	coravp = {
		-- page1
		"coracv", "corban", "correap", "cormart",				-- T2 con, banisher, tiger, quaker
		"corvrad", "coreter", "corgol", "cortrem",				-- radar, jammer, tzar, tremor
		"corseal", "corparrow", "corsent", "corvroc",			-- salamander, poison arrow, AA, negotiator
		-- page2
		"cormabm", "corvac", "corphantom", "corsiegebreaker",	-- antinuke, printer(RCU), phantom(RCU), siegebreaker(RCU)
	},
	legavp = {
		-- page1
		...
		"legmrv", "legfloat", "legvflak", "legavroc",			-- Quickshot, triton, AA, boreas
		-- page2
		"legvcarry", "cormabm",	"", "",							-- mantis, antinuke
	},

	-- T1 air
	armap = {
		"armca", "armfig", "armkam", "armthund",		-- T1 con, fig, gunship, bomber
		"armpeep", "armatlas", "armhvytrans",			-- radar, light transport, heavy transport
	},
	corap = {
		"corca", "corveng", "corbw", "corshad",			-- T1 con, fig, drone, bomber
		"corfink", "corvalk", "corhvytrans",			-- radar, light transport, heavy transport
	},
    legap = {
		"legca", "legfig", "legmos", "legkam",			-- T1 con, fig/scout, gunship, flyingbomb
		"legcib", "legatrans", "corhvytrans",			-- junobomber, light transport, heavy transport
	},
	...
	coraap = {
		...
		"corcrw","corcrwh",										-- archaic dragon, dragon
	},
	legaap = {
	...
	-- T1 boats 
	armsy = {
		"armcs", "armrecl", "armdecade", "",			-- T1 sea con, rez sub, dolphin
		"armpship", "armroy", "", "",					-- frigate, destroyer, transport ("armtship",)
		"armsub", "", "armpt", 							-- sub, PT boat
	},
	corsy = {
		"corcs", "correcl", "coresupp", "",				-- T1 sea con, rez sub, supporter
	...
	armasy = {
		...
		-- page2
		"armdronecarry", 									-- drone carrier(RCU)
	},
	corasy = {
		-- page1
		...
		"corshark", "corssub", "corarch", "corfship",		-- sub killer, battlesub, AA, flamethrower ship
		-- page2
		"cordronecarry",									-- drone carrier(RCU)
	},

	-- amphibious labs
	armamsub = {
		"armbeaver", "armdecom", "armpincer", "",			-- amphibious con, decoy com, T1 amph tank
		"armcroc", "", "", "",								-- turtle
		"", "armjeth", "armaak",							-- T1 AA bot, T2 AA bot
	},
	coramsub = {
		"cormuskrat", "cordecom", "corgarp", "",			-- amphibious con, decoy com, T1 amph tank
		"corseal", "corparrow", "", "",						-- salamander, poison arrow
	...
	-- hover labs
	armhp = {
		"armch", "", "armsh", "",				-- T1 con, seeker
		"armanac", "armmh", "", "",				-- crocodile, possum
		"", "", "armah",						-- AA hover
	},
	corhp = {
		"corch", "", "corsh", "",				-- T1 con, goon
		"corsnap", "cormh", "corhal", "",		-- cayman, mangonel, halberd
		"", "", "corah",						-- AA hover
	},
	leghp = {
		"legch", "", "legsh", "",				-- T1 con, glaucus
	...
	corgant = {
		"corcat", "corkarg", "corshiva", "corkorg",		-- catapult, kargneth, shiva, juggernaut
...
local unitGrids = {
	...
	armcomlvl2 = {
		...
		},
		{
			...
			{ "armdl", "armguard", "armtl", "armfrock"},            -- coastal torp launcher, gauntlet, offshore torp launcher, floating HLT
		},
		{
			{ "armrad", "armeyes", "armdrag", },             		-- radar, perimeter camera, dragon's teeth
			{ "armfrad", "armfdrag", },                      		-- floating radar, shark's teeth
	...
	corcomlvl3 = {
		...
		},
		{
			...
			{ "cordl", "corpun", "cortl", "", },       				-- coastal torp launcher, agitator, offshore torp launcher, floating HLT
		},
		{
	...
	legcomlvl2 = {
		...
		},
		{
			...
			{ "legrl", "corfrt", "legrail", "legbar",},             -- basic AA, floating AA, lance, barrage
			{ "cordl", },                                    		-- coastal torp launcher
		},
		{
			{ "legrad", "legeyes", "legdrag", },             		-- radar, perimeter camera, dragon's teeth
	...
	legcomlvl4 = {
		...
		},
		{
			...
			{ "corsent", "legmed", "legmg", "legdtr", },       		-- aa vehicle, medusa, cacophony, dragon maw
   ...
   legck = {
	...
	armcv = {
		{
			{ "armmex", "armsolar", "armwin", "armadvsol", },  	-- mex, solar, wind, adv. solar
			{ "armmakr", "armgeo", "armamex", },               	-- T1 converter, geo, twilight
			{ "armestor", "armmstor", },                       	-- e storage, m storage
		},
		{
			{ "armllt", "armbeamer", "armhlt", "armclaw", },  	-- LLT, beamer, HLT, lightning turret
			{ "armrl", "armferret", "armcir", },              	-- basic AA, ferret, chainsaw
	...
	corcv = {
		{
			{ "cormex", "corsolar", "corwin", "coradvsol", },   -- mex, solar, wind, adv. solar
			{ "cormakr", "corgeo", "corexp", },                 -- T1 converter, geo, exploiter
			{ "corestor", "cormstor", },                        -- e storage, m storage
		},
		{
			{ "corllt", "corhllt", "corhlt", "cormaw", },     	-- LLT, Double LLT, HLT, flame turret
			{ "corrl", "cormadsam", "corerad", },             	-- basic AA, SAM, eradicator
    ...
    legcv = {
		{
			{ "legmex", "legsolar", "legwin", "legadvsol", },   -- mex, solar, wind, adv. solar
			{ "legeconv", "leggeo", "legmext15", },             -- T1 converter, geo, T1.5 legion mex
			{ "legestor", "legmstor", },                        -- e storage, m storage
		},
		{
			{ "leglht", "legmg", "leghive", "legdtr", },     	-- LLT, machine gun, hive, riot turret
			{ "legrl", "legrhapsis", "leglupara", },          	-- basic AA, rhapsis, T1.5 flak
	...
	armcs = {
		...
		},
		{
			...
			{ "armfrt", },                                    -- floating AA
			{ "armdl", "armguard", },              			  -- coastal torp launcher, gauntlet, lightning turret
		},
		{
	...
	corcs = {
		...
		},
		{
			...
			{ "corfrt", },                                    -- floating AA
			{ "cordl", "corpun", },                 		  -- coastal torp launcher, agitator, flame turret
		},
		{
	...
	legch = {
		...
		{
			{ "leglab", "legvp", "legap", "corsy", },				-- bot lab, veh lab, air lab, shipyard
			{ "legnanotc", "legavp", "legnanotcplat", "corasy", },	-- nano, T2 veh lab, floating nano, T2 shipyard
	...
	armack = {
		...
		},
		{
			...
			{ "armbrtha", "armvulc", "armsilo", },              				-- LRPC, lolcannon, ICBM
		},
		{
	...
	corack = {
		...
		},
		{
			...
			{ "corint", "corbuzz", "corsilo", },                				-- LRPC, lolcannon, ICBM
		},
		{
	...
	legack = {
		...
		{
			{ "legbombard", "legbastion", "legacluster", "legperdition", },   	-- pop-up gauss, heavy defence, pop-up artillery, napalm missle
	...
	coracv = {
		...
		},
		{
			{ "corvipe", "cordoom", "cortoast", "cortron", },   				-- pop-up gauss, DDM, pop-up artillery, tac nuke
			{ "corflak", "corscreamer", "corfmd", "corbhmth", }, 				-- flak, long-range AA, anti-nuke, cerberus
			{ "leglrpc", "corbuzz", "corsilo", },                				-- LRPC, lolcannon, ICBM
		},
		{
			{ "corarad", "cortarg", "corfort", "corshroud", },  				-- adv radar, targeting facility, wall, adv jammer
			{ "corsd", "", "corasp" },                          				-- intrusion counter, air repair pad
	...
	legaca = {
		...
		},
		{
			{ "legbombard", "legbastion", "legacluster", "legperdition", },   	-- pop-up gauss, heavy defence, pop-up artillery, napalm missle
			{ "legflak", "leglraa", "legabm", "legrampart", }, 					-- flak, long-range AA, anti-nuke, rampart
			{ "corint", "legstarfall", "legsilo", },                			-- LRPC, lolcannon, ICBM
		},
		{
			{ "corarad", "cortarg", "legforti", "corshroud", },  				-- adv radar, targeting facility, wall, adv jammer
			{ "corsd", "", "corasp", "corfasp" },               				-- intrusion counter, air repair pad, floating air repair pad
