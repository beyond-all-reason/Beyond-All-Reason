...
local unitDefLights = {
	...
	[UnitDefNames['armham'].id] = {
		body = {
			lightType = 'point',
			pieceName = 'torso',
			lightConfig = { posx = 0, posy = 5, posz = 0, radius = 23,
							color2r = 1, color2g = 1, color2b = 0.5, colortime = 0,
							r = 1, g = 1, b = 0.33, a = 0.17,
	...
	[UnitDefNames['armrectr'].id] = {
		backpack = {
			lightType = 'point',
			pieceName = 'pelvis',
			lightConfig = { posx = 0, posy = 19, posz = -8, radius = 19,
							color2r = 1, color2g = 1, color2b = 0.5, colortime = 0,
							r = 1, g = 1, b = 0.4, a = 0.18,
							modelfactor = 0.4, specular = 0.4, scattering = 1.2, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
		nanolight = {
			lightType = 'point',
	...
	[UnitDefNames['armcom'].id] = {
		...
		eyes = {
			...
			lightConfig = { posx = 0, posy = 1, posz = 6.5, radius = 11,
							color2r = 0.6, color2g = 0.6, color2b = 0.2, colortime = 60,
	...
	[UnitDefNames['corcom'].id] = {
		...
		eyes = {
			...
			lightConfig = { posx = 0, posy = 3.5, posz = 6.3, radius = 10,
							color2r = 0.66, color2g = 0.15, color2b = 0.15, colortime = 60,
							r = 1, g = 0.25, b = 0.25, a = 0.17,
	...
	[UnitDefNames['corak'].id] = {
		eyes1 = {
			lightType = 'point',
			pieceName = 'torso',
			lightConfig = { posx = -2.8, posy = 8.4, posz = 8.9, radius = 13,
							color2r = 0.66, color2g = 0.15, color2b = 0.15, colortime = 60,
	...
	[UnitDefNames['corpyro'].id] = {
		flamelight = {
			...
			lightConfig = { posx = 0, posy = -1.4, posz = 15, radius = 28,
				...
				r = 0.95, g = 0.66, b = 0.07, a = 0.12,
				modelfactor = 0.4, specular = 0.8, scattering = 2, lensflare = 0,
				lifetime = 0, sustain = 0, animtype = 0},
		},
		backpack = {
			lightType = 'point',
	...
	[UnitDefNames['corsumo'].id] = {
		eyes = {
			lightType = 'point',
			pieceName = 'torso',
			lightConfig = { posx = 0, posy = 10.5, posz = 19, radius = 16,
							color2r = 1, color2g = 0.2, color2b = 0.2, colortime = 0,
