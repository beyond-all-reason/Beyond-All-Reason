...
local unitDefLights = {
	...
	[UnitDefNames['armstump'].id] = {
		...
		backpack = {
			...
			lightConfig = { posx = 0, posy = 2, posz = -6.5, radius = 19,
							...
							modelfactor = 0.2, specular = 0.4, scattering = 0.75, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
	},
	...
	[UnitDefNames['corcom'].id] = {
		...
		backpack1 = {
			...
			lightConfig = { posx = 0, posy = 1, posz = 0, radius = 22,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.75, a = 0.22,
							modelfactor = 0.15, specular = 0.5, scattering = 0.5, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
		backpack2 = {
			lightType = 'point',
	...
	[UnitDefNames['corpyro'].id] = {
		...
		backpack = {
			lightType = 'point',
			pieceName = 'backpack',
			lightConfig = { posx = 0, posy = 5, posz = -4, radius = 27,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
