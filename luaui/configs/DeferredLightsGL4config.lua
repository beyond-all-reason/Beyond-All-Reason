...
local unitDefLights = {
	...
	[UnitDefNames['corsolar'].id] = {
		light_small_1 = {
			lightType = 'point',
			pieceName = 'base',
			lightConfig = { posx = -10.5, posy = 6, posz = 34.5, radius = 19,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
		...
		light_small_5 = {
			lightType = 'point',
			pieceName = 'base',
			lightConfig = { posx = 34.5, posy = 6, posz = -10.5, radius = 19,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.5, a = 0.05,
							modelfactor = 0.3, specular = 0.5, scattering = 0.4, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		...
		light_large_1 = {
			lightType = 'point',
			pieceName = 'base',
			lightConfig = { posx = -21, posy = 6, posz = 30, radius = 25,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.5, a = 0.05,
							modelfactor = 0.3, specular = 0.5, scattering = 0.4, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		...
		light_large_5 = {
			lightType = 'point',
			pieceName = 'base',
			lightConfig = { posx = -30.2, posy = 6, posz = 20.7, radius = 25,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.5, a = 0.05,
							modelfactor = 0.3, specular = 0.5, scattering = 0.4, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
