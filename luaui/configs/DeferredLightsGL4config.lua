...
local unitDefLights = {
	...
	[UnitDefNames['armstump'].id] = {
		...
		front = {
			lightType = 'point',
			pieceName = 'turret',
			lightConfig = { posx = 0, posy = 3.5, posz = 8.5, radius = 10,
							color2r = 1, color2g = 1, color2b = 1, colortime = 0,
							r = 0.75, g = 0.75, b = 1, a = 0.1,
							modelfactor = 0.25, specular = 0.4, scattering = 1, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
		backpack = {
	...
	[UnitDefNames['corpyro'].id] = {
		flamelight = {
			lightType = 'point',
			pieceName = 'lloarm',
			lightConfig = { posx = 0, posy = -1.4, posz = 15, radius = 26,
		...
		backpack = {
			lightType = 'point',
			pieceName = 'backpack',
			lightConfig = { posx = 0, posy = 4, posz = -4, radius = 23,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.75, a = 0.13,
