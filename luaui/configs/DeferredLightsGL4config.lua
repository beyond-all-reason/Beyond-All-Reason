...
local unitDefLights = {
	...
	[UnitDefNames['armbeamer'].id] = {
		searchlightllt = {
			lightType = 'point',
				pieceName = 'barrel',
				lightConfig = { posx = 0, posy = 0, posz = 6, radius = 14,
				color2r = 0, color2g = 0.15, color2b = 1.5, colortime = 0,
				r = 0, g = 0.15, b = 1.3, a = 1,
				modelfactor = 1, specular = 1, scattering = 0.4, lensflare = 10,
				lifetime = 0, sustain = 0, animtype = 0},
		},
	},
	...
	[UnitDefNames['armamd'].id] = {
		readylightamd = {
			...
			lightConfig = { posx = 0, posy = 1, posz = 0, radius = 22,
				...
				r = 2, g = 1, b = 0, a = 1,
				modelfactor = 1, specular = 1, scattering = 0.4, lensflare = 6,
				lifetime = 0, sustain = 0, animtype = 0},
		},
	},
	...
	[UnitDefNames['armuwadves'].id] = {
		light1 = {
			lightType = 'point',
			pieceName = 'emit1',
			lightConfig = { posx = 0, posy = 0, posz = 0, radius = 42,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.3, a = 0.4,
							modelfactor = 0.1, specular = 0.5, scattering = 0.7, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
