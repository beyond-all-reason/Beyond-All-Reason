...
local unitDefLights = {
	...
	[UnitDefNames['armcom'].id] = {
		...
		shoulder1 = {
			...
			lightConfig = { posx = -1.5, posy = 2, posz = 0, radius = 10,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 0.95, b = 0.55, a = 0.1,
		...
		eyes = {
			lightType = 'point',
			pieceName = 'head',
			lightConfig = { posx = 0, posy = 1, posz = 6.8, radius = 14,
							color2r = 1, color2g = 0, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.4, a = 0.22,
							modelfactor = 0.15, specular = 0.5, scattering = 0.7, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
		arm1 = {
	...
	[UnitDefNames['corcom'].id] = {
		...
		backpack1 = {
			lightType = 'point',
			pieceName = 'emit1',
			lightConfig = { posx = 0, posy = 1.5, posz = 0, radius = 22,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
							r = 1, g = 1, b = 0.75, a = 0.24,
		...
		eyes = {
			lightType = 'point',
			pieceName = 'head',
			lightConfig = { posx = 0, posy = 3.5, posz = 6.4, radius = 13,
							color2r = 1, color2g = 0, color2b = 0, colortime = 0,
							r = 1, g = 0.4, b = 0.4, a = 0.17,
							modelfactor = 0.15, specular = 0.5, scattering = 0.6, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
		nanolight = {
