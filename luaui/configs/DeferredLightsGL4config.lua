...
local unitDefLights = {
	...
	[UnitDefNames['corpyro'].id] = {
		...
		eyes = {
			lightType = 'point',
			pieceName = 'head',
			lightConfig = { posx = 0, posy = 2.8, posz = 4.8, radius = 8,
							color2r = 1, color2g = 0.2, color2b = 0.2, colortime = 0,
							r = 1, g = 0.2, b = 0.2, a = 0.33,
							modelfactor = 0.15, specular = 0.5, scattering = 1.3, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
	},
	[UnitDefNames['corsumo'].id] = {
		eyes = {
			...
			lightConfig = { posx = 0, posy = 10.5, posz = 19, radius = 16,
							...
							modelfactor = 0.25, specular = 0.5, scattering = 1.3, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
	},
	[UnitDefNames['cormort'].id] = {
		...
		top1 = {
			lightType = 'point',
			pieceName = 'head',
			lightConfig = { posx = -4.3, posy = 6.5, posz = -9, radius = 9,
							color2r = 1, color2g = 0.2, color2b = 0.2, colortime = 0,
							r = 1, g = 0.2, b = 0.2, a = 0.16,
							modelfactor = 0.25, specular = 0.5, scattering = 0.9, lensflare = 0,
							lifetime = 0, sustain = 0, animtype = 0},
		},
		top2 = {
