...
local unitDefLights = {
	...
	[UnitDefNames['armflash'].id] = {
		back1 = {
			lightType = 'point',
			pieceName = 'base',
			lightConfig = { posx = -6, posy = 4.7, posz = -16, radius = 15,
	...
	[UnitDefNames['armfav'].id] = {
		light = {
			lightType = 'point',
			pieceName = 'base',
			lightConfig = { posx = 0, posy = 11.6, posz = -12, radius = 12,
							color2r = 1, color2g = 1, color2b = 0, colortime = 0,
