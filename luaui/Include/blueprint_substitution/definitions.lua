...
function DefinitionsModule.defineUnitCategories()
    ...
    DefCat("UW_ADVANCED_METAL_STORAGE", {[SIDES.ARM]="armuwmmm", [SIDES.CORE]="coruwmmm", [SIDES.LEGION]="coruwmmm"})
    ...
    DefCat("UW_ADVANCED_ENERGY_CONVERTER", {[SIDES.ARM]="armuwadvms", [SIDES.CORE]="coruwadvms", [SIDES.LEGION]="coruwadvms"})
    ...
    DefCat("UW_EXPIREMENTAL_GANTRY", {[SIDES.ARM]="armshltxuw", [SIDES.CORE]="corgantuw", [SIDES.LEGION]="corgantuw"})
    ...
    DefCat("NANO_TOWER", {[SIDES.ARM]="armnanotc", [SIDES.CORE]="cornanotc", [SIDES.LEGION]="cornanotc"})
    DefCat("FLOATING_NANO_TOWER", {[SIDES.ARM]="armnanotcplat", [SIDES.CORE]="cornanotcplat", [SIDES.LEGION]="cornanotcplat"})
