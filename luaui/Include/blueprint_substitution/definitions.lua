...
local function DefCat(enumKey, unitTable) -- Made local to definitions.lua
	if DefinitionsModule.UNIT_CATEGORIES[enumKey] then
		...
		Engine.Shared.Log("BlueprintDefs", LOG.ERROR, errorMsg)
	end
...
function DefinitionsModule.defineUnitCategories()
	Engine.Shared.Log("BlueprintDefs", LOG.DEBUG, "Defining static unit categories START...")
	...
	DefCat("ADVANCED_ENERGY_CONVERTER", { [SIDES.ARMADA] = "armmmkr", [SIDES.CORTEX] = "cormmkr", [SIDES.LEGION] = "legadveconv" })
	DefCat("UW_ADVANCED_ENERGY_CONVERTER", { [SIDES.ARMADA] = "armuwmmm", [SIDES.CORTEX] = "coruwmmm", [SIDES.LEGION] = "leganavaleconv" })
	...
	DefCat("AMPHIBIOUS_COMPLEX", { [SIDES.ARMADA] = "armamsub", [SIDES.CORTEX] = "coramsub", [SIDES.LEGION] = "legamphlab" })
	DefCat("EXPIREMENTAL_GANTRY", { [SIDES.ARMADA] = "armshltx", [SIDES.CORTEX] = "corgant", [SIDES.LEGION] = "leggant" })
	DefCat("UW_EXPIREMENTAL_GANTRY", { [SIDES.ARMADA] = "armshltxuw", [SIDES.CORTEX] = "corgantuw", [SIDES.LEGION] = "leggantuw" })
	...
	DefCat("FLOATING_FLAK", { [SIDES.ARMADA] = "armfflak", [SIDES.CORTEX] = "corenaa", [SIDES.LEGION] = "leganavalaaturret" })
	...
	DefCat("ADV_FLOATING_ANNIHILATOR", { [SIDES.ARMADA] = "armkraken", [SIDES.CORTEX] = "corfdoom", [SIDES.LEGION] = "leganavaldefturret" })
	...
	DefCat("FLOATING_PINPOINTER", { [SIDES.ARMADA] = "armfatf", [SIDES.CORTEX] = "corfatf", [SIDES.LEGION] = "leganavalpinpointer" })
	DefCat("FLOATING_TORPEDO_LAUNCHER_PG", { [SIDES.ARMADA] = "armtl", [SIDES.CORTEX] = "cortl", [SIDES.LEGION] = "legtl" })
	...
	DefCat("FLOATING_DRAGONSTEETH_PG", { [SIDES.ARMADA] = "armfdrag", [SIDES.CORTEX] = "corfdrag", [SIDES.LEGION] = "legfdrag" })
	...
	Engine.Shared.Log("BlueprintDefs", LOG.DEBUG, string.format("Defined %d categories covering %d units. END", categoryCount, unitCount))
end
