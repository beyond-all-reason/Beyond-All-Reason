...
local function DefCat(enumKey, unitTable) -- Made local to definitions.lua
	if DefinitionsModule.UNIT_CATEGORIES[enumKey] then
		local errorMsg = string.format(
			"[BlueprintDefinitions ERROR] Duplicate category key definition attempted: '%s'. The previous definition will be overwritten.",
			enumKey
		)
...
function DefinitionsModule.defineUnitCategories()
	...
	for k in pairs(DefinitionsModule.UNIT_CATEGORIES) do
		DefinitionsModule.UNIT_CATEGORIES[k] = nil
	end
	for k in pairs(DefinitionsModule.categoryUnits) do
		DefinitionsModule.categoryUnits[k] = nil
	end
	for k in pairs(DefinitionsModule.unitCategories) do
		DefinitionsModule.unitCategories[k] = nil
	end
	...
	DefCat(
		"ADVANCED_METAL_STORAGE",
		{ [SIDES.ARMADA] = "armuwadvms", [SIDES.CORTEX] = "coramstor", [SIDES.LEGION] = "legamstor" }
	)
	DefCat(
		"UW_METAL_STORAGE",
		{ [SIDES.ARMADA] = "armuwms", [SIDES.CORTEX] = "coruwms", [SIDES.LEGION] = "leguwmstore" }
	)
	DefCat(
	...
	DefCat(
		...
		{ [SIDES.ARMADA] = "armmmkr", [SIDES.CORTEX] = "cormmkr", [SIDES.LEGION] = "legadveconv" }
	)
	DefCat(
		"UW_ADVANCED_ENERGY_CONVERTER",
		{ [SIDES.ARMADA] = "armuwmmm", [SIDES.CORTEX] = "coruwmmm", [SIDES.LEGION] = "leganavaleconv" }
	)
	DefCat(
		"ADVANCED_SOLAR",
		{ [SIDES.ARMADA] = "armadvsol", [SIDES.CORTEX] = "coradvsol", [SIDES.LEGION] = "legadvsol" }
	)
	...
	DefCat(
		"AMPHIBIOUS_COMPLEX",
		{ [SIDES.ARMADA] = "armamsub", [SIDES.CORTEX] = "coramsub", [SIDES.LEGION] = "legamphlab" }
	)
	DefCat(
		"EXPIREMENTAL_GANTRY",
		{ [SIDES.ARMADA] = "armshltx", [SIDES.CORTEX] = "corgant", [SIDES.LEGION] = "leggant" }
	)
	DefCat(
		"UW_EXPIREMENTAL_GANTRY",
		{ [SIDES.ARMADA] = "armshltxuw", [SIDES.CORTEX] = "corgantuw", [SIDES.LEGION] = "leggantuw" }
	)
	DefCat("SEAPLANE_PLATFORM", { [SIDES.ARMADA] = "armplat", [SIDES.CORTEX] = "corplat", [SIDES.LEGION] = "legsplab" })
	...
	DefCat(
		"POPUP_AREA_DEFENSE",
		{ [SIDES.ARMADA] = "armpb", [SIDES.CORTEX] = "corvipe", [SIDES.LEGION] = "legbombard" }
	)
	DefCat(
		"POPUP_AIR_DEFENSE",
		{ [SIDES.ARMADA] = "armferret", [SIDES.CORTEX] = "corerad", [SIDES.LEGION] = "leglupara" }
	)
	DefCat("FLAK", { [SIDES.ARMADA] = "armflak", [SIDES.CORTEX] = "corflak", [SIDES.LEGION] = "legflak" })
	DefCat(
		"FLOATING_FLAK",
		{ [SIDES.ARMADA] = "armfflak", [SIDES.CORTEX] = "corenaa", [SIDES.LEGION] = "leganavalaaturret" }
	)
	DefCat(
	...
	DefCat(
		...
		{ [SIDES.ARMADA] = "armbrtha", [SIDES.CORTEX] = "corint", [SIDES.LEGION] = "leglrpc" }
	)
	DefCat(
		"RAPID_FIRE_LONG_RANGE_PLASMA_CANNON",
		{ [SIDES.ARMADA] = "armvulc", [SIDES.CORTEX] = "corbuzz", [SIDES.LEGION] = "legstarfall" }
	)
	DefCat("ANNIHILATOR", { [SIDES.ARMADA] = "armanni", [SIDES.CORTEX] = "cordoom", [SIDES.LEGION] = "legbastion" })
	DefCat(
		"ADV_FLOATING_ANNIHILATOR",
		{ [SIDES.ARMADA] = "armkraken", [SIDES.CORTEX] = "corfdoom", [SIDES.LEGION] = "leganavaldefturret" }
	)
	DefCat(
		"ADVANCED_PLASMA_ARTILLERY",
		{ [SIDES.ARMADA] = "armamb", [SIDES.CORTEX] = "cortoast", [SIDES.LEGION] = "legacluster" }
	)
	DefCat("DRAGONS_CLAW", { [SIDES.ARMADA] = "armclaw", [SIDES.CORTEX] = "cormaw", [SIDES.LEGION] = "legdtr" })
	DefCat("DRAGONS_TEETH", { [SIDES.ARMADA] = "armdrag", [SIDES.CORTEX] = "cordrag", [SIDES.LEGION] = "legdrag" })
	DefCat(
		"ADVANCED_DRAGONS_TEETH",
		{ [SIDES.ARMADA] = "armfort", [SIDES.CORTEX] = "corfort", [SIDES.LEGION] = "legforti" }
	)
	DefCat("SHIELD", { [SIDES.ARMADA] = "armgate", [SIDES.CORTEX] = "corgate", [SIDES.LEGION] = "legdeflector" })
	DefCat(
		"MEDIUM_RANGE_MISSILE",
		{ [SIDES.ARMADA] = "armemp", [SIDES.CORTEX] = "cortron", [SIDES.LEGION] = "legperdition" }
	)
	...
	DefCat(
		"FLOATING_NANO_TOWER",
		{ [SIDES.ARMADA] = "armnanotcplat", [SIDES.CORTEX] = "cornanotcplat", [SIDES.LEGION] = "legnanotcplat" }
	)
	DefCat(
		"ADV_NANO_TOWER",
		{ [SIDES.ARMADA] = "armnanotct2", [SIDES.CORTEX] = "cornanotct2", [SIDES.LEGION] = "legnanotct2" }
	)
	...
	DefCat(
		"FLOATING_PINPOINTER",
		{ [SIDES.ARMADA] = "armfatf", [SIDES.CORTEX] = "corfatf", [SIDES.LEGION] = "leganavalpinpointer" }
	)
	DefCat(
		"FLOATING_TORPEDO_LAUNCHER_PG",
		{ [SIDES.ARMADA] = "armtl", [SIDES.CORTEX] = "cortl", [SIDES.LEGION] = "legtl" }
	)
	...
	DefCat(
		...
		{ [SIDES.ARMADA] = "armfdrag", [SIDES.CORTEX] = "corfdrag", [SIDES.LEGION] = "legfdrag" }
	)
	DefCat(
		"FLOATING_HOVER_PLATFORM_PG",
		{ [SIDES.ARMADA] = "armfhp", [SIDES.CORTEX] = "corfhp", [SIDES.LEGION] = "legfhp" }
	)
	...
	for _ in pairs(DefinitionsModule.UNIT_CATEGORIES) do
		categoryCount = categoryCount + 1
	end
	Spring.Log(
		"BlueprintDefs",
		LOG.DEBUG,
		string.format("Defined %d categories covering %d units. END", categoryCount, unitCount)
	)
end
