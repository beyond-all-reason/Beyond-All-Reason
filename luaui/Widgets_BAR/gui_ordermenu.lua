...
function drawOrders()
	...
	-- background
	RectRound(backgroundRect[1], backgroundRect[2], backgroundRect[3], backgroundRect[4], bgpadding * 1.6, 1, 1, ((posY-height > 0 or posX <= 0) and 1 or 0), (posY-height > 0 and 1 or 0), { 0.05, 0.05, 0.05, ui_opacity }, { 0, 0, 0, ui_opacity })
