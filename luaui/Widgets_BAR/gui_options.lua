...
function init()
	...
	options = {
		...
		{id="allycursors_spectatorname", group="ui",  name=widgetOptionColor.."   show spectator name", type="bool", value=true, description='Shows the spectator name next to the cursor',
		...
		{id="allycursors_lights", basic=true, group="ui", name=widgetOptionColor.."   lights (non-specs)", type="bool", value=true, description='Adds a colored light to every ally cursor',
		...
		{id="allycursors_lightradius", group="ui", name=widgetOptionColor.."      radius", type="slider", min=0.15, max=1, step=0.05, value=0.55, description='',
