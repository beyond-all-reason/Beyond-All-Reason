...
function init()
	...
	options = {
		...
		{id="healthbarsvariable", group="ui", name=widgetOptionColor.."   variable sizes", type="bool", value=(WG['healthbar']~=nil and WG['healthbar'].getVariableSizes()), description='Increases healthbar sizes for bigger units',
		 onload = function(i) loadWidgetData("Health Bars", "healthbarsvariable", {'variableBarSizes'}) end,
		 onchange = function(i, value) saveOptionValue('Health Bars', 'healthbars', 'setVariableSizes', {'variableBarSizes'}, value) end,
		},
