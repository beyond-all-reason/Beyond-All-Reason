...
function DrawPicList()
  ...
  RectRound(backgroundDimentions[1]+borderPadding, backgroundDimentions[2]+borderPadding, backgroundDimentions[3]-borderPadding, backgroundDimentions[4]-borderPadding, usedIconSizeX / 12, 1,1,1,1, {0.15,0.15,0.15,ui_opacity*0.1}, {1,1,1,ui_opacity*0.1})
