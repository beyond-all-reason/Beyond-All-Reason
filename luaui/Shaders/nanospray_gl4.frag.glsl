...
uniform sampler2D nanoParticleTexture;
out vec4 fragColor;
...
void main(void)
{
	...
	texcolor = texture(nanoParticleTexture, g_uv.xy);
	fragColor = g_color * texcolor;
		
	
	#if 0
		//Textureless, pure fragment shader way of making it similar to old nanos
