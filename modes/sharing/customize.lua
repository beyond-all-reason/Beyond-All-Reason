...
return {
    ...
    allowRanked = true,
    -- Non-sticky: keeps the current mode's values; the entries below only expose and
    -- unlock the options (their values are defaults, ignored by the lobby). Display order
    -- follows modoptions.lua.
    retainValues = true,
    modOptions = {
