...
local modrules = {
	...
	system = {
		...
		nativeExcessSharing = false, -- default: true.  The transfer module's resource controller redistributes overflow (waterfill, taxed) through the ResourceExcess callin; the engine's own excess sharing must stay off or both would move resources.
	},
