-- genericbuildingexplosion-small-white
-- genericbuildingexplosion-large-white
-- genericbuildingexplosion-medium-white
-- genericbuildingexplosion-huge-white
  ...
  ["genericbuildingexplosion-small-white"] = {
	...
	explosionwave = {
      ...
      properties = {
        airdrag            = 0.87,
        alwaysvisible      = true,
        colormap           = [[1 1 1 0.05	0 0 0 0.0]], -- same as groundflash colors
        directional        = false,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0, 0, 0]],
