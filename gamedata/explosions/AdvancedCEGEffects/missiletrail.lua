...
return {
  ...
  ["missiletrailfighter"] = {
    ...
    glow = {
      ...
      water              = true,
      properties = {
        colormap           = [[0.08 0.042 0.008 0.004   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[trans]],
        length             = 41,
    ...
    trail = {
      ...
      water              = true,
      properties = {
        colormap           = [[0.01 0.01 0.01 0.18   0.1 0.085 0.065 0.3   0.1 0.075 0.06 0.25   0.07 0.065 0.055 0.2   0.05 0.05 0.05 0.16   0.05 0.05 0.05 0.12    0.03 0.03 0.03 0.07    0 0 0 0]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[trans]],
        length             = 30,
  ...
  ["missiletrailflashy"] = {		-- used for aa
    ...
    fire = {
      ...
      properties = {
        airdrag            = 0.4,
        alwaysvisible      = true,
        colormap           = [[0.8 0.5 0.1 0.44   0.66 0.22 0.07 0.7  0.2 0.1 0.05 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    trail1 = {
      ...
      properties = {
        airdrag            = 0.55,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.03 0.12   0.07 0.07 0.07 0.14   0.075 0.075 0.075 0.1    0.045 0.045 0.045 0.05    0 0 0 0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    trail2 = {
      ...
      properties = {
        airdrag            = 0.55,
        alwaysvisible      = true,
        colormap           = [[0.012 0.012 0.012 0.1  0.07 0.07 0.07 0.11   0.05 0.05 0.05 0.08   0 0 0 0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 4,
        emitvector         = [[0, 1, 0]],
