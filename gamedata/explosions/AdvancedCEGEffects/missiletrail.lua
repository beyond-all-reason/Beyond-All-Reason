  ...
  ["missiletrailtiny"] = {
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.60,
        alwaysvisible      = true,
        colormap           = [[0.8 0.6 0.2 0.4   0.9 0.58 0.15 0.7    0.56 0.24 0 0.5    0.2 0.08 0 0.35	    0.11 0.013 0 0.18   0.05 0.003 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    exhale = {
      ...
      properties = {
        airdrag            = 0.60,
        alwaysvisible      = true,
        colormap           = [[0.04 0.04 0.04 0.1   0.1 0.1 0.1 0.19   0.07 0.07 0.07 0.12    0.042 0.042 0.042 0.06    0 0 0 0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    exhale2 = {
      ...
      properties = {
        airdrag            = 0.6,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.03 0  0.06 0.06 0.06 0.13   0.05 0.05 0.05 0.09   0 0 0 0]],
        directional        = true,
        emitrot            = 4,
        emitrotspread      = 4,
        emitvector         = [[0, 1, 0]],
  ...
  ["missiletrailsmall"] = {
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.60,
        alwaysvisible      = true,
        colormap           = [[0.44 0.33 0.25 0.2   0.44 0.25 0 0.24    0.17 0.05 0 0.16    0.07 0.01 0 0.09	   0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    exhale = {
      ...
      properties = {
        airdrag            = 0.66,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.03 0.11   0.07 0.07 0.07 0.16   0.05 0.05 0.05 0.09    0.02 0.02 0.02 0.04    0 0 0 0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
    ...
    exhale2 = {
      ...
      properties = {
        airdrag            = 0.66,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.04 0  0.06 0.06 0.06 0.1   0.05 0.05 0.05 0.07   0 0 0 0]],
        directional        = true,
        emitrot            = 4,
        emitrotspread      = 4,
        emitvector         = [[0, 0.8, 0]],
