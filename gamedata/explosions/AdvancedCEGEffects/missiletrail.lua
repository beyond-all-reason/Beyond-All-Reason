  ...
  ["missiletrailtiny"] = {
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.60,
        alwaysvisible      = true,
        colormap           = [[0.9 0.75 0.4 0.4   0.95 0.8 0.33 0.7    0.7 0.48 0.26 0.5    0.44 0.3 0.15 0.35	    0.12 0.09 0 0.18   0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
  ...
  ["missiletrailsmall"] = {
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.60,
        alwaysvisible      = true,
        colormap           = [[0.45 0.38 0.26 0.2   0.45 0.33 0.035 0.24    0.22 0.08 0.01 0.16    0.1 0.025 0 0.09	   0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    exhale = {
      ...
      properties = {
        airdrag            = 0.66,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.03 0.11   0.07 0.07 0.07 0.18   0.05 0.05 0.05 0.11    0.02 0.02 0.02 0.05    0 0 0 0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
    ...
    exhale2 = {
      ...
      properties = {
        airdrag            = 0.66,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.03 0.05  0.1 0.1 0.1 0.13   0.08 0.08 0.08 0.07   0 0 0 0]],
        directional        = true,
        emitrot            = 4,
        emitrotspread      = 4,
        emitvector         = [[0, 0.8, 0]],
  ...
  ["missiletrailgunshiplesssmokey"] = {
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.6,
        alwaysvisible      = true,
        colormap           = [[0.55 0.47 0.3 0.2   0.5 0.36 0 0.3    0.4 0.14 0 0.24    0.12 0.03 0 0.14    0.08 0.01 0 0.07	 0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    exhale5 = {
      ...
      properties = {
        airdrag            = 0.6,
        alwaysvisible      = true,
        colormap           = [[0.03 0.03 0.03 0  0.05 0.05 0.05 0.1   0.06 0.06 0.06 0.05   0 0 0 0]],
        directional        = true,
        emitrot            = 4,
        emitrotspread      = 4,
        emitvector         = [[0, 1, 0]],
