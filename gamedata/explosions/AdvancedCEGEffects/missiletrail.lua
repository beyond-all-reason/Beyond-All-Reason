...
return {
  ...
  ["missiletrailfighter"] = {
    ...
    engineglow = {
      ...
      water              = true,
      properties = {
        colormap           = [[0.075 0.04 0.01 0.005   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[trans]],
        length             = 66,
  ...
  ["missiletraillarge"] = {
    ...
    fire = {
      ...
      properties = {
        airdrag            = 0.25,
        colormap           = [[0.9 0.7 0.33 0.15   0.44 0.26 0.09 0.2    0.24 0.055 0 0.17    0.066 0.03 0 0.11    0.01 0.0066 0 0.06	 0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
  ...
  ["missiletrailaa"] = {
    ...
    engineglow = {
      ...
      water              = true,
      properties = {
        colormap           = [[0.066 0.02 0.06 0.005   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[trans]],
        length             = 66,
