...
return {
  ...
  ["missiletrailtiny"] = {
    ...
    engine = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.66 0.25 0.01   1.0 0.6 0.18 0.01   1.0 0.5 0.09 0.01   0.55 0.3 0.05 0.012   0 0 0 0   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[none]],
        length             = 20,
  ...
  ["missiletrailsmall"] = {
    ...
    engine = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.7 0.4 0.01   1.0 0.66 0.25 0.01   1.0 0.5 0.15 0.01   0.55 0.3 0.1 0.012   0 0 0 0   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[none]],
        length             = -26,
  ...
  ["missiletraillarge"] = {
    ...
    smoke = {
      ...
      properties = {
        airdrag            = 0.6,
        colormap           = [[0.2 0.18 0.05 0.22   0.17 0.14 0.075 0.34   0.12 0.11 0.095 0.28   0.09 0.088 0.084 0.21    0.04 0.04 0.04 0.1   0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0.0, 1, 0.0]],
	...
	dustparticles = {
      ...
      properties = {
        airdrag            = 0.77,
        colormap           = [[1 0.7 0.33 0.016    0.45 0.35 0.3 0.12    0.13 0.12 0.11 0.07    0 0 0 0.01]],
        directional        = true,
        emitrot            = 80,
        emitrotspread      = 5,
        emitvector         = [[1, 1, 1]],
  ...
  ["missiletrailaa"] = {
    ...
    engine = {
      ...
      water              = true,
      properties = {
        --colormap           = [[1 0.5 0.1 0.01   1.0 0.4 0.05 0.01   1.0 0.2 0.02 0.01   0.5 0.1 0 0.01   0 0 0 0   0 0 0 0.01]],
        colormap           = [[1 0.5 0.85 0.01   1.0 0.4 0.85 0.01   1.0 0.2 0.8 0.01   0.5 0.1 0.4 0.01   0 0 0 0   0 0 0 0.01]],
        dir                = [[dir]],
        frontoffset        = 0,
        fronttexture       = [[none]],
        length             = 32,
