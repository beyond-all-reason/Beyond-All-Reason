...
return {
  ...
  ["nuke-floor"] = {
    smoke = {
      ...
      properties = {
        airdrag            = 0.82,
        colormap           = [[0.64 0.5 0.4 0.01  0.3 0.25 0.2 0.4   0.2 0.16 0.13 0.38   0.17 0.14 0.12 0.38   0.145 0.13 0.11 0.34   0.11 0.1 0.08 0.26   0.1 0.095 0.085 0.2   0.045 0.045 0.04 0.1   0 0 0 0.01]],
        directional        = true,
        emitrot            = 100,
        emitrotspread      = 4,
        emitvector         = [[0, 1, 0]],
  ...
  ["nuke-stem"] = {
    smoke = {
      ...
      properties = {
        airdrag            = 0.89,
        colormap           = [[0.25 0.2 0.1 0.35   0.45 0.24 0.18 0.35  0.3 0.18 0.13 0.3   0.25 0.17 0.13 0.3   0.33 0.22 0.12 0.33  0.25 0.19 0.12 0.33   0.2 0.15 0.11 0.25   0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 1, 0]],
  ...
  ["nuke-head"] = {
    smoke = {
      ...
      properties = {
        airdrag            = 0.9,
        colormap           = [[0.32 0.27 0.17 0.4   0.29 0.25 0.2 0.35   0.18 0.15 0.13 0.32   0.15 0.13 0.1 0.31   0.135 0.12 0.09 0.3  0.08 0.07 0.06 0.22   0.065 0.06 0.045 0.15   0 0 0 0.01]],
        directional        = true,
        emitrot            = 100,
        emitrotspread      = 2,
        emitvector         = [[0, 1, 0]],
  ...
  ["nuke-mid"] = {
    smoke = {
      ...
      properties = {
        airdrag            = 0.82,
        colormap           = [[0.38 0.28 0.18 0.33  0.22 0.16 0.1 0.25  0.2 0.15 0.1 0.25   0.2 0.15 0.1 0.2   0.22 0.18 0.09 0.25  0.2 0.15 0.07 0.2   0.19 0.16 0.1 0.25   0 0 0 0.01]],
        directional        = true,
        emitrot            = 100,
        emitrotspread      = 1,
        emitvector         = [[0, 1, 0]],
  ...
  ["nuke-midhead"] = {
    smoke = {
      ...
      properties = {
        airdrag            = 0.8,
        colormap           = [[0.33 0.27 0.16 0.33   0.3 0.22 0.1 0.28  0.27 0.2 0.05 0.25   0.3 0.2 0.1 0.25   0.25 0.18 0.1 0.2   0.25 0.2 0.08 0.25  0.2 0.16 0.08 0.2   0.18 0.14 0.08 0.25   0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 25,
        emitvector         = [[0, 1, 0]],
