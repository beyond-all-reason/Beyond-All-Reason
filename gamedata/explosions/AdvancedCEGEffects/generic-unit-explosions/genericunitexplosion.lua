...
local definitions = {
  [root.."-tiny"] = {
    ...
    --  properties = {
    --    airdrag            = 0.82,
    --    colormap           = [[0 0 0 0   1 0.75 0.9 0.09   0.45 0.4 0.66 0.066   0.33 0.3 0.05 0.033   0 0 0 0]],
    --    directional        = true,
    --    emitrot            = 45,
    --    emitrotspread      = 32,
    --    emitvector         = [[0, 1, 0]],
  ...
  [root.."-small"] = {
    ...
    groundflash_large = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.7 0.3 0.22   0 0 0 0.01]],
        size               = 85,
        sizegrowth         = -0.7,
        ttl                = 25,
        texture            = [[groundflash]],
    ...
    groundflash_white = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.9 0.75 0.16   0 0 0 0.01]],
        size               = 85,
        sizegrowth         = 0,
        ttl                = 6,
        texture            = [[groundflash]],
  ...
  [root.."-medium"] = {
    ...
    groundflash_large = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.7 0.3 0.25   0 0 0 0.01]],
        size               = 133,
        sizegrowth         = -1,
        ttl                = 32,
        texture            = [[groundflash]],
    ...
    groundflash_white = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.9 0.75 0.18   0 0 0 0.01]],
        size               = 133,
        sizegrowth         = 0,
        ttl                = 6.5,
        texture            = [[groundflash]],
  ...
  [root.."-large"] = {
    ...
    groundflash_white = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.9 0.75 0.19   0 0 0 0.01]],
        size               = 177,
        sizegrowth         = 0,
        ttl                = 7.5,
        texture            = [[groundflash]],
  ...
  [root.."-huge"] = {
    ...
    groundflash_white = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.9 0.75 0.2   0 0 0 0.01]],
        size               = 220,
        sizegrowth         = 0,
        ttl                = 7.5,
        texture            = [[groundflash]],
  ...
  [root.."-gigantic"] = {
    ...
    groundflash_white = {
      ...
      water              = true,
      properties = {
        colormap           = [[1 0.9 0.75 0.22   0 0 0 0.01]],
        size               = 285,
        sizegrowth         = 0,
        ttl                = 8,
        texture            = [[groundflash]],
