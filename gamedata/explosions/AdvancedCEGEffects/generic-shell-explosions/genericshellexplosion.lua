  ...
  [root.."-small"] = {
    ...
    clouddust = {
      ...
      properties = {
        airdrag            = 0.91,
        alwaysvisible      = true,
        colormap           = [[0.05 0.04 0.02 0.04  0.08 0.058 0.038 0.08  0.061 0.056 0.026 0.055  0.024 0.022 0.02 0.032  0 0 0 0]],
        directional        = true,
        emitrot            = 45,
        emitrotspread      = 4,
    ...
    grounddust = {
      ...
      properties = {
        airdrag            = 0.88,
        alwaysvisible      = true,
        colormap           = [[0.21 0.16 0.08 0.24 	0 0 0 0.0]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0, 1.3, 0]],
  ...
  [root.."-medium"] = {
    ...
    grounddust = {
      ...
      properties = {
        airdrag            = 0.8,
        alwaysvisible      = true,
        colormap           = [[0.18 0.13 0.06 0.18 	0 0 0 0.0]],
        directional        = false,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0, 1, 0]],
