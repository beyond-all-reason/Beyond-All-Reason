...
return {
  ["genericshellexplosion-small"] = {
    ...
    dirt = {
      ...
      properties = {
        airdrag            = 1,
        alwaysvisible      = true,
        colormap           = [[0.04 0.03 0.01 0   0.1 0.07 0.033 0.6    0.02 0.02 0.2 0.25   0.08 0.065 0.035 0.45   0.075 0.07 0.06 0.35   0 0 0 0  ]],
        directional        = true,
        emitrot            = 45,
        emitrotspread      = 32,
        emitvector         = [[0, 1, 0]],
  ...
  ["genericshellexplosion-large"] = {
    ...
    orangeexplosionsparks1 = {	-- part of inner explosion
      air                = true,
      class              = [[CSimpleParticleSystem]],
      count              = 1,
      ground             = true,
      ...
      properties = {
        airdrag            = 0.82,
        alwaysvisible      = true,
        colormap           = [[0.8 0.5 0.2 0.05   0.9 0.5 0.2 0.01   0 0 0 0]],
        directional        = true,
        emitrot            = 45,
        emitrotspread      = 32,
        emitvector         = [[0, 1, 0]],
