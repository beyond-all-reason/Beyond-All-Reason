  ...
  ["deathceg3"] = {
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.70,
        alwaysvisible      = true,
        colormap           = [[0.5 0.3 0.0 0.04    0.25 0.25 0.25 0.05	0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0.0, 1, 0.0]],
  ...
  ["deathceg4"] = {
    core = {
      ...
      properties = {
        airdrag            = 0.70,
        alwaysvisible      = true,
        colormap           = [[0.1 0.1 0.1 0.01    0.5 0.3 0.0 0.04    0.1 0.1 0.1 0.005	0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0.0, 1, 0.0]],
    ...
    smokeandfire = {
      ...
      properties = {
        airdrag            = 0.70,
        alwaysvisible      = true,
        colormap           = [[0 0 0 0.2    0 0 0 0.3	 0 0 0 0.01]],
        directional        = true,
        emitrot            = 90,
        emitrotspread      = 0,
        emitvector         = [[0.0, 1, 0.0]],
