...
local function scavUnitDef_Post(name, uDef)
	...
	if uDef.buildpic then
		...
		if
			(not string.find(uDef.buildpic, "scavengers"))
			...
			and (VFS.FileExists("unitpics/scavengers/" .. uDef.buildpic))
		then
	...
	if uDef.explodeas then
		if
			string.find(string.lower(uDef.explodeas), "explosiongeneric")
			or string.find(string.lower(uDef.explodeas), "buildingexplosiongeneric")
			or string.find(string.lower(uDef.explodeas), "explosiont3")
			or string.find(string.lower(uDef.explodeas), "bantha")
			or string.find(string.lower(uDef.explodeas), "lootbox")
		then
	...
	if uDef.selfdestructas then
		if
			string.find(string.lower(uDef.selfdestructas), "explosiongeneric")
			or string.find(string.lower(uDef.selfdestructas), "buildingexplosiongeneric")
			or string.find(string.lower(uDef.selfdestructas), "explosiont3")
			or string.find(string.lower(uDef.selfdestructas), "bantha")
			or string.find(string.lower(uDef.selfdestructas), "lootbox")
		then
	...
	if
		...
		or name == "corcom_scav"
		or name == "legcom_scav"
		or string.find(name, "armcomlvl")
		or string.find(name, "corcomlvl")
		or string.find(name, "legcomlvl")
	then
