...
-- absent outside a game (unitsync, specs) reads as disabled
local tractorBeamMode = modOptions.beta_tractorbeam
local tractorBeamEnabled = tractorBeamMode ~= nil and tractorBeamMode ~= "disabled"
if not tractorBeamEnabled then
	tractorBeamMode = nil
end
