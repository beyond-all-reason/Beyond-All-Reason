...
local function installCommandIDs()
	...
	local CMD = _G.CMD
	CMD.INSERT = CMD.INSERT or 1
	CMD.MOVE = CMD.MOVE or 10
	CMD.ATTACK = CMD.ATTACK or 20
	CMD.GUARD = CMD.GUARD or 25
	CMD.REPAIR = CMD.REPAIR or 40
	CMD.LOAD_UNITS = CMD.LOAD_UNITS or 75
	CMD.RECLAIM = CMD.RECLAIM or 90
	CMD.RESURRECT = CMD.RESURRECT or 125
	CMD.CAPTURE = CMD.CAPTURE or 130
