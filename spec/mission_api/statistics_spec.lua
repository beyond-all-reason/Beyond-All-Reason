...
describe("mission_api.statistics", function()
		...
		GG['MissionAPI'] = {
			...
			Modules = {
				Objectives = {
					...
					UpdateObjectiveProgress = function(objectiveID, teamID, unitDefName, unitNames, direction, managedObjective)
	...
	it("re-fires at each quantity milestone (2*q, 3*q, ...)", function()
		...
		for _ = 1, 6 do statistics.Increment(TRIGGER_TYPE, 0, 'armwar', {}) end
