...
local unitIDs = {}
GG["MissionAPI"].trackedUnitIDs = unitIDs
local unitNames = {}
GG["MissionAPI"].trackedUnitNames = unitNames
local featureIDs = {}
GG["MissionAPI"].trackedFeatureIDs = featureIDs
local featureNames = {}
GG["MissionAPI"].trackedFeatureNames = featureNames
