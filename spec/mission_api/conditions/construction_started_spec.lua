...
local constructionStarted = VFS.Include("luarules/mission_api/conditions/construction_started.lua")
...
describe("mission_api.conditions.construction_started", function()
