...
local constructionFinished = VFS.Include('luarules/mission_api/conditions/construction_finished.lua')
local onUnitFinished = constructionFinished.callins.UnitFinished

describe("mission_api.conditions.construction_finished", function()
