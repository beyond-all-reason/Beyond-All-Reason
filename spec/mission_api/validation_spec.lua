...
GG["MissionAPI"].ConditionDefinitions = VFS.Include("luarules/mission_api/conditions_loader.lua")
...
describe("mission_api.validation", function()
	...
	describe("ValidateObjectives", function()
		...
		it("logs an error for a missing required parameter", function()
			...
			assert.is_true(
				hasError("Objective missing required parameter. Objective: missingParam, Parameter: seconds")
			)
		end)
		...
		it("rejects count on a metric objective", function()
			...
			assert.is_true(
				hasError("Metric conditions are thresholded with atLeast/atMost, not count. Objective: wrongThreshold")
			)
		end)
		...
		it("rejects atLeast/atMost on an event objective", function()
			...
			assert.is_true(
				hasError("Event conditions are thresholded with count, not atLeast/atMost. Objective: wrongThreshold")
			)
		end)
