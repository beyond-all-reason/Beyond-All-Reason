...
local disableActions = VFS.Include('luarules/mission_api/actions/disable_trigger.lua')
local enableActions  = VFS.Include('luarules/mission_api/actions/enable_trigger.lua')
