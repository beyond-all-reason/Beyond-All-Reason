...
_G.UnitDefNames = {}
Spring.GetTeamUnits        = function(teamID)        return {} end
Spring.GetTeamUnitsByDefs  = function(teamID, defID) return {} end
Spring.GetAllyTeamList     = function()              return {} end
Spring.GetTeamList         = function(allyTeamID)    return {} end
...
describe("mission_api.actions.name_units", function()
    ...
    before_each(function()
        ...
        Spring.GetTeamUnitsByDefs  = function() return {} end
        Spring.GetAllyTeamList     = function() return {} end
        Spring.GetTeamList         = function() return {} end
        Spring.GetUnitsInRectangle = function() return {} end
        Spring.GetUnitsInCylinder  = function() return {} end
    end)
