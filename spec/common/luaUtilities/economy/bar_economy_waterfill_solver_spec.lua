...
local function modOptions(opts)
  return {
    ...
    [ModeEnums.ModOptions.PlayerMetalSendThreshold] = opts.metalThreshold or 0,
    [ModeEnums.ModOptions.PlayerEnergySendThreshold] = opts.energyThreshold or 0,
  }
end
...
describe("Bar economy ProcessEconomy", function()
  ...
  it("balances overflow without tax #focus", function()
    ...
    local cumulativeKey = ResourceShared.GetPassiveCumulativeParam(TransferEnums.ResourceType.METAL)
