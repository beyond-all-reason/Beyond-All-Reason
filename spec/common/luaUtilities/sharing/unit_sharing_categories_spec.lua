local Categories = VFS.Include("common/luaUtilities/sharing/unit_sharing_categories.lua")
...
describe("unit_sharing_categories #categories", function()
	...
	describe("isTransportDef", function()
		it("should return true for flying transports (any tech)", function()
			assert.is_true(Categories.isTransportDef({ canFly = true, transportCapacity = 8, customParams = { techlevel = "2" } }))
		end)
