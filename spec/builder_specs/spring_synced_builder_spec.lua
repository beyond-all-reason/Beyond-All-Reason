...
describe("SpringSyncedBuilder", function()
	it("should build spring mocks with teams", function()
		...
		local spring = Builders.Spring.new():WithTeam(team1):WithTeam(team2):WithAlliance(team1.id, team2.id, true):Build()
	...
	it("should integrate real unit definitions", function()
		...
		local spring = Builders.Spring.new():WithRealUnitDefs():WithTeam(teamBuilder):Build()
