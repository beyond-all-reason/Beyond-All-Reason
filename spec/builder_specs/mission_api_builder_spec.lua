...
describe("MissionApiBuilder", function()
	...
	describe("module call tracking", function()
		...
		it("records Objectives calls", function()
			...
			api.Modules.Objectives.SetObjectiveCompleted("obj1", true)
			api.Modules.Objectives.IncrementObjectiveProgress("obj1")
			...
			assert.are.equal("obj1", api.calls.setObjectiveCompleted[1].objectiveID)
			assert.is_true(api.calls.setObjectiveCompleted[1].completed)
			assert.are.equal("obj1", api.calls.incrementObjectiveProgress[1].objectiveID)
		...
		it("clears every tracked call list via clearCalls", function()
			...
			api.Modules.Objectives.SetObjectiveCompleted("o", true)
			api.Modules.Objectives.IncrementObjectiveProgress("o")
			...
			assert.are.equal(0, #api.calls.setObjectiveCompleted)
			assert.are.equal(0, #api.calls.incrementObjectiveProgress)
