...
local function buildSpring(opts, teams)
  ...
  builder:WithModOption(ModeEnums.ModOptions.PlayerMetalSendThreshold, opts.metalThreshold or 0)
  builder:WithModOption(ModeEnums.ModOptions.PlayerEnergySendThreshold, opts.energyThreshold or 0)
  for i = 1, #teams do
